...
part 'generated_search_result_poll_result56.g.dart';

abstract class SearchResultPollResult56
    implements Built<SearchResultPollResult56, SearchResultPollResult56Builder> {
  SearchResultPollResult56._();

  factory SearchResultPollResult56([updates(SearchResultPollResult56Builder b)]) =
  ...
  BuiltList<VehicleInfoList56> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap56> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap56> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups56> get filterGroups;
  ...
  static Serializer<SearchResultPollResult56> get serializer =>
      _$searchResultPollResult56Serializer;
}

abstract class VehicleInfoList56
    implements Built<VehicleInfoList56, VehicleInfoList56Builder> {
  VehicleInfoList56._();

  factory VehicleInfoList56([updates(VehicleInfoList56Builder b)]) =
      _$VehicleInfoList56;
  ...
  BuiltList<Packages56> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic56> get options;
  ...
  static Serializer<VehicleInfoList56> get serializer =>
      _$vehicleInfoList56Serializer;
}

abstract class VehicleCharacteristic56
    implements Built<VehicleCharacteristic56, VehicleCharacteristic56Builder> {
  VehicleCharacteristic56._();

  factory VehicleCharacteristic56([updates(VehicleCharacteristic56Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic56> get serializer =>
      _$vehicleCharacteristic56Serializer;
}

abstract class Service56 implements Built<Service56, Service56Builder> {
  Service56._();

  factory Service56([updates(Service56Builder b)]) = _$Service56;
  ...
  static Serializer<Service56> get serializer => _$service56Serializer;
}

abstract class Price56 implements Built<Price56, Price56Builder> {
  Price56._();

  factory Price56([updates(Price56Builder b)]) = _$Price56;
  ...
  static Serializer<Price56> get serializer => _$price56Serializer;
}

abstract class Packages56 implements Built<Packages56, Packages56Builder> {
  Packages56._();

  factory Packages56([updates(Packages56Builder b)]) = _$Packages56;
  ...
  PackageLabelInfo56 get packageLabelInfo;

  static Serializer<Packages56> get serializer => _$packages56Serializer;
}

abstract class Coverage56 implements Built<Coverage56, Coverage56Builder> {
  Coverage56._();

  factory Coverage56([updates(Coverage56Builder b)]) = _$Coverage56;
  ...
  InsuredPerson56 get insuredPerson;
  ...
  BuiltList<SubInsurances56> get subInsurances;

  static Serializer<Coverage56> get serializer => _$coverage56Serializer;
}

abstract class InsuredPerson56
    implements Built<InsuredPerson56, InsuredPerson56Builder> {
  InsuredPerson56._();

  factory InsuredPerson56([updates(InsuredPerson56Builder b)]) = _$InsuredPerson56;
  ...
  static Serializer<InsuredPerson56> get serializer => _$insuredPerson56Serializer;
}

abstract class SubInsurances56
    implements Built<SubInsurances56, SubInsurances56Builder> {
  SubInsurances56._();

  factory SubInsurances56([updates(SubInsurances56Builder b)]) = _$SubInsurances56;
  ...
  static Serializer<SubInsurances56> get serializer => _$subInsurances56Serializer;
}

abstract class ShopMap56 implements Built<ShopMap56, ShopMap56Builder> {
  ShopMap56._();

  factory ShopMap56([updates(ShopMap56Builder b)]) = _$ShopMap56;
  ...
  static Serializer<ShopMap56> get serializer => _$shopMap56Serializer;
}

abstract class SupplierMap56 implements Built<SupplierMap56, SupplierMap56Builder> {
  SupplierMap56._();

  factory SupplierMap56([updates(SupplierMap56Builder b)]) = _$SupplierMap56;
  ...
  static Serializer<SupplierMap56> get serializer => _$supplierMap56Serializer;
}

abstract class FilterGroups56
    implements Built<FilterGroups56, FilterGroups56Builder> {
  FilterGroups56._();

  factory FilterGroups56([updates(FilterGroups56Builder b)]) = _$FilterGroups56;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options56> get options;

  static Serializer<FilterGroups56> get serializer => _$filterGroups56Serializer;
}

abstract class Options56 implements Built<Options56, Options56Builder> {
  Options56._();

  factory Options56([updates(Options56Builder b)]) = _$Options56;
  ...
  static Serializer<Options56> get serializer => _$options56Serializer;
}

abstract class PackageLabelInfo56
    implements Built<PackageLabelInfo56, PackageLabelInfo56Builder> {
  PackageLabelInfo56._();

  factory PackageLabelInfo56([updates(PackageLabelInfo56Builder b)]) =
      _$PackageLabelInfo56;
  ...
  static Serializer<PackageLabelInfo56> get serializer =>
      _$packageLabelInfo56Serializer;
}

abstract class ActivityList56
    implements Built<ActivityList56, ActivityList56Builder> {
  ActivityList56._();

  factory ActivityList56([update(ActivityList56Builder b)]) = _$ActivityList56;
  ...
  CardTags56 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList56> get serializer => _$activityList56Serializer;
}

abstract class CardTags56 implements Built<CardTags56, CardTags56Builder> {
  CardTags56._();

  factory CardTags56([update(CardTags56Builder b)]) = _$CardTags56;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags56> get serializer => _$cardTags56Serializer;
}
