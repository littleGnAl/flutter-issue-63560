...
part 'generated_search_result_poll_result57.g.dart';

abstract class SearchResultPollResult57
    implements Built<SearchResultPollResult57, SearchResultPollResult57Builder> {
  SearchResultPollResult57._();

  factory SearchResultPollResult57([updates(SearchResultPollResult57Builder b)]) =
  ...
  BuiltList<VehicleInfoList57> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap57> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap57> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups57> get filterGroups;
  ...
  static Serializer<SearchResultPollResult57> get serializer =>
      _$searchResultPollResult57Serializer;
}

abstract class VehicleInfoList57
    implements Built<VehicleInfoList57, VehicleInfoList57Builder> {
  VehicleInfoList57._();

  factory VehicleInfoList57([updates(VehicleInfoList57Builder b)]) =
      _$VehicleInfoList57;
  ...
  BuiltList<Packages57> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic57> get options;
  ...
  static Serializer<VehicleInfoList57> get serializer =>
      _$vehicleInfoList57Serializer;
}

abstract class VehicleCharacteristic57
    implements Built<VehicleCharacteristic57, VehicleCharacteristic57Builder> {
  VehicleCharacteristic57._();

  factory VehicleCharacteristic57([updates(VehicleCharacteristic57Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic57> get serializer =>
      _$vehicleCharacteristic57Serializer;
}

abstract class Service57 implements Built<Service57, Service57Builder> {
  Service57._();

  factory Service57([updates(Service57Builder b)]) = _$Service57;
  ...
  static Serializer<Service57> get serializer => _$service57Serializer;
}

abstract class Price57 implements Built<Price57, Price57Builder> {
  Price57._();

  factory Price57([updates(Price57Builder b)]) = _$Price57;
  ...
  static Serializer<Price57> get serializer => _$price57Serializer;
}

abstract class Packages57 implements Built<Packages57, Packages57Builder> {
  Packages57._();

  factory Packages57([updates(Packages57Builder b)]) = _$Packages57;
  ...
  PackageLabelInfo57 get packageLabelInfo;

  static Serializer<Packages57> get serializer => _$packages57Serializer;
}

abstract class Coverage57 implements Built<Coverage57, Coverage57Builder> {
  Coverage57._();

  factory Coverage57([updates(Coverage57Builder b)]) = _$Coverage57;
  ...
  InsuredPerson57 get insuredPerson;
  ...
  BuiltList<SubInsurances57> get subInsurances;

  static Serializer<Coverage57> get serializer => _$coverage57Serializer;
}

abstract class InsuredPerson57
    implements Built<InsuredPerson57, InsuredPerson57Builder> {
  InsuredPerson57._();

  factory InsuredPerson57([updates(InsuredPerson57Builder b)]) = _$InsuredPerson57;
  ...
  static Serializer<InsuredPerson57> get serializer => _$insuredPerson57Serializer;
}

abstract class SubInsurances57
    implements Built<SubInsurances57, SubInsurances57Builder> {
  SubInsurances57._();

  factory SubInsurances57([updates(SubInsurances57Builder b)]) = _$SubInsurances57;
  ...
  static Serializer<SubInsurances57> get serializer => _$subInsurances57Serializer;
}

abstract class ShopMap57 implements Built<ShopMap57, ShopMap57Builder> {
  ShopMap57._();

  factory ShopMap57([updates(ShopMap57Builder b)]) = _$ShopMap57;
  ...
  static Serializer<ShopMap57> get serializer => _$shopMap57Serializer;
}

abstract class SupplierMap57 implements Built<SupplierMap57, SupplierMap57Builder> {
  SupplierMap57._();

  factory SupplierMap57([updates(SupplierMap57Builder b)]) = _$SupplierMap57;
  ...
  static Serializer<SupplierMap57> get serializer => _$supplierMap57Serializer;
}

abstract class FilterGroups57
    implements Built<FilterGroups57, FilterGroups57Builder> {
  FilterGroups57._();

  factory FilterGroups57([updates(FilterGroups57Builder b)]) = _$FilterGroups57;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options57> get options;

  static Serializer<FilterGroups57> get serializer => _$filterGroups57Serializer;
}

abstract class Options57 implements Built<Options57, Options57Builder> {
  Options57._();

  factory Options57([updates(Options57Builder b)]) = _$Options57;
  ...
  static Serializer<Options57> get serializer => _$options57Serializer;
}

abstract class PackageLabelInfo57
    implements Built<PackageLabelInfo57, PackageLabelInfo57Builder> {
  PackageLabelInfo57._();

  factory PackageLabelInfo57([updates(PackageLabelInfo57Builder b)]) =
      _$PackageLabelInfo57;
  ...
  static Serializer<PackageLabelInfo57> get serializer =>
      _$packageLabelInfo57Serializer;
}

abstract class ActivityList57
    implements Built<ActivityList57, ActivityList57Builder> {
  ActivityList57._();

  factory ActivityList57([update(ActivityList57Builder b)]) = _$ActivityList57;
  ...
  CardTags57 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList57> get serializer => _$activityList57Serializer;
}

abstract class CardTags57 implements Built<CardTags57, CardTags57Builder> {
  CardTags57._();

  factory CardTags57([update(CardTags57Builder b)]) = _$CardTags57;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags57> get serializer => _$cardTags57Serializer;
}

@SerializersFor([
  SearchResultPollResult57,
])
final Serializers serializers57 = _$serializers57;
