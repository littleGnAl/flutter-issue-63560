...
part 'generated_search_result_poll_result15.g.dart';

abstract class SearchResultPollResult15
    implements Built<SearchResultPollResult15, SearchResultPollResult15Builder> {
  SearchResultPollResult15._();

  factory SearchResultPollResult15([updates(SearchResultPollResult15Builder b)]) =
  ...
  BuiltList<VehicleInfoList15> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap15> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap15> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups15> get filterGroups;
  ...
  static Serializer<SearchResultPollResult15> get serializer =>
      _$searchResultPollResult15Serializer;
}

abstract class VehicleInfoList15
    implements Built<VehicleInfoList15, VehicleInfoList15Builder> {
  VehicleInfoList15._();

  factory VehicleInfoList15([updates(VehicleInfoList15Builder b)]) =
      _$VehicleInfoList15;
  ...
  BuiltList<Packages15> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic15> get options;
  ...
  static Serializer<VehicleInfoList15> get serializer =>
      _$vehicleInfoList15Serializer;
}

abstract class VehicleCharacteristic15
    implements Built<VehicleCharacteristic15, VehicleCharacteristic15Builder> {
  VehicleCharacteristic15._();

  factory VehicleCharacteristic15([updates(VehicleCharacteristic15Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic15> get serializer =>
      _$vehicleCharacteristic15Serializer;
}

abstract class Service15 implements Built<Service15, Service15Builder> {
  Service15._();

  factory Service15([updates(Service15Builder b)]) = _$Service15;
  ...
  static Serializer<Service15> get serializer => _$service15Serializer;
}

abstract class Price15 implements Built<Price15, Price15Builder> {
  Price15._();

  factory Price15([updates(Price15Builder b)]) = _$Price15;
  ...
  static Serializer<Price15> get serializer => _$price15Serializer;
}

abstract class Packages15 implements Built<Packages15, Packages15Builder> {
  Packages15._();

  factory Packages15([updates(Packages15Builder b)]) = _$Packages15;
  ...
  PackageLabelInfo15 get packageLabelInfo;

  static Serializer<Packages15> get serializer => _$packages15Serializer;
}

abstract class Coverage15 implements Built<Coverage15, Coverage15Builder> {
  Coverage15._();

  factory Coverage15([updates(Coverage15Builder b)]) = _$Coverage15;
  ...
  InsuredPerson15 get insuredPerson;
  ...
  BuiltList<SubInsurances15> get subInsurances;

  static Serializer<Coverage15> get serializer => _$coverage15Serializer;
}

abstract class InsuredPerson15
    implements Built<InsuredPerson15, InsuredPerson15Builder> {
  InsuredPerson15._();

  factory InsuredPerson15([updates(InsuredPerson15Builder b)]) = _$InsuredPerson15;
  ...
  static Serializer<InsuredPerson15> get serializer => _$insuredPerson15Serializer;
}

abstract class SubInsurances15
    implements Built<SubInsurances15, SubInsurances15Builder> {
  SubInsurances15._();

  factory SubInsurances15([updates(SubInsurances15Builder b)]) = _$SubInsurances15;
  ...
  static Serializer<SubInsurances15> get serializer => _$subInsurances15Serializer;
}

abstract class ShopMap15 implements Built<ShopMap15, ShopMap15Builder> {
  ShopMap15._();

  factory ShopMap15([updates(ShopMap15Builder b)]) = _$ShopMap15;
  ...
  static Serializer<ShopMap15> get serializer => _$shopMap15Serializer;
}

abstract class SupplierMap15 implements Built<SupplierMap15, SupplierMap15Builder> {
  SupplierMap15._();

  factory SupplierMap15([updates(SupplierMap15Builder b)]) = _$SupplierMap15;
  ...
  static Serializer<SupplierMap15> get serializer => _$supplierMap15Serializer;
}

abstract class FilterGroups15
    implements Built<FilterGroups15, FilterGroups15Builder> {
  FilterGroups15._();

  factory FilterGroups15([updates(FilterGroups15Builder b)]) = _$FilterGroups15;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options15> get options;

  static Serializer<FilterGroups15> get serializer => _$filterGroups15Serializer;
}

abstract class Options15 implements Built<Options15, Options15Builder> {
  Options15._();

  factory Options15([updates(Options15Builder b)]) = _$Options15;
  ...
  static Serializer<Options15> get serializer => _$options15Serializer;
}

abstract class PackageLabelInfo15
    implements Built<PackageLabelInfo15, PackageLabelInfo15Builder> {
  PackageLabelInfo15._();

  factory PackageLabelInfo15([updates(PackageLabelInfo15Builder b)]) =
      _$PackageLabelInfo15;
  ...
  static Serializer<PackageLabelInfo15> get serializer =>
      _$packageLabelInfo15Serializer;
}

abstract class ActivityList15
    implements Built<ActivityList15, ActivityList15Builder> {
  ActivityList15._();

  factory ActivityList15([update(ActivityList15Builder b)]) = _$ActivityList15;
  ...
  CardTags15 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList15> get serializer => _$activityList15Serializer;
}

abstract class CardTags15 implements Built<CardTags15, CardTags15Builder> {
  CardTags15._();

  factory CardTags15([update(CardTags15Builder b)]) = _$CardTags15;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags15> get serializer => _$cardTags15Serializer;
}

@SerializersFor([
  SearchResultPollResult15,
])
final Serializers serializers15 = _$serializers15;
