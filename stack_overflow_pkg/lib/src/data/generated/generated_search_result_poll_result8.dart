...
part 'generated_search_result_poll_result8.g.dart';

abstract class SearchResultPollResult8
    implements Built<SearchResultPollResult8, SearchResultPollResult8Builder> {
  SearchResultPollResult8._();

  factory SearchResultPollResult8([updates(SearchResultPollResult8Builder b)]) =
  ...
  BuiltList<VehicleInfoList8> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap8> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap8> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups8> get filterGroups;
  ...
  static Serializer<SearchResultPollResult8> get serializer =>
      _$searchResultPollResult8Serializer;
}

abstract class VehicleInfoList8
    implements Built<VehicleInfoList8, VehicleInfoList8Builder> {
  VehicleInfoList8._();

  factory VehicleInfoList8([updates(VehicleInfoList8Builder b)]) =
      _$VehicleInfoList8;
  ...
  BuiltList<Packages8> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic8> get options;
  ...
  static Serializer<VehicleInfoList8> get serializer =>
      _$vehicleInfoList8Serializer;
}

abstract class VehicleCharacteristic8
    implements Built<VehicleCharacteristic8, VehicleCharacteristic8Builder> {
  VehicleCharacteristic8._();

  factory VehicleCharacteristic8([updates(VehicleCharacteristic8Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic8> get serializer =>
      _$vehicleCharacteristic8Serializer;
}

abstract class Service8 implements Built<Service8, Service8Builder> {
  Service8._();

  factory Service8([updates(Service8Builder b)]) = _$Service8;
  ...
  static Serializer<Service8> get serializer => _$service8Serializer;
}

abstract class Price8 implements Built<Price8, Price8Builder> {
  Price8._();

  factory Price8([updates(Price8Builder b)]) = _$Price8;
  ...
  static Serializer<Price8> get serializer => _$price8Serializer;
}

abstract class Packages8 implements Built<Packages8, Packages8Builder> {
  Packages8._();

  factory Packages8([updates(Packages8Builder b)]) = _$Packages8;
  ...
  PackageLabelInfo8 get packageLabelInfo;

  static Serializer<Packages8> get serializer => _$packages8Serializer;
}

abstract class Coverage8 implements Built<Coverage8, Coverage8Builder> {
  Coverage8._();

  factory Coverage8([updates(Coverage8Builder b)]) = _$Coverage8;
  ...
  InsuredPerson8 get insuredPerson;
  ...
  BuiltList<SubInsurances8> get subInsurances;

  static Serializer<Coverage8> get serializer => _$coverage8Serializer;
}

abstract class InsuredPerson8
    implements Built<InsuredPerson8, InsuredPerson8Builder> {
  InsuredPerson8._();

  factory InsuredPerson8([updates(InsuredPerson8Builder b)]) = _$InsuredPerson8;
  ...
  static Serializer<InsuredPerson8> get serializer => _$insuredPerson8Serializer;
}

abstract class SubInsurances8
    implements Built<SubInsurances8, SubInsurances8Builder> {
  SubInsurances8._();

  factory SubInsurances8([updates(SubInsurances8Builder b)]) = _$SubInsurances8;
  ...
  static Serializer<SubInsurances8> get serializer => _$subInsurances8Serializer;
}

abstract class ShopMap8 implements Built<ShopMap8, ShopMap8Builder> {
  ShopMap8._();

  factory ShopMap8([updates(ShopMap8Builder b)]) = _$ShopMap8;
  ...
  static Serializer<ShopMap8> get serializer => _$shopMap8Serializer;
}

abstract class SupplierMap8 implements Built<SupplierMap8, SupplierMap8Builder> {
  SupplierMap8._();

  factory SupplierMap8([updates(SupplierMap8Builder b)]) = _$SupplierMap8;
  ...
  static Serializer<SupplierMap8> get serializer => _$supplierMap8Serializer;
}

abstract class FilterGroups8
    implements Built<FilterGroups8, FilterGroups8Builder> {
  FilterGroups8._();

  factory FilterGroups8([updates(FilterGroups8Builder b)]) = _$FilterGroups8;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options8> get options;

  static Serializer<FilterGroups8> get serializer => _$filterGroups8Serializer;
}

abstract class Options8 implements Built<Options8, Options8Builder> {
  Options8._();

  factory Options8([updates(Options8Builder b)]) = _$Options8;
  ...
  static Serializer<Options8> get serializer => _$options8Serializer;
}

abstract class PackageLabelInfo8
    implements Built<PackageLabelInfo8, PackageLabelInfo8Builder> {
  PackageLabelInfo8._();

  factory PackageLabelInfo8([updates(PackageLabelInfo8Builder b)]) =
      _$PackageLabelInfo8;
  ...
  static Serializer<PackageLabelInfo8> get serializer =>
      _$packageLabelInfo8Serializer;
}

abstract class ActivityList8
    implements Built<ActivityList8, ActivityList8Builder> {
  ActivityList8._();

  factory ActivityList8([update(ActivityList8Builder b)]) = _$ActivityList8;
  ...
  CardTags8 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList8> get serializer => _$activityList8Serializer;
}

abstract class CardTags8 implements Built<CardTags8, CardTags8Builder> {
  CardTags8._();

  factory CardTags8([update(CardTags8Builder b)]) = _$CardTags8;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags8> get serializer => _$cardTags8Serializer;
}
