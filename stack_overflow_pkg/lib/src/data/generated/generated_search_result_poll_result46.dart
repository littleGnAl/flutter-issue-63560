...
part 'generated_search_result_poll_result46.g.dart';

abstract class SearchResultPollResult46
    implements Built<SearchResultPollResult46, SearchResultPollResult46Builder> {
  SearchResultPollResult46._();

  factory SearchResultPollResult46([updates(SearchResultPollResult46Builder b)]) =
  ...
  BuiltList<VehicleInfoList46> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap46> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap46> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups46> get filterGroups;
  ...
  static Serializer<SearchResultPollResult46> get serializer =>
      _$searchResultPollResult46Serializer;
}

abstract class VehicleInfoList46
    implements Built<VehicleInfoList46, VehicleInfoList46Builder> {
  VehicleInfoList46._();

  factory VehicleInfoList46([updates(VehicleInfoList46Builder b)]) =
      _$VehicleInfoList46;
  ...
  BuiltList<Packages46> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic46> get options;
  ...
  static Serializer<VehicleInfoList46> get serializer =>
      _$vehicleInfoList46Serializer;
}

abstract class VehicleCharacteristic46
    implements Built<VehicleCharacteristic46, VehicleCharacteristic46Builder> {
  VehicleCharacteristic46._();

  factory VehicleCharacteristic46([updates(VehicleCharacteristic46Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic46> get serializer =>
      _$vehicleCharacteristic46Serializer;
}

abstract class Service46 implements Built<Service46, Service46Builder> {
  Service46._();

  factory Service46([updates(Service46Builder b)]) = _$Service46;
  ...
  static Serializer<Service46> get serializer => _$service46Serializer;
}

abstract class Price46 implements Built<Price46, Price46Builder> {
  Price46._();

  factory Price46([updates(Price46Builder b)]) = _$Price46;
  ...
  static Serializer<Price46> get serializer => _$price46Serializer;
}

abstract class Packages46 implements Built<Packages46, Packages46Builder> {
  Packages46._();

  factory Packages46([updates(Packages46Builder b)]) = _$Packages46;
  ...
  PackageLabelInfo46 get packageLabelInfo;

  static Serializer<Packages46> get serializer => _$packages46Serializer;
}

abstract class Coverage46 implements Built<Coverage46, Coverage46Builder> {
  Coverage46._();

  factory Coverage46([updates(Coverage46Builder b)]) = _$Coverage46;
  ...
  InsuredPerson46 get insuredPerson;
  ...
  BuiltList<SubInsurances46> get subInsurances;

  static Serializer<Coverage46> get serializer => _$coverage46Serializer;
}

abstract class InsuredPerson46
    implements Built<InsuredPerson46, InsuredPerson46Builder> {
  InsuredPerson46._();

  factory InsuredPerson46([updates(InsuredPerson46Builder b)]) = _$InsuredPerson46;
  ...
  static Serializer<InsuredPerson46> get serializer => _$insuredPerson46Serializer;
}

abstract class SubInsurances46
    implements Built<SubInsurances46, SubInsurances46Builder> {
  SubInsurances46._();

  factory SubInsurances46([updates(SubInsurances46Builder b)]) = _$SubInsurances46;
  ...
  static Serializer<SubInsurances46> get serializer => _$subInsurances46Serializer;
}

abstract class ShopMap46 implements Built<ShopMap46, ShopMap46Builder> {
  ShopMap46._();

  factory ShopMap46([updates(ShopMap46Builder b)]) = _$ShopMap46;
  ...
  static Serializer<ShopMap46> get serializer => _$shopMap46Serializer;
}

abstract class SupplierMap46 implements Built<SupplierMap46, SupplierMap46Builder> {
  SupplierMap46._();

  factory SupplierMap46([updates(SupplierMap46Builder b)]) = _$SupplierMap46;
  ...
  static Serializer<SupplierMap46> get serializer => _$supplierMap46Serializer;
}

abstract class FilterGroups46
    implements Built<FilterGroups46, FilterGroups46Builder> {
  FilterGroups46._();

  factory FilterGroups46([updates(FilterGroups46Builder b)]) = _$FilterGroups46;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options46> get options;

  static Serializer<FilterGroups46> get serializer => _$filterGroups46Serializer;
}

abstract class Options46 implements Built<Options46, Options46Builder> {
  Options46._();

  factory Options46([updates(Options46Builder b)]) = _$Options46;
  ...
  static Serializer<Options46> get serializer => _$options46Serializer;
}

abstract class PackageLabelInfo46
    implements Built<PackageLabelInfo46, PackageLabelInfo46Builder> {
  PackageLabelInfo46._();

  factory PackageLabelInfo46([updates(PackageLabelInfo46Builder b)]) =
      _$PackageLabelInfo46;
  ...
  static Serializer<PackageLabelInfo46> get serializer =>
      _$packageLabelInfo46Serializer;
}

abstract class ActivityList46
    implements Built<ActivityList46, ActivityList46Builder> {
  ActivityList46._();

  factory ActivityList46([update(ActivityList46Builder b)]) = _$ActivityList46;
  ...
  CardTags46 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList46> get serializer => _$activityList46Serializer;
}

abstract class CardTags46 implements Built<CardTags46, CardTags46Builder> {
  CardTags46._();

  factory CardTags46([update(CardTags46Builder b)]) = _$CardTags46;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags46> get serializer => _$cardTags46Serializer;
}

@SerializersFor([
  SearchResultPollResult46,
])
final Serializers serializers46 = _$serializers46;
