...
part 'generated_search_result_poll_result77.g.dart';

abstract class SearchResultPollResult77
    implements Built<SearchResultPollResult77, SearchResultPollResult77Builder> {
  SearchResultPollResult77._();

  factory SearchResultPollResult77([updates(SearchResultPollResult77Builder b)]) =
  ...
  BuiltList<VehicleInfoList77> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap77> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap77> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups77> get filterGroups;
  ...
  static Serializer<SearchResultPollResult77> get serializer =>
      _$searchResultPollResult77Serializer;
}

abstract class VehicleInfoList77
    implements Built<VehicleInfoList77, VehicleInfoList77Builder> {
  VehicleInfoList77._();

  factory VehicleInfoList77([updates(VehicleInfoList77Builder b)]) =
      _$VehicleInfoList77;
  ...
  BuiltList<Packages77> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic77> get options;
  ...
  static Serializer<VehicleInfoList77> get serializer =>
      _$vehicleInfoList77Serializer;
}

abstract class VehicleCharacteristic77
    implements Built<VehicleCharacteristic77, VehicleCharacteristic77Builder> {
  VehicleCharacteristic77._();

  factory VehicleCharacteristic77([updates(VehicleCharacteristic77Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic77> get serializer =>
      _$vehicleCharacteristic77Serializer;
}

abstract class Service77 implements Built<Service77, Service77Builder> {
  Service77._();

  factory Service77([updates(Service77Builder b)]) = _$Service77;
  ...
  static Serializer<Service77> get serializer => _$service77Serializer;
}

abstract class Price77 implements Built<Price77, Price77Builder> {
  Price77._();

  factory Price77([updates(Price77Builder b)]) = _$Price77;
  ...
  static Serializer<Price77> get serializer => _$price77Serializer;
}

abstract class Packages77 implements Built<Packages77, Packages77Builder> {
  Packages77._();

  factory Packages77([updates(Packages77Builder b)]) = _$Packages77;
  ...
  PackageLabelInfo77 get packageLabelInfo;

  static Serializer<Packages77> get serializer => _$packages77Serializer;
}

abstract class Coverage77 implements Built<Coverage77, Coverage77Builder> {
  Coverage77._();

  factory Coverage77([updates(Coverage77Builder b)]) = _$Coverage77;
  ...
  InsuredPerson77 get insuredPerson;
  ...
  BuiltList<SubInsurances77> get subInsurances;

  static Serializer<Coverage77> get serializer => _$coverage77Serializer;
}

abstract class InsuredPerson77
    implements Built<InsuredPerson77, InsuredPerson77Builder> {
  InsuredPerson77._();

  factory InsuredPerson77([updates(InsuredPerson77Builder b)]) = _$InsuredPerson77;
  ...
  static Serializer<InsuredPerson77> get serializer => _$insuredPerson77Serializer;
}

abstract class SubInsurances77
    implements Built<SubInsurances77, SubInsurances77Builder> {
  SubInsurances77._();

  factory SubInsurances77([updates(SubInsurances77Builder b)]) = _$SubInsurances77;
  ...
  static Serializer<SubInsurances77> get serializer => _$subInsurances77Serializer;
}

abstract class ShopMap77 implements Built<ShopMap77, ShopMap77Builder> {
  ShopMap77._();

  factory ShopMap77([updates(ShopMap77Builder b)]) = _$ShopMap77;
  ...
  static Serializer<ShopMap77> get serializer => _$shopMap77Serializer;
}

abstract class SupplierMap77 implements Built<SupplierMap77, SupplierMap77Builder> {
  SupplierMap77._();

  factory SupplierMap77([updates(SupplierMap77Builder b)]) = _$SupplierMap77;
  ...
  static Serializer<SupplierMap77> get serializer => _$supplierMap77Serializer;
}

abstract class FilterGroups77
    implements Built<FilterGroups77, FilterGroups77Builder> {
  FilterGroups77._();

  factory FilterGroups77([updates(FilterGroups77Builder b)]) = _$FilterGroups77;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options77> get options;

  static Serializer<FilterGroups77> get serializer => _$filterGroups77Serializer;
}

abstract class Options77 implements Built<Options77, Options77Builder> {
  Options77._();

  factory Options77([updates(Options77Builder b)]) = _$Options77;
  ...
  static Serializer<Options77> get serializer => _$options77Serializer;
}

abstract class PackageLabelInfo77
    implements Built<PackageLabelInfo77, PackageLabelInfo77Builder> {
  PackageLabelInfo77._();

  factory PackageLabelInfo77([updates(PackageLabelInfo77Builder b)]) =
      _$PackageLabelInfo77;
  ...
  static Serializer<PackageLabelInfo77> get serializer =>
      _$packageLabelInfo77Serializer;
}

abstract class ActivityList77
    implements Built<ActivityList77, ActivityList77Builder> {
  ActivityList77._();

  factory ActivityList77([update(ActivityList77Builder b)]) = _$ActivityList77;
  ...
  CardTags77 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList77> get serializer => _$activityList77Serializer;
}

abstract class CardTags77 implements Built<CardTags77, CardTags77Builder> {
  CardTags77._();

  factory CardTags77([update(CardTags77Builder b)]) = _$CardTags77;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags77> get serializer => _$cardTags77Serializer;
}

@SerializersFor([
  SearchResultPollResult77,
])
final Serializers serializers77 = _$serializers77;
