...
part 'generated_search_result_poll_result52.g.dart';

abstract class SearchResultPollResult52
    implements Built<SearchResultPollResult52, SearchResultPollResult52Builder> {
  SearchResultPollResult52._();

  factory SearchResultPollResult52([updates(SearchResultPollResult52Builder b)]) =
  ...
  BuiltList<VehicleInfoList52> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap52> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap52> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups52> get filterGroups;
  ...
  static Serializer<SearchResultPollResult52> get serializer =>
      _$searchResultPollResult52Serializer;
}

abstract class VehicleInfoList52
    implements Built<VehicleInfoList52, VehicleInfoList52Builder> {
  VehicleInfoList52._();

  factory VehicleInfoList52([updates(VehicleInfoList52Builder b)]) =
      _$VehicleInfoList52;
  ...
  BuiltList<Packages52> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic52> get options;
  ...
  static Serializer<VehicleInfoList52> get serializer =>
      _$vehicleInfoList52Serializer;
}

abstract class VehicleCharacteristic52
    implements Built<VehicleCharacteristic52, VehicleCharacteristic52Builder> {
  VehicleCharacteristic52._();

  factory VehicleCharacteristic52([updates(VehicleCharacteristic52Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic52> get serializer =>
      _$vehicleCharacteristic52Serializer;
}

abstract class Service52 implements Built<Service52, Service52Builder> {
  Service52._();

  factory Service52([updates(Service52Builder b)]) = _$Service52;
  ...
  static Serializer<Service52> get serializer => _$service52Serializer;
}

abstract class Price52 implements Built<Price52, Price52Builder> {
  Price52._();

  factory Price52([updates(Price52Builder b)]) = _$Price52;
  ...
  static Serializer<Price52> get serializer => _$price52Serializer;
}

abstract class Packages52 implements Built<Packages52, Packages52Builder> {
  Packages52._();

  factory Packages52([updates(Packages52Builder b)]) = _$Packages52;
  ...
  PackageLabelInfo52 get packageLabelInfo;

  static Serializer<Packages52> get serializer => _$packages52Serializer;
}

abstract class Coverage52 implements Built<Coverage52, Coverage52Builder> {
  Coverage52._();

  factory Coverage52([updates(Coverage52Builder b)]) = _$Coverage52;
  ...
  InsuredPerson52 get insuredPerson;
  ...
  BuiltList<SubInsurances52> get subInsurances;

  static Serializer<Coverage52> get serializer => _$coverage52Serializer;
}

abstract class InsuredPerson52
    implements Built<InsuredPerson52, InsuredPerson52Builder> {
  InsuredPerson52._();

  factory InsuredPerson52([updates(InsuredPerson52Builder b)]) = _$InsuredPerson52;
  ...
  static Serializer<InsuredPerson52> get serializer => _$insuredPerson52Serializer;
}

abstract class SubInsurances52
    implements Built<SubInsurances52, SubInsurances52Builder> {
  SubInsurances52._();

  factory SubInsurances52([updates(SubInsurances52Builder b)]) = _$SubInsurances52;
  ...
  static Serializer<SubInsurances52> get serializer => _$subInsurances52Serializer;
}

abstract class ShopMap52 implements Built<ShopMap52, ShopMap52Builder> {
  ShopMap52._();

  factory ShopMap52([updates(ShopMap52Builder b)]) = _$ShopMap52;
  ...
  static Serializer<ShopMap52> get serializer => _$shopMap52Serializer;
}

abstract class SupplierMap52 implements Built<SupplierMap52, SupplierMap52Builder> {
  SupplierMap52._();

  factory SupplierMap52([updates(SupplierMap52Builder b)]) = _$SupplierMap52;
  ...
  static Serializer<SupplierMap52> get serializer => _$supplierMap52Serializer;
}

abstract class FilterGroups52
    implements Built<FilterGroups52, FilterGroups52Builder> {
  FilterGroups52._();

  factory FilterGroups52([updates(FilterGroups52Builder b)]) = _$FilterGroups52;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options52> get options;

  static Serializer<FilterGroups52> get serializer => _$filterGroups52Serializer;
}

abstract class Options52 implements Built<Options52, Options52Builder> {
  Options52._();

  factory Options52([updates(Options52Builder b)]) = _$Options52;
  ...
  static Serializer<Options52> get serializer => _$options52Serializer;
}

abstract class PackageLabelInfo52
    implements Built<PackageLabelInfo52, PackageLabelInfo52Builder> {
  PackageLabelInfo52._();

  factory PackageLabelInfo52([updates(PackageLabelInfo52Builder b)]) =
      _$PackageLabelInfo52;
  ...
  static Serializer<PackageLabelInfo52> get serializer =>
      _$packageLabelInfo52Serializer;
}

abstract class ActivityList52
    implements Built<ActivityList52, ActivityList52Builder> {
  ActivityList52._();

  factory ActivityList52([update(ActivityList52Builder b)]) = _$ActivityList52;
  ...
  CardTags52 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList52> get serializer => _$activityList52Serializer;
}

abstract class CardTags52 implements Built<CardTags52, CardTags52Builder> {
  CardTags52._();

  factory CardTags52([update(CardTags52Builder b)]) = _$CardTags52;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags52> get serializer => _$cardTags52Serializer;
}

@SerializersFor([
  SearchResultPollResult52,
])
final Serializers serializers52 = _$serializers52;
