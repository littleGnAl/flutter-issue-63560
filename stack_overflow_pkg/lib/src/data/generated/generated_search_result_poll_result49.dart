...
part 'generated_search_result_poll_result49.g.dart';

abstract class SearchResultPollResult49
    implements Built<SearchResultPollResult49, SearchResultPollResult49Builder> {
  SearchResultPollResult49._();

  factory SearchResultPollResult49([updates(SearchResultPollResult49Builder b)]) =
  ...
  BuiltList<VehicleInfoList49> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap49> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap49> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups49> get filterGroups;
  ...
  static Serializer<SearchResultPollResult49> get serializer =>
      _$searchResultPollResult49Serializer;
}

abstract class VehicleInfoList49
    implements Built<VehicleInfoList49, VehicleInfoList49Builder> {
  VehicleInfoList49._();

  factory VehicleInfoList49([updates(VehicleInfoList49Builder b)]) =
      _$VehicleInfoList49;
  ...
  BuiltList<Packages49> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic49> get options;
  ...
  static Serializer<VehicleInfoList49> get serializer =>
      _$vehicleInfoList49Serializer;
}

abstract class VehicleCharacteristic49
    implements Built<VehicleCharacteristic49, VehicleCharacteristic49Builder> {
  VehicleCharacteristic49._();

  factory VehicleCharacteristic49([updates(VehicleCharacteristic49Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic49> get serializer =>
      _$vehicleCharacteristic49Serializer;
}

abstract class Service49 implements Built<Service49, Service49Builder> {
  Service49._();

  factory Service49([updates(Service49Builder b)]) = _$Service49;
  ...
  static Serializer<Service49> get serializer => _$service49Serializer;
}

abstract class Price49 implements Built<Price49, Price49Builder> {
  Price49._();

  factory Price49([updates(Price49Builder b)]) = _$Price49;
  ...
  static Serializer<Price49> get serializer => _$price49Serializer;
}

abstract class Packages49 implements Built<Packages49, Packages49Builder> {
  Packages49._();

  factory Packages49([updates(Packages49Builder b)]) = _$Packages49;
  ...
  PackageLabelInfo49 get packageLabelInfo;

  static Serializer<Packages49> get serializer => _$packages49Serializer;
}

abstract class Coverage49 implements Built<Coverage49, Coverage49Builder> {
  Coverage49._();

  factory Coverage49([updates(Coverage49Builder b)]) = _$Coverage49;
  ...
  InsuredPerson49 get insuredPerson;
  ...
  BuiltList<SubInsurances49> get subInsurances;

  static Serializer<Coverage49> get serializer => _$coverage49Serializer;
}

abstract class InsuredPerson49
    implements Built<InsuredPerson49, InsuredPerson49Builder> {
  InsuredPerson49._();

  factory InsuredPerson49([updates(InsuredPerson49Builder b)]) = _$InsuredPerson49;
  ...
  static Serializer<InsuredPerson49> get serializer => _$insuredPerson49Serializer;
}

abstract class SubInsurances49
    implements Built<SubInsurances49, SubInsurances49Builder> {
  SubInsurances49._();

  factory SubInsurances49([updates(SubInsurances49Builder b)]) = _$SubInsurances49;
  ...
  static Serializer<SubInsurances49> get serializer => _$subInsurances49Serializer;
}

abstract class ShopMap49 implements Built<ShopMap49, ShopMap49Builder> {
  ShopMap49._();

  factory ShopMap49([updates(ShopMap49Builder b)]) = _$ShopMap49;
  ...
  static Serializer<ShopMap49> get serializer => _$shopMap49Serializer;
}

abstract class SupplierMap49 implements Built<SupplierMap49, SupplierMap49Builder> {
  SupplierMap49._();

  factory SupplierMap49([updates(SupplierMap49Builder b)]) = _$SupplierMap49;
  ...
  static Serializer<SupplierMap49> get serializer => _$supplierMap49Serializer;
}

abstract class FilterGroups49
    implements Built<FilterGroups49, FilterGroups49Builder> {
  FilterGroups49._();

  factory FilterGroups49([updates(FilterGroups49Builder b)]) = _$FilterGroups49;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options49> get options;

  static Serializer<FilterGroups49> get serializer => _$filterGroups49Serializer;
}

abstract class Options49 implements Built<Options49, Options49Builder> {
  Options49._();

  factory Options49([updates(Options49Builder b)]) = _$Options49;
  ...
  static Serializer<Options49> get serializer => _$options49Serializer;
}

abstract class PackageLabelInfo49
    implements Built<PackageLabelInfo49, PackageLabelInfo49Builder> {
  PackageLabelInfo49._();

  factory PackageLabelInfo49([updates(PackageLabelInfo49Builder b)]) =
      _$PackageLabelInfo49;
  ...
  static Serializer<PackageLabelInfo49> get serializer =>
      _$packageLabelInfo49Serializer;
}

abstract class ActivityList49
    implements Built<ActivityList49, ActivityList49Builder> {
  ActivityList49._();

  factory ActivityList49([update(ActivityList49Builder b)]) = _$ActivityList49;
  ...
  CardTags49 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList49> get serializer => _$activityList49Serializer;
}

abstract class CardTags49 implements Built<CardTags49, CardTags49Builder> {
  CardTags49._();

  factory CardTags49([update(CardTags49Builder b)]) = _$CardTags49;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags49> get serializer => _$cardTags49Serializer;
}
