...
part 'generated_search_result_poll_result76.g.dart';

abstract class SearchResultPollResult76
    implements Built<SearchResultPollResult76, SearchResultPollResult76Builder> {
  SearchResultPollResult76._();

  factory SearchResultPollResult76([updates(SearchResultPollResult76Builder b)]) =
  ...
  BuiltList<VehicleInfoList76> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap76> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap76> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups76> get filterGroups;
  ...
  static Serializer<SearchResultPollResult76> get serializer =>
      _$searchResultPollResult76Serializer;
}

abstract class VehicleInfoList76
    implements Built<VehicleInfoList76, VehicleInfoList76Builder> {
  VehicleInfoList76._();

  factory VehicleInfoList76([updates(VehicleInfoList76Builder b)]) =
      _$VehicleInfoList76;
  ...
  BuiltList<Packages76> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic76> get options;
  ...
  static Serializer<VehicleInfoList76> get serializer =>
      _$vehicleInfoList76Serializer;
}

abstract class VehicleCharacteristic76
    implements Built<VehicleCharacteristic76, VehicleCharacteristic76Builder> {
  VehicleCharacteristic76._();

  factory VehicleCharacteristic76([updates(VehicleCharacteristic76Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic76> get serializer =>
      _$vehicleCharacteristic76Serializer;
}

abstract class Service76 implements Built<Service76, Service76Builder> {
  Service76._();

  factory Service76([updates(Service76Builder b)]) = _$Service76;
  ...
  static Serializer<Service76> get serializer => _$service76Serializer;
}

abstract class Price76 implements Built<Price76, Price76Builder> {
  Price76._();

  factory Price76([updates(Price76Builder b)]) = _$Price76;
  ...
  static Serializer<Price76> get serializer => _$price76Serializer;
}

abstract class Packages76 implements Built<Packages76, Packages76Builder> {
  Packages76._();

  factory Packages76([updates(Packages76Builder b)]) = _$Packages76;
  ...
  PackageLabelInfo76 get packageLabelInfo;

  static Serializer<Packages76> get serializer => _$packages76Serializer;
}

abstract class Coverage76 implements Built<Coverage76, Coverage76Builder> {
  Coverage76._();

  factory Coverage76([updates(Coverage76Builder b)]) = _$Coverage76;
  ...
  InsuredPerson76 get insuredPerson;
  ...
  BuiltList<SubInsurances76> get subInsurances;

  static Serializer<Coverage76> get serializer => _$coverage76Serializer;
}

abstract class InsuredPerson76
    implements Built<InsuredPerson76, InsuredPerson76Builder> {
  InsuredPerson76._();

  factory InsuredPerson76([updates(InsuredPerson76Builder b)]) = _$InsuredPerson76;
  ...
  static Serializer<InsuredPerson76> get serializer => _$insuredPerson76Serializer;
}

abstract class SubInsurances76
    implements Built<SubInsurances76, SubInsurances76Builder> {
  SubInsurances76._();

  factory SubInsurances76([updates(SubInsurances76Builder b)]) = _$SubInsurances76;
  ...
  static Serializer<SubInsurances76> get serializer => _$subInsurances76Serializer;
}

abstract class ShopMap76 implements Built<ShopMap76, ShopMap76Builder> {
  ShopMap76._();

  factory ShopMap76([updates(ShopMap76Builder b)]) = _$ShopMap76;
  ...
  static Serializer<ShopMap76> get serializer => _$shopMap76Serializer;
}

abstract class SupplierMap76 implements Built<SupplierMap76, SupplierMap76Builder> {
  SupplierMap76._();

  factory SupplierMap76([updates(SupplierMap76Builder b)]) = _$SupplierMap76;
  ...
  static Serializer<SupplierMap76> get serializer => _$supplierMap76Serializer;
}

abstract class FilterGroups76
    implements Built<FilterGroups76, FilterGroups76Builder> {
  FilterGroups76._();

  factory FilterGroups76([updates(FilterGroups76Builder b)]) = _$FilterGroups76;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options76> get options;

  static Serializer<FilterGroups76> get serializer => _$filterGroups76Serializer;
}

abstract class Options76 implements Built<Options76, Options76Builder> {
  Options76._();

  factory Options76([updates(Options76Builder b)]) = _$Options76;
  ...
  static Serializer<Options76> get serializer => _$options76Serializer;
}

abstract class PackageLabelInfo76
    implements Built<PackageLabelInfo76, PackageLabelInfo76Builder> {
  PackageLabelInfo76._();

  factory PackageLabelInfo76([updates(PackageLabelInfo76Builder b)]) =
      _$PackageLabelInfo76;
  ...
  static Serializer<PackageLabelInfo76> get serializer =>
      _$packageLabelInfo76Serializer;
}

abstract class ActivityList76
    implements Built<ActivityList76, ActivityList76Builder> {
  ActivityList76._();

  factory ActivityList76([update(ActivityList76Builder b)]) = _$ActivityList76;
  ...
  CardTags76 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList76> get serializer => _$activityList76Serializer;
}

abstract class CardTags76 implements Built<CardTags76, CardTags76Builder> {
  CardTags76._();

  factory CardTags76([update(CardTags76Builder b)]) = _$CardTags76;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags76> get serializer => _$cardTags76Serializer;
}

@SerializersFor([
  SearchResultPollResult76,
])
final Serializers serializers76 = _$serializers76;
