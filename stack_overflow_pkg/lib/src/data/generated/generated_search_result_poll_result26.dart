...
part 'generated_search_result_poll_result26.g.dart';

abstract class SearchResultPollResult26
    implements Built<SearchResultPollResult26, SearchResultPollResult26Builder> {
  SearchResultPollResult26._();

  factory SearchResultPollResult26([updates(SearchResultPollResult26Builder b)]) =
  ...
  BuiltList<VehicleInfoList26> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap26> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap26> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups26> get filterGroups;
  ...
  static Serializer<SearchResultPollResult26> get serializer =>
      _$searchResultPollResult26Serializer;
}

abstract class VehicleInfoList26
    implements Built<VehicleInfoList26, VehicleInfoList26Builder> {
  VehicleInfoList26._();

  factory VehicleInfoList26([updates(VehicleInfoList26Builder b)]) =
      _$VehicleInfoList26;
  ...
  BuiltList<Packages26> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic26> get options;
  ...
  static Serializer<VehicleInfoList26> get serializer =>
      _$vehicleInfoList26Serializer;
}

abstract class VehicleCharacteristic26
    implements Built<VehicleCharacteristic26, VehicleCharacteristic26Builder> {
  VehicleCharacteristic26._();

  factory VehicleCharacteristic26([updates(VehicleCharacteristic26Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic26> get serializer =>
      _$vehicleCharacteristic26Serializer;
}

abstract class Service26 implements Built<Service26, Service26Builder> {
  Service26._();

  factory Service26([updates(Service26Builder b)]) = _$Service26;
  ...
  static Serializer<Service26> get serializer => _$service26Serializer;
}

abstract class Price26 implements Built<Price26, Price26Builder> {
  Price26._();

  factory Price26([updates(Price26Builder b)]) = _$Price26;
  ...
  static Serializer<Price26> get serializer => _$price26Serializer;
}

abstract class Packages26 implements Built<Packages26, Packages26Builder> {
  Packages26._();

  factory Packages26([updates(Packages26Builder b)]) = _$Packages26;
  ...
  PackageLabelInfo26 get packageLabelInfo;

  static Serializer<Packages26> get serializer => _$packages26Serializer;
}

abstract class Coverage26 implements Built<Coverage26, Coverage26Builder> {
  Coverage26._();

  factory Coverage26([updates(Coverage26Builder b)]) = _$Coverage26;
  ...
  InsuredPerson26 get insuredPerson;
  ...
  BuiltList<SubInsurances26> get subInsurances;

  static Serializer<Coverage26> get serializer => _$coverage26Serializer;
}

abstract class InsuredPerson26
    implements Built<InsuredPerson26, InsuredPerson26Builder> {
  InsuredPerson26._();

  factory InsuredPerson26([updates(InsuredPerson26Builder b)]) = _$InsuredPerson26;
  ...
  static Serializer<InsuredPerson26> get serializer => _$insuredPerson26Serializer;
}

abstract class SubInsurances26
    implements Built<SubInsurances26, SubInsurances26Builder> {
  SubInsurances26._();

  factory SubInsurances26([updates(SubInsurances26Builder b)]) = _$SubInsurances26;
  ...
  static Serializer<SubInsurances26> get serializer => _$subInsurances26Serializer;
}

abstract class ShopMap26 implements Built<ShopMap26, ShopMap26Builder> {
  ShopMap26._();

  factory ShopMap26([updates(ShopMap26Builder b)]) = _$ShopMap26;
  ...
  static Serializer<ShopMap26> get serializer => _$shopMap26Serializer;
}

abstract class SupplierMap26 implements Built<SupplierMap26, SupplierMap26Builder> {
  SupplierMap26._();

  factory SupplierMap26([updates(SupplierMap26Builder b)]) = _$SupplierMap26;
  ...
  static Serializer<SupplierMap26> get serializer => _$supplierMap26Serializer;
}

abstract class FilterGroups26
    implements Built<FilterGroups26, FilterGroups26Builder> {
  FilterGroups26._();

  factory FilterGroups26([updates(FilterGroups26Builder b)]) = _$FilterGroups26;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options26> get options;

  static Serializer<FilterGroups26> get serializer => _$filterGroups26Serializer;
}

abstract class Options26 implements Built<Options26, Options26Builder> {
  Options26._();

  factory Options26([updates(Options26Builder b)]) = _$Options26;
  ...
  static Serializer<Options26> get serializer => _$options26Serializer;
}

abstract class PackageLabelInfo26
    implements Built<PackageLabelInfo26, PackageLabelInfo26Builder> {
  PackageLabelInfo26._();

  factory PackageLabelInfo26([updates(PackageLabelInfo26Builder b)]) =
      _$PackageLabelInfo26;
  ...
  static Serializer<PackageLabelInfo26> get serializer =>
      _$packageLabelInfo26Serializer;
}

abstract class ActivityList26
    implements Built<ActivityList26, ActivityList26Builder> {
  ActivityList26._();

  factory ActivityList26([update(ActivityList26Builder b)]) = _$ActivityList26;
  ...
  CardTags26 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList26> get serializer => _$activityList26Serializer;
}

abstract class CardTags26 implements Built<CardTags26, CardTags26Builder> {
  CardTags26._();

  factory CardTags26([update(CardTags26Builder b)]) = _$CardTags26;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags26> get serializer => _$cardTags26Serializer;
}

@SerializersFor([
  SearchResultPollResult26,
])
final Serializers serializers26 = _$serializers26;
