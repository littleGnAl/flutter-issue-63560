...
part 'generated_search_result_poll_result23.g.dart';

abstract class SearchResultPollResult23
    implements Built<SearchResultPollResult23, SearchResultPollResult23Builder> {
  SearchResultPollResult23._();

  factory SearchResultPollResult23([updates(SearchResultPollResult23Builder b)]) =
  ...
  BuiltList<VehicleInfoList23> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap23> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap23> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups23> get filterGroups;
  ...
  static Serializer<SearchResultPollResult23> get serializer =>
      _$searchResultPollResult23Serializer;
}

abstract class VehicleInfoList23
    implements Built<VehicleInfoList23, VehicleInfoList23Builder> {
  VehicleInfoList23._();

  factory VehicleInfoList23([updates(VehicleInfoList23Builder b)]) =
      _$VehicleInfoList23;
  ...
  BuiltList<Packages23> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic23> get options;
  ...
  static Serializer<VehicleInfoList23> get serializer =>
      _$vehicleInfoList23Serializer;
}

abstract class VehicleCharacteristic23
    implements Built<VehicleCharacteristic23, VehicleCharacteristic23Builder> {
  VehicleCharacteristic23._();

  factory VehicleCharacteristic23([updates(VehicleCharacteristic23Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic23> get serializer =>
      _$vehicleCharacteristic23Serializer;
}

abstract class Service23 implements Built<Service23, Service23Builder> {
  Service23._();

  factory Service23([updates(Service23Builder b)]) = _$Service23;
  ...
  static Serializer<Service23> get serializer => _$service23Serializer;
}

abstract class Price23 implements Built<Price23, Price23Builder> {
  Price23._();

  factory Price23([updates(Price23Builder b)]) = _$Price23;
  ...
  static Serializer<Price23> get serializer => _$price23Serializer;
}

abstract class Packages23 implements Built<Packages23, Packages23Builder> {
  Packages23._();

  factory Packages23([updates(Packages23Builder b)]) = _$Packages23;
  ...
  PackageLabelInfo23 get packageLabelInfo;

  static Serializer<Packages23> get serializer => _$packages23Serializer;
}

abstract class Coverage23 implements Built<Coverage23, Coverage23Builder> {
  Coverage23._();

  factory Coverage23([updates(Coverage23Builder b)]) = _$Coverage23;
  ...
  InsuredPerson23 get insuredPerson;
  ...
  BuiltList<SubInsurances23> get subInsurances;

  static Serializer<Coverage23> get serializer => _$coverage23Serializer;
}

abstract class InsuredPerson23
    implements Built<InsuredPerson23, InsuredPerson23Builder> {
  InsuredPerson23._();

  factory InsuredPerson23([updates(InsuredPerson23Builder b)]) = _$InsuredPerson23;
  ...
  static Serializer<InsuredPerson23> get serializer => _$insuredPerson23Serializer;
}

abstract class SubInsurances23
    implements Built<SubInsurances23, SubInsurances23Builder> {
  SubInsurances23._();

  factory SubInsurances23([updates(SubInsurances23Builder b)]) = _$SubInsurances23;
  ...
  static Serializer<SubInsurances23> get serializer => _$subInsurances23Serializer;
}

abstract class ShopMap23 implements Built<ShopMap23, ShopMap23Builder> {
  ShopMap23._();

  factory ShopMap23([updates(ShopMap23Builder b)]) = _$ShopMap23;
  ...
  static Serializer<ShopMap23> get serializer => _$shopMap23Serializer;
}

abstract class SupplierMap23 implements Built<SupplierMap23, SupplierMap23Builder> {
  SupplierMap23._();

  factory SupplierMap23([updates(SupplierMap23Builder b)]) = _$SupplierMap23;
  ...
  static Serializer<SupplierMap23> get serializer => _$supplierMap23Serializer;
}

abstract class FilterGroups23
    implements Built<FilterGroups23, FilterGroups23Builder> {
  FilterGroups23._();

  factory FilterGroups23([updates(FilterGroups23Builder b)]) = _$FilterGroups23;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options23> get options;

  static Serializer<FilterGroups23> get serializer => _$filterGroups23Serializer;
}

abstract class Options23 implements Built<Options23, Options23Builder> {
  Options23._();

  factory Options23([updates(Options23Builder b)]) = _$Options23;
  ...
  static Serializer<Options23> get serializer => _$options23Serializer;
}

abstract class PackageLabelInfo23
    implements Built<PackageLabelInfo23, PackageLabelInfo23Builder> {
  PackageLabelInfo23._();

  factory PackageLabelInfo23([updates(PackageLabelInfo23Builder b)]) =
      _$PackageLabelInfo23;
  ...
  static Serializer<PackageLabelInfo23> get serializer =>
      _$packageLabelInfo23Serializer;
}

abstract class ActivityList23
    implements Built<ActivityList23, ActivityList23Builder> {
  ActivityList23._();

  factory ActivityList23([update(ActivityList23Builder b)]) = _$ActivityList23;
  ...
  CardTags23 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList23> get serializer => _$activityList23Serializer;
}

abstract class CardTags23 implements Built<CardTags23, CardTags23Builder> {
  CardTags23._();

  factory CardTags23([update(CardTags23Builder b)]) = _$CardTags23;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags23> get serializer => _$cardTags23Serializer;
}

@SerializersFor([
  SearchResultPollResult23,
])
final Serializers serializers23 = _$serializers23;
