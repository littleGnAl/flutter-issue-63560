...
part 'generated_search_result_poll_result7.g.dart';

abstract class SearchResultPollResult7
    implements Built<SearchResultPollResult7, SearchResultPollResult7Builder> {
  SearchResultPollResult7._();

  factory SearchResultPollResult7([updates(SearchResultPollResult7Builder b)]) =
  ...
  BuiltList<VehicleInfoList7> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap7> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap7> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups7> get filterGroups;
  ...
  static Serializer<SearchResultPollResult7> get serializer =>
      _$searchResultPollResult7Serializer;
}

abstract class VehicleInfoList7
    implements Built<VehicleInfoList7, VehicleInfoList7Builder> {
  VehicleInfoList7._();

  factory VehicleInfoList7([updates(VehicleInfoList7Builder b)]) =
      _$VehicleInfoList7;
  ...
  BuiltList<Packages7> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic7> get options;
  ...
  static Serializer<VehicleInfoList7> get serializer =>
      _$vehicleInfoList7Serializer;
}

abstract class VehicleCharacteristic7
    implements Built<VehicleCharacteristic7, VehicleCharacteristic7Builder> {
  VehicleCharacteristic7._();

  factory VehicleCharacteristic7([updates(VehicleCharacteristic7Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic7> get serializer =>
      _$vehicleCharacteristic7Serializer;
}

abstract class Service7 implements Built<Service7, Service7Builder> {
  Service7._();

  factory Service7([updates(Service7Builder b)]) = _$Service7;
  ...
  static Serializer<Service7> get serializer => _$service7Serializer;
}

abstract class Price7 implements Built<Price7, Price7Builder> {
  Price7._();

  factory Price7([updates(Price7Builder b)]) = _$Price7;
  ...
  static Serializer<Price7> get serializer => _$price7Serializer;
}

abstract class Packages7 implements Built<Packages7, Packages7Builder> {
  Packages7._();

  factory Packages7([updates(Packages7Builder b)]) = _$Packages7;
  ...
  PackageLabelInfo7 get packageLabelInfo;

  static Serializer<Packages7> get serializer => _$packages7Serializer;
}

abstract class Coverage7 implements Built<Coverage7, Coverage7Builder> {
  Coverage7._();

  factory Coverage7([updates(Coverage7Builder b)]) = _$Coverage7;
  ...
  InsuredPerson7 get insuredPerson;
  ...
  BuiltList<SubInsurances7> get subInsurances;

  static Serializer<Coverage7> get serializer => _$coverage7Serializer;
}

abstract class InsuredPerson7
    implements Built<InsuredPerson7, InsuredPerson7Builder> {
  InsuredPerson7._();

  factory InsuredPerson7([updates(InsuredPerson7Builder b)]) = _$InsuredPerson7;
  ...
  static Serializer<InsuredPerson7> get serializer => _$insuredPerson7Serializer;
}

abstract class SubInsurances7
    implements Built<SubInsurances7, SubInsurances7Builder> {
  SubInsurances7._();

  factory SubInsurances7([updates(SubInsurances7Builder b)]) = _$SubInsurances7;
  ...
  static Serializer<SubInsurances7> get serializer => _$subInsurances7Serializer;
}

abstract class ShopMap7 implements Built<ShopMap7, ShopMap7Builder> {
  ShopMap7._();

  factory ShopMap7([updates(ShopMap7Builder b)]) = _$ShopMap7;
  ...
  static Serializer<ShopMap7> get serializer => _$shopMap7Serializer;
}

abstract class SupplierMap7 implements Built<SupplierMap7, SupplierMap7Builder> {
  SupplierMap7._();

  factory SupplierMap7([updates(SupplierMap7Builder b)]) = _$SupplierMap7;
  ...
  static Serializer<SupplierMap7> get serializer => _$supplierMap7Serializer;
}

abstract class FilterGroups7
    implements Built<FilterGroups7, FilterGroups7Builder> {
  FilterGroups7._();

  factory FilterGroups7([updates(FilterGroups7Builder b)]) = _$FilterGroups7;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options7> get options;

  static Serializer<FilterGroups7> get serializer => _$filterGroups7Serializer;
}

abstract class Options7 implements Built<Options7, Options7Builder> {
  Options7._();

  factory Options7([updates(Options7Builder b)]) = _$Options7;
  ...
  static Serializer<Options7> get serializer => _$options7Serializer;
}

abstract class PackageLabelInfo7
    implements Built<PackageLabelInfo7, PackageLabelInfo7Builder> {
  PackageLabelInfo7._();

  factory PackageLabelInfo7([updates(PackageLabelInfo7Builder b)]) =
      _$PackageLabelInfo7;
  ...
  static Serializer<PackageLabelInfo7> get serializer =>
      _$packageLabelInfo7Serializer;
}

abstract class ActivityList7
    implements Built<ActivityList7, ActivityList7Builder> {
  ActivityList7._();

  factory ActivityList7([update(ActivityList7Builder b)]) = _$ActivityList7;
  ...
  CardTags7 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList7> get serializer => _$activityList7Serializer;
}

abstract class CardTags7 implements Built<CardTags7, CardTags7Builder> {
  CardTags7._();

  factory CardTags7([update(CardTags7Builder b)]) = _$CardTags7;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags7> get serializer => _$cardTags7Serializer;
}
