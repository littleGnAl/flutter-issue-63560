...
part 'generated_search_result_poll_result6.g.dart';

abstract class SearchResultPollResult6
    implements Built<SearchResultPollResult6, SearchResultPollResult6Builder> {
  SearchResultPollResult6._();

  factory SearchResultPollResult6([updates(SearchResultPollResult6Builder b)]) =
  ...
  BuiltList<VehicleInfoList6> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap6> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap6> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups6> get filterGroups;
  ...
  static Serializer<SearchResultPollResult6> get serializer =>
      _$searchResultPollResult6Serializer;
}

abstract class VehicleInfoList6
    implements Built<VehicleInfoList6, VehicleInfoList6Builder> {
  VehicleInfoList6._();

  factory VehicleInfoList6([updates(VehicleInfoList6Builder b)]) =
      _$VehicleInfoList6;
  ...
  BuiltList<Packages6> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic6> get options;
  ...
  static Serializer<VehicleInfoList6> get serializer =>
      _$vehicleInfoList6Serializer;
}

abstract class VehicleCharacteristic6
    implements Built<VehicleCharacteristic6, VehicleCharacteristic6Builder> {
  VehicleCharacteristic6._();

  factory VehicleCharacteristic6([updates(VehicleCharacteristic6Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic6> get serializer =>
      _$vehicleCharacteristic6Serializer;
}

abstract class Service6 implements Built<Service6, Service6Builder> {
  Service6._();

  factory Service6([updates(Service6Builder b)]) = _$Service6;
  ...
  static Serializer<Service6> get serializer => _$service6Serializer;
}

abstract class Price6 implements Built<Price6, Price6Builder> {
  Price6._();

  factory Price6([updates(Price6Builder b)]) = _$Price6;
  ...
  static Serializer<Price6> get serializer => _$price6Serializer;
}

abstract class Packages6 implements Built<Packages6, Packages6Builder> {
  Packages6._();

  factory Packages6([updates(Packages6Builder b)]) = _$Packages6;
  ...
  PackageLabelInfo6 get packageLabelInfo;

  static Serializer<Packages6> get serializer => _$packages6Serializer;
}

abstract class Coverage6 implements Built<Coverage6, Coverage6Builder> {
  Coverage6._();

  factory Coverage6([updates(Coverage6Builder b)]) = _$Coverage6;
  ...
  InsuredPerson6 get insuredPerson;
  ...
  BuiltList<SubInsurances6> get subInsurances;

  static Serializer<Coverage6> get serializer => _$coverage6Serializer;
}

abstract class InsuredPerson6
    implements Built<InsuredPerson6, InsuredPerson6Builder> {
  InsuredPerson6._();

  factory InsuredPerson6([updates(InsuredPerson6Builder b)]) = _$InsuredPerson6;
  ...
  static Serializer<InsuredPerson6> get serializer => _$insuredPerson6Serializer;
}

abstract class SubInsurances6
    implements Built<SubInsurances6, SubInsurances6Builder> {
  SubInsurances6._();

  factory SubInsurances6([updates(SubInsurances6Builder b)]) = _$SubInsurances6;
  ...
  static Serializer<SubInsurances6> get serializer => _$subInsurances6Serializer;
}

abstract class ShopMap6 implements Built<ShopMap6, ShopMap6Builder> {
  ShopMap6._();

  factory ShopMap6([updates(ShopMap6Builder b)]) = _$ShopMap6;
  ...
  static Serializer<ShopMap6> get serializer => _$shopMap6Serializer;
}

abstract class SupplierMap6 implements Built<SupplierMap6, SupplierMap6Builder> {
  SupplierMap6._();

  factory SupplierMap6([updates(SupplierMap6Builder b)]) = _$SupplierMap6;
  ...
  static Serializer<SupplierMap6> get serializer => _$supplierMap6Serializer;
}

abstract class FilterGroups6
    implements Built<FilterGroups6, FilterGroups6Builder> {
  FilterGroups6._();

  factory FilterGroups6([updates(FilterGroups6Builder b)]) = _$FilterGroups6;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options6> get options;

  static Serializer<FilterGroups6> get serializer => _$filterGroups6Serializer;
}

abstract class Options6 implements Built<Options6, Options6Builder> {
  Options6._();

  factory Options6([updates(Options6Builder b)]) = _$Options6;
  ...
  static Serializer<Options6> get serializer => _$options6Serializer;
}

abstract class PackageLabelInfo6
    implements Built<PackageLabelInfo6, PackageLabelInfo6Builder> {
  PackageLabelInfo6._();

  factory PackageLabelInfo6([updates(PackageLabelInfo6Builder b)]) =
      _$PackageLabelInfo6;
  ...
  static Serializer<PackageLabelInfo6> get serializer =>
      _$packageLabelInfo6Serializer;
}

abstract class ActivityList6
    implements Built<ActivityList6, ActivityList6Builder> {
  ActivityList6._();

  factory ActivityList6([update(ActivityList6Builder b)]) = _$ActivityList6;
  ...
  CardTags6 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList6> get serializer => _$activityList6Serializer;
}

abstract class CardTags6 implements Built<CardTags6, CardTags6Builder> {
  CardTags6._();

  factory CardTags6([update(CardTags6Builder b)]) = _$CardTags6;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags6> get serializer => _$cardTags6Serializer;
}
