...
part 'generated_search_result_poll_result34.g.dart';

abstract class SearchResultPollResult34
    implements Built<SearchResultPollResult34, SearchResultPollResult34Builder> {
  SearchResultPollResult34._();

  factory SearchResultPollResult34([updates(SearchResultPollResult34Builder b)]) =
  ...
  BuiltList<VehicleInfoList34> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap34> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap34> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups34> get filterGroups;
  ...
  static Serializer<SearchResultPollResult34> get serializer =>
      _$searchResultPollResult34Serializer;
}

abstract class VehicleInfoList34
    implements Built<VehicleInfoList34, VehicleInfoList34Builder> {
  VehicleInfoList34._();

  factory VehicleInfoList34([updates(VehicleInfoList34Builder b)]) =
      _$VehicleInfoList34;
  ...
  BuiltList<Packages34> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic34> get options;
  ...
  static Serializer<VehicleInfoList34> get serializer =>
      _$vehicleInfoList34Serializer;
}

abstract class VehicleCharacteristic34
    implements Built<VehicleCharacteristic34, VehicleCharacteristic34Builder> {
  VehicleCharacteristic34._();

  factory VehicleCharacteristic34([updates(VehicleCharacteristic34Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic34> get serializer =>
      _$vehicleCharacteristic34Serializer;
}

abstract class Service34 implements Built<Service34, Service34Builder> {
  Service34._();

  factory Service34([updates(Service34Builder b)]) = _$Service34;
  ...
  static Serializer<Service34> get serializer => _$service34Serializer;
}

abstract class Price34 implements Built<Price34, Price34Builder> {
  Price34._();

  factory Price34([updates(Price34Builder b)]) = _$Price34;
  ...
  static Serializer<Price34> get serializer => _$price34Serializer;
}

abstract class Packages34 implements Built<Packages34, Packages34Builder> {
  Packages34._();

  factory Packages34([updates(Packages34Builder b)]) = _$Packages34;
  ...
  PackageLabelInfo34 get packageLabelInfo;

  static Serializer<Packages34> get serializer => _$packages34Serializer;
}

abstract class Coverage34 implements Built<Coverage34, Coverage34Builder> {
  Coverage34._();

  factory Coverage34([updates(Coverage34Builder b)]) = _$Coverage34;
  ...
  InsuredPerson34 get insuredPerson;
  ...
  BuiltList<SubInsurances34> get subInsurances;

  static Serializer<Coverage34> get serializer => _$coverage34Serializer;
}

abstract class InsuredPerson34
    implements Built<InsuredPerson34, InsuredPerson34Builder> {
  InsuredPerson34._();

  factory InsuredPerson34([updates(InsuredPerson34Builder b)]) = _$InsuredPerson34;
  ...
  static Serializer<InsuredPerson34> get serializer => _$insuredPerson34Serializer;
}

abstract class SubInsurances34
    implements Built<SubInsurances34, SubInsurances34Builder> {
  SubInsurances34._();

  factory SubInsurances34([updates(SubInsurances34Builder b)]) = _$SubInsurances34;
  ...
  static Serializer<SubInsurances34> get serializer => _$subInsurances34Serializer;
}

abstract class ShopMap34 implements Built<ShopMap34, ShopMap34Builder> {
  ShopMap34._();

  factory ShopMap34([updates(ShopMap34Builder b)]) = _$ShopMap34;
  ...
  static Serializer<ShopMap34> get serializer => _$shopMap34Serializer;
}

abstract class SupplierMap34 implements Built<SupplierMap34, SupplierMap34Builder> {
  SupplierMap34._();

  factory SupplierMap34([updates(SupplierMap34Builder b)]) = _$SupplierMap34;
  ...
  static Serializer<SupplierMap34> get serializer => _$supplierMap34Serializer;
}

abstract class FilterGroups34
    implements Built<FilterGroups34, FilterGroups34Builder> {
  FilterGroups34._();

  factory FilterGroups34([updates(FilterGroups34Builder b)]) = _$FilterGroups34;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options34> get options;

  static Serializer<FilterGroups34> get serializer => _$filterGroups34Serializer;
}

abstract class Options34 implements Built<Options34, Options34Builder> {
  Options34._();

  factory Options34([updates(Options34Builder b)]) = _$Options34;
  ...
  static Serializer<Options34> get serializer => _$options34Serializer;
}

abstract class PackageLabelInfo34
    implements Built<PackageLabelInfo34, PackageLabelInfo34Builder> {
  PackageLabelInfo34._();

  factory PackageLabelInfo34([updates(PackageLabelInfo34Builder b)]) =
      _$PackageLabelInfo34;
  ...
  static Serializer<PackageLabelInfo34> get serializer =>
      _$packageLabelInfo34Serializer;
}

abstract class ActivityList34
    implements Built<ActivityList34, ActivityList34Builder> {
  ActivityList34._();

  factory ActivityList34([update(ActivityList34Builder b)]) = _$ActivityList34;
  ...
  CardTags34 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList34> get serializer => _$activityList34Serializer;
}

abstract class CardTags34 implements Built<CardTags34, CardTags34Builder> {
  CardTags34._();

  factory CardTags34([update(CardTags34Builder b)]) = _$CardTags34;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags34> get serializer => _$cardTags34Serializer;
}
