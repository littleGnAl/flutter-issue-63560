...
part 'generated_search_result_poll_result21.g.dart';

abstract class SearchResultPollResult21
    implements Built<SearchResultPollResult21, SearchResultPollResult21Builder> {
  SearchResultPollResult21._();

  factory SearchResultPollResult21([updates(SearchResultPollResult21Builder b)]) =
  ...
  BuiltList<VehicleInfoList21> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap21> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap21> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups21> get filterGroups;
  ...
  static Serializer<SearchResultPollResult21> get serializer =>
      _$searchResultPollResult21Serializer;
}

abstract class VehicleInfoList21
    implements Built<VehicleInfoList21, VehicleInfoList21Builder> {
  VehicleInfoList21._();

  factory VehicleInfoList21([updates(VehicleInfoList21Builder b)]) =
      _$VehicleInfoList21;
  ...
  BuiltList<Packages21> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic21> get options;
  ...
  static Serializer<VehicleInfoList21> get serializer =>
      _$vehicleInfoList21Serializer;
}

abstract class VehicleCharacteristic21
    implements Built<VehicleCharacteristic21, VehicleCharacteristic21Builder> {
  VehicleCharacteristic21._();

  factory VehicleCharacteristic21([updates(VehicleCharacteristic21Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic21> get serializer =>
      _$vehicleCharacteristic21Serializer;
}

abstract class Service21 implements Built<Service21, Service21Builder> {
  Service21._();

  factory Service21([updates(Service21Builder b)]) = _$Service21;
  ...
  static Serializer<Service21> get serializer => _$service21Serializer;
}

abstract class Price21 implements Built<Price21, Price21Builder> {
  Price21._();

  factory Price21([updates(Price21Builder b)]) = _$Price21;
  ...
  static Serializer<Price21> get serializer => _$price21Serializer;
}

abstract class Packages21 implements Built<Packages21, Packages21Builder> {
  Packages21._();

  factory Packages21([updates(Packages21Builder b)]) = _$Packages21;
  ...
  PackageLabelInfo21 get packageLabelInfo;

  static Serializer<Packages21> get serializer => _$packages21Serializer;
}

abstract class Coverage21 implements Built<Coverage21, Coverage21Builder> {
  Coverage21._();

  factory Coverage21([updates(Coverage21Builder b)]) = _$Coverage21;
  ...
  InsuredPerson21 get insuredPerson;
  ...
  BuiltList<SubInsurances21> get subInsurances;

  static Serializer<Coverage21> get serializer => _$coverage21Serializer;
}

abstract class InsuredPerson21
    implements Built<InsuredPerson21, InsuredPerson21Builder> {
  InsuredPerson21._();

  factory InsuredPerson21([updates(InsuredPerson21Builder b)]) = _$InsuredPerson21;
  ...
  static Serializer<InsuredPerson21> get serializer => _$insuredPerson21Serializer;
}

abstract class SubInsurances21
    implements Built<SubInsurances21, SubInsurances21Builder> {
  SubInsurances21._();

  factory SubInsurances21([updates(SubInsurances21Builder b)]) = _$SubInsurances21;
  ...
  static Serializer<SubInsurances21> get serializer => _$subInsurances21Serializer;
}

abstract class ShopMap21 implements Built<ShopMap21, ShopMap21Builder> {
  ShopMap21._();

  factory ShopMap21([updates(ShopMap21Builder b)]) = _$ShopMap21;
  ...
  static Serializer<ShopMap21> get serializer => _$shopMap21Serializer;
}

abstract class SupplierMap21 implements Built<SupplierMap21, SupplierMap21Builder> {
  SupplierMap21._();

  factory SupplierMap21([updates(SupplierMap21Builder b)]) = _$SupplierMap21;
  ...
  static Serializer<SupplierMap21> get serializer => _$supplierMap21Serializer;
}

abstract class FilterGroups21
    implements Built<FilterGroups21, FilterGroups21Builder> {
  FilterGroups21._();

  factory FilterGroups21([updates(FilterGroups21Builder b)]) = _$FilterGroups21;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options21> get options;

  static Serializer<FilterGroups21> get serializer => _$filterGroups21Serializer;
}

abstract class Options21 implements Built<Options21, Options21Builder> {
  Options21._();

  factory Options21([updates(Options21Builder b)]) = _$Options21;
  ...
  static Serializer<Options21> get serializer => _$options21Serializer;
}

abstract class PackageLabelInfo21
    implements Built<PackageLabelInfo21, PackageLabelInfo21Builder> {
  PackageLabelInfo21._();

  factory PackageLabelInfo21([updates(PackageLabelInfo21Builder b)]) =
      _$PackageLabelInfo21;
  ...
  static Serializer<PackageLabelInfo21> get serializer =>
      _$packageLabelInfo21Serializer;
}

abstract class ActivityList21
    implements Built<ActivityList21, ActivityList21Builder> {
  ActivityList21._();

  factory ActivityList21([update(ActivityList21Builder b)]) = _$ActivityList21;
  ...
  CardTags21 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList21> get serializer => _$activityList21Serializer;
}

abstract class CardTags21 implements Built<CardTags21, CardTags21Builder> {
  CardTags21._();

  factory CardTags21([update(CardTags21Builder b)]) = _$CardTags21;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags21> get serializer => _$cardTags21Serializer;
}

@SerializersFor([
  SearchResultPollResult21,
])
final Serializers serializers21 = _$serializers21;
