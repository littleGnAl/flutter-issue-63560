...
part 'generated_search_result_poll_result24.g.dart';

abstract class SearchResultPollResult24
    implements Built<SearchResultPollResult24, SearchResultPollResult24Builder> {
  SearchResultPollResult24._();

  factory SearchResultPollResult24([updates(SearchResultPollResult24Builder b)]) =
  ...
  BuiltList<VehicleInfoList24> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap24> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap24> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups24> get filterGroups;
  ...
  static Serializer<SearchResultPollResult24> get serializer =>
      _$searchResultPollResult24Serializer;
}

abstract class VehicleInfoList24
    implements Built<VehicleInfoList24, VehicleInfoList24Builder> {
  VehicleInfoList24._();

  factory VehicleInfoList24([updates(VehicleInfoList24Builder b)]) =
      _$VehicleInfoList24;
  ...
  BuiltList<Packages24> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic24> get options;
  ...
  static Serializer<VehicleInfoList24> get serializer =>
      _$vehicleInfoList24Serializer;
}

abstract class VehicleCharacteristic24
    implements Built<VehicleCharacteristic24, VehicleCharacteristic24Builder> {
  VehicleCharacteristic24._();

  factory VehicleCharacteristic24([updates(VehicleCharacteristic24Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic24> get serializer =>
      _$vehicleCharacteristic24Serializer;
}

abstract class Service24 implements Built<Service24, Service24Builder> {
  Service24._();

  factory Service24([updates(Service24Builder b)]) = _$Service24;
  ...
  static Serializer<Service24> get serializer => _$service24Serializer;
}

abstract class Price24 implements Built<Price24, Price24Builder> {
  Price24._();

  factory Price24([updates(Price24Builder b)]) = _$Price24;
  ...
  static Serializer<Price24> get serializer => _$price24Serializer;
}

abstract class Packages24 implements Built<Packages24, Packages24Builder> {
  Packages24._();

  factory Packages24([updates(Packages24Builder b)]) = _$Packages24;
  ...
  PackageLabelInfo24 get packageLabelInfo;

  static Serializer<Packages24> get serializer => _$packages24Serializer;
}

abstract class Coverage24 implements Built<Coverage24, Coverage24Builder> {
  Coverage24._();

  factory Coverage24([updates(Coverage24Builder b)]) = _$Coverage24;
  ...
  InsuredPerson24 get insuredPerson;
  ...
  BuiltList<SubInsurances24> get subInsurances;

  static Serializer<Coverage24> get serializer => _$coverage24Serializer;
}

abstract class InsuredPerson24
    implements Built<InsuredPerson24, InsuredPerson24Builder> {
  InsuredPerson24._();

  factory InsuredPerson24([updates(InsuredPerson24Builder b)]) = _$InsuredPerson24;
  ...
  static Serializer<InsuredPerson24> get serializer => _$insuredPerson24Serializer;
}

abstract class SubInsurances24
    implements Built<SubInsurances24, SubInsurances24Builder> {
  SubInsurances24._();

  factory SubInsurances24([updates(SubInsurances24Builder b)]) = _$SubInsurances24;
  ...
  static Serializer<SubInsurances24> get serializer => _$subInsurances24Serializer;
}

abstract class ShopMap24 implements Built<ShopMap24, ShopMap24Builder> {
  ShopMap24._();

  factory ShopMap24([updates(ShopMap24Builder b)]) = _$ShopMap24;
  ...
  static Serializer<ShopMap24> get serializer => _$shopMap24Serializer;
}

abstract class SupplierMap24 implements Built<SupplierMap24, SupplierMap24Builder> {
  SupplierMap24._();

  factory SupplierMap24([updates(SupplierMap24Builder b)]) = _$SupplierMap24;
  ...
  static Serializer<SupplierMap24> get serializer => _$supplierMap24Serializer;
}

abstract class FilterGroups24
    implements Built<FilterGroups24, FilterGroups24Builder> {
  FilterGroups24._();

  factory FilterGroups24([updates(FilterGroups24Builder b)]) = _$FilterGroups24;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options24> get options;

  static Serializer<FilterGroups24> get serializer => _$filterGroups24Serializer;
}

abstract class Options24 implements Built<Options24, Options24Builder> {
  Options24._();

  factory Options24([updates(Options24Builder b)]) = _$Options24;
  ...
  static Serializer<Options24> get serializer => _$options24Serializer;
}

abstract class PackageLabelInfo24
    implements Built<PackageLabelInfo24, PackageLabelInfo24Builder> {
  PackageLabelInfo24._();

  factory PackageLabelInfo24([updates(PackageLabelInfo24Builder b)]) =
      _$PackageLabelInfo24;
  ...
  static Serializer<PackageLabelInfo24> get serializer =>
      _$packageLabelInfo24Serializer;
}

abstract class ActivityList24
    implements Built<ActivityList24, ActivityList24Builder> {
  ActivityList24._();

  factory ActivityList24([update(ActivityList24Builder b)]) = _$ActivityList24;
  ...
  CardTags24 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList24> get serializer => _$activityList24Serializer;
}

abstract class CardTags24 implements Built<CardTags24, CardTags24Builder> {
  CardTags24._();

  factory CardTags24([update(CardTags24Builder b)]) = _$CardTags24;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags24> get serializer => _$cardTags24Serializer;
}

@SerializersFor([
  SearchResultPollResult24,
])
final Serializers serializers24 = _$serializers24;
