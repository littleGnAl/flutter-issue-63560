...
part 'generated_search_result_poll_result90.g.dart';

abstract class SearchResultPollResult90
    implements Built<SearchResultPollResult90, SearchResultPollResult90Builder> {
  SearchResultPollResult90._();

  factory SearchResultPollResult90([updates(SearchResultPollResult90Builder b)]) =
  ...
  BuiltList<VehicleInfoList90> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap90> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap90> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups90> get filterGroups;
  ...
  static Serializer<SearchResultPollResult90> get serializer =>
      _$searchResultPollResult90Serializer;
}

abstract class VehicleInfoList90
    implements Built<VehicleInfoList90, VehicleInfoList90Builder> {
  VehicleInfoList90._();

  factory VehicleInfoList90([updates(VehicleInfoList90Builder b)]) =
      _$VehicleInfoList90;
  ...
  BuiltList<Packages90> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic90> get options;
  ...
  static Serializer<VehicleInfoList90> get serializer =>
      _$vehicleInfoList90Serializer;
}

abstract class VehicleCharacteristic90
    implements Built<VehicleCharacteristic90, VehicleCharacteristic90Builder> {
  VehicleCharacteristic90._();

  factory VehicleCharacteristic90([updates(VehicleCharacteristic90Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic90> get serializer =>
      _$vehicleCharacteristic90Serializer;
}

abstract class Service90 implements Built<Service90, Service90Builder> {
  Service90._();

  factory Service90([updates(Service90Builder b)]) = _$Service90;
  ...
  static Serializer<Service90> get serializer => _$service90Serializer;
}

abstract class Price90 implements Built<Price90, Price90Builder> {
  Price90._();

  factory Price90([updates(Price90Builder b)]) = _$Price90;
  ...
  static Serializer<Price90> get serializer => _$price90Serializer;
}

abstract class Packages90 implements Built<Packages90, Packages90Builder> {
  Packages90._();

  factory Packages90([updates(Packages90Builder b)]) = _$Packages90;
  ...
  PackageLabelInfo90 get packageLabelInfo;

  static Serializer<Packages90> get serializer => _$packages90Serializer;
}

abstract class Coverage90 implements Built<Coverage90, Coverage90Builder> {
  Coverage90._();

  factory Coverage90([updates(Coverage90Builder b)]) = _$Coverage90;
  ...
  InsuredPerson90 get insuredPerson;
  ...
  BuiltList<SubInsurances90> get subInsurances;

  static Serializer<Coverage90> get serializer => _$coverage90Serializer;
}

abstract class InsuredPerson90
    implements Built<InsuredPerson90, InsuredPerson90Builder> {
  InsuredPerson90._();

  factory InsuredPerson90([updates(InsuredPerson90Builder b)]) = _$InsuredPerson90;
  ...
  static Serializer<InsuredPerson90> get serializer => _$insuredPerson90Serializer;
}

abstract class SubInsurances90
    implements Built<SubInsurances90, SubInsurances90Builder> {
  SubInsurances90._();

  factory SubInsurances90([updates(SubInsurances90Builder b)]) = _$SubInsurances90;
  ...
  static Serializer<SubInsurances90> get serializer => _$subInsurances90Serializer;
}

abstract class ShopMap90 implements Built<ShopMap90, ShopMap90Builder> {
  ShopMap90._();

  factory ShopMap90([updates(ShopMap90Builder b)]) = _$ShopMap90;
  ...
  static Serializer<ShopMap90> get serializer => _$shopMap90Serializer;
}

abstract class SupplierMap90 implements Built<SupplierMap90, SupplierMap90Builder> {
  SupplierMap90._();

  factory SupplierMap90([updates(SupplierMap90Builder b)]) = _$SupplierMap90;
  ...
  static Serializer<SupplierMap90> get serializer => _$supplierMap90Serializer;
}

abstract class FilterGroups90
    implements Built<FilterGroups90, FilterGroups90Builder> {
  FilterGroups90._();

  factory FilterGroups90([updates(FilterGroups90Builder b)]) = _$FilterGroups90;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options90> get options;

  static Serializer<FilterGroups90> get serializer => _$filterGroups90Serializer;
}

abstract class Options90 implements Built<Options90, Options90Builder> {
  Options90._();

  factory Options90([updates(Options90Builder b)]) = _$Options90;
  ...
  static Serializer<Options90> get serializer => _$options90Serializer;
}

abstract class PackageLabelInfo90
    implements Built<PackageLabelInfo90, PackageLabelInfo90Builder> {
  PackageLabelInfo90._();

  factory PackageLabelInfo90([updates(PackageLabelInfo90Builder b)]) =
      _$PackageLabelInfo90;
  ...
  static Serializer<PackageLabelInfo90> get serializer =>
      _$packageLabelInfo90Serializer;
}

abstract class ActivityList90
    implements Built<ActivityList90, ActivityList90Builder> {
  ActivityList90._();

  factory ActivityList90([update(ActivityList90Builder b)]) = _$ActivityList90;
  ...
  CardTags90 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList90> get serializer => _$activityList90Serializer;
}

abstract class CardTags90 implements Built<CardTags90, CardTags90Builder> {
  CardTags90._();

  factory CardTags90([update(CardTags90Builder b)]) = _$CardTags90;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags90> get serializer => _$cardTags90Serializer;
}

@SerializersFor([
  SearchResultPollResult90,
])
final Serializers serializers90 = _$serializers90;
