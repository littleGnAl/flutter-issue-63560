...
part 'generated_search_result_poll_result39.g.dart';

abstract class SearchResultPollResult39
    implements Built<SearchResultPollResult39, SearchResultPollResult39Builder> {
  SearchResultPollResult39._();

  factory SearchResultPollResult39([updates(SearchResultPollResult39Builder b)]) =
  ...
  BuiltList<VehicleInfoList39> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap39> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap39> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups39> get filterGroups;
  ...
  static Serializer<SearchResultPollResult39> get serializer =>
      _$searchResultPollResult39Serializer;
}

abstract class VehicleInfoList39
    implements Built<VehicleInfoList39, VehicleInfoList39Builder> {
  VehicleInfoList39._();

  factory VehicleInfoList39([updates(VehicleInfoList39Builder b)]) =
      _$VehicleInfoList39;
  ...
  BuiltList<Packages39> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic39> get options;
  ...
  static Serializer<VehicleInfoList39> get serializer =>
      _$vehicleInfoList39Serializer;
}

abstract class VehicleCharacteristic39
    implements Built<VehicleCharacteristic39, VehicleCharacteristic39Builder> {
  VehicleCharacteristic39._();

  factory VehicleCharacteristic39([updates(VehicleCharacteristic39Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic39> get serializer =>
      _$vehicleCharacteristic39Serializer;
}

abstract class Service39 implements Built<Service39, Service39Builder> {
  Service39._();

  factory Service39([updates(Service39Builder b)]) = _$Service39;
  ...
  static Serializer<Service39> get serializer => _$service39Serializer;
}

abstract class Price39 implements Built<Price39, Price39Builder> {
  Price39._();

  factory Price39([updates(Price39Builder b)]) = _$Price39;
  ...
  static Serializer<Price39> get serializer => _$price39Serializer;
}

abstract class Packages39 implements Built<Packages39, Packages39Builder> {
  Packages39._();

  factory Packages39([updates(Packages39Builder b)]) = _$Packages39;
  ...
  PackageLabelInfo39 get packageLabelInfo;

  static Serializer<Packages39> get serializer => _$packages39Serializer;
}

abstract class Coverage39 implements Built<Coverage39, Coverage39Builder> {
  Coverage39._();

  factory Coverage39([updates(Coverage39Builder b)]) = _$Coverage39;
  ...
  InsuredPerson39 get insuredPerson;
  ...
  BuiltList<SubInsurances39> get subInsurances;

  static Serializer<Coverage39> get serializer => _$coverage39Serializer;
}

abstract class InsuredPerson39
    implements Built<InsuredPerson39, InsuredPerson39Builder> {
  InsuredPerson39._();

  factory InsuredPerson39([updates(InsuredPerson39Builder b)]) = _$InsuredPerson39;
  ...
  static Serializer<InsuredPerson39> get serializer => _$insuredPerson39Serializer;
}

abstract class SubInsurances39
    implements Built<SubInsurances39, SubInsurances39Builder> {
  SubInsurances39._();

  factory SubInsurances39([updates(SubInsurances39Builder b)]) = _$SubInsurances39;
  ...
  static Serializer<SubInsurances39> get serializer => _$subInsurances39Serializer;
}

abstract class ShopMap39 implements Built<ShopMap39, ShopMap39Builder> {
  ShopMap39._();

  factory ShopMap39([updates(ShopMap39Builder b)]) = _$ShopMap39;
  ...
  static Serializer<ShopMap39> get serializer => _$shopMap39Serializer;
}

abstract class SupplierMap39 implements Built<SupplierMap39, SupplierMap39Builder> {
  SupplierMap39._();

  factory SupplierMap39([updates(SupplierMap39Builder b)]) = _$SupplierMap39;
  ...
  static Serializer<SupplierMap39> get serializer => _$supplierMap39Serializer;
}

abstract class FilterGroups39
    implements Built<FilterGroups39, FilterGroups39Builder> {
  FilterGroups39._();

  factory FilterGroups39([updates(FilterGroups39Builder b)]) = _$FilterGroups39;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options39> get options;

  static Serializer<FilterGroups39> get serializer => _$filterGroups39Serializer;
}

abstract class Options39 implements Built<Options39, Options39Builder> {
  Options39._();

  factory Options39([updates(Options39Builder b)]) = _$Options39;
  ...
  static Serializer<Options39> get serializer => _$options39Serializer;
}

abstract class PackageLabelInfo39
    implements Built<PackageLabelInfo39, PackageLabelInfo39Builder> {
  PackageLabelInfo39._();

  factory PackageLabelInfo39([updates(PackageLabelInfo39Builder b)]) =
      _$PackageLabelInfo39;
  ...
  static Serializer<PackageLabelInfo39> get serializer =>
      _$packageLabelInfo39Serializer;
}

abstract class ActivityList39
    implements Built<ActivityList39, ActivityList39Builder> {
  ActivityList39._();

  factory ActivityList39([update(ActivityList39Builder b)]) = _$ActivityList39;
  ...
  CardTags39 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList39> get serializer => _$activityList39Serializer;
}

abstract class CardTags39 implements Built<CardTags39, CardTags39Builder> {
  CardTags39._();

  factory CardTags39([update(CardTags39Builder b)]) = _$CardTags39;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags39> get serializer => _$cardTags39Serializer;
}

@SerializersFor([
  SearchResultPollResult39,
])
final Serializers serializers39 = _$serializers39;
