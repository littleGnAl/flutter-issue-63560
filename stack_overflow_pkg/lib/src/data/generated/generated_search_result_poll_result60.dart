...
part 'generated_search_result_poll_result60.g.dart';

abstract class SearchResultPollResult60
    implements Built<SearchResultPollResult60, SearchResultPollResult60Builder> {
  SearchResultPollResult60._();

  factory SearchResultPollResult60([updates(SearchResultPollResult60Builder b)]) =
  ...
  BuiltList<VehicleInfoList60> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap60> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap60> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups60> get filterGroups;
  ...
  static Serializer<SearchResultPollResult60> get serializer =>
      _$searchResultPollResult60Serializer;
}

abstract class VehicleInfoList60
    implements Built<VehicleInfoList60, VehicleInfoList60Builder> {
  VehicleInfoList60._();

  factory VehicleInfoList60([updates(VehicleInfoList60Builder b)]) =
      _$VehicleInfoList60;
  ...
  BuiltList<Packages60> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic60> get options;
  ...
  static Serializer<VehicleInfoList60> get serializer =>
      _$vehicleInfoList60Serializer;
}

abstract class VehicleCharacteristic60
    implements Built<VehicleCharacteristic60, VehicleCharacteristic60Builder> {
  VehicleCharacteristic60._();

  factory VehicleCharacteristic60([updates(VehicleCharacteristic60Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic60> get serializer =>
      _$vehicleCharacteristic60Serializer;
}

abstract class Service60 implements Built<Service60, Service60Builder> {
  Service60._();

  factory Service60([updates(Service60Builder b)]) = _$Service60;
  ...
  static Serializer<Service60> get serializer => _$service60Serializer;
}

abstract class Price60 implements Built<Price60, Price60Builder> {
  Price60._();

  factory Price60([updates(Price60Builder b)]) = _$Price60;
  ...
  static Serializer<Price60> get serializer => _$price60Serializer;
}

abstract class Packages60 implements Built<Packages60, Packages60Builder> {
  Packages60._();

  factory Packages60([updates(Packages60Builder b)]) = _$Packages60;
  ...
  PackageLabelInfo60 get packageLabelInfo;

  static Serializer<Packages60> get serializer => _$packages60Serializer;
}

abstract class Coverage60 implements Built<Coverage60, Coverage60Builder> {
  Coverage60._();

  factory Coverage60([updates(Coverage60Builder b)]) = _$Coverage60;
  ...
  InsuredPerson60 get insuredPerson;
  ...
  BuiltList<SubInsurances60> get subInsurances;

  static Serializer<Coverage60> get serializer => _$coverage60Serializer;
}

abstract class InsuredPerson60
    implements Built<InsuredPerson60, InsuredPerson60Builder> {
  InsuredPerson60._();

  factory InsuredPerson60([updates(InsuredPerson60Builder b)]) = _$InsuredPerson60;
  ...
  static Serializer<InsuredPerson60> get serializer => _$insuredPerson60Serializer;
}

abstract class SubInsurances60
    implements Built<SubInsurances60, SubInsurances60Builder> {
  SubInsurances60._();

  factory SubInsurances60([updates(SubInsurances60Builder b)]) = _$SubInsurances60;
  ...
  static Serializer<SubInsurances60> get serializer => _$subInsurances60Serializer;
}

abstract class ShopMap60 implements Built<ShopMap60, ShopMap60Builder> {
  ShopMap60._();

  factory ShopMap60([updates(ShopMap60Builder b)]) = _$ShopMap60;
  ...
  static Serializer<ShopMap60> get serializer => _$shopMap60Serializer;
}

abstract class SupplierMap60 implements Built<SupplierMap60, SupplierMap60Builder> {
  SupplierMap60._();

  factory SupplierMap60([updates(SupplierMap60Builder b)]) = _$SupplierMap60;
  ...
  static Serializer<SupplierMap60> get serializer => _$supplierMap60Serializer;
}

abstract class FilterGroups60
    implements Built<FilterGroups60, FilterGroups60Builder> {
  FilterGroups60._();

  factory FilterGroups60([updates(FilterGroups60Builder b)]) = _$FilterGroups60;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options60> get options;

  static Serializer<FilterGroups60> get serializer => _$filterGroups60Serializer;
}

abstract class Options60 implements Built<Options60, Options60Builder> {
  Options60._();

  factory Options60([updates(Options60Builder b)]) = _$Options60;
  ...
  static Serializer<Options60> get serializer => _$options60Serializer;
}

abstract class PackageLabelInfo60
    implements Built<PackageLabelInfo60, PackageLabelInfo60Builder> {
  PackageLabelInfo60._();

  factory PackageLabelInfo60([updates(PackageLabelInfo60Builder b)]) =
      _$PackageLabelInfo60;
  ...
  static Serializer<PackageLabelInfo60> get serializer =>
      _$packageLabelInfo60Serializer;
}

abstract class ActivityList60
    implements Built<ActivityList60, ActivityList60Builder> {
  ActivityList60._();

  factory ActivityList60([update(ActivityList60Builder b)]) = _$ActivityList60;
  ...
  CardTags60 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList60> get serializer => _$activityList60Serializer;
}

abstract class CardTags60 implements Built<CardTags60, CardTags60Builder> {
  CardTags60._();

  factory CardTags60([update(CardTags60Builder b)]) = _$CardTags60;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags60> get serializer => _$cardTags60Serializer;
}

@SerializersFor([
  SearchResultPollResult60,
])
final Serializers serializers60 = _$serializers60;
