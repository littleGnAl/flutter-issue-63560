...
part 'generated_search_result_poll_result37.g.dart';

abstract class SearchResultPollResult37
    implements Built<SearchResultPollResult37, SearchResultPollResult37Builder> {
  SearchResultPollResult37._();

  factory SearchResultPollResult37([updates(SearchResultPollResult37Builder b)]) =
  ...
  BuiltList<VehicleInfoList37> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap37> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap37> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups37> get filterGroups;
  ...
  static Serializer<SearchResultPollResult37> get serializer =>
      _$searchResultPollResult37Serializer;
}

abstract class VehicleInfoList37
    implements Built<VehicleInfoList37, VehicleInfoList37Builder> {
  VehicleInfoList37._();

  factory VehicleInfoList37([updates(VehicleInfoList37Builder b)]) =
      _$VehicleInfoList37;
  ...
  BuiltList<Packages37> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic37> get options;
  ...
  static Serializer<VehicleInfoList37> get serializer =>
      _$vehicleInfoList37Serializer;
}

abstract class VehicleCharacteristic37
    implements Built<VehicleCharacteristic37, VehicleCharacteristic37Builder> {
  VehicleCharacteristic37._();

  factory VehicleCharacteristic37([updates(VehicleCharacteristic37Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic37> get serializer =>
      _$vehicleCharacteristic37Serializer;
}

abstract class Service37 implements Built<Service37, Service37Builder> {
  Service37._();

  factory Service37([updates(Service37Builder b)]) = _$Service37;
  ...
  static Serializer<Service37> get serializer => _$service37Serializer;
}

abstract class Price37 implements Built<Price37, Price37Builder> {
  Price37._();

  factory Price37([updates(Price37Builder b)]) = _$Price37;
  ...
  static Serializer<Price37> get serializer => _$price37Serializer;
}

abstract class Packages37 implements Built<Packages37, Packages37Builder> {
  Packages37._();

  factory Packages37([updates(Packages37Builder b)]) = _$Packages37;
  ...
  PackageLabelInfo37 get packageLabelInfo;

  static Serializer<Packages37> get serializer => _$packages37Serializer;
}

abstract class Coverage37 implements Built<Coverage37, Coverage37Builder> {
  Coverage37._();

  factory Coverage37([updates(Coverage37Builder b)]) = _$Coverage37;
  ...
  InsuredPerson37 get insuredPerson;
  ...
  BuiltList<SubInsurances37> get subInsurances;

  static Serializer<Coverage37> get serializer => _$coverage37Serializer;
}

abstract class InsuredPerson37
    implements Built<InsuredPerson37, InsuredPerson37Builder> {
  InsuredPerson37._();

  factory InsuredPerson37([updates(InsuredPerson37Builder b)]) = _$InsuredPerson37;
  ...
  static Serializer<InsuredPerson37> get serializer => _$insuredPerson37Serializer;
}

abstract class SubInsurances37
    implements Built<SubInsurances37, SubInsurances37Builder> {
  SubInsurances37._();

  factory SubInsurances37([updates(SubInsurances37Builder b)]) = _$SubInsurances37;
  ...
  static Serializer<SubInsurances37> get serializer => _$subInsurances37Serializer;
}

abstract class ShopMap37 implements Built<ShopMap37, ShopMap37Builder> {
  ShopMap37._();

  factory ShopMap37([updates(ShopMap37Builder b)]) = _$ShopMap37;
  ...
  static Serializer<ShopMap37> get serializer => _$shopMap37Serializer;
}

abstract class SupplierMap37 implements Built<SupplierMap37, SupplierMap37Builder> {
  SupplierMap37._();

  factory SupplierMap37([updates(SupplierMap37Builder b)]) = _$SupplierMap37;
  ...
  static Serializer<SupplierMap37> get serializer => _$supplierMap37Serializer;
}

abstract class FilterGroups37
    implements Built<FilterGroups37, FilterGroups37Builder> {
  FilterGroups37._();

  factory FilterGroups37([updates(FilterGroups37Builder b)]) = _$FilterGroups37;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options37> get options;

  static Serializer<FilterGroups37> get serializer => _$filterGroups37Serializer;
}

abstract class Options37 implements Built<Options37, Options37Builder> {
  Options37._();

  factory Options37([updates(Options37Builder b)]) = _$Options37;
  ...
  static Serializer<Options37> get serializer => _$options37Serializer;
}

abstract class PackageLabelInfo37
    implements Built<PackageLabelInfo37, PackageLabelInfo37Builder> {
  PackageLabelInfo37._();

  factory PackageLabelInfo37([updates(PackageLabelInfo37Builder b)]) =
      _$PackageLabelInfo37;
  ...
  static Serializer<PackageLabelInfo37> get serializer =>
      _$packageLabelInfo37Serializer;
}

abstract class ActivityList37
    implements Built<ActivityList37, ActivityList37Builder> {
  ActivityList37._();

  factory ActivityList37([update(ActivityList37Builder b)]) = _$ActivityList37;
  ...
  CardTags37 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList37> get serializer => _$activityList37Serializer;
}

abstract class CardTags37 implements Built<CardTags37, CardTags37Builder> {
  CardTags37._();

  factory CardTags37([update(CardTags37Builder b)]) = _$CardTags37;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags37> get serializer => _$cardTags37Serializer;
}

@SerializersFor([
  SearchResultPollResult37,
])
final Serializers serializers37 = _$serializers37;
