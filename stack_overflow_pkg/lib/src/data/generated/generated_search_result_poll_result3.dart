...
part 'generated_search_result_poll_result3.g.dart';

abstract class SearchResultPollResult3
    implements Built<SearchResultPollResult3, SearchResultPollResult3Builder> {
  SearchResultPollResult3._();

  factory SearchResultPollResult3([updates(SearchResultPollResult3Builder b)]) =
  ...
  BuiltList<VehicleInfoList3> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap3> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap3> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups3> get filterGroups;
  ...
  static Serializer<SearchResultPollResult3> get serializer =>
      _$searchResultPollResult3Serializer;
}

abstract class VehicleInfoList3
    implements Built<VehicleInfoList3, VehicleInfoList3Builder> {
  VehicleInfoList3._();

  factory VehicleInfoList3([updates(VehicleInfoList3Builder b)]) =
      _$VehicleInfoList3;
  ...
  BuiltList<Packages3> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic3> get options;
  ...
  static Serializer<VehicleInfoList3> get serializer =>
      _$vehicleInfoList3Serializer;
}

abstract class VehicleCharacteristic3
    implements Built<VehicleCharacteristic3, VehicleCharacteristic3Builder> {
  VehicleCharacteristic3._();

  factory VehicleCharacteristic3([updates(VehicleCharacteristic3Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic3> get serializer =>
      _$vehicleCharacteristic3Serializer;
}

abstract class Service3 implements Built<Service3, Service3Builder> {
  Service3._();

  factory Service3([updates(Service3Builder b)]) = _$Service3;
  ...
  static Serializer<Service3> get serializer => _$service3Serializer;
}

abstract class Price3 implements Built<Price3, Price3Builder> {
  Price3._();

  factory Price3([updates(Price3Builder b)]) = _$Price3;
  ...
  static Serializer<Price3> get serializer => _$price3Serializer;
}

abstract class Packages3 implements Built<Packages3, Packages3Builder> {
  Packages3._();

  factory Packages3([updates(Packages3Builder b)]) = _$Packages3;
  ...
  PackageLabelInfo3 get packageLabelInfo;

  static Serializer<Packages3> get serializer => _$packages3Serializer;
}

abstract class Coverage3 implements Built<Coverage3, Coverage3Builder> {
  Coverage3._();

  factory Coverage3([updates(Coverage3Builder b)]) = _$Coverage3;
  ...
  InsuredPerson3 get insuredPerson;
  ...
  BuiltList<SubInsurances3> get subInsurances;

  static Serializer<Coverage3> get serializer => _$coverage3Serializer;
}

abstract class InsuredPerson3
    implements Built<InsuredPerson3, InsuredPerson3Builder> {
  InsuredPerson3._();

  factory InsuredPerson3([updates(InsuredPerson3Builder b)]) = _$InsuredPerson3;
  ...
  static Serializer<InsuredPerson3> get serializer => _$insuredPerson3Serializer;
}

abstract class SubInsurances3
    implements Built<SubInsurances3, SubInsurances3Builder> {
  SubInsurances3._();

  factory SubInsurances3([updates(SubInsurances3Builder b)]) = _$SubInsurances3;
  ...
  static Serializer<SubInsurances3> get serializer => _$subInsurances3Serializer;
}

abstract class ShopMap3 implements Built<ShopMap3, ShopMap3Builder> {
  ShopMap3._();

  factory ShopMap3([updates(ShopMap3Builder b)]) = _$ShopMap3;
  ...
  static Serializer<ShopMap3> get serializer => _$shopMap3Serializer;
}

abstract class SupplierMap3 implements Built<SupplierMap3, SupplierMap3Builder> {
  SupplierMap3._();

  factory SupplierMap3([updates(SupplierMap3Builder b)]) = _$SupplierMap3;
  ...
  static Serializer<SupplierMap3> get serializer => _$supplierMap3Serializer;
}

abstract class FilterGroups3
    implements Built<FilterGroups3, FilterGroups3Builder> {
  FilterGroups3._();

  factory FilterGroups3([updates(FilterGroups3Builder b)]) = _$FilterGroups3;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options3> get options;

  static Serializer<FilterGroups3> get serializer => _$filterGroups3Serializer;
}

abstract class Options3 implements Built<Options3, Options3Builder> {
  Options3._();

  factory Options3([updates(Options3Builder b)]) = _$Options3;
  ...
  static Serializer<Options3> get serializer => _$options3Serializer;
}

abstract class PackageLabelInfo3
    implements Built<PackageLabelInfo3, PackageLabelInfo3Builder> {
  PackageLabelInfo3._();

  factory PackageLabelInfo3([updates(PackageLabelInfo3Builder b)]) =
      _$PackageLabelInfo3;
  ...
  static Serializer<PackageLabelInfo3> get serializer =>
      _$packageLabelInfo3Serializer;
}

abstract class ActivityList3
    implements Built<ActivityList3, ActivityList3Builder> {
  ActivityList3._();

  factory ActivityList3([update(ActivityList3Builder b)]) = _$ActivityList3;
  ...
  CardTags3 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList3> get serializer => _$activityList3Serializer;
}

abstract class CardTags3 implements Built<CardTags3, CardTags3Builder> {
  CardTags3._();

  factory CardTags3([update(CardTags3Builder b)]) = _$CardTags3;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags3> get serializer => _$cardTags3Serializer;
}
