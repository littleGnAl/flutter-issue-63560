...
part 'generated_search_result_poll_result79.g.dart';

abstract class SearchResultPollResult79
    implements Built<SearchResultPollResult79, SearchResultPollResult79Builder> {
  SearchResultPollResult79._();

  factory SearchResultPollResult79([updates(SearchResultPollResult79Builder b)]) =
  ...
  BuiltList<VehicleInfoList79> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap79> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap79> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups79> get filterGroups;
  ...
  static Serializer<SearchResultPollResult79> get serializer =>
      _$searchResultPollResult79Serializer;
}

abstract class VehicleInfoList79
    implements Built<VehicleInfoList79, VehicleInfoList79Builder> {
  VehicleInfoList79._();

  factory VehicleInfoList79([updates(VehicleInfoList79Builder b)]) =
      _$VehicleInfoList79;
  ...
  BuiltList<Packages79> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic79> get options;
  ...
  static Serializer<VehicleInfoList79> get serializer =>
      _$vehicleInfoList79Serializer;
}

abstract class VehicleCharacteristic79
    implements Built<VehicleCharacteristic79, VehicleCharacteristic79Builder> {
  VehicleCharacteristic79._();

  factory VehicleCharacteristic79([updates(VehicleCharacteristic79Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic79> get serializer =>
      _$vehicleCharacteristic79Serializer;
}

abstract class Service79 implements Built<Service79, Service79Builder> {
  Service79._();

  factory Service79([updates(Service79Builder b)]) = _$Service79;
  ...
  static Serializer<Service79> get serializer => _$service79Serializer;
}

abstract class Price79 implements Built<Price79, Price79Builder> {
  Price79._();

  factory Price79([updates(Price79Builder b)]) = _$Price79;
  ...
  static Serializer<Price79> get serializer => _$price79Serializer;
}

abstract class Packages79 implements Built<Packages79, Packages79Builder> {
  Packages79._();

  factory Packages79([updates(Packages79Builder b)]) = _$Packages79;
  ...
  PackageLabelInfo79 get packageLabelInfo;

  static Serializer<Packages79> get serializer => _$packages79Serializer;
}

abstract class Coverage79 implements Built<Coverage79, Coverage79Builder> {
  Coverage79._();

  factory Coverage79([updates(Coverage79Builder b)]) = _$Coverage79;
  ...
  InsuredPerson79 get insuredPerson;
  ...
  BuiltList<SubInsurances79> get subInsurances;

  static Serializer<Coverage79> get serializer => _$coverage79Serializer;
}

abstract class InsuredPerson79
    implements Built<InsuredPerson79, InsuredPerson79Builder> {
  InsuredPerson79._();

  factory InsuredPerson79([updates(InsuredPerson79Builder b)]) = _$InsuredPerson79;
  ...
  static Serializer<InsuredPerson79> get serializer => _$insuredPerson79Serializer;
}

abstract class SubInsurances79
    implements Built<SubInsurances79, SubInsurances79Builder> {
  SubInsurances79._();

  factory SubInsurances79([updates(SubInsurances79Builder b)]) = _$SubInsurances79;
  ...
  static Serializer<SubInsurances79> get serializer => _$subInsurances79Serializer;
}

abstract class ShopMap79 implements Built<ShopMap79, ShopMap79Builder> {
  ShopMap79._();

  factory ShopMap79([updates(ShopMap79Builder b)]) = _$ShopMap79;
  ...
  static Serializer<ShopMap79> get serializer => _$shopMap79Serializer;
}

abstract class SupplierMap79 implements Built<SupplierMap79, SupplierMap79Builder> {
  SupplierMap79._();

  factory SupplierMap79([updates(SupplierMap79Builder b)]) = _$SupplierMap79;
  ...
  static Serializer<SupplierMap79> get serializer => _$supplierMap79Serializer;
}

abstract class FilterGroups79
    implements Built<FilterGroups79, FilterGroups79Builder> {
  FilterGroups79._();

  factory FilterGroups79([updates(FilterGroups79Builder b)]) = _$FilterGroups79;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options79> get options;

  static Serializer<FilterGroups79> get serializer => _$filterGroups79Serializer;
}

abstract class Options79 implements Built<Options79, Options79Builder> {
  Options79._();

  factory Options79([updates(Options79Builder b)]) = _$Options79;
  ...
  static Serializer<Options79> get serializer => _$options79Serializer;
}

abstract class PackageLabelInfo79
    implements Built<PackageLabelInfo79, PackageLabelInfo79Builder> {
  PackageLabelInfo79._();

  factory PackageLabelInfo79([updates(PackageLabelInfo79Builder b)]) =
      _$PackageLabelInfo79;
  ...
  static Serializer<PackageLabelInfo79> get serializer =>
      _$packageLabelInfo79Serializer;
}

abstract class ActivityList79
    implements Built<ActivityList79, ActivityList79Builder> {
  ActivityList79._();

  factory ActivityList79([update(ActivityList79Builder b)]) = _$ActivityList79;
  ...
  CardTags79 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList79> get serializer => _$activityList79Serializer;
}

abstract class CardTags79 implements Built<CardTags79, CardTags79Builder> {
  CardTags79._();

  factory CardTags79([update(CardTags79Builder b)]) = _$CardTags79;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags79> get serializer => _$cardTags79Serializer;
}

@SerializersFor([
  SearchResultPollResult79,
])
final Serializers serializers79 = _$serializers79;
