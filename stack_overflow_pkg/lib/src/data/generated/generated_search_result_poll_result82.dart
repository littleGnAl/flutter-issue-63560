...
part 'generated_search_result_poll_result82.g.dart';

abstract class SearchResultPollResult82
    implements Built<SearchResultPollResult82, SearchResultPollResult82Builder> {
  SearchResultPollResult82._();

  factory SearchResultPollResult82([updates(SearchResultPollResult82Builder b)]) =
  ...
  BuiltList<VehicleInfoList82> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap82> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap82> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups82> get filterGroups;
  ...
  static Serializer<SearchResultPollResult82> get serializer =>
      _$searchResultPollResult82Serializer;
}

abstract class VehicleInfoList82
    implements Built<VehicleInfoList82, VehicleInfoList82Builder> {
  VehicleInfoList82._();

  factory VehicleInfoList82([updates(VehicleInfoList82Builder b)]) =
      _$VehicleInfoList82;
  ...
  BuiltList<Packages82> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic82> get options;
  ...
  static Serializer<VehicleInfoList82> get serializer =>
      _$vehicleInfoList82Serializer;
}

abstract class VehicleCharacteristic82
    implements Built<VehicleCharacteristic82, VehicleCharacteristic82Builder> {
  VehicleCharacteristic82._();

  factory VehicleCharacteristic82([updates(VehicleCharacteristic82Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic82> get serializer =>
      _$vehicleCharacteristic82Serializer;
}

abstract class Service82 implements Built<Service82, Service82Builder> {
  Service82._();

  factory Service82([updates(Service82Builder b)]) = _$Service82;
  ...
  static Serializer<Service82> get serializer => _$service82Serializer;
}

abstract class Price82 implements Built<Price82, Price82Builder> {
  Price82._();

  factory Price82([updates(Price82Builder b)]) = _$Price82;
  ...
  static Serializer<Price82> get serializer => _$price82Serializer;
}

abstract class Packages82 implements Built<Packages82, Packages82Builder> {
  Packages82._();

  factory Packages82([updates(Packages82Builder b)]) = _$Packages82;
  ...
  PackageLabelInfo82 get packageLabelInfo;

  static Serializer<Packages82> get serializer => _$packages82Serializer;
}

abstract class Coverage82 implements Built<Coverage82, Coverage82Builder> {
  Coverage82._();

  factory Coverage82([updates(Coverage82Builder b)]) = _$Coverage82;
  ...
  InsuredPerson82 get insuredPerson;
  ...
  BuiltList<SubInsurances82> get subInsurances;

  static Serializer<Coverage82> get serializer => _$coverage82Serializer;
}

abstract class InsuredPerson82
    implements Built<InsuredPerson82, InsuredPerson82Builder> {
  InsuredPerson82._();

  factory InsuredPerson82([updates(InsuredPerson82Builder b)]) = _$InsuredPerson82;
  ...
  static Serializer<InsuredPerson82> get serializer => _$insuredPerson82Serializer;
}

abstract class SubInsurances82
    implements Built<SubInsurances82, SubInsurances82Builder> {
  SubInsurances82._();

  factory SubInsurances82([updates(SubInsurances82Builder b)]) = _$SubInsurances82;
  ...
  static Serializer<SubInsurances82> get serializer => _$subInsurances82Serializer;
}

abstract class ShopMap82 implements Built<ShopMap82, ShopMap82Builder> {
  ShopMap82._();

  factory ShopMap82([updates(ShopMap82Builder b)]) = _$ShopMap82;
  ...
  static Serializer<ShopMap82> get serializer => _$shopMap82Serializer;
}

abstract class SupplierMap82 implements Built<SupplierMap82, SupplierMap82Builder> {
  SupplierMap82._();

  factory SupplierMap82([updates(SupplierMap82Builder b)]) = _$SupplierMap82;
  ...
  static Serializer<SupplierMap82> get serializer => _$supplierMap82Serializer;
}

abstract class FilterGroups82
    implements Built<FilterGroups82, FilterGroups82Builder> {
  FilterGroups82._();

  factory FilterGroups82([updates(FilterGroups82Builder b)]) = _$FilterGroups82;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options82> get options;

  static Serializer<FilterGroups82> get serializer => _$filterGroups82Serializer;
}

abstract class Options82 implements Built<Options82, Options82Builder> {
  Options82._();

  factory Options82([updates(Options82Builder b)]) = _$Options82;
  ...
  static Serializer<Options82> get serializer => _$options82Serializer;
}

abstract class PackageLabelInfo82
    implements Built<PackageLabelInfo82, PackageLabelInfo82Builder> {
  PackageLabelInfo82._();

  factory PackageLabelInfo82([updates(PackageLabelInfo82Builder b)]) =
      _$PackageLabelInfo82;
  ...
  static Serializer<PackageLabelInfo82> get serializer =>
      _$packageLabelInfo82Serializer;
}

abstract class ActivityList82
    implements Built<ActivityList82, ActivityList82Builder> {
  ActivityList82._();

  factory ActivityList82([update(ActivityList82Builder b)]) = _$ActivityList82;
  ...
  CardTags82 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList82> get serializer => _$activityList82Serializer;
}

abstract class CardTags82 implements Built<CardTags82, CardTags82Builder> {
  CardTags82._();

  factory CardTags82([update(CardTags82Builder b)]) = _$CardTags82;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags82> get serializer => _$cardTags82Serializer;
}
