...
part of 'generated_search_result_poll_result45.dart';
...
Serializer<VehicleInfoList45> _$vehicleInfoList45Serializer =
    new _$VehicleInfoList45Serializer();
Serializer<VehicleCharacteristic45> _$vehicleCharacteristic45Serializer =
    new _$VehicleCharacteristic45Serializer();
Serializer<Service45> _$service45Serializer = new _$Service45Serializer();
Serializer<Price45> _$price45Serializer = new _$Price45Serializer();
Serializer<Packages45> _$packages45Serializer = new _$Packages45Serializer();
Serializer<Coverage45> _$coverage45Serializer = new _$Coverage45Serializer();
Serializer<InsuredPerson45> _$insuredPerson45Serializer =
    new _$InsuredPerson45Serializer();
Serializer<SubInsurances45> _$subInsurances45Serializer =
    new _$SubInsurances45Serializer();
Serializer<ShopMap45> _$shopMap45Serializer = new _$ShopMap45Serializer();
Serializer<SupplierMap45> _$supplierMap45Serializer =
    new _$SupplierMap45Serializer();
Serializer<FilterGroups45> _$filterGroups45Serializer =
    new _$FilterGroups45Serializer();
Serializer<Options45> _$options45Serializer = new _$Options45Serializer();
Serializer<PackageLabelInfo45> _$packageLabelInfo45Serializer =
    new _$PackageLabelInfo45Serializer();
Serializer<ActivityList45> _$activityList45Serializer =
    new _$ActivityList45Serializer();
Serializer<CardTags45> _$cardTags45Serializer = new _$CardTags45Serializer();

class _$SearchResultPollResult45Serializer
    implements StructuredSerializer<SearchResultPollResult45> {
  @override
  final Iterable<Type> types = const [
    SearchResultPollResult45,
    _$SearchResultPollResult45
  ];
  @override
  final String wireName = 'SearchResultPollResult45';

  @override
  Iterable<Object> serialize(
      Serializers serializers, SearchResultPollResult45 object,
      ...
      result
        ...
        ..add(serializers.serialize(object.vehicleInfoList,
            specifiedType: const FullType(
                BuiltList, const [const FullType(VehicleInfoList45)])));
    }
    ...
    if (object.filterGroups != null) {
      result
        ...
        ..add(serializers.serialize(object.filterGroups,
            specifiedType: const FullType(
                BuiltList, const [const FullType(FilterGroups45)])));
    }
  ...
  @override
  SearchResultPollResult45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SearchResultPollResult45Builder();
...
class _$VehicleInfoList45Serializer
    implements StructuredSerializer<VehicleInfoList45> {
  @override
  final Iterable<Type> types = const [VehicleInfoList45, _$VehicleInfoList45];
  @override
  final String wireName = 'VehicleInfoList45';

  @override
  Iterable<Object> serialize(Serializers serializers, VehicleInfoList45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  VehicleInfoList45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new VehicleInfoList45Builder();
      ...
      switch (key) {
        ...
        case 'packages':
          result.packages.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(Packages45)]))
              as BuiltList<Object>);
          break;
        case 'options':
          result.options.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(VehicleCharacteristic45)
              ])) as BuiltList<Object>);
          break;
        case 'specific_title':
...
class _$VehicleCharacteristic45Serializer
    implements StructuredSerializer<VehicleCharacteristic45> {
  @override
  final Iterable<Type> types = const [
    VehicleCharacteristic45,
    _$VehicleCharacteristic45
  ];
  @override
  final String wireName = 'VehicleCharacteristic45';

  @override
  Iterable<Object> serialize(
      Serializers serializers, VehicleCharacteristic45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.desc != null) {
      result
  ...
  @override
  VehicleCharacteristic45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new VehicleCharacteristic45Builder();
...
class _$Service45Serializer implements StructuredSerializer<Service45> {
  @override
  final Iterable<Type> types = const [Service45, _$Service45];
  @override
  final String wireName = 'Service45';

  @override
  Iterable<Object> serialize(Serializers serializers, Service45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  Service45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new Service45Builder();
...
class _$Price45Serializer implements StructuredSerializer<Price45> {
  @override
  final Iterable<Type> types = const [Price45, _$Price45];
  @override
  final String wireName = 'Price45';

  @override
  Iterable<Object> serialize(Serializers serializers, Price45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  Price45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new Price45Builder();
...
class _$Packages45Serializer implements StructuredSerializer<Packages45> {
  @override
  final Iterable<Type> types = const [Packages45, _$Packages45];
  @override
  final String wireName = 'Packages45';

  @override
  Iterable<Object> serialize(Serializers serializers, Packages45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    ...
    if (object.service != null) {
      result
        ...
        ..add(serializers.serialize(object.service,
            specifiedType: const FullType(Service45)));
    }
    if (object.price != null) {
      result
        ..add('price')
        ..add(serializers.serialize(object.price,
            specifiedType: const FullType(Price45)));
    }
    ...
    if (object.packageLabelInfo != null) {
      result
        ...
        ..add(serializers.serialize(object.packageLabelInfo,
            specifiedType: const FullType(PackageLabelInfo45)));
    }
    return result;
  }

  @override
  Packages45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new Packages45Builder();
      ...
      switch (key) {
        ...
        case 'service':
          result.service.replace(serializers.deserialize(value,
              specifiedType: const FullType(Service45)) as Service45);
          break;
        case 'price':
          result.price.replace(serializers.deserialize(value,
              specifiedType: const FullType(Price45)) as Price45);
          break;
        case 'supplier_id':
...
class _$Coverage45Serializer implements StructuredSerializer<Coverage45> {
  @override
  final Iterable<Type> types = const [Coverage45, _$Coverage45];
  @override
  final String wireName = 'Coverage45';

  @override
  Iterable<Object> serialize(Serializers serializers, Coverage45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.code != null) {
      result
    ...
    if (object.insuredPerson != null) {
      result
        ...
        ..add(serializers.serialize(object.insuredPerson,
            specifiedType: const FullType(InsuredPerson45)));
    }
    ...
    if (object.subInsurances != null) {
      result
        ...
        ..add(serializers.serialize(object.subInsurances,
            specifiedType: const FullType(
                BuiltList, const [const FullType(SubInsurances45)])));
    }
    return result;
  }

  @override
  Coverage45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new Coverage45Builder();
...
class _$InsuredPerson45Serializer
    implements StructuredSerializer<InsuredPerson45> {
  @override
  final Iterable<Type> types = const [InsuredPerson45, _$InsuredPerson45];
  @override
  final String wireName = 'InsuredPerson45';

  @override
  Iterable<Object> serialize(Serializers serializers, InsuredPerson45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.seq != null) {
      result
  ...
  @override
  InsuredPerson45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new InsuredPerson45Builder();
...
class _$SubInsurances45Serializer
    implements StructuredSerializer<SubInsurances45> {
  @override
  final Iterable<Type> types = const [SubInsurances45, _$SubInsurances45];
  @override
  final String wireName = 'SubInsurances45';

  @override
  Iterable<Object> serialize(Serializers serializers, SubInsurances45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  SubInsurances45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SubInsurances45Builder();
...
class _$ShopMap45Serializer implements StructuredSerializer<ShopMap45> {
  @override
  final Iterable<Type> types = const [ShopMap45, _$ShopMap45];
  @override
  final String wireName = 'ShopMap45';

  @override
  Iterable<Object> serialize(Serializers serializers, ShopMap45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.shopCode != null) {
      result
  ...
  @override
  ShopMap45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ShopMap45Builder();
...
class _$SupplierMap45Serializer implements StructuredSerializer<SupplierMap45> {
  @override
  final Iterable<Type> types = const [SupplierMap45, _$SupplierMap45];
  @override
  final String wireName = 'SupplierMap45';

  @override
  Iterable<Object> serialize(Serializers serializers, SupplierMap45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.id != null) {
      result
  ...
  @override
  SupplierMap45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SupplierMap45Builder();
...
class _$FilterGroups45Serializer
    implements StructuredSerializer<FilterGroups45> {
  @override
  final Iterable<Type> types = const [FilterGroups45, _$FilterGroups45];
  @override
  final String wireName = 'FilterGroups45';

  @override
  Iterable<Object> serialize(Serializers serializers, FilterGroups45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.key != null) {
      result
  ...
  @override
  FilterGroups45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new FilterGroups45Builder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'options':
          result.options.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(Options45)]))
              as BuiltList<Object>);
          break;
      }
    }
...
class _$Options45Serializer implements StructuredSerializer<Options45> {
  @override
  final Iterable<Type> types = const [Options45, _$Options45];
  @override
  final String wireName = 'Options45';

  @override
  Iterable<Object> serialize(Serializers serializers, Options45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.key != null) {
      result
  ...
  @override
  Options45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new Options45Builder();
...
class _$PackageLabelInfo45Serializer
    implements StructuredSerializer<PackageLabelInfo45> {
  @override
  final Iterable<Type> types = const [PackageLabelInfo45, _$PackageLabelInfo45];
  @override
  final String wireName = 'PackageLabelInfo45';

  @override
  Iterable<Object> serialize(Serializers serializers, PackageLabelInfo45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  PackageLabelInfo45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PackageLabelInfo45Builder();
...
class _$ActivityList45Serializer
    implements StructuredSerializer<ActivityList45> {
  @override
  final Iterable<Type> types = const [ActivityList45, _$ActivityList45];
  @override
  final String wireName = 'ActivityList45';

  @override
  Iterable<Object> serialize(Serializers serializers, ActivityList45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.id != null) {
      result
    ...
    if (object.cardTags != null) {
      result
        ...
        ..add(serializers.serialize(object.cardTags,
            specifiedType: const FullType(CardTags45)));
    }
  ...
  @override
  ActivityList45 deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ActivityList45Builder();
      ...
      switch (key) {
        ...
        case 'card_tags':
          result.cardTags.replace(serializers.deserialize(value,
              specifiedType: const FullType(CardTags45)) as CardTags45);
          break;
        case 'native_path':
...
class _$CardTags45Serializer implements StructuredSerializer<CardTags45> {
  @override
  final Iterable<Type> types = const [CardTags45, _$CardTags45];
  @override
  final String wireName = 'CardTags45';

  @override
  Iterable<Object> serialize(Serializers serializers, CardTags45 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  CardTags45 deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CardTags45Builder();
...
class _$SearchResultPollResult45 extends SearchResultPollResult45 {
  @override
  final String searchId;
  @override
  final bool hasMore;
  @override
  final BuiltList<VehicleInfoList45> vehicleInfoList;
  @override
  final BuiltMap<String, ShopMap45> shopMaps;
  @override
  final BuiltMap<String, SupplierMap45> supplierMaps;
  @override
  final BuiltList<FilterGroups45> filterGroups;
  @override
  ...
  factory _$SearchResultPollResult45(
          [void Function(SearchResultPollResult45Builder) updates]) =>
      (new SearchResultPollResult45Builder()..update(updates)).build();

  _$SearchResultPollResult45._(
      {this.searchId,
      this.hasMore,
  ...
  @override
  SearchResultPollResult45 rebuild(
          void Function(SearchResultPollResult45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SearchResultPollResult45Builder toBuilder() =>
      new SearchResultPollResult45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SearchResultPollResult45 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SearchResultPollResult45')
...
class SearchResultPollResult45Builder
    implements
        Builder<SearchResultPollResult45, SearchResultPollResult45Builder> {
  _$SearchResultPollResult45 _$v;
  ...
  ListBuilder<VehicleInfoList45> _vehicleInfoList;
  ListBuilder<VehicleInfoList45> get vehicleInfoList =>
      _$this._vehicleInfoList ??= new ListBuilder<VehicleInfoList45>();
  set vehicleInfoList(ListBuilder<VehicleInfoList45> vehicleInfoList) =>
      _$this._vehicleInfoList = vehicleInfoList;

  MapBuilder<String, ShopMap45> _shopMaps;
  MapBuilder<String, ShopMap45> get shopMaps =>
      _$this._shopMaps ??= new MapBuilder<String, ShopMap45>();
  set shopMaps(MapBuilder<String, ShopMap45> shopMaps) =>
      _$this._shopMaps = shopMaps;

  MapBuilder<String, SupplierMap45> _supplierMaps;
  MapBuilder<String, SupplierMap45> get supplierMaps =>
      _$this._supplierMaps ??= new MapBuilder<String, SupplierMap45>();
  set supplierMaps(MapBuilder<String, SupplierMap45> supplierMaps) =>
      _$this._supplierMaps = supplierMaps;

  ListBuilder<FilterGroups45> _filterGroups;
  ListBuilder<FilterGroups45> get filterGroups =>
      _$this._filterGroups ??= new ListBuilder<FilterGroups45>();
  set filterGroups(ListBuilder<FilterGroups45> filterGroups) =>
  ...
  SearchResultPollResult45Builder();

  SearchResultPollResult45Builder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(SearchResultPollResult45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$SearchResultPollResult45;
  }

  @override
  void update(void Function(SearchResultPollResult45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$SearchResultPollResult45 build() {
    _$SearchResultPollResult45 _$result;
    try {
      _$result = _$v ??
          new _$SearchResultPollResult45._(
              searchId: searchId,
              hasMore: hasMore,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'SearchResultPollResult45', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$VehicleInfoList45 extends VehicleInfoList45 {
  @override
  final int carId;
  @override
  ...
  final String logoL;
  @override
  final BuiltList<Packages45> packages;
  @override
  final BuiltList<VehicleCharacteristic45> options;
  @override
  ...
  factory _$VehicleInfoList45(
          [void Function(VehicleInfoList45Builder) updates]) =>
      (new VehicleInfoList45Builder()..update(updates)).build();

  _$VehicleInfoList45._(
      {this.carId,
      this.carGroupTypeId,
      this.carGroupType,
      this.carGroupCode,
  ...
  @override
  VehicleInfoList45 rebuild(void Function(VehicleInfoList45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VehicleInfoList45Builder toBuilder() =>
      new VehicleInfoList45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VehicleInfoList45 &&
        carId == other.carId &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('VehicleInfoList45')
          ..add('carId', carId)
...
class VehicleInfoList45Builder
    implements Builder<VehicleInfoList45, VehicleInfoList45Builder> {
  _$VehicleInfoList45 _$v;
  ...
  ListBuilder<Packages45> _packages;
  ListBuilder<Packages45> get packages =>
      _$this._packages ??= new ListBuilder<Packages45>();
  set packages(ListBuilder<Packages45> packages) => _$this._packages = packages;

  ListBuilder<VehicleCharacteristic45> _options;
  ListBuilder<VehicleCharacteristic45> get options =>
      _$this._options ??= new ListBuilder<VehicleCharacteristic45>();
  set options(ListBuilder<VehicleCharacteristic45> options) =>
  ...
  VehicleInfoList45Builder();

  VehicleInfoList45Builder get _$this {
    if (_$v != null) {
      _carId = _$v.carId;
  ...
  @override
  void replace(VehicleInfoList45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$VehicleInfoList45;
  }

  @override
  void update(void Function(VehicleInfoList45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$VehicleInfoList45 build() {
    _$VehicleInfoList45 _$result;
    try {
      _$result = _$v ??
          new _$VehicleInfoList45._(
              carId: carId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'VehicleInfoList45', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$VehicleCharacteristic45 extends VehicleCharacteristic45 {
  @override
  final String desc;
  @override
  final String icon;

  factory _$VehicleCharacteristic45(
          [void Function(VehicleCharacteristic45Builder) updates]) =>
      (new VehicleCharacteristic45Builder()..update(updates)).build();

  _$VehicleCharacteristic45._({this.desc, this.icon}) : super._();

  @override
  VehicleCharacteristic45 rebuild(
          void Function(VehicleCharacteristic45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VehicleCharacteristic45Builder toBuilder() =>
      new VehicleCharacteristic45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VehicleCharacteristic45 &&
        desc == other.desc &&
        icon == other.icon;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('VehicleCharacteristic45')
          ..add('desc', desc)
          ..add('icon', icon))
        .toString();
  }
...
class VehicleCharacteristic45Builder
    implements
        Builder<VehicleCharacteristic45, VehicleCharacteristic45Builder> {
  _$VehicleCharacteristic45 _$v;
  ...
  VehicleCharacteristic45Builder();

  VehicleCharacteristic45Builder get _$this {
    if (_$v != null) {
      _desc = _$v.desc;
      _icon = _$v.icon;
      _$v = null;
  ...
  @override
  void replace(VehicleCharacteristic45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$VehicleCharacteristic45;
  }

  @override
  void update(void Function(VehicleCharacteristic45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$VehicleCharacteristic45 build() {
    final _$result =
        _$v ?? new _$VehicleCharacteristic45._(desc: desc, icon: icon);
    replace(_$result);
    return _$result;
  }
}

class _$Service45 extends Service45 {
  @override
  ...
  factory _$Service45([void Function(Service45Builder) updates]) =>
      (new Service45Builder()..update(updates)).build();
  ...
  @override
  Service45 rebuild(void Function(Service45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Service45Builder toBuilder() => new Service45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Service45 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Service45')
...
class Service45Builder implements Builder<Service45, Service45Builder> {
  _$Service45 _$v;
  ...
  @override
  void replace(Service45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$Service45;
  }

  @override
  void update(void Function(Service45Builder) updates) {
    if (updates != null) updates(this);
  }
...
class _$Price45 extends Price45 {
  @override
  ...
  factory _$Price45([void Function(Price45Builder) updates]) =>
      (new Price45Builder()..update(updates)).build();
  ...
  @override
  Price45 rebuild(void Function(Price45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Price45Builder toBuilder() => new Price45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Price45 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Price45')
...
class Price45Builder implements Builder<Price45, Price45Builder> {
  _$Price45 _$v;
  ...
  @override
  void replace(Price45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$Price45;
  }

  @override
  void update(void Function(Price45Builder) updates) {
    if (updates != null) updates(this);
  }
...
class _$Packages45 extends Packages45 {
  @override
  ...
  @override
  final PackageLabelInfo45 packageLabelInfo;

  factory _$Packages45([void Function(Packages45Builder) updates]) =>
      (new Packages45Builder()..update(updates)).build();
  ...
  @override
  Packages45 rebuild(void Function(Packages45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Packages45Builder toBuilder() => new Packages45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Packages45 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Packages45')
...
class Packages45Builder implements Builder<Packages45, Packages45Builder> {
  _$Packages45 _$v;
  ...
  Service45Builder _service;
  Service45Builder get service => _$this._service ??= new Service45Builder();
  set service(Service45Builder service) => _$this._service = service;

  Price45Builder _price;
  Price45Builder get price => _$this._price ??= new Price45Builder();
  set price(Price45Builder price) => _$this._price = price;
  ...
  PackageLabelInfo45Builder _packageLabelInfo;
  PackageLabelInfo45Builder get packageLabelInfo =>
      _$this._packageLabelInfo ??= new PackageLabelInfo45Builder();
  set packageLabelInfo(PackageLabelInfo45Builder packageLabelInfo) =>
      _$this._packageLabelInfo = packageLabelInfo;

  Packages45Builder();

  Packages45Builder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(Packages45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$Packages45;
  }

  @override
  void update(void Function(Packages45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$Packages45 build() {
    _$Packages45 _$result;
    try {
      _$result = _$v ??
          new _$Packages45._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'Packages45', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$Coverage45 extends Coverage45 {
  @override
  final String code;
  @override
  final String name;
  ...
  final String coveragePackageDesc;
  @override
  final InsuredPerson45 insuredPerson;
  @override
  final String iconUrl;
  @override
  final String iconfont;
  @override
  final BuiltList<SubInsurances45> subInsurances;

  factory _$Coverage45([void Function(Coverage45Builder) updates]) =>
      (new Coverage45Builder()..update(updates)).build();
  ...
  @override
  Coverage45 rebuild(void Function(Coverage45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Coverage45Builder toBuilder() => new Coverage45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Coverage45 &&
        code == other.code &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Coverage45')
          ..add('code', code)
          ..add('name', name)
...
class Coverage45Builder implements Builder<Coverage45, Coverage45Builder> {
  _$Coverage45 _$v;
  ...
  InsuredPerson45Builder _insuredPerson;
  InsuredPerson45Builder get insuredPerson =>
      _$this._insuredPerson ??= new InsuredPerson45Builder();
  set insuredPerson(InsuredPerson45Builder insuredPerson) =>
  ...
  ListBuilder<SubInsurances45> _subInsurances;
  ListBuilder<SubInsurances45> get subInsurances =>
      _$this._subInsurances ??= new ListBuilder<SubInsurances45>();
  set subInsurances(ListBuilder<SubInsurances45> subInsurances) =>
      _$this._subInsurances = subInsurances;

  Coverage45Builder();

  Coverage45Builder get _$this {
    if (_$v != null) {
      _code = _$v.code;
      _name = _$v.name;
  ...
  @override
  void replace(Coverage45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$Coverage45;
  }

  @override
  void update(void Function(Coverage45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$Coverage45 build() {
    _$Coverage45 _$result;
    try {
      _$result = _$v ??
          new _$Coverage45._(
              code: code,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'Coverage45', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$InsuredPerson45 extends InsuredPerson45 {
  @override
  final int seq;
  @override
  final int type;

  factory _$InsuredPerson45([void Function(InsuredPerson45Builder) updates]) =>
      (new InsuredPerson45Builder()..update(updates)).build();

  _$InsuredPerson45._({this.seq, this.type}) : super._();

  @override
  InsuredPerson45 rebuild(void Function(InsuredPerson45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  InsuredPerson45Builder toBuilder() =>
      new InsuredPerson45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is InsuredPerson45 && seq == other.seq && type == other.type;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InsuredPerson45')
          ..add('seq', seq)
          ..add('type', type))
        .toString();
  }
...
class InsuredPerson45Builder
    implements Builder<InsuredPerson45, InsuredPerson45Builder> {
  _$InsuredPerson45 _$v;
  ...
  InsuredPerson45Builder();

  InsuredPerson45Builder get _$this {
    if (_$v != null) {
      _seq = _$v.seq;
      _type = _$v.type;
      _$v = null;
  ...
  @override
  void replace(InsuredPerson45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$InsuredPerson45;
  }

  @override
  void update(void Function(InsuredPerson45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$InsuredPerson45 build() {
    final _$result = _$v ?? new _$InsuredPerson45._(seq: seq, type: type);
    replace(_$result);
    return _$result;
  }
}

class _$SubInsurances45 extends SubInsurances45 {
  @override
  final String title;
  @override
  ...
  factory _$SubInsurances45([void Function(SubInsurances45Builder) updates]) =>
      (new SubInsurances45Builder()..update(updates)).build();

  _$SubInsurances45._({this.title, this.depositDesc, this.excessDesc})
      : super._();

  @override
  SubInsurances45 rebuild(void Function(SubInsurances45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SubInsurances45Builder toBuilder() =>
      new SubInsurances45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SubInsurances45 &&
        title == other.title &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SubInsurances45')
          ..add('title', title)
...
class SubInsurances45Builder
    implements Builder<SubInsurances45, SubInsurances45Builder> {
  _$SubInsurances45 _$v;
  ...
  SubInsurances45Builder();

  SubInsurances45Builder get _$this {
    if (_$v != null) {
      _title = _$v.title;
  ...
  @override
  void replace(SubInsurances45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$SubInsurances45;
  }

  @override
  void update(void Function(SubInsurances45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$SubInsurances45 build() {
    final _$result = _$v ??
        new _$SubInsurances45._(
...
class _$ShopMap45 extends ShopMap45 {
  @override
  final String shopCode;
  @override
  ...
  factory _$ShopMap45([void Function(ShopMap45Builder) updates]) =>
      (new ShopMap45Builder()..update(updates)).build();
  ...
  @override
  ShopMap45 rebuild(void Function(ShopMap45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ShopMap45Builder toBuilder() => new ShopMap45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ShopMap45 &&
        shopCode == other.shopCode &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ShopMap45')
          ..add('shopCode', shopCode)
...
class ShopMap45Builder implements Builder<ShopMap45, ShopMap45Builder> {
  _$ShopMap45 _$v;
  ...
  @override
  void replace(ShopMap45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ShopMap45;
  }

  @override
  void update(void Function(ShopMap45Builder) updates) {
    if (updates != null) updates(this);
  }
...
class _$SupplierMap45 extends SupplierMap45 {
  @override
  final int id;
  @override
  final String name;
  ...
  factory _$SupplierMap45([void Function(SupplierMap45Builder) updates]) =>
      (new SupplierMap45Builder()..update(updates)).build();
  ...
  @override
  SupplierMap45 rebuild(void Function(SupplierMap45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SupplierMap45Builder toBuilder() => new SupplierMap45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SupplierMap45 &&
        id == other.id &&
        name == other.name &&
        logoL == other.logoL &&
        logoM == other.logoM &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SupplierMap45')
          ..add('id', id)
          ..add('name', name)
          ..add('logoL', logoL)
          ..add('logoM', logoM)
...
class SupplierMap45Builder
    implements Builder<SupplierMap45, SupplierMap45Builder> {
  _$SupplierMap45 _$v;
  ...
  SupplierMap45Builder();

  SupplierMap45Builder get _$this {
    if (_$v != null) {
      _id = _$v.id;
      _name = _$v.name;
      _logoL = _$v.logoL;
  ...
  @override
  void replace(SupplierMap45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$SupplierMap45;
  }

  @override
  void update(void Function(SupplierMap45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$SupplierMap45 build() {
    final _$result = _$v ??
        new _$SupplierMap45._(
            id: id,
            name: name,
            logoL: logoL,
            logoM: logoM,
...
class _$FilterGroups45 extends FilterGroups45 {
  @override
  final int key;
  @override
  final String name;
  @override
  final BuiltList<Options45> options;

  factory _$FilterGroups45([void Function(FilterGroups45Builder) updates]) =>
      (new FilterGroups45Builder()..update(updates)).build();

  _$FilterGroups45._({this.key, this.name, this.options}) : super._();

  @override
  FilterGroups45 rebuild(void Function(FilterGroups45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  FilterGroups45Builder toBuilder() =>
      new FilterGroups45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is FilterGroups45 &&
        key == other.key &&
        name == other.name &&
        options == other.options;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('FilterGroups45')
          ..add('key', key)
          ..add('name', name)
          ..add('options', options))
        .toString();
...
class FilterGroups45Builder
    implements Builder<FilterGroups45, FilterGroups45Builder> {
  _$FilterGroups45 _$v;
  ...
  ListBuilder<Options45> _options;
  ListBuilder<Options45> get options =>
      _$this._options ??= new ListBuilder<Options45>();
  set options(ListBuilder<Options45> options) => _$this._options = options;

  FilterGroups45Builder();

  FilterGroups45Builder get _$this {
    if (_$v != null) {
      _key = _$v.key;
      _name = _$v.name;
      _options = _$v.options?.toBuilder();
  ...
  @override
  void replace(FilterGroups45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$FilterGroups45;
  }

  @override
  void update(void Function(FilterGroups45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$FilterGroups45 build() {
    _$FilterGroups45 _$result;
    try {
      _$result = _$v ??
          new _$FilterGroups45._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'FilterGroups45', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$Options45 extends Options45 {
  @override
  final int key;
  @override
  final String name;
  ...
  factory _$Options45([void Function(Options45Builder) updates]) =>
      (new Options45Builder()..update(updates)).build();
  ...
  @override
  Options45 rebuild(void Function(Options45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Options45Builder toBuilder() => new Options45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Options45 &&
        key == other.key &&
        name == other.name &&
        value == other.value &&
        carGroupTypeLogo == other.carGroupTypeLogo &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Options45')
          ..add('key', key)
          ..add('name', name)
          ..add('value', value)
          ..add('carGroupTypeLogo', carGroupTypeLogo)
...
class Options45Builder implements Builder<Options45, Options45Builder> {
  _$Options45 _$v;
  ...
  @override
  void replace(Options45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$Options45;
  }

  @override
  void update(void Function(Options45Builder) updates) {
    if (updates != null) updates(this);
  }
...
class _$PackageLabelInfo45 extends PackageLabelInfo45 {
  @override
  ...
  factory _$PackageLabelInfo45(
          [void Function(PackageLabelInfo45Builder) updates]) =>
      (new PackageLabelInfo45Builder()..update(updates)).build();

  _$PackageLabelInfo45._(
  ...
  @override
  PackageLabelInfo45 rebuild(
          void Function(PackageLabelInfo45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PackageLabelInfo45Builder toBuilder() =>
      new PackageLabelInfo45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PackageLabelInfo45 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PackageLabelInfo45')
...
class PackageLabelInfo45Builder
    implements Builder<PackageLabelInfo45, PackageLabelInfo45Builder> {
  _$PackageLabelInfo45 _$v;
  ...
  PackageLabelInfo45Builder();

  PackageLabelInfo45Builder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(PackageLabelInfo45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$PackageLabelInfo45;
  }

  @override
  void update(void Function(PackageLabelInfo45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$PackageLabelInfo45 build() {
    final _$result = _$v ??
        new _$PackageLabelInfo45._(
...
class _$ActivityList45 extends ActivityList45 {
  @override
  final int id;
  @override
  final int instance;
  ...
  @override
  final CardTags45 cardTags;
  @override
  final String nativePath;

  factory _$ActivityList45([void Function(ActivityList45Builder) updates]) =>
      (new ActivityList45Builder()..update(updates)).build();
  ...
  @override
  ActivityList45 rebuild(void Function(ActivityList45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ActivityList45Builder toBuilder() =>
      new ActivityList45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ActivityList45 &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ActivityList45')
          ..add('id', id)
...
class ActivityList45Builder
    implements Builder<ActivityList45, ActivityList45Builder> {
  _$ActivityList45 _$v;
  ...
  CardTags45Builder _cardTags;
  CardTags45Builder get cardTags =>
      _$this._cardTags ??= new CardTags45Builder();
  set cardTags(CardTags45Builder cardTags) => _$this._cardTags = cardTags;

  String _nativePath;
  String get nativePath => _$this._nativePath;
  set nativePath(String nativePath) => _$this._nativePath = nativePath;

  ActivityList45Builder();

  ActivityList45Builder get _$this {
    if (_$v != null) {
      _id = _$v.id;
  ...
  @override
  void replace(ActivityList45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ActivityList45;
  }

  @override
  void update(void Function(ActivityList45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$ActivityList45 build() {
    _$ActivityList45 _$result;
    try {
      _$result = _$v ??
          new _$ActivityList45._(
              id: id,
              instance: instance,
              urlSeo: urlSeo,
              score: score,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'ActivityList45', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$CardTags45 extends CardTags45 {
  @override
  final String bestseller;

  factory _$CardTags45([void Function(CardTags45Builder) updates]) =>
      (new CardTags45Builder()..update(updates)).build();

  _$CardTags45._({this.bestseller}) : super._();

  @override
  CardTags45 rebuild(void Function(CardTags45Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CardTags45Builder toBuilder() => new CardTags45Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CardTags45 && bestseller == other.bestseller;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CardTags45')
          ..add('bestseller', bestseller))
        .toString();
  }
}

class CardTags45Builder implements Builder<CardTags45, CardTags45Builder> {
  _$CardTags45 _$v;
  ...
  @override
  void replace(CardTags45 other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$CardTags45;
  }

  @override
  void update(void Function(CardTags45Builder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$CardTags45 build() {
    final _$result = _$v ?? new _$CardTags45._(bestseller: bestseller);
    replace(_$result);
    return _$result;
  }
}
