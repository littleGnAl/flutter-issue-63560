...
part 'generated_search_result_poll_result72.g.dart';

abstract class SearchResultPollResult72
    implements Built<SearchResultPollResult72, SearchResultPollResult72Builder> {
  SearchResultPollResult72._();

  factory SearchResultPollResult72([updates(SearchResultPollResult72Builder b)]) =
  ...
  BuiltList<VehicleInfoList72> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap72> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap72> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups72> get filterGroups;
  ...
  static Serializer<SearchResultPollResult72> get serializer =>
      _$searchResultPollResult72Serializer;
}

abstract class VehicleInfoList72
    implements Built<VehicleInfoList72, VehicleInfoList72Builder> {
  VehicleInfoList72._();

  factory VehicleInfoList72([updates(VehicleInfoList72Builder b)]) =
      _$VehicleInfoList72;
  ...
  BuiltList<Packages72> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic72> get options;
  ...
  static Serializer<VehicleInfoList72> get serializer =>
      _$vehicleInfoList72Serializer;
}

abstract class VehicleCharacteristic72
    implements Built<VehicleCharacteristic72, VehicleCharacteristic72Builder> {
  VehicleCharacteristic72._();

  factory VehicleCharacteristic72([updates(VehicleCharacteristic72Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic72> get serializer =>
      _$vehicleCharacteristic72Serializer;
}

abstract class Service72 implements Built<Service72, Service72Builder> {
  Service72._();

  factory Service72([updates(Service72Builder b)]) = _$Service72;
  ...
  static Serializer<Service72> get serializer => _$service72Serializer;
}

abstract class Price72 implements Built<Price72, Price72Builder> {
  Price72._();

  factory Price72([updates(Price72Builder b)]) = _$Price72;
  ...
  static Serializer<Price72> get serializer => _$price72Serializer;
}

abstract class Packages72 implements Built<Packages72, Packages72Builder> {
  Packages72._();

  factory Packages72([updates(Packages72Builder b)]) = _$Packages72;
  ...
  PackageLabelInfo72 get packageLabelInfo;

  static Serializer<Packages72> get serializer => _$packages72Serializer;
}

abstract class Coverage72 implements Built<Coverage72, Coverage72Builder> {
  Coverage72._();

  factory Coverage72([updates(Coverage72Builder b)]) = _$Coverage72;
  ...
  InsuredPerson72 get insuredPerson;
  ...
  BuiltList<SubInsurances72> get subInsurances;

  static Serializer<Coverage72> get serializer => _$coverage72Serializer;
}

abstract class InsuredPerson72
    implements Built<InsuredPerson72, InsuredPerson72Builder> {
  InsuredPerson72._();

  factory InsuredPerson72([updates(InsuredPerson72Builder b)]) = _$InsuredPerson72;
  ...
  static Serializer<InsuredPerson72> get serializer => _$insuredPerson72Serializer;
}

abstract class SubInsurances72
    implements Built<SubInsurances72, SubInsurances72Builder> {
  SubInsurances72._();

  factory SubInsurances72([updates(SubInsurances72Builder b)]) = _$SubInsurances72;
  ...
  static Serializer<SubInsurances72> get serializer => _$subInsurances72Serializer;
}

abstract class ShopMap72 implements Built<ShopMap72, ShopMap72Builder> {
  ShopMap72._();

  factory ShopMap72([updates(ShopMap72Builder b)]) = _$ShopMap72;
  ...
  static Serializer<ShopMap72> get serializer => _$shopMap72Serializer;
}

abstract class SupplierMap72 implements Built<SupplierMap72, SupplierMap72Builder> {
  SupplierMap72._();

  factory SupplierMap72([updates(SupplierMap72Builder b)]) = _$SupplierMap72;
  ...
  static Serializer<SupplierMap72> get serializer => _$supplierMap72Serializer;
}

abstract class FilterGroups72
    implements Built<FilterGroups72, FilterGroups72Builder> {
  FilterGroups72._();

  factory FilterGroups72([updates(FilterGroups72Builder b)]) = _$FilterGroups72;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options72> get options;

  static Serializer<FilterGroups72> get serializer => _$filterGroups72Serializer;
}

abstract class Options72 implements Built<Options72, Options72Builder> {
  Options72._();

  factory Options72([updates(Options72Builder b)]) = _$Options72;
  ...
  static Serializer<Options72> get serializer => _$options72Serializer;
}

abstract class PackageLabelInfo72
    implements Built<PackageLabelInfo72, PackageLabelInfo72Builder> {
  PackageLabelInfo72._();

  factory PackageLabelInfo72([updates(PackageLabelInfo72Builder b)]) =
      _$PackageLabelInfo72;
  ...
  static Serializer<PackageLabelInfo72> get serializer =>
      _$packageLabelInfo72Serializer;
}

abstract class ActivityList72
    implements Built<ActivityList72, ActivityList72Builder> {
  ActivityList72._();

  factory ActivityList72([update(ActivityList72Builder b)]) = _$ActivityList72;
  ...
  CardTags72 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList72> get serializer => _$activityList72Serializer;
}

abstract class CardTags72 implements Built<CardTags72, CardTags72Builder> {
  CardTags72._();

  factory CardTags72([update(CardTags72Builder b)]) = _$CardTags72;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags72> get serializer => _$cardTags72Serializer;
}
