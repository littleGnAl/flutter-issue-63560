...
part 'generated_search_result_poll_result80.g.dart';

abstract class SearchResultPollResult80
    implements Built<SearchResultPollResult80, SearchResultPollResult80Builder> {
  SearchResultPollResult80._();

  factory SearchResultPollResult80([updates(SearchResultPollResult80Builder b)]) =
  ...
  BuiltList<VehicleInfoList80> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap80> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap80> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups80> get filterGroups;
  ...
  static Serializer<SearchResultPollResult80> get serializer =>
      _$searchResultPollResult80Serializer;
}

abstract class VehicleInfoList80
    implements Built<VehicleInfoList80, VehicleInfoList80Builder> {
  VehicleInfoList80._();

  factory VehicleInfoList80([updates(VehicleInfoList80Builder b)]) =
      _$VehicleInfoList80;
  ...
  BuiltList<Packages80> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic80> get options;
  ...
  static Serializer<VehicleInfoList80> get serializer =>
      _$vehicleInfoList80Serializer;
}

abstract class VehicleCharacteristic80
    implements Built<VehicleCharacteristic80, VehicleCharacteristic80Builder> {
  VehicleCharacteristic80._();

  factory VehicleCharacteristic80([updates(VehicleCharacteristic80Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic80> get serializer =>
      _$vehicleCharacteristic80Serializer;
}

abstract class Service80 implements Built<Service80, Service80Builder> {
  Service80._();

  factory Service80([updates(Service80Builder b)]) = _$Service80;
  ...
  static Serializer<Service80> get serializer => _$service80Serializer;
}

abstract class Price80 implements Built<Price80, Price80Builder> {
  Price80._();

  factory Price80([updates(Price80Builder b)]) = _$Price80;
  ...
  static Serializer<Price80> get serializer => _$price80Serializer;
}

abstract class Packages80 implements Built<Packages80, Packages80Builder> {
  Packages80._();

  factory Packages80([updates(Packages80Builder b)]) = _$Packages80;
  ...
  PackageLabelInfo80 get packageLabelInfo;

  static Serializer<Packages80> get serializer => _$packages80Serializer;
}

abstract class Coverage80 implements Built<Coverage80, Coverage80Builder> {
  Coverage80._();

  factory Coverage80([updates(Coverage80Builder b)]) = _$Coverage80;
  ...
  InsuredPerson80 get insuredPerson;
  ...
  BuiltList<SubInsurances80> get subInsurances;

  static Serializer<Coverage80> get serializer => _$coverage80Serializer;
}

abstract class InsuredPerson80
    implements Built<InsuredPerson80, InsuredPerson80Builder> {
  InsuredPerson80._();

  factory InsuredPerson80([updates(InsuredPerson80Builder b)]) = _$InsuredPerson80;
  ...
  static Serializer<InsuredPerson80> get serializer => _$insuredPerson80Serializer;
}

abstract class SubInsurances80
    implements Built<SubInsurances80, SubInsurances80Builder> {
  SubInsurances80._();

  factory SubInsurances80([updates(SubInsurances80Builder b)]) = _$SubInsurances80;
  ...
  static Serializer<SubInsurances80> get serializer => _$subInsurances80Serializer;
}

abstract class ShopMap80 implements Built<ShopMap80, ShopMap80Builder> {
  ShopMap80._();

  factory ShopMap80([updates(ShopMap80Builder b)]) = _$ShopMap80;
  ...
  static Serializer<ShopMap80> get serializer => _$shopMap80Serializer;
}

abstract class SupplierMap80 implements Built<SupplierMap80, SupplierMap80Builder> {
  SupplierMap80._();

  factory SupplierMap80([updates(SupplierMap80Builder b)]) = _$SupplierMap80;
  ...
  static Serializer<SupplierMap80> get serializer => _$supplierMap80Serializer;
}

abstract class FilterGroups80
    implements Built<FilterGroups80, FilterGroups80Builder> {
  FilterGroups80._();

  factory FilterGroups80([updates(FilterGroups80Builder b)]) = _$FilterGroups80;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options80> get options;

  static Serializer<FilterGroups80> get serializer => _$filterGroups80Serializer;
}

abstract class Options80 implements Built<Options80, Options80Builder> {
  Options80._();

  factory Options80([updates(Options80Builder b)]) = _$Options80;
  ...
  static Serializer<Options80> get serializer => _$options80Serializer;
}

abstract class PackageLabelInfo80
    implements Built<PackageLabelInfo80, PackageLabelInfo80Builder> {
  PackageLabelInfo80._();

  factory PackageLabelInfo80([updates(PackageLabelInfo80Builder b)]) =
      _$PackageLabelInfo80;
  ...
  static Serializer<PackageLabelInfo80> get serializer =>
      _$packageLabelInfo80Serializer;
}

abstract class ActivityList80
    implements Built<ActivityList80, ActivityList80Builder> {
  ActivityList80._();

  factory ActivityList80([update(ActivityList80Builder b)]) = _$ActivityList80;
  ...
  CardTags80 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList80> get serializer => _$activityList80Serializer;
}

abstract class CardTags80 implements Built<CardTags80, CardTags80Builder> {
  CardTags80._();

  factory CardTags80([update(CardTags80Builder b)]) = _$CardTags80;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags80> get serializer => _$cardTags80Serializer;
}
