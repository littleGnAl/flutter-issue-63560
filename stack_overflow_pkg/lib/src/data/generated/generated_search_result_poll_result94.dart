...
part 'generated_search_result_poll_result94.g.dart';

abstract class SearchResultPollResult94
    implements Built<SearchResultPollResult94, SearchResultPollResult94Builder> {
  SearchResultPollResult94._();

  factory SearchResultPollResult94([updates(SearchResultPollResult94Builder b)]) =
  ...
  BuiltList<VehicleInfoList94> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap94> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap94> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups94> get filterGroups;
  ...
  static Serializer<SearchResultPollResult94> get serializer =>
      _$searchResultPollResult94Serializer;
}

abstract class VehicleInfoList94
    implements Built<VehicleInfoList94, VehicleInfoList94Builder> {
  VehicleInfoList94._();

  factory VehicleInfoList94([updates(VehicleInfoList94Builder b)]) =
      _$VehicleInfoList94;
  ...
  BuiltList<Packages94> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic94> get options;
  ...
  static Serializer<VehicleInfoList94> get serializer =>
      _$vehicleInfoList94Serializer;
}

abstract class VehicleCharacteristic94
    implements Built<VehicleCharacteristic94, VehicleCharacteristic94Builder> {
  VehicleCharacteristic94._();

  factory VehicleCharacteristic94([updates(VehicleCharacteristic94Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic94> get serializer =>
      _$vehicleCharacteristic94Serializer;
}

abstract class Service94 implements Built<Service94, Service94Builder> {
  Service94._();

  factory Service94([updates(Service94Builder b)]) = _$Service94;
  ...
  static Serializer<Service94> get serializer => _$service94Serializer;
}

abstract class Price94 implements Built<Price94, Price94Builder> {
  Price94._();

  factory Price94([updates(Price94Builder b)]) = _$Price94;
  ...
  static Serializer<Price94> get serializer => _$price94Serializer;
}

abstract class Packages94 implements Built<Packages94, Packages94Builder> {
  Packages94._();

  factory Packages94([updates(Packages94Builder b)]) = _$Packages94;
  ...
  PackageLabelInfo94 get packageLabelInfo;

  static Serializer<Packages94> get serializer => _$packages94Serializer;
}

abstract class Coverage94 implements Built<Coverage94, Coverage94Builder> {
  Coverage94._();

  factory Coverage94([updates(Coverage94Builder b)]) = _$Coverage94;
  ...
  InsuredPerson94 get insuredPerson;
  ...
  BuiltList<SubInsurances94> get subInsurances;

  static Serializer<Coverage94> get serializer => _$coverage94Serializer;
}

abstract class InsuredPerson94
    implements Built<InsuredPerson94, InsuredPerson94Builder> {
  InsuredPerson94._();

  factory InsuredPerson94([updates(InsuredPerson94Builder b)]) = _$InsuredPerson94;
  ...
  static Serializer<InsuredPerson94> get serializer => _$insuredPerson94Serializer;
}

abstract class SubInsurances94
    implements Built<SubInsurances94, SubInsurances94Builder> {
  SubInsurances94._();

  factory SubInsurances94([updates(SubInsurances94Builder b)]) = _$SubInsurances94;
  ...
  static Serializer<SubInsurances94> get serializer => _$subInsurances94Serializer;
}

abstract class ShopMap94 implements Built<ShopMap94, ShopMap94Builder> {
  ShopMap94._();

  factory ShopMap94([updates(ShopMap94Builder b)]) = _$ShopMap94;
  ...
  static Serializer<ShopMap94> get serializer => _$shopMap94Serializer;
}

abstract class SupplierMap94 implements Built<SupplierMap94, SupplierMap94Builder> {
  SupplierMap94._();

  factory SupplierMap94([updates(SupplierMap94Builder b)]) = _$SupplierMap94;
  ...
  static Serializer<SupplierMap94> get serializer => _$supplierMap94Serializer;
}

abstract class FilterGroups94
    implements Built<FilterGroups94, FilterGroups94Builder> {
  FilterGroups94._();

  factory FilterGroups94([updates(FilterGroups94Builder b)]) = _$FilterGroups94;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options94> get options;

  static Serializer<FilterGroups94> get serializer => _$filterGroups94Serializer;
}

abstract class Options94 implements Built<Options94, Options94Builder> {
  Options94._();

  factory Options94([updates(Options94Builder b)]) = _$Options94;
  ...
  static Serializer<Options94> get serializer => _$options94Serializer;
}

abstract class PackageLabelInfo94
    implements Built<PackageLabelInfo94, PackageLabelInfo94Builder> {
  PackageLabelInfo94._();

  factory PackageLabelInfo94([updates(PackageLabelInfo94Builder b)]) =
      _$PackageLabelInfo94;
  ...
  static Serializer<PackageLabelInfo94> get serializer =>
      _$packageLabelInfo94Serializer;
}

abstract class ActivityList94
    implements Built<ActivityList94, ActivityList94Builder> {
  ActivityList94._();

  factory ActivityList94([update(ActivityList94Builder b)]) = _$ActivityList94;
  ...
  CardTags94 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList94> get serializer => _$activityList94Serializer;
}

abstract class CardTags94 implements Built<CardTags94, CardTags94Builder> {
  CardTags94._();

  factory CardTags94([update(CardTags94Builder b)]) = _$CardTags94;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags94> get serializer => _$cardTags94Serializer;
}
