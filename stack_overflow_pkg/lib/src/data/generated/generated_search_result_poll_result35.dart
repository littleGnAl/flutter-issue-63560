...
part 'generated_search_result_poll_result35.g.dart';

abstract class SearchResultPollResult35
    implements Built<SearchResultPollResult35, SearchResultPollResult35Builder> {
  SearchResultPollResult35._();

  factory SearchResultPollResult35([updates(SearchResultPollResult35Builder b)]) =
  ...
  BuiltList<VehicleInfoList35> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap35> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap35> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups35> get filterGroups;
  ...
  static Serializer<SearchResultPollResult35> get serializer =>
      _$searchResultPollResult35Serializer;
}

abstract class VehicleInfoList35
    implements Built<VehicleInfoList35, VehicleInfoList35Builder> {
  VehicleInfoList35._();

  factory VehicleInfoList35([updates(VehicleInfoList35Builder b)]) =
      _$VehicleInfoList35;
  ...
  BuiltList<Packages35> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic35> get options;
  ...
  static Serializer<VehicleInfoList35> get serializer =>
      _$vehicleInfoList35Serializer;
}

abstract class VehicleCharacteristic35
    implements Built<VehicleCharacteristic35, VehicleCharacteristic35Builder> {
  VehicleCharacteristic35._();

  factory VehicleCharacteristic35([updates(VehicleCharacteristic35Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic35> get serializer =>
      _$vehicleCharacteristic35Serializer;
}

abstract class Service35 implements Built<Service35, Service35Builder> {
  Service35._();

  factory Service35([updates(Service35Builder b)]) = _$Service35;
  ...
  static Serializer<Service35> get serializer => _$service35Serializer;
}

abstract class Price35 implements Built<Price35, Price35Builder> {
  Price35._();

  factory Price35([updates(Price35Builder b)]) = _$Price35;
  ...
  static Serializer<Price35> get serializer => _$price35Serializer;
}

abstract class Packages35 implements Built<Packages35, Packages35Builder> {
  Packages35._();

  factory Packages35([updates(Packages35Builder b)]) = _$Packages35;
  ...
  PackageLabelInfo35 get packageLabelInfo;

  static Serializer<Packages35> get serializer => _$packages35Serializer;
}

abstract class Coverage35 implements Built<Coverage35, Coverage35Builder> {
  Coverage35._();

  factory Coverage35([updates(Coverage35Builder b)]) = _$Coverage35;
  ...
  InsuredPerson35 get insuredPerson;
  ...
  BuiltList<SubInsurances35> get subInsurances;

  static Serializer<Coverage35> get serializer => _$coverage35Serializer;
}

abstract class InsuredPerson35
    implements Built<InsuredPerson35, InsuredPerson35Builder> {
  InsuredPerson35._();

  factory InsuredPerson35([updates(InsuredPerson35Builder b)]) = _$InsuredPerson35;
  ...
  static Serializer<InsuredPerson35> get serializer => _$insuredPerson35Serializer;
}

abstract class SubInsurances35
    implements Built<SubInsurances35, SubInsurances35Builder> {
  SubInsurances35._();

  factory SubInsurances35([updates(SubInsurances35Builder b)]) = _$SubInsurances35;
  ...
  static Serializer<SubInsurances35> get serializer => _$subInsurances35Serializer;
}

abstract class ShopMap35 implements Built<ShopMap35, ShopMap35Builder> {
  ShopMap35._();

  factory ShopMap35([updates(ShopMap35Builder b)]) = _$ShopMap35;
  ...
  static Serializer<ShopMap35> get serializer => _$shopMap35Serializer;
}

abstract class SupplierMap35 implements Built<SupplierMap35, SupplierMap35Builder> {
  SupplierMap35._();

  factory SupplierMap35([updates(SupplierMap35Builder b)]) = _$SupplierMap35;
  ...
  static Serializer<SupplierMap35> get serializer => _$supplierMap35Serializer;
}

abstract class FilterGroups35
    implements Built<FilterGroups35, FilterGroups35Builder> {
  FilterGroups35._();

  factory FilterGroups35([updates(FilterGroups35Builder b)]) = _$FilterGroups35;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options35> get options;

  static Serializer<FilterGroups35> get serializer => _$filterGroups35Serializer;
}

abstract class Options35 implements Built<Options35, Options35Builder> {
  Options35._();

  factory Options35([updates(Options35Builder b)]) = _$Options35;
  ...
  static Serializer<Options35> get serializer => _$options35Serializer;
}

abstract class PackageLabelInfo35
    implements Built<PackageLabelInfo35, PackageLabelInfo35Builder> {
  PackageLabelInfo35._();

  factory PackageLabelInfo35([updates(PackageLabelInfo35Builder b)]) =
      _$PackageLabelInfo35;
  ...
  static Serializer<PackageLabelInfo35> get serializer =>
      _$packageLabelInfo35Serializer;
}

abstract class ActivityList35
    implements Built<ActivityList35, ActivityList35Builder> {
  ActivityList35._();

  factory ActivityList35([update(ActivityList35Builder b)]) = _$ActivityList35;
  ...
  CardTags35 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList35> get serializer => _$activityList35Serializer;
}

abstract class CardTags35 implements Built<CardTags35, CardTags35Builder> {
  CardTags35._();

  factory CardTags35([update(CardTags35Builder b)]) = _$CardTags35;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags35> get serializer => _$cardTags35Serializer;
}

@SerializersFor([
  SearchResultPollResult35,
])
final Serializers serializers35 = _$serializers35;
