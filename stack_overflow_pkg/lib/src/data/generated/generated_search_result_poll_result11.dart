...
part 'generated_search_result_poll_result11.g.dart';

abstract class SearchResultPollResult11
    implements Built<SearchResultPollResult11, SearchResultPollResult11Builder> {
  SearchResultPollResult11._();

  factory SearchResultPollResult11([updates(SearchResultPollResult11Builder b)]) =
  ...
  BuiltList<VehicleInfoList11> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap11> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap11> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups11> get filterGroups;
  ...
  static Serializer<SearchResultPollResult11> get serializer =>
      _$searchResultPollResult11Serializer;
}

abstract class VehicleInfoList11
    implements Built<VehicleInfoList11, VehicleInfoList11Builder> {
  VehicleInfoList11._();

  factory VehicleInfoList11([updates(VehicleInfoList11Builder b)]) =
      _$VehicleInfoList11;
  ...
  BuiltList<Packages11> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic11> get options;
  ...
  static Serializer<VehicleInfoList11> get serializer =>
      _$vehicleInfoList11Serializer;
}

abstract class VehicleCharacteristic11
    implements Built<VehicleCharacteristic11, VehicleCharacteristic11Builder> {
  VehicleCharacteristic11._();

  factory VehicleCharacteristic11([updates(VehicleCharacteristic11Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic11> get serializer =>
      _$vehicleCharacteristic11Serializer;
}

abstract class Service11 implements Built<Service11, Service11Builder> {
  Service11._();

  factory Service11([updates(Service11Builder b)]) = _$Service11;
  ...
  static Serializer<Service11> get serializer => _$service11Serializer;
}

abstract class Price11 implements Built<Price11, Price11Builder> {
  Price11._();

  factory Price11([updates(Price11Builder b)]) = _$Price11;
  ...
  static Serializer<Price11> get serializer => _$price11Serializer;
}

abstract class Packages11 implements Built<Packages11, Packages11Builder> {
  Packages11._();

  factory Packages11([updates(Packages11Builder b)]) = _$Packages11;
  ...
  PackageLabelInfo11 get packageLabelInfo;

  static Serializer<Packages11> get serializer => _$packages11Serializer;
}

abstract class Coverage11 implements Built<Coverage11, Coverage11Builder> {
  Coverage11._();

  factory Coverage11([updates(Coverage11Builder b)]) = _$Coverage11;
  ...
  InsuredPerson11 get insuredPerson;
  ...
  BuiltList<SubInsurances11> get subInsurances;

  static Serializer<Coverage11> get serializer => _$coverage11Serializer;
}

abstract class InsuredPerson11
    implements Built<InsuredPerson11, InsuredPerson11Builder> {
  InsuredPerson11._();

  factory InsuredPerson11([updates(InsuredPerson11Builder b)]) = _$InsuredPerson11;
  ...
  static Serializer<InsuredPerson11> get serializer => _$insuredPerson11Serializer;
}

abstract class SubInsurances11
    implements Built<SubInsurances11, SubInsurances11Builder> {
  SubInsurances11._();

  factory SubInsurances11([updates(SubInsurances11Builder b)]) = _$SubInsurances11;
  ...
  static Serializer<SubInsurances11> get serializer => _$subInsurances11Serializer;
}

abstract class ShopMap11 implements Built<ShopMap11, ShopMap11Builder> {
  ShopMap11._();

  factory ShopMap11([updates(ShopMap11Builder b)]) = _$ShopMap11;
  ...
  static Serializer<ShopMap11> get serializer => _$shopMap11Serializer;
}

abstract class SupplierMap11 implements Built<SupplierMap11, SupplierMap11Builder> {
  SupplierMap11._();

  factory SupplierMap11([updates(SupplierMap11Builder b)]) = _$SupplierMap11;
  ...
  static Serializer<SupplierMap11> get serializer => _$supplierMap11Serializer;
}

abstract class FilterGroups11
    implements Built<FilterGroups11, FilterGroups11Builder> {
  FilterGroups11._();

  factory FilterGroups11([updates(FilterGroups11Builder b)]) = _$FilterGroups11;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options11> get options;

  static Serializer<FilterGroups11> get serializer => _$filterGroups11Serializer;
}

abstract class Options11 implements Built<Options11, Options11Builder> {
  Options11._();

  factory Options11([updates(Options11Builder b)]) = _$Options11;
  ...
  static Serializer<Options11> get serializer => _$options11Serializer;
}

abstract class PackageLabelInfo11
    implements Built<PackageLabelInfo11, PackageLabelInfo11Builder> {
  PackageLabelInfo11._();

  factory PackageLabelInfo11([updates(PackageLabelInfo11Builder b)]) =
      _$PackageLabelInfo11;
  ...
  static Serializer<PackageLabelInfo11> get serializer =>
      _$packageLabelInfo11Serializer;
}

abstract class ActivityList11
    implements Built<ActivityList11, ActivityList11Builder> {
  ActivityList11._();

  factory ActivityList11([update(ActivityList11Builder b)]) = _$ActivityList11;
  ...
  CardTags11 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList11> get serializer => _$activityList11Serializer;
}

abstract class CardTags11 implements Built<CardTags11, CardTags11Builder> {
  CardTags11._();

  factory CardTags11([update(CardTags11Builder b)]) = _$CardTags11;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags11> get serializer => _$cardTags11Serializer;
}
