...
part 'generated_search_result_poll_result87.g.dart';

abstract class SearchResultPollResult87
    implements Built<SearchResultPollResult87, SearchResultPollResult87Builder> {
  SearchResultPollResult87._();

  factory SearchResultPollResult87([updates(SearchResultPollResult87Builder b)]) =
  ...
  BuiltList<VehicleInfoList87> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap87> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap87> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups87> get filterGroups;
  ...
  static Serializer<SearchResultPollResult87> get serializer =>
      _$searchResultPollResult87Serializer;
}

abstract class VehicleInfoList87
    implements Built<VehicleInfoList87, VehicleInfoList87Builder> {
  VehicleInfoList87._();

  factory VehicleInfoList87([updates(VehicleInfoList87Builder b)]) =
      _$VehicleInfoList87;
  ...
  BuiltList<Packages87> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic87> get options;
  ...
  static Serializer<VehicleInfoList87> get serializer =>
      _$vehicleInfoList87Serializer;
}

abstract class VehicleCharacteristic87
    implements Built<VehicleCharacteristic87, VehicleCharacteristic87Builder> {
  VehicleCharacteristic87._();

  factory VehicleCharacteristic87([updates(VehicleCharacteristic87Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic87> get serializer =>
      _$vehicleCharacteristic87Serializer;
}

abstract class Service87 implements Built<Service87, Service87Builder> {
  Service87._();

  factory Service87([updates(Service87Builder b)]) = _$Service87;
  ...
  static Serializer<Service87> get serializer => _$service87Serializer;
}

abstract class Price87 implements Built<Price87, Price87Builder> {
  Price87._();

  factory Price87([updates(Price87Builder b)]) = _$Price87;
  ...
  static Serializer<Price87> get serializer => _$price87Serializer;
}

abstract class Packages87 implements Built<Packages87, Packages87Builder> {
  Packages87._();

  factory Packages87([updates(Packages87Builder b)]) = _$Packages87;
  ...
  PackageLabelInfo87 get packageLabelInfo;

  static Serializer<Packages87> get serializer => _$packages87Serializer;
}

abstract class Coverage87 implements Built<Coverage87, Coverage87Builder> {
  Coverage87._();

  factory Coverage87([updates(Coverage87Builder b)]) = _$Coverage87;
  ...
  InsuredPerson87 get insuredPerson;
  ...
  BuiltList<SubInsurances87> get subInsurances;

  static Serializer<Coverage87> get serializer => _$coverage87Serializer;
}

abstract class InsuredPerson87
    implements Built<InsuredPerson87, InsuredPerson87Builder> {
  InsuredPerson87._();

  factory InsuredPerson87([updates(InsuredPerson87Builder b)]) = _$InsuredPerson87;
  ...
  static Serializer<InsuredPerson87> get serializer => _$insuredPerson87Serializer;
}

abstract class SubInsurances87
    implements Built<SubInsurances87, SubInsurances87Builder> {
  SubInsurances87._();

  factory SubInsurances87([updates(SubInsurances87Builder b)]) = _$SubInsurances87;
  ...
  static Serializer<SubInsurances87> get serializer => _$subInsurances87Serializer;
}

abstract class ShopMap87 implements Built<ShopMap87, ShopMap87Builder> {
  ShopMap87._();

  factory ShopMap87([updates(ShopMap87Builder b)]) = _$ShopMap87;
  ...
  static Serializer<ShopMap87> get serializer => _$shopMap87Serializer;
}

abstract class SupplierMap87 implements Built<SupplierMap87, SupplierMap87Builder> {
  SupplierMap87._();

  factory SupplierMap87([updates(SupplierMap87Builder b)]) = _$SupplierMap87;
  ...
  static Serializer<SupplierMap87> get serializer => _$supplierMap87Serializer;
}

abstract class FilterGroups87
    implements Built<FilterGroups87, FilterGroups87Builder> {
  FilterGroups87._();

  factory FilterGroups87([updates(FilterGroups87Builder b)]) = _$FilterGroups87;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options87> get options;

  static Serializer<FilterGroups87> get serializer => _$filterGroups87Serializer;
}

abstract class Options87 implements Built<Options87, Options87Builder> {
  Options87._();

  factory Options87([updates(Options87Builder b)]) = _$Options87;
  ...
  static Serializer<Options87> get serializer => _$options87Serializer;
}

abstract class PackageLabelInfo87
    implements Built<PackageLabelInfo87, PackageLabelInfo87Builder> {
  PackageLabelInfo87._();

  factory PackageLabelInfo87([updates(PackageLabelInfo87Builder b)]) =
      _$PackageLabelInfo87;
  ...
  static Serializer<PackageLabelInfo87> get serializer =>
      _$packageLabelInfo87Serializer;
}

abstract class ActivityList87
    implements Built<ActivityList87, ActivityList87Builder> {
  ActivityList87._();

  factory ActivityList87([update(ActivityList87Builder b)]) = _$ActivityList87;
  ...
  CardTags87 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList87> get serializer => _$activityList87Serializer;
}

abstract class CardTags87 implements Built<CardTags87, CardTags87Builder> {
  CardTags87._();

  factory CardTags87([update(CardTags87Builder b)]) = _$CardTags87;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags87> get serializer => _$cardTags87Serializer;
}

@SerializersFor([
  SearchResultPollResult87,
])
final Serializers serializers87 = _$serializers87;
