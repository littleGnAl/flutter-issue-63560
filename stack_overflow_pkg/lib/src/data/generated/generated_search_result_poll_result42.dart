...
part 'generated_search_result_poll_result42.g.dart';

abstract class SearchResultPollResult42
    implements Built<SearchResultPollResult42, SearchResultPollResult42Builder> {
  SearchResultPollResult42._();

  factory SearchResultPollResult42([updates(SearchResultPollResult42Builder b)]) =
  ...
  BuiltList<VehicleInfoList42> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap42> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap42> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups42> get filterGroups;
  ...
  static Serializer<SearchResultPollResult42> get serializer =>
      _$searchResultPollResult42Serializer;
}

abstract class VehicleInfoList42
    implements Built<VehicleInfoList42, VehicleInfoList42Builder> {
  VehicleInfoList42._();

  factory VehicleInfoList42([updates(VehicleInfoList42Builder b)]) =
      _$VehicleInfoList42;
  ...
  BuiltList<Packages42> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic42> get options;
  ...
  static Serializer<VehicleInfoList42> get serializer =>
      _$vehicleInfoList42Serializer;
}

abstract class VehicleCharacteristic42
    implements Built<VehicleCharacteristic42, VehicleCharacteristic42Builder> {
  VehicleCharacteristic42._();

  factory VehicleCharacteristic42([updates(VehicleCharacteristic42Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic42> get serializer =>
      _$vehicleCharacteristic42Serializer;
}

abstract class Service42 implements Built<Service42, Service42Builder> {
  Service42._();

  factory Service42([updates(Service42Builder b)]) = _$Service42;
  ...
  static Serializer<Service42> get serializer => _$service42Serializer;
}

abstract class Price42 implements Built<Price42, Price42Builder> {
  Price42._();

  factory Price42([updates(Price42Builder b)]) = _$Price42;
  ...
  static Serializer<Price42> get serializer => _$price42Serializer;
}

abstract class Packages42 implements Built<Packages42, Packages42Builder> {
  Packages42._();

  factory Packages42([updates(Packages42Builder b)]) = _$Packages42;
  ...
  PackageLabelInfo42 get packageLabelInfo;

  static Serializer<Packages42> get serializer => _$packages42Serializer;
}

abstract class Coverage42 implements Built<Coverage42, Coverage42Builder> {
  Coverage42._();

  factory Coverage42([updates(Coverage42Builder b)]) = _$Coverage42;
  ...
  InsuredPerson42 get insuredPerson;
  ...
  BuiltList<SubInsurances42> get subInsurances;

  static Serializer<Coverage42> get serializer => _$coverage42Serializer;
}

abstract class InsuredPerson42
    implements Built<InsuredPerson42, InsuredPerson42Builder> {
  InsuredPerson42._();

  factory InsuredPerson42([updates(InsuredPerson42Builder b)]) = _$InsuredPerson42;
  ...
  static Serializer<InsuredPerson42> get serializer => _$insuredPerson42Serializer;
}

abstract class SubInsurances42
    implements Built<SubInsurances42, SubInsurances42Builder> {
  SubInsurances42._();

  factory SubInsurances42([updates(SubInsurances42Builder b)]) = _$SubInsurances42;
  ...
  static Serializer<SubInsurances42> get serializer => _$subInsurances42Serializer;
}

abstract class ShopMap42 implements Built<ShopMap42, ShopMap42Builder> {
  ShopMap42._();

  factory ShopMap42([updates(ShopMap42Builder b)]) = _$ShopMap42;
  ...
  static Serializer<ShopMap42> get serializer => _$shopMap42Serializer;
}

abstract class SupplierMap42 implements Built<SupplierMap42, SupplierMap42Builder> {
  SupplierMap42._();

  factory SupplierMap42([updates(SupplierMap42Builder b)]) = _$SupplierMap42;
  ...
  static Serializer<SupplierMap42> get serializer => _$supplierMap42Serializer;
}

abstract class FilterGroups42
    implements Built<FilterGroups42, FilterGroups42Builder> {
  FilterGroups42._();

  factory FilterGroups42([updates(FilterGroups42Builder b)]) = _$FilterGroups42;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options42> get options;

  static Serializer<FilterGroups42> get serializer => _$filterGroups42Serializer;
}

abstract class Options42 implements Built<Options42, Options42Builder> {
  Options42._();

  factory Options42([updates(Options42Builder b)]) = _$Options42;
  ...
  static Serializer<Options42> get serializer => _$options42Serializer;
}

abstract class PackageLabelInfo42
    implements Built<PackageLabelInfo42, PackageLabelInfo42Builder> {
  PackageLabelInfo42._();

  factory PackageLabelInfo42([updates(PackageLabelInfo42Builder b)]) =
      _$PackageLabelInfo42;
  ...
  static Serializer<PackageLabelInfo42> get serializer =>
      _$packageLabelInfo42Serializer;
}

abstract class ActivityList42
    implements Built<ActivityList42, ActivityList42Builder> {
  ActivityList42._();

  factory ActivityList42([update(ActivityList42Builder b)]) = _$ActivityList42;
  ...
  CardTags42 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList42> get serializer => _$activityList42Serializer;
}

abstract class CardTags42 implements Built<CardTags42, CardTags42Builder> {
  CardTags42._();

  factory CardTags42([update(CardTags42Builder b)]) = _$CardTags42;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags42> get serializer => _$cardTags42Serializer;
}
