...
part 'generated_search_result_poll_result44.g.dart';

abstract class SearchResultPollResult44
    implements Built<SearchResultPollResult44, SearchResultPollResult44Builder> {
  SearchResultPollResult44._();

  factory SearchResultPollResult44([updates(SearchResultPollResult44Builder b)]) =
  ...
  BuiltList<VehicleInfoList44> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap44> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap44> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups44> get filterGroups;
  ...
  static Serializer<SearchResultPollResult44> get serializer =>
      _$searchResultPollResult44Serializer;
}

abstract class VehicleInfoList44
    implements Built<VehicleInfoList44, VehicleInfoList44Builder> {
  VehicleInfoList44._();

  factory VehicleInfoList44([updates(VehicleInfoList44Builder b)]) =
      _$VehicleInfoList44;
  ...
  BuiltList<Packages44> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic44> get options;
  ...
  static Serializer<VehicleInfoList44> get serializer =>
      _$vehicleInfoList44Serializer;
}

abstract class VehicleCharacteristic44
    implements Built<VehicleCharacteristic44, VehicleCharacteristic44Builder> {
  VehicleCharacteristic44._();

  factory VehicleCharacteristic44([updates(VehicleCharacteristic44Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic44> get serializer =>
      _$vehicleCharacteristic44Serializer;
}

abstract class Service44 implements Built<Service44, Service44Builder> {
  Service44._();

  factory Service44([updates(Service44Builder b)]) = _$Service44;
  ...
  static Serializer<Service44> get serializer => _$service44Serializer;
}

abstract class Price44 implements Built<Price44, Price44Builder> {
  Price44._();

  factory Price44([updates(Price44Builder b)]) = _$Price44;
  ...
  static Serializer<Price44> get serializer => _$price44Serializer;
}

abstract class Packages44 implements Built<Packages44, Packages44Builder> {
  Packages44._();

  factory Packages44([updates(Packages44Builder b)]) = _$Packages44;
  ...
  PackageLabelInfo44 get packageLabelInfo;

  static Serializer<Packages44> get serializer => _$packages44Serializer;
}

abstract class Coverage44 implements Built<Coverage44, Coverage44Builder> {
  Coverage44._();

  factory Coverage44([updates(Coverage44Builder b)]) = _$Coverage44;
  ...
  InsuredPerson44 get insuredPerson;
  ...
  BuiltList<SubInsurances44> get subInsurances;

  static Serializer<Coverage44> get serializer => _$coverage44Serializer;
}

abstract class InsuredPerson44
    implements Built<InsuredPerson44, InsuredPerson44Builder> {
  InsuredPerson44._();

  factory InsuredPerson44([updates(InsuredPerson44Builder b)]) = _$InsuredPerson44;
  ...
  static Serializer<InsuredPerson44> get serializer => _$insuredPerson44Serializer;
}

abstract class SubInsurances44
    implements Built<SubInsurances44, SubInsurances44Builder> {
  SubInsurances44._();

  factory SubInsurances44([updates(SubInsurances44Builder b)]) = _$SubInsurances44;
  ...
  static Serializer<SubInsurances44> get serializer => _$subInsurances44Serializer;
}

abstract class ShopMap44 implements Built<ShopMap44, ShopMap44Builder> {
  ShopMap44._();

  factory ShopMap44([updates(ShopMap44Builder b)]) = _$ShopMap44;
  ...
  static Serializer<ShopMap44> get serializer => _$shopMap44Serializer;
}

abstract class SupplierMap44 implements Built<SupplierMap44, SupplierMap44Builder> {
  SupplierMap44._();

  factory SupplierMap44([updates(SupplierMap44Builder b)]) = _$SupplierMap44;
  ...
  static Serializer<SupplierMap44> get serializer => _$supplierMap44Serializer;
}

abstract class FilterGroups44
    implements Built<FilterGroups44, FilterGroups44Builder> {
  FilterGroups44._();

  factory FilterGroups44([updates(FilterGroups44Builder b)]) = _$FilterGroups44;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options44> get options;

  static Serializer<FilterGroups44> get serializer => _$filterGroups44Serializer;
}

abstract class Options44 implements Built<Options44, Options44Builder> {
  Options44._();

  factory Options44([updates(Options44Builder b)]) = _$Options44;
  ...
  static Serializer<Options44> get serializer => _$options44Serializer;
}

abstract class PackageLabelInfo44
    implements Built<PackageLabelInfo44, PackageLabelInfo44Builder> {
  PackageLabelInfo44._();

  factory PackageLabelInfo44([updates(PackageLabelInfo44Builder b)]) =
      _$PackageLabelInfo44;
  ...
  static Serializer<PackageLabelInfo44> get serializer =>
      _$packageLabelInfo44Serializer;
}

abstract class ActivityList44
    implements Built<ActivityList44, ActivityList44Builder> {
  ActivityList44._();

  factory ActivityList44([update(ActivityList44Builder b)]) = _$ActivityList44;
  ...
  CardTags44 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList44> get serializer => _$activityList44Serializer;
}

abstract class CardTags44 implements Built<CardTags44, CardTags44Builder> {
  CardTags44._();

  factory CardTags44([update(CardTags44Builder b)]) = _$CardTags44;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags44> get serializer => _$cardTags44Serializer;
}
