...
part 'generated_search_result_poll_result17.g.dart';

abstract class SearchResultPollResult17
    implements Built<SearchResultPollResult17, SearchResultPollResult17Builder> {
  SearchResultPollResult17._();

  factory SearchResultPollResult17([updates(SearchResultPollResult17Builder b)]) =
  ...
  BuiltList<VehicleInfoList17> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap17> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap17> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups17> get filterGroups;
  ...
  static Serializer<SearchResultPollResult17> get serializer =>
      _$searchResultPollResult17Serializer;
}

abstract class VehicleInfoList17
    implements Built<VehicleInfoList17, VehicleInfoList17Builder> {
  VehicleInfoList17._();

  factory VehicleInfoList17([updates(VehicleInfoList17Builder b)]) =
      _$VehicleInfoList17;
  ...
  BuiltList<Packages17> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic17> get options;
  ...
  static Serializer<VehicleInfoList17> get serializer =>
      _$vehicleInfoList17Serializer;
}

abstract class VehicleCharacteristic17
    implements Built<VehicleCharacteristic17, VehicleCharacteristic17Builder> {
  VehicleCharacteristic17._();

  factory VehicleCharacteristic17([updates(VehicleCharacteristic17Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic17> get serializer =>
      _$vehicleCharacteristic17Serializer;
}

abstract class Service17 implements Built<Service17, Service17Builder> {
  Service17._();

  factory Service17([updates(Service17Builder b)]) = _$Service17;
  ...
  static Serializer<Service17> get serializer => _$service17Serializer;
}

abstract class Price17 implements Built<Price17, Price17Builder> {
  Price17._();

  factory Price17([updates(Price17Builder b)]) = _$Price17;
  ...
  static Serializer<Price17> get serializer => _$price17Serializer;
}

abstract class Packages17 implements Built<Packages17, Packages17Builder> {
  Packages17._();

  factory Packages17([updates(Packages17Builder b)]) = _$Packages17;
  ...
  PackageLabelInfo17 get packageLabelInfo;

  static Serializer<Packages17> get serializer => _$packages17Serializer;
}

abstract class Coverage17 implements Built<Coverage17, Coverage17Builder> {
  Coverage17._();

  factory Coverage17([updates(Coverage17Builder b)]) = _$Coverage17;
  ...
  InsuredPerson17 get insuredPerson;
  ...
  BuiltList<SubInsurances17> get subInsurances;

  static Serializer<Coverage17> get serializer => _$coverage17Serializer;
}

abstract class InsuredPerson17
    implements Built<InsuredPerson17, InsuredPerson17Builder> {
  InsuredPerson17._();

  factory InsuredPerson17([updates(InsuredPerson17Builder b)]) = _$InsuredPerson17;
  ...
  static Serializer<InsuredPerson17> get serializer => _$insuredPerson17Serializer;
}

abstract class SubInsurances17
    implements Built<SubInsurances17, SubInsurances17Builder> {
  SubInsurances17._();

  factory SubInsurances17([updates(SubInsurances17Builder b)]) = _$SubInsurances17;
  ...
  static Serializer<SubInsurances17> get serializer => _$subInsurances17Serializer;
}

abstract class ShopMap17 implements Built<ShopMap17, ShopMap17Builder> {
  ShopMap17._();

  factory ShopMap17([updates(ShopMap17Builder b)]) = _$ShopMap17;
  ...
  static Serializer<ShopMap17> get serializer => _$shopMap17Serializer;
}

abstract class SupplierMap17 implements Built<SupplierMap17, SupplierMap17Builder> {
  SupplierMap17._();

  factory SupplierMap17([updates(SupplierMap17Builder b)]) = _$SupplierMap17;
  ...
  static Serializer<SupplierMap17> get serializer => _$supplierMap17Serializer;
}

abstract class FilterGroups17
    implements Built<FilterGroups17, FilterGroups17Builder> {
  FilterGroups17._();

  factory FilterGroups17([updates(FilterGroups17Builder b)]) = _$FilterGroups17;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options17> get options;

  static Serializer<FilterGroups17> get serializer => _$filterGroups17Serializer;
}

abstract class Options17 implements Built<Options17, Options17Builder> {
  Options17._();

  factory Options17([updates(Options17Builder b)]) = _$Options17;
  ...
  static Serializer<Options17> get serializer => _$options17Serializer;
}

abstract class PackageLabelInfo17
    implements Built<PackageLabelInfo17, PackageLabelInfo17Builder> {
  PackageLabelInfo17._();

  factory PackageLabelInfo17([updates(PackageLabelInfo17Builder b)]) =
      _$PackageLabelInfo17;
  ...
  static Serializer<PackageLabelInfo17> get serializer =>
      _$packageLabelInfo17Serializer;
}

abstract class ActivityList17
    implements Built<ActivityList17, ActivityList17Builder> {
  ActivityList17._();

  factory ActivityList17([update(ActivityList17Builder b)]) = _$ActivityList17;
  ...
  CardTags17 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList17> get serializer => _$activityList17Serializer;
}

abstract class CardTags17 implements Built<CardTags17, CardTags17Builder> {
  CardTags17._();

  factory CardTags17([update(CardTags17Builder b)]) = _$CardTags17;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags17> get serializer => _$cardTags17Serializer;
}
