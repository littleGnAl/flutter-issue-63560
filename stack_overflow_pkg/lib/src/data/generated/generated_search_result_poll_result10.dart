...
part 'generated_search_result_poll_result10.g.dart';

abstract class SearchResultPollResult10
    implements Built<SearchResultPollResult10, SearchResultPollResult10Builder> {
  SearchResultPollResult10._();

  factory SearchResultPollResult10([updates(SearchResultPollResult10Builder b)]) =
  ...
  BuiltList<VehicleInfoList10> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap10> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap10> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups10> get filterGroups;
  ...
  static Serializer<SearchResultPollResult10> get serializer =>
      _$searchResultPollResult10Serializer;
}

abstract class VehicleInfoList10
    implements Built<VehicleInfoList10, VehicleInfoList10Builder> {
  VehicleInfoList10._();

  factory VehicleInfoList10([updates(VehicleInfoList10Builder b)]) =
      _$VehicleInfoList10;
  ...
  BuiltList<Packages10> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic10> get options;
  ...
  static Serializer<VehicleInfoList10> get serializer =>
      _$vehicleInfoList10Serializer;
}

abstract class VehicleCharacteristic10
    implements Built<VehicleCharacteristic10, VehicleCharacteristic10Builder> {
  VehicleCharacteristic10._();

  factory VehicleCharacteristic10([updates(VehicleCharacteristic10Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic10> get serializer =>
      _$vehicleCharacteristic10Serializer;
}

abstract class Service10 implements Built<Service10, Service10Builder> {
  Service10._();

  factory Service10([updates(Service10Builder b)]) = _$Service10;
  ...
  static Serializer<Service10> get serializer => _$service10Serializer;
}

abstract class Price10 implements Built<Price10, Price10Builder> {
  Price10._();

  factory Price10([updates(Price10Builder b)]) = _$Price10;
  ...
  static Serializer<Price10> get serializer => _$price10Serializer;
}

abstract class Packages10 implements Built<Packages10, Packages10Builder> {
  Packages10._();

  factory Packages10([updates(Packages10Builder b)]) = _$Packages10;
  ...
  PackageLabelInfo10 get packageLabelInfo;

  static Serializer<Packages10> get serializer => _$packages10Serializer;
}

abstract class Coverage10 implements Built<Coverage10, Coverage10Builder> {
  Coverage10._();

  factory Coverage10([updates(Coverage10Builder b)]) = _$Coverage10;
  ...
  InsuredPerson10 get insuredPerson;
  ...
  BuiltList<SubInsurances10> get subInsurances;

  static Serializer<Coverage10> get serializer => _$coverage10Serializer;
}

abstract class InsuredPerson10
    implements Built<InsuredPerson10, InsuredPerson10Builder> {
  InsuredPerson10._();

  factory InsuredPerson10([updates(InsuredPerson10Builder b)]) = _$InsuredPerson10;
  ...
  static Serializer<InsuredPerson10> get serializer => _$insuredPerson10Serializer;
}

abstract class SubInsurances10
    implements Built<SubInsurances10, SubInsurances10Builder> {
  SubInsurances10._();

  factory SubInsurances10([updates(SubInsurances10Builder b)]) = _$SubInsurances10;
  ...
  static Serializer<SubInsurances10> get serializer => _$subInsurances10Serializer;
}

abstract class ShopMap10 implements Built<ShopMap10, ShopMap10Builder> {
  ShopMap10._();

  factory ShopMap10([updates(ShopMap10Builder b)]) = _$ShopMap10;
  ...
  static Serializer<ShopMap10> get serializer => _$shopMap10Serializer;
}

abstract class SupplierMap10 implements Built<SupplierMap10, SupplierMap10Builder> {
  SupplierMap10._();

  factory SupplierMap10([updates(SupplierMap10Builder b)]) = _$SupplierMap10;
  ...
  static Serializer<SupplierMap10> get serializer => _$supplierMap10Serializer;
}

abstract class FilterGroups10
    implements Built<FilterGroups10, FilterGroups10Builder> {
  FilterGroups10._();

  factory FilterGroups10([updates(FilterGroups10Builder b)]) = _$FilterGroups10;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options10> get options;

  static Serializer<FilterGroups10> get serializer => _$filterGroups10Serializer;
}

abstract class Options10 implements Built<Options10, Options10Builder> {
  Options10._();

  factory Options10([updates(Options10Builder b)]) = _$Options10;
  ...
  static Serializer<Options10> get serializer => _$options10Serializer;
}

abstract class PackageLabelInfo10
    implements Built<PackageLabelInfo10, PackageLabelInfo10Builder> {
  PackageLabelInfo10._();

  factory PackageLabelInfo10([updates(PackageLabelInfo10Builder b)]) =
      _$PackageLabelInfo10;
  ...
  static Serializer<PackageLabelInfo10> get serializer =>
      _$packageLabelInfo10Serializer;
}

abstract class ActivityList10
    implements Built<ActivityList10, ActivityList10Builder> {
  ActivityList10._();

  factory ActivityList10([update(ActivityList10Builder b)]) = _$ActivityList10;
  ...
  CardTags10 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList10> get serializer => _$activityList10Serializer;
}

abstract class CardTags10 implements Built<CardTags10, CardTags10Builder> {
  CardTags10._();

  factory CardTags10([update(CardTags10Builder b)]) = _$CardTags10;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags10> get serializer => _$cardTags10Serializer;
}

@SerializersFor([
  SearchResultPollResult10,
])
final Serializers serializers10 = _$serializers10;
