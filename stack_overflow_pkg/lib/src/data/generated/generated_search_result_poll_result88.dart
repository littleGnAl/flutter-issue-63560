...
part 'generated_search_result_poll_result88.g.dart';

abstract class SearchResultPollResult88
    implements Built<SearchResultPollResult88, SearchResultPollResult88Builder> {
  SearchResultPollResult88._();

  factory SearchResultPollResult88([updates(SearchResultPollResult88Builder b)]) =
  ...
  BuiltList<VehicleInfoList88> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap88> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap88> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups88> get filterGroups;
  ...
  static Serializer<SearchResultPollResult88> get serializer =>
      _$searchResultPollResult88Serializer;
}

abstract class VehicleInfoList88
    implements Built<VehicleInfoList88, VehicleInfoList88Builder> {
  VehicleInfoList88._();

  factory VehicleInfoList88([updates(VehicleInfoList88Builder b)]) =
      _$VehicleInfoList88;
  ...
  BuiltList<Packages88> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic88> get options;
  ...
  static Serializer<VehicleInfoList88> get serializer =>
      _$vehicleInfoList88Serializer;
}

abstract class VehicleCharacteristic88
    implements Built<VehicleCharacteristic88, VehicleCharacteristic88Builder> {
  VehicleCharacteristic88._();

  factory VehicleCharacteristic88([updates(VehicleCharacteristic88Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic88> get serializer =>
      _$vehicleCharacteristic88Serializer;
}

abstract class Service88 implements Built<Service88, Service88Builder> {
  Service88._();

  factory Service88([updates(Service88Builder b)]) = _$Service88;
  ...
  static Serializer<Service88> get serializer => _$service88Serializer;
}

abstract class Price88 implements Built<Price88, Price88Builder> {
  Price88._();

  factory Price88([updates(Price88Builder b)]) = _$Price88;
  ...
  static Serializer<Price88> get serializer => _$price88Serializer;
}

abstract class Packages88 implements Built<Packages88, Packages88Builder> {
  Packages88._();

  factory Packages88([updates(Packages88Builder b)]) = _$Packages88;
  ...
  PackageLabelInfo88 get packageLabelInfo;

  static Serializer<Packages88> get serializer => _$packages88Serializer;
}

abstract class Coverage88 implements Built<Coverage88, Coverage88Builder> {
  Coverage88._();

  factory Coverage88([updates(Coverage88Builder b)]) = _$Coverage88;
  ...
  InsuredPerson88 get insuredPerson;
  ...
  BuiltList<SubInsurances88> get subInsurances;

  static Serializer<Coverage88> get serializer => _$coverage88Serializer;
}

abstract class InsuredPerson88
    implements Built<InsuredPerson88, InsuredPerson88Builder> {
  InsuredPerson88._();

  factory InsuredPerson88([updates(InsuredPerson88Builder b)]) = _$InsuredPerson88;
  ...
  static Serializer<InsuredPerson88> get serializer => _$insuredPerson88Serializer;
}

abstract class SubInsurances88
    implements Built<SubInsurances88, SubInsurances88Builder> {
  SubInsurances88._();

  factory SubInsurances88([updates(SubInsurances88Builder b)]) = _$SubInsurances88;
  ...
  static Serializer<SubInsurances88> get serializer => _$subInsurances88Serializer;
}

abstract class ShopMap88 implements Built<ShopMap88, ShopMap88Builder> {
  ShopMap88._();

  factory ShopMap88([updates(ShopMap88Builder b)]) = _$ShopMap88;
  ...
  static Serializer<ShopMap88> get serializer => _$shopMap88Serializer;
}

abstract class SupplierMap88 implements Built<SupplierMap88, SupplierMap88Builder> {
  SupplierMap88._();

  factory SupplierMap88([updates(SupplierMap88Builder b)]) = _$SupplierMap88;
  ...
  static Serializer<SupplierMap88> get serializer => _$supplierMap88Serializer;
}

abstract class FilterGroups88
    implements Built<FilterGroups88, FilterGroups88Builder> {
  FilterGroups88._();

  factory FilterGroups88([updates(FilterGroups88Builder b)]) = _$FilterGroups88;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options88> get options;

  static Serializer<FilterGroups88> get serializer => _$filterGroups88Serializer;
}

abstract class Options88 implements Built<Options88, Options88Builder> {
  Options88._();

  factory Options88([updates(Options88Builder b)]) = _$Options88;
  ...
  static Serializer<Options88> get serializer => _$options88Serializer;
}

abstract class PackageLabelInfo88
    implements Built<PackageLabelInfo88, PackageLabelInfo88Builder> {
  PackageLabelInfo88._();

  factory PackageLabelInfo88([updates(PackageLabelInfo88Builder b)]) =
      _$PackageLabelInfo88;
  ...
  static Serializer<PackageLabelInfo88> get serializer =>
      _$packageLabelInfo88Serializer;
}

abstract class ActivityList88
    implements Built<ActivityList88, ActivityList88Builder> {
  ActivityList88._();

  factory ActivityList88([update(ActivityList88Builder b)]) = _$ActivityList88;
  ...
  CardTags88 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList88> get serializer => _$activityList88Serializer;
}

abstract class CardTags88 implements Built<CardTags88, CardTags88Builder> {
  CardTags88._();

  factory CardTags88([update(CardTags88Builder b)]) = _$CardTags88;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags88> get serializer => _$cardTags88Serializer;
}
