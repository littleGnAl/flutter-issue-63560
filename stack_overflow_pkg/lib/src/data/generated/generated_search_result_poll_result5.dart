...
part 'generated_search_result_poll_result5.g.dart';

abstract class SearchResultPollResult5
    implements Built<SearchResultPollResult5, SearchResultPollResult5Builder> {
  SearchResultPollResult5._();

  factory SearchResultPollResult5([updates(SearchResultPollResult5Builder b)]) =
  ...
  BuiltList<VehicleInfoList5> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap5> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap5> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups5> get filterGroups;
  ...
  static Serializer<SearchResultPollResult5> get serializer =>
      _$searchResultPollResult5Serializer;
}

abstract class VehicleInfoList5
    implements Built<VehicleInfoList5, VehicleInfoList5Builder> {
  VehicleInfoList5._();

  factory VehicleInfoList5([updates(VehicleInfoList5Builder b)]) =
      _$VehicleInfoList5;
  ...
  BuiltList<Packages5> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic5> get options;
  ...
  static Serializer<VehicleInfoList5> get serializer =>
      _$vehicleInfoList5Serializer;
}

abstract class VehicleCharacteristic5
    implements Built<VehicleCharacteristic5, VehicleCharacteristic5Builder> {
  VehicleCharacteristic5._();

  factory VehicleCharacteristic5([updates(VehicleCharacteristic5Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic5> get serializer =>
      _$vehicleCharacteristic5Serializer;
}

abstract class Service5 implements Built<Service5, Service5Builder> {
  Service5._();

  factory Service5([updates(Service5Builder b)]) = _$Service5;
  ...
  static Serializer<Service5> get serializer => _$service5Serializer;
}

abstract class Price5 implements Built<Price5, Price5Builder> {
  Price5._();

  factory Price5([updates(Price5Builder b)]) = _$Price5;
  ...
  static Serializer<Price5> get serializer => _$price5Serializer;
}

abstract class Packages5 implements Built<Packages5, Packages5Builder> {
  Packages5._();

  factory Packages5([updates(Packages5Builder b)]) = _$Packages5;
  ...
  PackageLabelInfo5 get packageLabelInfo;

  static Serializer<Packages5> get serializer => _$packages5Serializer;
}

abstract class Coverage5 implements Built<Coverage5, Coverage5Builder> {
  Coverage5._();

  factory Coverage5([updates(Coverage5Builder b)]) = _$Coverage5;
  ...
  InsuredPerson5 get insuredPerson;
  ...
  BuiltList<SubInsurances5> get subInsurances;

  static Serializer<Coverage5> get serializer => _$coverage5Serializer;
}

abstract class InsuredPerson5
    implements Built<InsuredPerson5, InsuredPerson5Builder> {
  InsuredPerson5._();

  factory InsuredPerson5([updates(InsuredPerson5Builder b)]) = _$InsuredPerson5;
  ...
  static Serializer<InsuredPerson5> get serializer => _$insuredPerson5Serializer;
}

abstract class SubInsurances5
    implements Built<SubInsurances5, SubInsurances5Builder> {
  SubInsurances5._();

  factory SubInsurances5([updates(SubInsurances5Builder b)]) = _$SubInsurances5;
  ...
  static Serializer<SubInsurances5> get serializer => _$subInsurances5Serializer;
}

abstract class ShopMap5 implements Built<ShopMap5, ShopMap5Builder> {
  ShopMap5._();

  factory ShopMap5([updates(ShopMap5Builder b)]) = _$ShopMap5;
  ...
  static Serializer<ShopMap5> get serializer => _$shopMap5Serializer;
}

abstract class SupplierMap5 implements Built<SupplierMap5, SupplierMap5Builder> {
  SupplierMap5._();

  factory SupplierMap5([updates(SupplierMap5Builder b)]) = _$SupplierMap5;
  ...
  static Serializer<SupplierMap5> get serializer => _$supplierMap5Serializer;
}

abstract class FilterGroups5
    implements Built<FilterGroups5, FilterGroups5Builder> {
  FilterGroups5._();

  factory FilterGroups5([updates(FilterGroups5Builder b)]) = _$FilterGroups5;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options5> get options;

  static Serializer<FilterGroups5> get serializer => _$filterGroups5Serializer;
}

abstract class Options5 implements Built<Options5, Options5Builder> {
  Options5._();

  factory Options5([updates(Options5Builder b)]) = _$Options5;
  ...
  static Serializer<Options5> get serializer => _$options5Serializer;
}

abstract class PackageLabelInfo5
    implements Built<PackageLabelInfo5, PackageLabelInfo5Builder> {
  PackageLabelInfo5._();

  factory PackageLabelInfo5([updates(PackageLabelInfo5Builder b)]) =
      _$PackageLabelInfo5;
  ...
  static Serializer<PackageLabelInfo5> get serializer =>
      _$packageLabelInfo5Serializer;
}

abstract class ActivityList5
    implements Built<ActivityList5, ActivityList5Builder> {
  ActivityList5._();

  factory ActivityList5([update(ActivityList5Builder b)]) = _$ActivityList5;
  ...
  CardTags5 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList5> get serializer => _$activityList5Serializer;
}

abstract class CardTags5 implements Built<CardTags5, CardTags5Builder> {
  CardTags5._();

  factory CardTags5([update(CardTags5Builder b)]) = _$CardTags5;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags5> get serializer => _$cardTags5Serializer;
}

@SerializersFor([
  SearchResultPollResult5,
])
final Serializers serializers5 = _$serializers5;
