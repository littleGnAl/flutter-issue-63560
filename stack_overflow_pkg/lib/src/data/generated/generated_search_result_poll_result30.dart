...
part 'generated_search_result_poll_result30.g.dart';

abstract class SearchResultPollResult30
    implements Built<SearchResultPollResult30, SearchResultPollResult30Builder> {
  SearchResultPollResult30._();

  factory SearchResultPollResult30([updates(SearchResultPollResult30Builder b)]) =
  ...
  BuiltList<VehicleInfoList30> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap30> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap30> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups30> get filterGroups;
  ...
  static Serializer<SearchResultPollResult30> get serializer =>
      _$searchResultPollResult30Serializer;
}

abstract class VehicleInfoList30
    implements Built<VehicleInfoList30, VehicleInfoList30Builder> {
  VehicleInfoList30._();

  factory VehicleInfoList30([updates(VehicleInfoList30Builder b)]) =
      _$VehicleInfoList30;
  ...
  BuiltList<Packages30> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic30> get options;
  ...
  static Serializer<VehicleInfoList30> get serializer =>
      _$vehicleInfoList30Serializer;
}

abstract class VehicleCharacteristic30
    implements Built<VehicleCharacteristic30, VehicleCharacteristic30Builder> {
  VehicleCharacteristic30._();

  factory VehicleCharacteristic30([updates(VehicleCharacteristic30Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic30> get serializer =>
      _$vehicleCharacteristic30Serializer;
}

abstract class Service30 implements Built<Service30, Service30Builder> {
  Service30._();

  factory Service30([updates(Service30Builder b)]) = _$Service30;
  ...
  static Serializer<Service30> get serializer => _$service30Serializer;
}

abstract class Price30 implements Built<Price30, Price30Builder> {
  Price30._();

  factory Price30([updates(Price30Builder b)]) = _$Price30;
  ...
  static Serializer<Price30> get serializer => _$price30Serializer;
}

abstract class Packages30 implements Built<Packages30, Packages30Builder> {
  Packages30._();

  factory Packages30([updates(Packages30Builder b)]) = _$Packages30;
  ...
  PackageLabelInfo30 get packageLabelInfo;

  static Serializer<Packages30> get serializer => _$packages30Serializer;
}

abstract class Coverage30 implements Built<Coverage30, Coverage30Builder> {
  Coverage30._();

  factory Coverage30([updates(Coverage30Builder b)]) = _$Coverage30;
  ...
  InsuredPerson30 get insuredPerson;
  ...
  BuiltList<SubInsurances30> get subInsurances;

  static Serializer<Coverage30> get serializer => _$coverage30Serializer;
}

abstract class InsuredPerson30
    implements Built<InsuredPerson30, InsuredPerson30Builder> {
  InsuredPerson30._();

  factory InsuredPerson30([updates(InsuredPerson30Builder b)]) = _$InsuredPerson30;
  ...
  static Serializer<InsuredPerson30> get serializer => _$insuredPerson30Serializer;
}

abstract class SubInsurances30
    implements Built<SubInsurances30, SubInsurances30Builder> {
  SubInsurances30._();

  factory SubInsurances30([updates(SubInsurances30Builder b)]) = _$SubInsurances30;
  ...
  static Serializer<SubInsurances30> get serializer => _$subInsurances30Serializer;
}

abstract class ShopMap30 implements Built<ShopMap30, ShopMap30Builder> {
  ShopMap30._();

  factory ShopMap30([updates(ShopMap30Builder b)]) = _$ShopMap30;
  ...
  static Serializer<ShopMap30> get serializer => _$shopMap30Serializer;
}

abstract class SupplierMap30 implements Built<SupplierMap30, SupplierMap30Builder> {
  SupplierMap30._();

  factory SupplierMap30([updates(SupplierMap30Builder b)]) = _$SupplierMap30;
  ...
  static Serializer<SupplierMap30> get serializer => _$supplierMap30Serializer;
}

abstract class FilterGroups30
    implements Built<FilterGroups30, FilterGroups30Builder> {
  FilterGroups30._();

  factory FilterGroups30([updates(FilterGroups30Builder b)]) = _$FilterGroups30;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options30> get options;

  static Serializer<FilterGroups30> get serializer => _$filterGroups30Serializer;
}

abstract class Options30 implements Built<Options30, Options30Builder> {
  Options30._();

  factory Options30([updates(Options30Builder b)]) = _$Options30;
  ...
  static Serializer<Options30> get serializer => _$options30Serializer;
}

abstract class PackageLabelInfo30
    implements Built<PackageLabelInfo30, PackageLabelInfo30Builder> {
  PackageLabelInfo30._();

  factory PackageLabelInfo30([updates(PackageLabelInfo30Builder b)]) =
      _$PackageLabelInfo30;
  ...
  static Serializer<PackageLabelInfo30> get serializer =>
      _$packageLabelInfo30Serializer;
}

abstract class ActivityList30
    implements Built<ActivityList30, ActivityList30Builder> {
  ActivityList30._();

  factory ActivityList30([update(ActivityList30Builder b)]) = _$ActivityList30;
  ...
  CardTags30 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList30> get serializer => _$activityList30Serializer;
}

abstract class CardTags30 implements Built<CardTags30, CardTags30Builder> {
  CardTags30._();

  factory CardTags30([update(CardTags30Builder b)]) = _$CardTags30;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags30> get serializer => _$cardTags30Serializer;
}

@SerializersFor([
  SearchResultPollResult30,
])
final Serializers serializers30 = _$serializers30;
