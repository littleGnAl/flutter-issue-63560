...
part 'generated_search_result_poll_result100.g.dart';

abstract class SearchResultPollResult100
    implements Built<SearchResultPollResult100, SearchResultPollResult100Builder> {
  SearchResultPollResult100._();

  factory SearchResultPollResult100([updates(SearchResultPollResult100Builder b)]) =
  ...
  BuiltList<VehicleInfoList100> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap100> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap100> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups100> get filterGroups;
  ...
  static Serializer<SearchResultPollResult100> get serializer =>
      _$searchResultPollResult100Serializer;
}

abstract class VehicleInfoList100
    implements Built<VehicleInfoList100, VehicleInfoList100Builder> {
  VehicleInfoList100._();

  factory VehicleInfoList100([updates(VehicleInfoList100Builder b)]) =
      _$VehicleInfoList100;
  ...
  BuiltList<Packages100> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic100> get options;
  ...
  static Serializer<VehicleInfoList100> get serializer =>
      _$vehicleInfoList100Serializer;
}

abstract class VehicleCharacteristic100
    implements Built<VehicleCharacteristic100, VehicleCharacteristic100Builder> {
  VehicleCharacteristic100._();

  factory VehicleCharacteristic100([updates(VehicleCharacteristic100Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic100> get serializer =>
      _$vehicleCharacteristic100Serializer;
}

abstract class Service100 implements Built<Service100, Service100Builder> {
  Service100._();

  factory Service100([updates(Service100Builder b)]) = _$Service100;
  ...
  static Serializer<Service100> get serializer => _$service100Serializer;
}

abstract class Price100 implements Built<Price100, Price100Builder> {
  Price100._();

  factory Price100([updates(Price100Builder b)]) = _$Price100;
  ...
  static Serializer<Price100> get serializer => _$price100Serializer;
}

abstract class Packages100 implements Built<Packages100, Packages100Builder> {
  Packages100._();

  factory Packages100([updates(Packages100Builder b)]) = _$Packages100;
  ...
  PackageLabelInfo100 get packageLabelInfo;

  static Serializer<Packages100> get serializer => _$packages100Serializer;
}

abstract class Coverage100 implements Built<Coverage100, Coverage100Builder> {
  Coverage100._();

  factory Coverage100([updates(Coverage100Builder b)]) = _$Coverage100;
  ...
  InsuredPerson100 get insuredPerson;
  ...
  BuiltList<SubInsurances100> get subInsurances;

  static Serializer<Coverage100> get serializer => _$coverage100Serializer;
}

abstract class InsuredPerson100
    implements Built<InsuredPerson100, InsuredPerson100Builder> {
  InsuredPerson100._();

  factory InsuredPerson100([updates(InsuredPerson100Builder b)]) = _$InsuredPerson100;
  ...
  static Serializer<InsuredPerson100> get serializer => _$insuredPerson100Serializer;
}

abstract class SubInsurances100
    implements Built<SubInsurances100, SubInsurances100Builder> {
  SubInsurances100._();

  factory SubInsurances100([updates(SubInsurances100Builder b)]) = _$SubInsurances100;
  ...
  static Serializer<SubInsurances100> get serializer => _$subInsurances100Serializer;
}

abstract class ShopMap100 implements Built<ShopMap100, ShopMap100Builder> {
  ShopMap100._();

  factory ShopMap100([updates(ShopMap100Builder b)]) = _$ShopMap100;
  ...
  static Serializer<ShopMap100> get serializer => _$shopMap100Serializer;
}

abstract class SupplierMap100 implements Built<SupplierMap100, SupplierMap100Builder> {
  SupplierMap100._();

  factory SupplierMap100([updates(SupplierMap100Builder b)]) = _$SupplierMap100;
  ...
  static Serializer<SupplierMap100> get serializer => _$supplierMap100Serializer;
}

abstract class FilterGroups100
    implements Built<FilterGroups100, FilterGroups100Builder> {
  FilterGroups100._();

  factory FilterGroups100([updates(FilterGroups100Builder b)]) = _$FilterGroups100;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options100> get options;

  static Serializer<FilterGroups100> get serializer => _$filterGroups100Serializer;
}

abstract class Options100 implements Built<Options100, Options100Builder> {
  Options100._();

  factory Options100([updates(Options100Builder b)]) = _$Options100;
  ...
  static Serializer<Options100> get serializer => _$options100Serializer;
}

abstract class PackageLabelInfo100
    implements Built<PackageLabelInfo100, PackageLabelInfo100Builder> {
  PackageLabelInfo100._();

  factory PackageLabelInfo100([updates(PackageLabelInfo100Builder b)]) =
  ...
  static Serializer<PackageLabelInfo100> get serializer =>
      _$packageLabelInfo100Serializer;
}

abstract class ActivityList100
    implements Built<ActivityList100, ActivityList100Builder> {
  ActivityList100._();

  factory ActivityList100([update(ActivityList100Builder b)]) = _$ActivityList100;
  ...
  CardTags100 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList100> get serializer => _$activityList100Serializer;
}

abstract class CardTags100 implements Built<CardTags100, CardTags100Builder> {
  CardTags100._();

  factory CardTags100([update(CardTags100Builder b)]) = _$CardTags100;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags100> get serializer => _$cardTags100Serializer;
}

@SerializersFor([
  SearchResultPollResult100,
])
final Serializers serializers100 = _$serializers100;
