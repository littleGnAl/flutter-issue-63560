...
part 'generated_search_result_poll_result18.g.dart';

abstract class SearchResultPollResult18
    implements Built<SearchResultPollResult18, SearchResultPollResult18Builder> {
  SearchResultPollResult18._();

  factory SearchResultPollResult18([updates(SearchResultPollResult18Builder b)]) =
  ...
  BuiltList<VehicleInfoList18> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap18> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap18> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups18> get filterGroups;
  ...
  static Serializer<SearchResultPollResult18> get serializer =>
      _$searchResultPollResult18Serializer;
}

abstract class VehicleInfoList18
    implements Built<VehicleInfoList18, VehicleInfoList18Builder> {
  VehicleInfoList18._();

  factory VehicleInfoList18([updates(VehicleInfoList18Builder b)]) =
      _$VehicleInfoList18;
  ...
  BuiltList<Packages18> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic18> get options;
  ...
  static Serializer<VehicleInfoList18> get serializer =>
      _$vehicleInfoList18Serializer;
}

abstract class VehicleCharacteristic18
    implements Built<VehicleCharacteristic18, VehicleCharacteristic18Builder> {
  VehicleCharacteristic18._();

  factory VehicleCharacteristic18([updates(VehicleCharacteristic18Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic18> get serializer =>
      _$vehicleCharacteristic18Serializer;
}

abstract class Service18 implements Built<Service18, Service18Builder> {
  Service18._();

  factory Service18([updates(Service18Builder b)]) = _$Service18;
  ...
  static Serializer<Service18> get serializer => _$service18Serializer;
}

abstract class Price18 implements Built<Price18, Price18Builder> {
  Price18._();

  factory Price18([updates(Price18Builder b)]) = _$Price18;
  ...
  static Serializer<Price18> get serializer => _$price18Serializer;
}

abstract class Packages18 implements Built<Packages18, Packages18Builder> {
  Packages18._();

  factory Packages18([updates(Packages18Builder b)]) = _$Packages18;
  ...
  PackageLabelInfo18 get packageLabelInfo;

  static Serializer<Packages18> get serializer => _$packages18Serializer;
}

abstract class Coverage18 implements Built<Coverage18, Coverage18Builder> {
  Coverage18._();

  factory Coverage18([updates(Coverage18Builder b)]) = _$Coverage18;
  ...
  InsuredPerson18 get insuredPerson;
  ...
  BuiltList<SubInsurances18> get subInsurances;

  static Serializer<Coverage18> get serializer => _$coverage18Serializer;
}

abstract class InsuredPerson18
    implements Built<InsuredPerson18, InsuredPerson18Builder> {
  InsuredPerson18._();

  factory InsuredPerson18([updates(InsuredPerson18Builder b)]) = _$InsuredPerson18;
  ...
  static Serializer<InsuredPerson18> get serializer => _$insuredPerson18Serializer;
}

abstract class SubInsurances18
    implements Built<SubInsurances18, SubInsurances18Builder> {
  SubInsurances18._();

  factory SubInsurances18([updates(SubInsurances18Builder b)]) = _$SubInsurances18;
  ...
  static Serializer<SubInsurances18> get serializer => _$subInsurances18Serializer;
}

abstract class ShopMap18 implements Built<ShopMap18, ShopMap18Builder> {
  ShopMap18._();

  factory ShopMap18([updates(ShopMap18Builder b)]) = _$ShopMap18;
  ...
  static Serializer<ShopMap18> get serializer => _$shopMap18Serializer;
}

abstract class SupplierMap18 implements Built<SupplierMap18, SupplierMap18Builder> {
  SupplierMap18._();

  factory SupplierMap18([updates(SupplierMap18Builder b)]) = _$SupplierMap18;
  ...
  static Serializer<SupplierMap18> get serializer => _$supplierMap18Serializer;
}

abstract class FilterGroups18
    implements Built<FilterGroups18, FilterGroups18Builder> {
  FilterGroups18._();

  factory FilterGroups18([updates(FilterGroups18Builder b)]) = _$FilterGroups18;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options18> get options;

  static Serializer<FilterGroups18> get serializer => _$filterGroups18Serializer;
}

abstract class Options18 implements Built<Options18, Options18Builder> {
  Options18._();

  factory Options18([updates(Options18Builder b)]) = _$Options18;
  ...
  static Serializer<Options18> get serializer => _$options18Serializer;
}

abstract class PackageLabelInfo18
    implements Built<PackageLabelInfo18, PackageLabelInfo18Builder> {
  PackageLabelInfo18._();

  factory PackageLabelInfo18([updates(PackageLabelInfo18Builder b)]) =
      _$PackageLabelInfo18;
  ...
  static Serializer<PackageLabelInfo18> get serializer =>
      _$packageLabelInfo18Serializer;
}

abstract class ActivityList18
    implements Built<ActivityList18, ActivityList18Builder> {
  ActivityList18._();

  factory ActivityList18([update(ActivityList18Builder b)]) = _$ActivityList18;
  ...
  CardTags18 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList18> get serializer => _$activityList18Serializer;
}

abstract class CardTags18 implements Built<CardTags18, CardTags18Builder> {
  CardTags18._();

  factory CardTags18([update(CardTags18Builder b)]) = _$CardTags18;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags18> get serializer => _$cardTags18Serializer;
}
