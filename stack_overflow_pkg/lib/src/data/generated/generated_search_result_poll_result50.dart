...
part 'generated_search_result_poll_result50.g.dart';

abstract class SearchResultPollResult50
    implements Built<SearchResultPollResult50, SearchResultPollResult50Builder> {
  SearchResultPollResult50._();

  factory SearchResultPollResult50([updates(SearchResultPollResult50Builder b)]) =
  ...
  BuiltList<VehicleInfoList50> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap50> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap50> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups50> get filterGroups;
  ...
  static Serializer<SearchResultPollResult50> get serializer =>
      _$searchResultPollResult50Serializer;
}

abstract class VehicleInfoList50
    implements Built<VehicleInfoList50, VehicleInfoList50Builder> {
  VehicleInfoList50._();

  factory VehicleInfoList50([updates(VehicleInfoList50Builder b)]) =
      _$VehicleInfoList50;
  ...
  BuiltList<Packages50> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic50> get options;
  ...
  static Serializer<VehicleInfoList50> get serializer =>
      _$vehicleInfoList50Serializer;
}

abstract class VehicleCharacteristic50
    implements Built<VehicleCharacteristic50, VehicleCharacteristic50Builder> {
  VehicleCharacteristic50._();

  factory VehicleCharacteristic50([updates(VehicleCharacteristic50Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic50> get serializer =>
      _$vehicleCharacteristic50Serializer;
}

abstract class Service50 implements Built<Service50, Service50Builder> {
  Service50._();

  factory Service50([updates(Service50Builder b)]) = _$Service50;
  ...
  static Serializer<Service50> get serializer => _$service50Serializer;
}

abstract class Price50 implements Built<Price50, Price50Builder> {
  Price50._();

  factory Price50([updates(Price50Builder b)]) = _$Price50;
  ...
  static Serializer<Price50> get serializer => _$price50Serializer;
}

abstract class Packages50 implements Built<Packages50, Packages50Builder> {
  Packages50._();

  factory Packages50([updates(Packages50Builder b)]) = _$Packages50;
  ...
  PackageLabelInfo50 get packageLabelInfo;

  static Serializer<Packages50> get serializer => _$packages50Serializer;
}

abstract class Coverage50 implements Built<Coverage50, Coverage50Builder> {
  Coverage50._();

  factory Coverage50([updates(Coverage50Builder b)]) = _$Coverage50;
  ...
  InsuredPerson50 get insuredPerson;
  ...
  BuiltList<SubInsurances50> get subInsurances;

  static Serializer<Coverage50> get serializer => _$coverage50Serializer;
}

abstract class InsuredPerson50
    implements Built<InsuredPerson50, InsuredPerson50Builder> {
  InsuredPerson50._();

  factory InsuredPerson50([updates(InsuredPerson50Builder b)]) = _$InsuredPerson50;
  ...
  static Serializer<InsuredPerson50> get serializer => _$insuredPerson50Serializer;
}

abstract class SubInsurances50
    implements Built<SubInsurances50, SubInsurances50Builder> {
  SubInsurances50._();

  factory SubInsurances50([updates(SubInsurances50Builder b)]) = _$SubInsurances50;
  ...
  static Serializer<SubInsurances50> get serializer => _$subInsurances50Serializer;
}

abstract class ShopMap50 implements Built<ShopMap50, ShopMap50Builder> {
  ShopMap50._();

  factory ShopMap50([updates(ShopMap50Builder b)]) = _$ShopMap50;
  ...
  static Serializer<ShopMap50> get serializer => _$shopMap50Serializer;
}

abstract class SupplierMap50 implements Built<SupplierMap50, SupplierMap50Builder> {
  SupplierMap50._();

  factory SupplierMap50([updates(SupplierMap50Builder b)]) = _$SupplierMap50;
  ...
  static Serializer<SupplierMap50> get serializer => _$supplierMap50Serializer;
}

abstract class FilterGroups50
    implements Built<FilterGroups50, FilterGroups50Builder> {
  FilterGroups50._();

  factory FilterGroups50([updates(FilterGroups50Builder b)]) = _$FilterGroups50;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options50> get options;

  static Serializer<FilterGroups50> get serializer => _$filterGroups50Serializer;
}

abstract class Options50 implements Built<Options50, Options50Builder> {
  Options50._();

  factory Options50([updates(Options50Builder b)]) = _$Options50;
  ...
  static Serializer<Options50> get serializer => _$options50Serializer;
}

abstract class PackageLabelInfo50
    implements Built<PackageLabelInfo50, PackageLabelInfo50Builder> {
  PackageLabelInfo50._();

  factory PackageLabelInfo50([updates(PackageLabelInfo50Builder b)]) =
      _$PackageLabelInfo50;
  ...
  static Serializer<PackageLabelInfo50> get serializer =>
      _$packageLabelInfo50Serializer;
}

abstract class ActivityList50
    implements Built<ActivityList50, ActivityList50Builder> {
  ActivityList50._();

  factory ActivityList50([update(ActivityList50Builder b)]) = _$ActivityList50;
  ...
  CardTags50 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList50> get serializer => _$activityList50Serializer;
}

abstract class CardTags50 implements Built<CardTags50, CardTags50Builder> {
  CardTags50._();

  factory CardTags50([update(CardTags50Builder b)]) = _$CardTags50;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags50> get serializer => _$cardTags50Serializer;
}

@SerializersFor([
  SearchResultPollResult50,
])
final Serializers serializers50 = _$serializers50;
