...
part 'generated_search_result_poll_result33.g.dart';

abstract class SearchResultPollResult33
    implements Built<SearchResultPollResult33, SearchResultPollResult33Builder> {
  SearchResultPollResult33._();

  factory SearchResultPollResult33([updates(SearchResultPollResult33Builder b)]) =
  ...
  BuiltList<VehicleInfoList33> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap33> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap33> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups33> get filterGroups;
  ...
  static Serializer<SearchResultPollResult33> get serializer =>
      _$searchResultPollResult33Serializer;
}

abstract class VehicleInfoList33
    implements Built<VehicleInfoList33, VehicleInfoList33Builder> {
  VehicleInfoList33._();

  factory VehicleInfoList33([updates(VehicleInfoList33Builder b)]) =
      _$VehicleInfoList33;
  ...
  BuiltList<Packages33> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic33> get options;
  ...
  static Serializer<VehicleInfoList33> get serializer =>
      _$vehicleInfoList33Serializer;
}

abstract class VehicleCharacteristic33
    implements Built<VehicleCharacteristic33, VehicleCharacteristic33Builder> {
  VehicleCharacteristic33._();

  factory VehicleCharacteristic33([updates(VehicleCharacteristic33Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic33> get serializer =>
      _$vehicleCharacteristic33Serializer;
}

abstract class Service33 implements Built<Service33, Service33Builder> {
  Service33._();

  factory Service33([updates(Service33Builder b)]) = _$Service33;
  ...
  static Serializer<Service33> get serializer => _$service33Serializer;
}

abstract class Price33 implements Built<Price33, Price33Builder> {
  Price33._();

  factory Price33([updates(Price33Builder b)]) = _$Price33;
  ...
  static Serializer<Price33> get serializer => _$price33Serializer;
}

abstract class Packages33 implements Built<Packages33, Packages33Builder> {
  Packages33._();

  factory Packages33([updates(Packages33Builder b)]) = _$Packages33;
  ...
  PackageLabelInfo33 get packageLabelInfo;

  static Serializer<Packages33> get serializer => _$packages33Serializer;
}

abstract class Coverage33 implements Built<Coverage33, Coverage33Builder> {
  Coverage33._();

  factory Coverage33([updates(Coverage33Builder b)]) = _$Coverage33;
  ...
  InsuredPerson33 get insuredPerson;
  ...
  BuiltList<SubInsurances33> get subInsurances;

  static Serializer<Coverage33> get serializer => _$coverage33Serializer;
}

abstract class InsuredPerson33
    implements Built<InsuredPerson33, InsuredPerson33Builder> {
  InsuredPerson33._();

  factory InsuredPerson33([updates(InsuredPerson33Builder b)]) = _$InsuredPerson33;
  ...
  static Serializer<InsuredPerson33> get serializer => _$insuredPerson33Serializer;
}

abstract class SubInsurances33
    implements Built<SubInsurances33, SubInsurances33Builder> {
  SubInsurances33._();

  factory SubInsurances33([updates(SubInsurances33Builder b)]) = _$SubInsurances33;
  ...
  static Serializer<SubInsurances33> get serializer => _$subInsurances33Serializer;
}

abstract class ShopMap33 implements Built<ShopMap33, ShopMap33Builder> {
  ShopMap33._();

  factory ShopMap33([updates(ShopMap33Builder b)]) = _$ShopMap33;
  ...
  static Serializer<ShopMap33> get serializer => _$shopMap33Serializer;
}

abstract class SupplierMap33 implements Built<SupplierMap33, SupplierMap33Builder> {
  SupplierMap33._();

  factory SupplierMap33([updates(SupplierMap33Builder b)]) = _$SupplierMap33;
  ...
  static Serializer<SupplierMap33> get serializer => _$supplierMap33Serializer;
}

abstract class FilterGroups33
    implements Built<FilterGroups33, FilterGroups33Builder> {
  FilterGroups33._();

  factory FilterGroups33([updates(FilterGroups33Builder b)]) = _$FilterGroups33;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options33> get options;

  static Serializer<FilterGroups33> get serializer => _$filterGroups33Serializer;
}

abstract class Options33 implements Built<Options33, Options33Builder> {
  Options33._();

  factory Options33([updates(Options33Builder b)]) = _$Options33;
  ...
  static Serializer<Options33> get serializer => _$options33Serializer;
}

abstract class PackageLabelInfo33
    implements Built<PackageLabelInfo33, PackageLabelInfo33Builder> {
  PackageLabelInfo33._();

  factory PackageLabelInfo33([updates(PackageLabelInfo33Builder b)]) =
      _$PackageLabelInfo33;
  ...
  static Serializer<PackageLabelInfo33> get serializer =>
      _$packageLabelInfo33Serializer;
}

abstract class ActivityList33
    implements Built<ActivityList33, ActivityList33Builder> {
  ActivityList33._();

  factory ActivityList33([update(ActivityList33Builder b)]) = _$ActivityList33;
  ...
  CardTags33 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList33> get serializer => _$activityList33Serializer;
}

abstract class CardTags33 implements Built<CardTags33, CardTags33Builder> {
  CardTags33._();

  factory CardTags33([update(CardTags33Builder b)]) = _$CardTags33;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags33> get serializer => _$cardTags33Serializer;
}

@SerializersFor([
  SearchResultPollResult33,
])
final Serializers serializers33 = _$serializers33;
