...
part 'generated_search_result_poll_result65.g.dart';

abstract class SearchResultPollResult65
    implements Built<SearchResultPollResult65, SearchResultPollResult65Builder> {
  SearchResultPollResult65._();

  factory SearchResultPollResult65([updates(SearchResultPollResult65Builder b)]) =
  ...
  BuiltList<VehicleInfoList65> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap65> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap65> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups65> get filterGroups;
  ...
  static Serializer<SearchResultPollResult65> get serializer =>
      _$searchResultPollResult65Serializer;
}

abstract class VehicleInfoList65
    implements Built<VehicleInfoList65, VehicleInfoList65Builder> {
  VehicleInfoList65._();

  factory VehicleInfoList65([updates(VehicleInfoList65Builder b)]) =
      _$VehicleInfoList65;
  ...
  BuiltList<Packages65> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic65> get options;
  ...
  static Serializer<VehicleInfoList65> get serializer =>
      _$vehicleInfoList65Serializer;
}

abstract class VehicleCharacteristic65
    implements Built<VehicleCharacteristic65, VehicleCharacteristic65Builder> {
  VehicleCharacteristic65._();

  factory VehicleCharacteristic65([updates(VehicleCharacteristic65Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic65> get serializer =>
      _$vehicleCharacteristic65Serializer;
}

abstract class Service65 implements Built<Service65, Service65Builder> {
  Service65._();

  factory Service65([updates(Service65Builder b)]) = _$Service65;
  ...
  static Serializer<Service65> get serializer => _$service65Serializer;
}

abstract class Price65 implements Built<Price65, Price65Builder> {
  Price65._();

  factory Price65([updates(Price65Builder b)]) = _$Price65;
  ...
  static Serializer<Price65> get serializer => _$price65Serializer;
}

abstract class Packages65 implements Built<Packages65, Packages65Builder> {
  Packages65._();

  factory Packages65([updates(Packages65Builder b)]) = _$Packages65;
  ...
  PackageLabelInfo65 get packageLabelInfo;

  static Serializer<Packages65> get serializer => _$packages65Serializer;
}

abstract class Coverage65 implements Built<Coverage65, Coverage65Builder> {
  Coverage65._();

  factory Coverage65([updates(Coverage65Builder b)]) = _$Coverage65;
  ...
  InsuredPerson65 get insuredPerson;
  ...
  BuiltList<SubInsurances65> get subInsurances;

  static Serializer<Coverage65> get serializer => _$coverage65Serializer;
}

abstract class InsuredPerson65
    implements Built<InsuredPerson65, InsuredPerson65Builder> {
  InsuredPerson65._();

  factory InsuredPerson65([updates(InsuredPerson65Builder b)]) = _$InsuredPerson65;
  ...
  static Serializer<InsuredPerson65> get serializer => _$insuredPerson65Serializer;
}

abstract class SubInsurances65
    implements Built<SubInsurances65, SubInsurances65Builder> {
  SubInsurances65._();

  factory SubInsurances65([updates(SubInsurances65Builder b)]) = _$SubInsurances65;
  ...
  static Serializer<SubInsurances65> get serializer => _$subInsurances65Serializer;
}

abstract class ShopMap65 implements Built<ShopMap65, ShopMap65Builder> {
  ShopMap65._();

  factory ShopMap65([updates(ShopMap65Builder b)]) = _$ShopMap65;
  ...
  static Serializer<ShopMap65> get serializer => _$shopMap65Serializer;
}

abstract class SupplierMap65 implements Built<SupplierMap65, SupplierMap65Builder> {
  SupplierMap65._();

  factory SupplierMap65([updates(SupplierMap65Builder b)]) = _$SupplierMap65;
  ...
  static Serializer<SupplierMap65> get serializer => _$supplierMap65Serializer;
}

abstract class FilterGroups65
    implements Built<FilterGroups65, FilterGroups65Builder> {
  FilterGroups65._();

  factory FilterGroups65([updates(FilterGroups65Builder b)]) = _$FilterGroups65;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options65> get options;

  static Serializer<FilterGroups65> get serializer => _$filterGroups65Serializer;
}

abstract class Options65 implements Built<Options65, Options65Builder> {
  Options65._();

  factory Options65([updates(Options65Builder b)]) = _$Options65;
  ...
  static Serializer<Options65> get serializer => _$options65Serializer;
}

abstract class PackageLabelInfo65
    implements Built<PackageLabelInfo65, PackageLabelInfo65Builder> {
  PackageLabelInfo65._();

  factory PackageLabelInfo65([updates(PackageLabelInfo65Builder b)]) =
      _$PackageLabelInfo65;
  ...
  static Serializer<PackageLabelInfo65> get serializer =>
      _$packageLabelInfo65Serializer;
}

abstract class ActivityList65
    implements Built<ActivityList65, ActivityList65Builder> {
  ActivityList65._();

  factory ActivityList65([update(ActivityList65Builder b)]) = _$ActivityList65;
  ...
  CardTags65 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList65> get serializer => _$activityList65Serializer;
}

abstract class CardTags65 implements Built<CardTags65, CardTags65Builder> {
  CardTags65._();

  factory CardTags65([update(CardTags65Builder b)]) = _$CardTags65;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags65> get serializer => _$cardTags65Serializer;
}

@SerializersFor([
  SearchResultPollResult65,
])
final Serializers serializers65 = _$serializers65;
