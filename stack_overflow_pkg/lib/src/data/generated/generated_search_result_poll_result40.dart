...
part 'generated_search_result_poll_result40.g.dart';

abstract class SearchResultPollResult40
    implements Built<SearchResultPollResult40, SearchResultPollResult40Builder> {
  SearchResultPollResult40._();

  factory SearchResultPollResult40([updates(SearchResultPollResult40Builder b)]) =
  ...
  BuiltList<VehicleInfoList40> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap40> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap40> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups40> get filterGroups;
  ...
  static Serializer<SearchResultPollResult40> get serializer =>
      _$searchResultPollResult40Serializer;
}

abstract class VehicleInfoList40
    implements Built<VehicleInfoList40, VehicleInfoList40Builder> {
  VehicleInfoList40._();

  factory VehicleInfoList40([updates(VehicleInfoList40Builder b)]) =
      _$VehicleInfoList40;
  ...
  BuiltList<Packages40> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic40> get options;
  ...
  static Serializer<VehicleInfoList40> get serializer =>
      _$vehicleInfoList40Serializer;
}

abstract class VehicleCharacteristic40
    implements Built<VehicleCharacteristic40, VehicleCharacteristic40Builder> {
  VehicleCharacteristic40._();

  factory VehicleCharacteristic40([updates(VehicleCharacteristic40Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic40> get serializer =>
      _$vehicleCharacteristic40Serializer;
}

abstract class Service40 implements Built<Service40, Service40Builder> {
  Service40._();

  factory Service40([updates(Service40Builder b)]) = _$Service40;
  ...
  static Serializer<Service40> get serializer => _$service40Serializer;
}

abstract class Price40 implements Built<Price40, Price40Builder> {
  Price40._();

  factory Price40([updates(Price40Builder b)]) = _$Price40;
  ...
  static Serializer<Price40> get serializer => _$price40Serializer;
}

abstract class Packages40 implements Built<Packages40, Packages40Builder> {
  Packages40._();

  factory Packages40([updates(Packages40Builder b)]) = _$Packages40;
  ...
  PackageLabelInfo40 get packageLabelInfo;

  static Serializer<Packages40> get serializer => _$packages40Serializer;
}

abstract class Coverage40 implements Built<Coverage40, Coverage40Builder> {
  Coverage40._();

  factory Coverage40([updates(Coverage40Builder b)]) = _$Coverage40;
  ...
  InsuredPerson40 get insuredPerson;
  ...
  BuiltList<SubInsurances40> get subInsurances;

  static Serializer<Coverage40> get serializer => _$coverage40Serializer;
}

abstract class InsuredPerson40
    implements Built<InsuredPerson40, InsuredPerson40Builder> {
  InsuredPerson40._();

  factory InsuredPerson40([updates(InsuredPerson40Builder b)]) = _$InsuredPerson40;
  ...
  static Serializer<InsuredPerson40> get serializer => _$insuredPerson40Serializer;
}

abstract class SubInsurances40
    implements Built<SubInsurances40, SubInsurances40Builder> {
  SubInsurances40._();

  factory SubInsurances40([updates(SubInsurances40Builder b)]) = _$SubInsurances40;
  ...
  static Serializer<SubInsurances40> get serializer => _$subInsurances40Serializer;
}

abstract class ShopMap40 implements Built<ShopMap40, ShopMap40Builder> {
  ShopMap40._();

  factory ShopMap40([updates(ShopMap40Builder b)]) = _$ShopMap40;
  ...
  static Serializer<ShopMap40> get serializer => _$shopMap40Serializer;
}

abstract class SupplierMap40 implements Built<SupplierMap40, SupplierMap40Builder> {
  SupplierMap40._();

  factory SupplierMap40([updates(SupplierMap40Builder b)]) = _$SupplierMap40;
  ...
  static Serializer<SupplierMap40> get serializer => _$supplierMap40Serializer;
}

abstract class FilterGroups40
    implements Built<FilterGroups40, FilterGroups40Builder> {
  FilterGroups40._();

  factory FilterGroups40([updates(FilterGroups40Builder b)]) = _$FilterGroups40;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options40> get options;

  static Serializer<FilterGroups40> get serializer => _$filterGroups40Serializer;
}

abstract class Options40 implements Built<Options40, Options40Builder> {
  Options40._();

  factory Options40([updates(Options40Builder b)]) = _$Options40;
  ...
  static Serializer<Options40> get serializer => _$options40Serializer;
}

abstract class PackageLabelInfo40
    implements Built<PackageLabelInfo40, PackageLabelInfo40Builder> {
  PackageLabelInfo40._();

  factory PackageLabelInfo40([updates(PackageLabelInfo40Builder b)]) =
      _$PackageLabelInfo40;
  ...
  static Serializer<PackageLabelInfo40> get serializer =>
      _$packageLabelInfo40Serializer;
}

abstract class ActivityList40
    implements Built<ActivityList40, ActivityList40Builder> {
  ActivityList40._();

  factory ActivityList40([update(ActivityList40Builder b)]) = _$ActivityList40;
  ...
  CardTags40 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList40> get serializer => _$activityList40Serializer;
}

abstract class CardTags40 implements Built<CardTags40, CardTags40Builder> {
  CardTags40._();

  factory CardTags40([update(CardTags40Builder b)]) = _$CardTags40;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags40> get serializer => _$cardTags40Serializer;
}
