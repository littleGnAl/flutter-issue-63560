...
part 'generated_search_result_poll_result31.g.dart';

abstract class SearchResultPollResult31
    implements Built<SearchResultPollResult31, SearchResultPollResult31Builder> {
  SearchResultPollResult31._();

  factory SearchResultPollResult31([updates(SearchResultPollResult31Builder b)]) =
  ...
  BuiltList<VehicleInfoList31> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap31> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap31> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups31> get filterGroups;
  ...
  static Serializer<SearchResultPollResult31> get serializer =>
      _$searchResultPollResult31Serializer;
}

abstract class VehicleInfoList31
    implements Built<VehicleInfoList31, VehicleInfoList31Builder> {
  VehicleInfoList31._();

  factory VehicleInfoList31([updates(VehicleInfoList31Builder b)]) =
      _$VehicleInfoList31;
  ...
  BuiltList<Packages31> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic31> get options;
  ...
  static Serializer<VehicleInfoList31> get serializer =>
      _$vehicleInfoList31Serializer;
}

abstract class VehicleCharacteristic31
    implements Built<VehicleCharacteristic31, VehicleCharacteristic31Builder> {
  VehicleCharacteristic31._();

  factory VehicleCharacteristic31([updates(VehicleCharacteristic31Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic31> get serializer =>
      _$vehicleCharacteristic31Serializer;
}

abstract class Service31 implements Built<Service31, Service31Builder> {
  Service31._();

  factory Service31([updates(Service31Builder b)]) = _$Service31;
  ...
  static Serializer<Service31> get serializer => _$service31Serializer;
}

abstract class Price31 implements Built<Price31, Price31Builder> {
  Price31._();

  factory Price31([updates(Price31Builder b)]) = _$Price31;
  ...
  static Serializer<Price31> get serializer => _$price31Serializer;
}

abstract class Packages31 implements Built<Packages31, Packages31Builder> {
  Packages31._();

  factory Packages31([updates(Packages31Builder b)]) = _$Packages31;
  ...
  PackageLabelInfo31 get packageLabelInfo;

  static Serializer<Packages31> get serializer => _$packages31Serializer;
}

abstract class Coverage31 implements Built<Coverage31, Coverage31Builder> {
  Coverage31._();

  factory Coverage31([updates(Coverage31Builder b)]) = _$Coverage31;
  ...
  InsuredPerson31 get insuredPerson;
  ...
  BuiltList<SubInsurances31> get subInsurances;

  static Serializer<Coverage31> get serializer => _$coverage31Serializer;
}

abstract class InsuredPerson31
    implements Built<InsuredPerson31, InsuredPerson31Builder> {
  InsuredPerson31._();

  factory InsuredPerson31([updates(InsuredPerson31Builder b)]) = _$InsuredPerson31;
  ...
  static Serializer<InsuredPerson31> get serializer => _$insuredPerson31Serializer;
}

abstract class SubInsurances31
    implements Built<SubInsurances31, SubInsurances31Builder> {
  SubInsurances31._();

  factory SubInsurances31([updates(SubInsurances31Builder b)]) = _$SubInsurances31;
  ...
  static Serializer<SubInsurances31> get serializer => _$subInsurances31Serializer;
}

abstract class ShopMap31 implements Built<ShopMap31, ShopMap31Builder> {
  ShopMap31._();

  factory ShopMap31([updates(ShopMap31Builder b)]) = _$ShopMap31;
  ...
  static Serializer<ShopMap31> get serializer => _$shopMap31Serializer;
}

abstract class SupplierMap31 implements Built<SupplierMap31, SupplierMap31Builder> {
  SupplierMap31._();

  factory SupplierMap31([updates(SupplierMap31Builder b)]) = _$SupplierMap31;
  ...
  static Serializer<SupplierMap31> get serializer => _$supplierMap31Serializer;
}

abstract class FilterGroups31
    implements Built<FilterGroups31, FilterGroups31Builder> {
  FilterGroups31._();

  factory FilterGroups31([updates(FilterGroups31Builder b)]) = _$FilterGroups31;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options31> get options;

  static Serializer<FilterGroups31> get serializer => _$filterGroups31Serializer;
}

abstract class Options31 implements Built<Options31, Options31Builder> {
  Options31._();

  factory Options31([updates(Options31Builder b)]) = _$Options31;
  ...
  static Serializer<Options31> get serializer => _$options31Serializer;
}

abstract class PackageLabelInfo31
    implements Built<PackageLabelInfo31, PackageLabelInfo31Builder> {
  PackageLabelInfo31._();

  factory PackageLabelInfo31([updates(PackageLabelInfo31Builder b)]) =
      _$PackageLabelInfo31;
  ...
  static Serializer<PackageLabelInfo31> get serializer =>
      _$packageLabelInfo31Serializer;
}

abstract class ActivityList31
    implements Built<ActivityList31, ActivityList31Builder> {
  ActivityList31._();

  factory ActivityList31([update(ActivityList31Builder b)]) = _$ActivityList31;
  ...
  CardTags31 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList31> get serializer => _$activityList31Serializer;
}

abstract class CardTags31 implements Built<CardTags31, CardTags31Builder> {
  CardTags31._();

  factory CardTags31([update(CardTags31Builder b)]) = _$CardTags31;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags31> get serializer => _$cardTags31Serializer;
}
