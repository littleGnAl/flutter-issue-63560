...
part 'generated_search_result_poll_result74.g.dart';

abstract class SearchResultPollResult74
    implements Built<SearchResultPollResult74, SearchResultPollResult74Builder> {
  SearchResultPollResult74._();

  factory SearchResultPollResult74([updates(SearchResultPollResult74Builder b)]) =
  ...
  BuiltList<VehicleInfoList74> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap74> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap74> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups74> get filterGroups;
  ...
  static Serializer<SearchResultPollResult74> get serializer =>
      _$searchResultPollResult74Serializer;
}

abstract class VehicleInfoList74
    implements Built<VehicleInfoList74, VehicleInfoList74Builder> {
  VehicleInfoList74._();

  factory VehicleInfoList74([updates(VehicleInfoList74Builder b)]) =
      _$VehicleInfoList74;
  ...
  BuiltList<Packages74> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic74> get options;
  ...
  static Serializer<VehicleInfoList74> get serializer =>
      _$vehicleInfoList74Serializer;
}

abstract class VehicleCharacteristic74
    implements Built<VehicleCharacteristic74, VehicleCharacteristic74Builder> {
  VehicleCharacteristic74._();

  factory VehicleCharacteristic74([updates(VehicleCharacteristic74Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic74> get serializer =>
      _$vehicleCharacteristic74Serializer;
}

abstract class Service74 implements Built<Service74, Service74Builder> {
  Service74._();

  factory Service74([updates(Service74Builder b)]) = _$Service74;
  ...
  static Serializer<Service74> get serializer => _$service74Serializer;
}

abstract class Price74 implements Built<Price74, Price74Builder> {
  Price74._();

  factory Price74([updates(Price74Builder b)]) = _$Price74;
  ...
  static Serializer<Price74> get serializer => _$price74Serializer;
}

abstract class Packages74 implements Built<Packages74, Packages74Builder> {
  Packages74._();

  factory Packages74([updates(Packages74Builder b)]) = _$Packages74;
  ...
  PackageLabelInfo74 get packageLabelInfo;

  static Serializer<Packages74> get serializer => _$packages74Serializer;
}

abstract class Coverage74 implements Built<Coverage74, Coverage74Builder> {
  Coverage74._();

  factory Coverage74([updates(Coverage74Builder b)]) = _$Coverage74;
  ...
  InsuredPerson74 get insuredPerson;
  ...
  BuiltList<SubInsurances74> get subInsurances;

  static Serializer<Coverage74> get serializer => _$coverage74Serializer;
}

abstract class InsuredPerson74
    implements Built<InsuredPerson74, InsuredPerson74Builder> {
  InsuredPerson74._();

  factory InsuredPerson74([updates(InsuredPerson74Builder b)]) = _$InsuredPerson74;
  ...
  static Serializer<InsuredPerson74> get serializer => _$insuredPerson74Serializer;
}

abstract class SubInsurances74
    implements Built<SubInsurances74, SubInsurances74Builder> {
  SubInsurances74._();

  factory SubInsurances74([updates(SubInsurances74Builder b)]) = _$SubInsurances74;
  ...
  static Serializer<SubInsurances74> get serializer => _$subInsurances74Serializer;
}

abstract class ShopMap74 implements Built<ShopMap74, ShopMap74Builder> {
  ShopMap74._();

  factory ShopMap74([updates(ShopMap74Builder b)]) = _$ShopMap74;
  ...
  static Serializer<ShopMap74> get serializer => _$shopMap74Serializer;
}

abstract class SupplierMap74 implements Built<SupplierMap74, SupplierMap74Builder> {
  SupplierMap74._();

  factory SupplierMap74([updates(SupplierMap74Builder b)]) = _$SupplierMap74;
  ...
  static Serializer<SupplierMap74> get serializer => _$supplierMap74Serializer;
}

abstract class FilterGroups74
    implements Built<FilterGroups74, FilterGroups74Builder> {
  FilterGroups74._();

  factory FilterGroups74([updates(FilterGroups74Builder b)]) = _$FilterGroups74;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options74> get options;

  static Serializer<FilterGroups74> get serializer => _$filterGroups74Serializer;
}

abstract class Options74 implements Built<Options74, Options74Builder> {
  Options74._();

  factory Options74([updates(Options74Builder b)]) = _$Options74;
  ...
  static Serializer<Options74> get serializer => _$options74Serializer;
}

abstract class PackageLabelInfo74
    implements Built<PackageLabelInfo74, PackageLabelInfo74Builder> {
  PackageLabelInfo74._();

  factory PackageLabelInfo74([updates(PackageLabelInfo74Builder b)]) =
      _$PackageLabelInfo74;
  ...
  static Serializer<PackageLabelInfo74> get serializer =>
      _$packageLabelInfo74Serializer;
}

abstract class ActivityList74
    implements Built<ActivityList74, ActivityList74Builder> {
  ActivityList74._();

  factory ActivityList74([update(ActivityList74Builder b)]) = _$ActivityList74;
  ...
  CardTags74 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList74> get serializer => _$activityList74Serializer;
}

abstract class CardTags74 implements Built<CardTags74, CardTags74Builder> {
  CardTags74._();

  factory CardTags74([update(CardTags74Builder b)]) = _$CardTags74;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags74> get serializer => _$cardTags74Serializer;
}
