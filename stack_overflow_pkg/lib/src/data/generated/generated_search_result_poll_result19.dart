...
part 'generated_search_result_poll_result19.g.dart';

abstract class SearchResultPollResult19
    implements Built<SearchResultPollResult19, SearchResultPollResult19Builder> {
  SearchResultPollResult19._();

  factory SearchResultPollResult19([updates(SearchResultPollResult19Builder b)]) =
  ...
  BuiltList<VehicleInfoList19> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap19> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap19> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups19> get filterGroups;
  ...
  static Serializer<SearchResultPollResult19> get serializer =>
      _$searchResultPollResult19Serializer;
}

abstract class VehicleInfoList19
    implements Built<VehicleInfoList19, VehicleInfoList19Builder> {
  VehicleInfoList19._();

  factory VehicleInfoList19([updates(VehicleInfoList19Builder b)]) =
      _$VehicleInfoList19;
  ...
  BuiltList<Packages19> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic19> get options;
  ...
  static Serializer<VehicleInfoList19> get serializer =>
      _$vehicleInfoList19Serializer;
}

abstract class VehicleCharacteristic19
    implements Built<VehicleCharacteristic19, VehicleCharacteristic19Builder> {
  VehicleCharacteristic19._();

  factory VehicleCharacteristic19([updates(VehicleCharacteristic19Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic19> get serializer =>
      _$vehicleCharacteristic19Serializer;
}

abstract class Service19 implements Built<Service19, Service19Builder> {
  Service19._();

  factory Service19([updates(Service19Builder b)]) = _$Service19;
  ...
  static Serializer<Service19> get serializer => _$service19Serializer;
}

abstract class Price19 implements Built<Price19, Price19Builder> {
  Price19._();

  factory Price19([updates(Price19Builder b)]) = _$Price19;
  ...
  static Serializer<Price19> get serializer => _$price19Serializer;
}

abstract class Packages19 implements Built<Packages19, Packages19Builder> {
  Packages19._();

  factory Packages19([updates(Packages19Builder b)]) = _$Packages19;
  ...
  PackageLabelInfo19 get packageLabelInfo;

  static Serializer<Packages19> get serializer => _$packages19Serializer;
}

abstract class Coverage19 implements Built<Coverage19, Coverage19Builder> {
  Coverage19._();

  factory Coverage19([updates(Coverage19Builder b)]) = _$Coverage19;
  ...
  InsuredPerson19 get insuredPerson;
  ...
  BuiltList<SubInsurances19> get subInsurances;

  static Serializer<Coverage19> get serializer => _$coverage19Serializer;
}

abstract class InsuredPerson19
    implements Built<InsuredPerson19, InsuredPerson19Builder> {
  InsuredPerson19._();

  factory InsuredPerson19([updates(InsuredPerson19Builder b)]) = _$InsuredPerson19;
  ...
  static Serializer<InsuredPerson19> get serializer => _$insuredPerson19Serializer;
}

abstract class SubInsurances19
    implements Built<SubInsurances19, SubInsurances19Builder> {
  SubInsurances19._();

  factory SubInsurances19([updates(SubInsurances19Builder b)]) = _$SubInsurances19;
  ...
  static Serializer<SubInsurances19> get serializer => _$subInsurances19Serializer;
}

abstract class ShopMap19 implements Built<ShopMap19, ShopMap19Builder> {
  ShopMap19._();

  factory ShopMap19([updates(ShopMap19Builder b)]) = _$ShopMap19;
  ...
  static Serializer<ShopMap19> get serializer => _$shopMap19Serializer;
}

abstract class SupplierMap19 implements Built<SupplierMap19, SupplierMap19Builder> {
  SupplierMap19._();

  factory SupplierMap19([updates(SupplierMap19Builder b)]) = _$SupplierMap19;
  ...
  static Serializer<SupplierMap19> get serializer => _$supplierMap19Serializer;
}

abstract class FilterGroups19
    implements Built<FilterGroups19, FilterGroups19Builder> {
  FilterGroups19._();

  factory FilterGroups19([updates(FilterGroups19Builder b)]) = _$FilterGroups19;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options19> get options;

  static Serializer<FilterGroups19> get serializer => _$filterGroups19Serializer;
}

abstract class Options19 implements Built<Options19, Options19Builder> {
  Options19._();

  factory Options19([updates(Options19Builder b)]) = _$Options19;
  ...
  static Serializer<Options19> get serializer => _$options19Serializer;
}

abstract class PackageLabelInfo19
    implements Built<PackageLabelInfo19, PackageLabelInfo19Builder> {
  PackageLabelInfo19._();

  factory PackageLabelInfo19([updates(PackageLabelInfo19Builder b)]) =
      _$PackageLabelInfo19;
  ...
  static Serializer<PackageLabelInfo19> get serializer =>
      _$packageLabelInfo19Serializer;
}

abstract class ActivityList19
    implements Built<ActivityList19, ActivityList19Builder> {
  ActivityList19._();

  factory ActivityList19([update(ActivityList19Builder b)]) = _$ActivityList19;
  ...
  CardTags19 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList19> get serializer => _$activityList19Serializer;
}

abstract class CardTags19 implements Built<CardTags19, CardTags19Builder> {
  CardTags19._();

  factory CardTags19([update(CardTags19Builder b)]) = _$CardTags19;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags19> get serializer => _$cardTags19Serializer;
}
