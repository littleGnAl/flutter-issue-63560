...
part 'generated_search_result_poll_result96.g.dart';

abstract class SearchResultPollResult96
    implements Built<SearchResultPollResult96, SearchResultPollResult96Builder> {
  SearchResultPollResult96._();

  factory SearchResultPollResult96([updates(SearchResultPollResult96Builder b)]) =
  ...
  BuiltList<VehicleInfoList96> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap96> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap96> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups96> get filterGroups;
  ...
  static Serializer<SearchResultPollResult96> get serializer =>
      _$searchResultPollResult96Serializer;
}

abstract class VehicleInfoList96
    implements Built<VehicleInfoList96, VehicleInfoList96Builder> {
  VehicleInfoList96._();

  factory VehicleInfoList96([updates(VehicleInfoList96Builder b)]) =
      _$VehicleInfoList96;
  ...
  BuiltList<Packages96> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic96> get options;
  ...
  static Serializer<VehicleInfoList96> get serializer =>
      _$vehicleInfoList96Serializer;
}

abstract class VehicleCharacteristic96
    implements Built<VehicleCharacteristic96, VehicleCharacteristic96Builder> {
  VehicleCharacteristic96._();

  factory VehicleCharacteristic96([updates(VehicleCharacteristic96Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic96> get serializer =>
      _$vehicleCharacteristic96Serializer;
}

abstract class Service96 implements Built<Service96, Service96Builder> {
  Service96._();

  factory Service96([updates(Service96Builder b)]) = _$Service96;
  ...
  static Serializer<Service96> get serializer => _$service96Serializer;
}

abstract class Price96 implements Built<Price96, Price96Builder> {
  Price96._();

  factory Price96([updates(Price96Builder b)]) = _$Price96;
  ...
  static Serializer<Price96> get serializer => _$price96Serializer;
}

abstract class Packages96 implements Built<Packages96, Packages96Builder> {
  Packages96._();

  factory Packages96([updates(Packages96Builder b)]) = _$Packages96;
  ...
  PackageLabelInfo96 get packageLabelInfo;

  static Serializer<Packages96> get serializer => _$packages96Serializer;
}

abstract class Coverage96 implements Built<Coverage96, Coverage96Builder> {
  Coverage96._();

  factory Coverage96([updates(Coverage96Builder b)]) = _$Coverage96;
  ...
  InsuredPerson96 get insuredPerson;
  ...
  BuiltList<SubInsurances96> get subInsurances;

  static Serializer<Coverage96> get serializer => _$coverage96Serializer;
}

abstract class InsuredPerson96
    implements Built<InsuredPerson96, InsuredPerson96Builder> {
  InsuredPerson96._();

  factory InsuredPerson96([updates(InsuredPerson96Builder b)]) = _$InsuredPerson96;
  ...
  static Serializer<InsuredPerson96> get serializer => _$insuredPerson96Serializer;
}

abstract class SubInsurances96
    implements Built<SubInsurances96, SubInsurances96Builder> {
  SubInsurances96._();

  factory SubInsurances96([updates(SubInsurances96Builder b)]) = _$SubInsurances96;
  ...
  static Serializer<SubInsurances96> get serializer => _$subInsurances96Serializer;
}

abstract class ShopMap96 implements Built<ShopMap96, ShopMap96Builder> {
  ShopMap96._();

  factory ShopMap96([updates(ShopMap96Builder b)]) = _$ShopMap96;
  ...
  static Serializer<ShopMap96> get serializer => _$shopMap96Serializer;
}

abstract class SupplierMap96 implements Built<SupplierMap96, SupplierMap96Builder> {
  SupplierMap96._();

  factory SupplierMap96([updates(SupplierMap96Builder b)]) = _$SupplierMap96;
  ...
  static Serializer<SupplierMap96> get serializer => _$supplierMap96Serializer;
}

abstract class FilterGroups96
    implements Built<FilterGroups96, FilterGroups96Builder> {
  FilterGroups96._();

  factory FilterGroups96([updates(FilterGroups96Builder b)]) = _$FilterGroups96;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options96> get options;

  static Serializer<FilterGroups96> get serializer => _$filterGroups96Serializer;
}

abstract class Options96 implements Built<Options96, Options96Builder> {
  Options96._();

  factory Options96([updates(Options96Builder b)]) = _$Options96;
  ...
  static Serializer<Options96> get serializer => _$options96Serializer;
}

abstract class PackageLabelInfo96
    implements Built<PackageLabelInfo96, PackageLabelInfo96Builder> {
  PackageLabelInfo96._();

  factory PackageLabelInfo96([updates(PackageLabelInfo96Builder b)]) =
      _$PackageLabelInfo96;
  ...
  static Serializer<PackageLabelInfo96> get serializer =>
      _$packageLabelInfo96Serializer;
}

abstract class ActivityList96
    implements Built<ActivityList96, ActivityList96Builder> {
  ActivityList96._();

  factory ActivityList96([update(ActivityList96Builder b)]) = _$ActivityList96;
  ...
  CardTags96 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList96> get serializer => _$activityList96Serializer;
}

abstract class CardTags96 implements Built<CardTags96, CardTags96Builder> {
  CardTags96._();

  factory CardTags96([update(CardTags96Builder b)]) = _$CardTags96;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags96> get serializer => _$cardTags96Serializer;
}
