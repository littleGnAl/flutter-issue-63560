...
part 'generated_search_result_poll_result62.g.dart';

abstract class SearchResultPollResult62
    implements Built<SearchResultPollResult62, SearchResultPollResult62Builder> {
  SearchResultPollResult62._();

  factory SearchResultPollResult62([updates(SearchResultPollResult62Builder b)]) =
  ...
  BuiltList<VehicleInfoList62> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap62> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap62> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups62> get filterGroups;
  ...
  static Serializer<SearchResultPollResult62> get serializer =>
      _$searchResultPollResult62Serializer;
}

abstract class VehicleInfoList62
    implements Built<VehicleInfoList62, VehicleInfoList62Builder> {
  VehicleInfoList62._();

  factory VehicleInfoList62([updates(VehicleInfoList62Builder b)]) =
      _$VehicleInfoList62;
  ...
  BuiltList<Packages62> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic62> get options;
  ...
  static Serializer<VehicleInfoList62> get serializer =>
      _$vehicleInfoList62Serializer;
}

abstract class VehicleCharacteristic62
    implements Built<VehicleCharacteristic62, VehicleCharacteristic62Builder> {
  VehicleCharacteristic62._();

  factory VehicleCharacteristic62([updates(VehicleCharacteristic62Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic62> get serializer =>
      _$vehicleCharacteristic62Serializer;
}

abstract class Service62 implements Built<Service62, Service62Builder> {
  Service62._();

  factory Service62([updates(Service62Builder b)]) = _$Service62;
  ...
  static Serializer<Service62> get serializer => _$service62Serializer;
}

abstract class Price62 implements Built<Price62, Price62Builder> {
  Price62._();

  factory Price62([updates(Price62Builder b)]) = _$Price62;
  ...
  static Serializer<Price62> get serializer => _$price62Serializer;
}

abstract class Packages62 implements Built<Packages62, Packages62Builder> {
  Packages62._();

  factory Packages62([updates(Packages62Builder b)]) = _$Packages62;
  ...
  PackageLabelInfo62 get packageLabelInfo;

  static Serializer<Packages62> get serializer => _$packages62Serializer;
}

abstract class Coverage62 implements Built<Coverage62, Coverage62Builder> {
  Coverage62._();

  factory Coverage62([updates(Coverage62Builder b)]) = _$Coverage62;
  ...
  InsuredPerson62 get insuredPerson;
  ...
  BuiltList<SubInsurances62> get subInsurances;

  static Serializer<Coverage62> get serializer => _$coverage62Serializer;
}

abstract class InsuredPerson62
    implements Built<InsuredPerson62, InsuredPerson62Builder> {
  InsuredPerson62._();

  factory InsuredPerson62([updates(InsuredPerson62Builder b)]) = _$InsuredPerson62;
  ...
  static Serializer<InsuredPerson62> get serializer => _$insuredPerson62Serializer;
}

abstract class SubInsurances62
    implements Built<SubInsurances62, SubInsurances62Builder> {
  SubInsurances62._();

  factory SubInsurances62([updates(SubInsurances62Builder b)]) = _$SubInsurances62;
  ...
  static Serializer<SubInsurances62> get serializer => _$subInsurances62Serializer;
}

abstract class ShopMap62 implements Built<ShopMap62, ShopMap62Builder> {
  ShopMap62._();

  factory ShopMap62([updates(ShopMap62Builder b)]) = _$ShopMap62;
  ...
  static Serializer<ShopMap62> get serializer => _$shopMap62Serializer;
}

abstract class SupplierMap62 implements Built<SupplierMap62, SupplierMap62Builder> {
  SupplierMap62._();

  factory SupplierMap62([updates(SupplierMap62Builder b)]) = _$SupplierMap62;
  ...
  static Serializer<SupplierMap62> get serializer => _$supplierMap62Serializer;
}

abstract class FilterGroups62
    implements Built<FilterGroups62, FilterGroups62Builder> {
  FilterGroups62._();

  factory FilterGroups62([updates(FilterGroups62Builder b)]) = _$FilterGroups62;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options62> get options;

  static Serializer<FilterGroups62> get serializer => _$filterGroups62Serializer;
}

abstract class Options62 implements Built<Options62, Options62Builder> {
  Options62._();

  factory Options62([updates(Options62Builder b)]) = _$Options62;
  ...
  static Serializer<Options62> get serializer => _$options62Serializer;
}

abstract class PackageLabelInfo62
    implements Built<PackageLabelInfo62, PackageLabelInfo62Builder> {
  PackageLabelInfo62._();

  factory PackageLabelInfo62([updates(PackageLabelInfo62Builder b)]) =
      _$PackageLabelInfo62;
  ...
  static Serializer<PackageLabelInfo62> get serializer =>
      _$packageLabelInfo62Serializer;
}

abstract class ActivityList62
    implements Built<ActivityList62, ActivityList62Builder> {
  ActivityList62._();

  factory ActivityList62([update(ActivityList62Builder b)]) = _$ActivityList62;
  ...
  CardTags62 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList62> get serializer => _$activityList62Serializer;
}

abstract class CardTags62 implements Built<CardTags62, CardTags62Builder> {
  CardTags62._();

  factory CardTags62([update(CardTags62Builder b)]) = _$CardTags62;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags62> get serializer => _$cardTags62Serializer;
}
