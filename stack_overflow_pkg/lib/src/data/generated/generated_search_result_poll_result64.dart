...
part 'generated_search_result_poll_result64.g.dart';

abstract class SearchResultPollResult64
    implements Built<SearchResultPollResult64, SearchResultPollResult64Builder> {
  SearchResultPollResult64._();

  factory SearchResultPollResult64([updates(SearchResultPollResult64Builder b)]) =
  ...
  BuiltList<VehicleInfoList64> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap64> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap64> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups64> get filterGroups;
  ...
  static Serializer<SearchResultPollResult64> get serializer =>
      _$searchResultPollResult64Serializer;
}

abstract class VehicleInfoList64
    implements Built<VehicleInfoList64, VehicleInfoList64Builder> {
  VehicleInfoList64._();

  factory VehicleInfoList64([updates(VehicleInfoList64Builder b)]) =
      _$VehicleInfoList64;
  ...
  BuiltList<Packages64> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic64> get options;
  ...
  static Serializer<VehicleInfoList64> get serializer =>
      _$vehicleInfoList64Serializer;
}

abstract class VehicleCharacteristic64
    implements Built<VehicleCharacteristic64, VehicleCharacteristic64Builder> {
  VehicleCharacteristic64._();

  factory VehicleCharacteristic64([updates(VehicleCharacteristic64Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic64> get serializer =>
      _$vehicleCharacteristic64Serializer;
}

abstract class Service64 implements Built<Service64, Service64Builder> {
  Service64._();

  factory Service64([updates(Service64Builder b)]) = _$Service64;
  ...
  static Serializer<Service64> get serializer => _$service64Serializer;
}

abstract class Price64 implements Built<Price64, Price64Builder> {
  Price64._();

  factory Price64([updates(Price64Builder b)]) = _$Price64;
  ...
  static Serializer<Price64> get serializer => _$price64Serializer;
}

abstract class Packages64 implements Built<Packages64, Packages64Builder> {
  Packages64._();

  factory Packages64([updates(Packages64Builder b)]) = _$Packages64;
  ...
  PackageLabelInfo64 get packageLabelInfo;

  static Serializer<Packages64> get serializer => _$packages64Serializer;
}

abstract class Coverage64 implements Built<Coverage64, Coverage64Builder> {
  Coverage64._();

  factory Coverage64([updates(Coverage64Builder b)]) = _$Coverage64;
  ...
  InsuredPerson64 get insuredPerson;
  ...
  BuiltList<SubInsurances64> get subInsurances;

  static Serializer<Coverage64> get serializer => _$coverage64Serializer;
}

abstract class InsuredPerson64
    implements Built<InsuredPerson64, InsuredPerson64Builder> {
  InsuredPerson64._();

  factory InsuredPerson64([updates(InsuredPerson64Builder b)]) = _$InsuredPerson64;
  ...
  static Serializer<InsuredPerson64> get serializer => _$insuredPerson64Serializer;
}

abstract class SubInsurances64
    implements Built<SubInsurances64, SubInsurances64Builder> {
  SubInsurances64._();

  factory SubInsurances64([updates(SubInsurances64Builder b)]) = _$SubInsurances64;
  ...
  static Serializer<SubInsurances64> get serializer => _$subInsurances64Serializer;
}

abstract class ShopMap64 implements Built<ShopMap64, ShopMap64Builder> {
  ShopMap64._();

  factory ShopMap64([updates(ShopMap64Builder b)]) = _$ShopMap64;
  ...
  static Serializer<ShopMap64> get serializer => _$shopMap64Serializer;
}

abstract class SupplierMap64 implements Built<SupplierMap64, SupplierMap64Builder> {
  SupplierMap64._();

  factory SupplierMap64([updates(SupplierMap64Builder b)]) = _$SupplierMap64;
  ...
  static Serializer<SupplierMap64> get serializer => _$supplierMap64Serializer;
}

abstract class FilterGroups64
    implements Built<FilterGroups64, FilterGroups64Builder> {
  FilterGroups64._();

  factory FilterGroups64([updates(FilterGroups64Builder b)]) = _$FilterGroups64;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options64> get options;

  static Serializer<FilterGroups64> get serializer => _$filterGroups64Serializer;
}

abstract class Options64 implements Built<Options64, Options64Builder> {
  Options64._();

  factory Options64([updates(Options64Builder b)]) = _$Options64;
  ...
  static Serializer<Options64> get serializer => _$options64Serializer;
}

abstract class PackageLabelInfo64
    implements Built<PackageLabelInfo64, PackageLabelInfo64Builder> {
  PackageLabelInfo64._();

  factory PackageLabelInfo64([updates(PackageLabelInfo64Builder b)]) =
      _$PackageLabelInfo64;
  ...
  static Serializer<PackageLabelInfo64> get serializer =>
      _$packageLabelInfo64Serializer;
}

abstract class ActivityList64
    implements Built<ActivityList64, ActivityList64Builder> {
  ActivityList64._();

  factory ActivityList64([update(ActivityList64Builder b)]) = _$ActivityList64;
  ...
  CardTags64 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList64> get serializer => _$activityList64Serializer;
}

abstract class CardTags64 implements Built<CardTags64, CardTags64Builder> {
  CardTags64._();

  factory CardTags64([update(CardTags64Builder b)]) = _$CardTags64;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags64> get serializer => _$cardTags64Serializer;
}

@SerializersFor([
  SearchResultPollResult64,
])
final Serializers serializers64 = _$serializers64;
