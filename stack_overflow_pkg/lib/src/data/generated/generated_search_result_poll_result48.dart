...
part 'generated_search_result_poll_result48.g.dart';

abstract class SearchResultPollResult48
    implements Built<SearchResultPollResult48, SearchResultPollResult48Builder> {
  SearchResultPollResult48._();

  factory SearchResultPollResult48([updates(SearchResultPollResult48Builder b)]) =
  ...
  BuiltList<VehicleInfoList48> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap48> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap48> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups48> get filterGroups;
  ...
  static Serializer<SearchResultPollResult48> get serializer =>
      _$searchResultPollResult48Serializer;
}

abstract class VehicleInfoList48
    implements Built<VehicleInfoList48, VehicleInfoList48Builder> {
  VehicleInfoList48._();

  factory VehicleInfoList48([updates(VehicleInfoList48Builder b)]) =
      _$VehicleInfoList48;
  ...
  BuiltList<Packages48> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic48> get options;
  ...
  static Serializer<VehicleInfoList48> get serializer =>
      _$vehicleInfoList48Serializer;
}

abstract class VehicleCharacteristic48
    implements Built<VehicleCharacteristic48, VehicleCharacteristic48Builder> {
  VehicleCharacteristic48._();

  factory VehicleCharacteristic48([updates(VehicleCharacteristic48Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic48> get serializer =>
      _$vehicleCharacteristic48Serializer;
}

abstract class Service48 implements Built<Service48, Service48Builder> {
  Service48._();

  factory Service48([updates(Service48Builder b)]) = _$Service48;
  ...
  static Serializer<Service48> get serializer => _$service48Serializer;
}

abstract class Price48 implements Built<Price48, Price48Builder> {
  Price48._();

  factory Price48([updates(Price48Builder b)]) = _$Price48;
  ...
  static Serializer<Price48> get serializer => _$price48Serializer;
}

abstract class Packages48 implements Built<Packages48, Packages48Builder> {
  Packages48._();

  factory Packages48([updates(Packages48Builder b)]) = _$Packages48;
  ...
  PackageLabelInfo48 get packageLabelInfo;

  static Serializer<Packages48> get serializer => _$packages48Serializer;
}

abstract class Coverage48 implements Built<Coverage48, Coverage48Builder> {
  Coverage48._();

  factory Coverage48([updates(Coverage48Builder b)]) = _$Coverage48;
  ...
  InsuredPerson48 get insuredPerson;
  ...
  BuiltList<SubInsurances48> get subInsurances;

  static Serializer<Coverage48> get serializer => _$coverage48Serializer;
}

abstract class InsuredPerson48
    implements Built<InsuredPerson48, InsuredPerson48Builder> {
  InsuredPerson48._();

  factory InsuredPerson48([updates(InsuredPerson48Builder b)]) = _$InsuredPerson48;
  ...
  static Serializer<InsuredPerson48> get serializer => _$insuredPerson48Serializer;
}

abstract class SubInsurances48
    implements Built<SubInsurances48, SubInsurances48Builder> {
  SubInsurances48._();

  factory SubInsurances48([updates(SubInsurances48Builder b)]) = _$SubInsurances48;
  ...
  static Serializer<SubInsurances48> get serializer => _$subInsurances48Serializer;
}

abstract class ShopMap48 implements Built<ShopMap48, ShopMap48Builder> {
  ShopMap48._();

  factory ShopMap48([updates(ShopMap48Builder b)]) = _$ShopMap48;
  ...
  static Serializer<ShopMap48> get serializer => _$shopMap48Serializer;
}

abstract class SupplierMap48 implements Built<SupplierMap48, SupplierMap48Builder> {
  SupplierMap48._();

  factory SupplierMap48([updates(SupplierMap48Builder b)]) = _$SupplierMap48;
  ...
  static Serializer<SupplierMap48> get serializer => _$supplierMap48Serializer;
}

abstract class FilterGroups48
    implements Built<FilterGroups48, FilterGroups48Builder> {
  FilterGroups48._();

  factory FilterGroups48([updates(FilterGroups48Builder b)]) = _$FilterGroups48;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options48> get options;

  static Serializer<FilterGroups48> get serializer => _$filterGroups48Serializer;
}

abstract class Options48 implements Built<Options48, Options48Builder> {
  Options48._();

  factory Options48([updates(Options48Builder b)]) = _$Options48;
  ...
  static Serializer<Options48> get serializer => _$options48Serializer;
}

abstract class PackageLabelInfo48
    implements Built<PackageLabelInfo48, PackageLabelInfo48Builder> {
  PackageLabelInfo48._();

  factory PackageLabelInfo48([updates(PackageLabelInfo48Builder b)]) =
      _$PackageLabelInfo48;
  ...
  static Serializer<PackageLabelInfo48> get serializer =>
      _$packageLabelInfo48Serializer;
}

abstract class ActivityList48
    implements Built<ActivityList48, ActivityList48Builder> {
  ActivityList48._();

  factory ActivityList48([update(ActivityList48Builder b)]) = _$ActivityList48;
  ...
  CardTags48 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList48> get serializer => _$activityList48Serializer;
}

abstract class CardTags48 implements Built<CardTags48, CardTags48Builder> {
  CardTags48._();

  factory CardTags48([update(CardTags48Builder b)]) = _$CardTags48;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags48> get serializer => _$cardTags48Serializer;
}

@SerializersFor([
  SearchResultPollResult48,
])
final Serializers serializers48 = _$serializers48;
