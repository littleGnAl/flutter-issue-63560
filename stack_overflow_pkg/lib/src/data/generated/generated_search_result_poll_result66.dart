...
part 'generated_search_result_poll_result66.g.dart';

abstract class SearchResultPollResult66
    implements Built<SearchResultPollResult66, SearchResultPollResult66Builder> {
  SearchResultPollResult66._();

  factory SearchResultPollResult66([updates(SearchResultPollResult66Builder b)]) =
  ...
  BuiltList<VehicleInfoList66> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap66> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap66> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups66> get filterGroups;
  ...
  static Serializer<SearchResultPollResult66> get serializer =>
      _$searchResultPollResult66Serializer;
}

abstract class VehicleInfoList66
    implements Built<VehicleInfoList66, VehicleInfoList66Builder> {
  VehicleInfoList66._();

  factory VehicleInfoList66([updates(VehicleInfoList66Builder b)]) =
      _$VehicleInfoList66;
  ...
  BuiltList<Packages66> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic66> get options;
  ...
  static Serializer<VehicleInfoList66> get serializer =>
      _$vehicleInfoList66Serializer;
}

abstract class VehicleCharacteristic66
    implements Built<VehicleCharacteristic66, VehicleCharacteristic66Builder> {
  VehicleCharacteristic66._();

  factory VehicleCharacteristic66([updates(VehicleCharacteristic66Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic66> get serializer =>
      _$vehicleCharacteristic66Serializer;
}

abstract class Service66 implements Built<Service66, Service66Builder> {
  Service66._();

  factory Service66([updates(Service66Builder b)]) = _$Service66;
  ...
  static Serializer<Service66> get serializer => _$service66Serializer;
}

abstract class Price66 implements Built<Price66, Price66Builder> {
  Price66._();

  factory Price66([updates(Price66Builder b)]) = _$Price66;
  ...
  static Serializer<Price66> get serializer => _$price66Serializer;
}

abstract class Packages66 implements Built<Packages66, Packages66Builder> {
  Packages66._();

  factory Packages66([updates(Packages66Builder b)]) = _$Packages66;
  ...
  PackageLabelInfo66 get packageLabelInfo;

  static Serializer<Packages66> get serializer => _$packages66Serializer;
}

abstract class Coverage66 implements Built<Coverage66, Coverage66Builder> {
  Coverage66._();

  factory Coverage66([updates(Coverage66Builder b)]) = _$Coverage66;
  ...
  InsuredPerson66 get insuredPerson;
  ...
  BuiltList<SubInsurances66> get subInsurances;

  static Serializer<Coverage66> get serializer => _$coverage66Serializer;
}

abstract class InsuredPerson66
    implements Built<InsuredPerson66, InsuredPerson66Builder> {
  InsuredPerson66._();

  factory InsuredPerson66([updates(InsuredPerson66Builder b)]) = _$InsuredPerson66;
  ...
  static Serializer<InsuredPerson66> get serializer => _$insuredPerson66Serializer;
}

abstract class SubInsurances66
    implements Built<SubInsurances66, SubInsurances66Builder> {
  SubInsurances66._();

  factory SubInsurances66([updates(SubInsurances66Builder b)]) = _$SubInsurances66;
  ...
  static Serializer<SubInsurances66> get serializer => _$subInsurances66Serializer;
}

abstract class ShopMap66 implements Built<ShopMap66, ShopMap66Builder> {
  ShopMap66._();

  factory ShopMap66([updates(ShopMap66Builder b)]) = _$ShopMap66;
  ...
  static Serializer<ShopMap66> get serializer => _$shopMap66Serializer;
}

abstract class SupplierMap66 implements Built<SupplierMap66, SupplierMap66Builder> {
  SupplierMap66._();

  factory SupplierMap66([updates(SupplierMap66Builder b)]) = _$SupplierMap66;
  ...
  static Serializer<SupplierMap66> get serializer => _$supplierMap66Serializer;
}

abstract class FilterGroups66
    implements Built<FilterGroups66, FilterGroups66Builder> {
  FilterGroups66._();

  factory FilterGroups66([updates(FilterGroups66Builder b)]) = _$FilterGroups66;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options66> get options;

  static Serializer<FilterGroups66> get serializer => _$filterGroups66Serializer;
}

abstract class Options66 implements Built<Options66, Options66Builder> {
  Options66._();

  factory Options66([updates(Options66Builder b)]) = _$Options66;
  ...
  static Serializer<Options66> get serializer => _$options66Serializer;
}

abstract class PackageLabelInfo66
    implements Built<PackageLabelInfo66, PackageLabelInfo66Builder> {
  PackageLabelInfo66._();

  factory PackageLabelInfo66([updates(PackageLabelInfo66Builder b)]) =
      _$PackageLabelInfo66;
  ...
  static Serializer<PackageLabelInfo66> get serializer =>
      _$packageLabelInfo66Serializer;
}

abstract class ActivityList66
    implements Built<ActivityList66, ActivityList66Builder> {
  ActivityList66._();

  factory ActivityList66([update(ActivityList66Builder b)]) = _$ActivityList66;
  ...
  CardTags66 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList66> get serializer => _$activityList66Serializer;
}

abstract class CardTags66 implements Built<CardTags66, CardTags66Builder> {
  CardTags66._();

  factory CardTags66([update(CardTags66Builder b)]) = _$CardTags66;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags66> get serializer => _$cardTags66Serializer;
}

@SerializersFor([
  SearchResultPollResult66,
])
final Serializers serializers66 = _$serializers66;
