...
part 'generated_search_result_poll_result29.g.dart';

abstract class SearchResultPollResult29
    implements Built<SearchResultPollResult29, SearchResultPollResult29Builder> {
  SearchResultPollResult29._();

  factory SearchResultPollResult29([updates(SearchResultPollResult29Builder b)]) =
  ...
  BuiltList<VehicleInfoList29> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap29> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap29> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups29> get filterGroups;
  ...
  static Serializer<SearchResultPollResult29> get serializer =>
      _$searchResultPollResult29Serializer;
}

abstract class VehicleInfoList29
    implements Built<VehicleInfoList29, VehicleInfoList29Builder> {
  VehicleInfoList29._();

  factory VehicleInfoList29([updates(VehicleInfoList29Builder b)]) =
      _$VehicleInfoList29;
  ...
  BuiltList<Packages29> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic29> get options;
  ...
  static Serializer<VehicleInfoList29> get serializer =>
      _$vehicleInfoList29Serializer;
}

abstract class VehicleCharacteristic29
    implements Built<VehicleCharacteristic29, VehicleCharacteristic29Builder> {
  VehicleCharacteristic29._();

  factory VehicleCharacteristic29([updates(VehicleCharacteristic29Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic29> get serializer =>
      _$vehicleCharacteristic29Serializer;
}

abstract class Service29 implements Built<Service29, Service29Builder> {
  Service29._();

  factory Service29([updates(Service29Builder b)]) = _$Service29;
  ...
  static Serializer<Service29> get serializer => _$service29Serializer;
}

abstract class Price29 implements Built<Price29, Price29Builder> {
  Price29._();

  factory Price29([updates(Price29Builder b)]) = _$Price29;
  ...
  static Serializer<Price29> get serializer => _$price29Serializer;
}

abstract class Packages29 implements Built<Packages29, Packages29Builder> {
  Packages29._();

  factory Packages29([updates(Packages29Builder b)]) = _$Packages29;
  ...
  PackageLabelInfo29 get packageLabelInfo;

  static Serializer<Packages29> get serializer => _$packages29Serializer;
}

abstract class Coverage29 implements Built<Coverage29, Coverage29Builder> {
  Coverage29._();

  factory Coverage29([updates(Coverage29Builder b)]) = _$Coverage29;
  ...
  InsuredPerson29 get insuredPerson;
  ...
  BuiltList<SubInsurances29> get subInsurances;

  static Serializer<Coverage29> get serializer => _$coverage29Serializer;
}

abstract class InsuredPerson29
    implements Built<InsuredPerson29, InsuredPerson29Builder> {
  InsuredPerson29._();

  factory InsuredPerson29([updates(InsuredPerson29Builder b)]) = _$InsuredPerson29;
  ...
  static Serializer<InsuredPerson29> get serializer => _$insuredPerson29Serializer;
}

abstract class SubInsurances29
    implements Built<SubInsurances29, SubInsurances29Builder> {
  SubInsurances29._();

  factory SubInsurances29([updates(SubInsurances29Builder b)]) = _$SubInsurances29;
  ...
  static Serializer<SubInsurances29> get serializer => _$subInsurances29Serializer;
}

abstract class ShopMap29 implements Built<ShopMap29, ShopMap29Builder> {
  ShopMap29._();

  factory ShopMap29([updates(ShopMap29Builder b)]) = _$ShopMap29;
  ...
  static Serializer<ShopMap29> get serializer => _$shopMap29Serializer;
}

abstract class SupplierMap29 implements Built<SupplierMap29, SupplierMap29Builder> {
  SupplierMap29._();

  factory SupplierMap29([updates(SupplierMap29Builder b)]) = _$SupplierMap29;
  ...
  static Serializer<SupplierMap29> get serializer => _$supplierMap29Serializer;
}

abstract class FilterGroups29
    implements Built<FilterGroups29, FilterGroups29Builder> {
  FilterGroups29._();

  factory FilterGroups29([updates(FilterGroups29Builder b)]) = _$FilterGroups29;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options29> get options;

  static Serializer<FilterGroups29> get serializer => _$filterGroups29Serializer;
}

abstract class Options29 implements Built<Options29, Options29Builder> {
  Options29._();

  factory Options29([updates(Options29Builder b)]) = _$Options29;
  ...
  static Serializer<Options29> get serializer => _$options29Serializer;
}

abstract class PackageLabelInfo29
    implements Built<PackageLabelInfo29, PackageLabelInfo29Builder> {
  PackageLabelInfo29._();

  factory PackageLabelInfo29([updates(PackageLabelInfo29Builder b)]) =
      _$PackageLabelInfo29;
  ...
  static Serializer<PackageLabelInfo29> get serializer =>
      _$packageLabelInfo29Serializer;
}

abstract class ActivityList29
    implements Built<ActivityList29, ActivityList29Builder> {
  ActivityList29._();

  factory ActivityList29([update(ActivityList29Builder b)]) = _$ActivityList29;
  ...
  CardTags29 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList29> get serializer => _$activityList29Serializer;
}

abstract class CardTags29 implements Built<CardTags29, CardTags29Builder> {
  CardTags29._();

  factory CardTags29([update(CardTags29Builder b)]) = _$CardTags29;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags29> get serializer => _$cardTags29Serializer;
}
