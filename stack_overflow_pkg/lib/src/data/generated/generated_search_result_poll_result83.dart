...
part 'generated_search_result_poll_result83.g.dart';

abstract class SearchResultPollResult83
    implements Built<SearchResultPollResult83, SearchResultPollResult83Builder> {
  SearchResultPollResult83._();

  factory SearchResultPollResult83([updates(SearchResultPollResult83Builder b)]) =
  ...
  BuiltList<VehicleInfoList83> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap83> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap83> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups83> get filterGroups;
  ...
  static Serializer<SearchResultPollResult83> get serializer =>
      _$searchResultPollResult83Serializer;
}

abstract class VehicleInfoList83
    implements Built<VehicleInfoList83, VehicleInfoList83Builder> {
  VehicleInfoList83._();

  factory VehicleInfoList83([updates(VehicleInfoList83Builder b)]) =
      _$VehicleInfoList83;
  ...
  BuiltList<Packages83> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic83> get options;
  ...
  static Serializer<VehicleInfoList83> get serializer =>
      _$vehicleInfoList83Serializer;
}

abstract class VehicleCharacteristic83
    implements Built<VehicleCharacteristic83, VehicleCharacteristic83Builder> {
  VehicleCharacteristic83._();

  factory VehicleCharacteristic83([updates(VehicleCharacteristic83Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic83> get serializer =>
      _$vehicleCharacteristic83Serializer;
}

abstract class Service83 implements Built<Service83, Service83Builder> {
  Service83._();

  factory Service83([updates(Service83Builder b)]) = _$Service83;
  ...
  static Serializer<Service83> get serializer => _$service83Serializer;
}

abstract class Price83 implements Built<Price83, Price83Builder> {
  Price83._();

  factory Price83([updates(Price83Builder b)]) = _$Price83;
  ...
  static Serializer<Price83> get serializer => _$price83Serializer;
}

abstract class Packages83 implements Built<Packages83, Packages83Builder> {
  Packages83._();

  factory Packages83([updates(Packages83Builder b)]) = _$Packages83;
  ...
  PackageLabelInfo83 get packageLabelInfo;

  static Serializer<Packages83> get serializer => _$packages83Serializer;
}

abstract class Coverage83 implements Built<Coverage83, Coverage83Builder> {
  Coverage83._();

  factory Coverage83([updates(Coverage83Builder b)]) = _$Coverage83;
  ...
  InsuredPerson83 get insuredPerson;
  ...
  BuiltList<SubInsurances83> get subInsurances;

  static Serializer<Coverage83> get serializer => _$coverage83Serializer;
}

abstract class InsuredPerson83
    implements Built<InsuredPerson83, InsuredPerson83Builder> {
  InsuredPerson83._();

  factory InsuredPerson83([updates(InsuredPerson83Builder b)]) = _$InsuredPerson83;
  ...
  static Serializer<InsuredPerson83> get serializer => _$insuredPerson83Serializer;
}

abstract class SubInsurances83
    implements Built<SubInsurances83, SubInsurances83Builder> {
  SubInsurances83._();

  factory SubInsurances83([updates(SubInsurances83Builder b)]) = _$SubInsurances83;
  ...
  static Serializer<SubInsurances83> get serializer => _$subInsurances83Serializer;
}

abstract class ShopMap83 implements Built<ShopMap83, ShopMap83Builder> {
  ShopMap83._();

  factory ShopMap83([updates(ShopMap83Builder b)]) = _$ShopMap83;
  ...
  static Serializer<ShopMap83> get serializer => _$shopMap83Serializer;
}

abstract class SupplierMap83 implements Built<SupplierMap83, SupplierMap83Builder> {
  SupplierMap83._();

  factory SupplierMap83([updates(SupplierMap83Builder b)]) = _$SupplierMap83;
  ...
  static Serializer<SupplierMap83> get serializer => _$supplierMap83Serializer;
}

abstract class FilterGroups83
    implements Built<FilterGroups83, FilterGroups83Builder> {
  FilterGroups83._();

  factory FilterGroups83([updates(FilterGroups83Builder b)]) = _$FilterGroups83;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options83> get options;

  static Serializer<FilterGroups83> get serializer => _$filterGroups83Serializer;
}

abstract class Options83 implements Built<Options83, Options83Builder> {
  Options83._();

  factory Options83([updates(Options83Builder b)]) = _$Options83;
  ...
  static Serializer<Options83> get serializer => _$options83Serializer;
}

abstract class PackageLabelInfo83
    implements Built<PackageLabelInfo83, PackageLabelInfo83Builder> {
  PackageLabelInfo83._();

  factory PackageLabelInfo83([updates(PackageLabelInfo83Builder b)]) =
      _$PackageLabelInfo83;
  ...
  static Serializer<PackageLabelInfo83> get serializer =>
      _$packageLabelInfo83Serializer;
}

abstract class ActivityList83
    implements Built<ActivityList83, ActivityList83Builder> {
  ActivityList83._();

  factory ActivityList83([update(ActivityList83Builder b)]) = _$ActivityList83;
  ...
  CardTags83 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList83> get serializer => _$activityList83Serializer;
}

abstract class CardTags83 implements Built<CardTags83, CardTags83Builder> {
  CardTags83._();

  factory CardTags83([update(CardTags83Builder b)]) = _$CardTags83;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags83> get serializer => _$cardTags83Serializer;
}

@SerializersFor([
  SearchResultPollResult83,
])
final Serializers serializers83 = _$serializers83;
