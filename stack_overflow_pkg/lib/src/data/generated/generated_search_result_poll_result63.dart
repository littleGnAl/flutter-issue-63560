...
part 'generated_search_result_poll_result63.g.dart';

abstract class SearchResultPollResult63
    implements Built<SearchResultPollResult63, SearchResultPollResult63Builder> {
  SearchResultPollResult63._();

  factory SearchResultPollResult63([updates(SearchResultPollResult63Builder b)]) =
  ...
  BuiltList<VehicleInfoList63> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap63> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap63> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups63> get filterGroups;
  ...
  static Serializer<SearchResultPollResult63> get serializer =>
      _$searchResultPollResult63Serializer;
}

abstract class VehicleInfoList63
    implements Built<VehicleInfoList63, VehicleInfoList63Builder> {
  VehicleInfoList63._();

  factory VehicleInfoList63([updates(VehicleInfoList63Builder b)]) =
      _$VehicleInfoList63;
  ...
  BuiltList<Packages63> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic63> get options;
  ...
  static Serializer<VehicleInfoList63> get serializer =>
      _$vehicleInfoList63Serializer;
}

abstract class VehicleCharacteristic63
    implements Built<VehicleCharacteristic63, VehicleCharacteristic63Builder> {
  VehicleCharacteristic63._();

  factory VehicleCharacteristic63([updates(VehicleCharacteristic63Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic63> get serializer =>
      _$vehicleCharacteristic63Serializer;
}

abstract class Service63 implements Built<Service63, Service63Builder> {
  Service63._();

  factory Service63([updates(Service63Builder b)]) = _$Service63;
  ...
  static Serializer<Service63> get serializer => _$service63Serializer;
}

abstract class Price63 implements Built<Price63, Price63Builder> {
  Price63._();

  factory Price63([updates(Price63Builder b)]) = _$Price63;
  ...
  static Serializer<Price63> get serializer => _$price63Serializer;
}

abstract class Packages63 implements Built<Packages63, Packages63Builder> {
  Packages63._();

  factory Packages63([updates(Packages63Builder b)]) = _$Packages63;
  ...
  PackageLabelInfo63 get packageLabelInfo;

  static Serializer<Packages63> get serializer => _$packages63Serializer;
}

abstract class Coverage63 implements Built<Coverage63, Coverage63Builder> {
  Coverage63._();

  factory Coverage63([updates(Coverage63Builder b)]) = _$Coverage63;
  ...
  InsuredPerson63 get insuredPerson;
  ...
  BuiltList<SubInsurances63> get subInsurances;

  static Serializer<Coverage63> get serializer => _$coverage63Serializer;
}

abstract class InsuredPerson63
    implements Built<InsuredPerson63, InsuredPerson63Builder> {
  InsuredPerson63._();

  factory InsuredPerson63([updates(InsuredPerson63Builder b)]) = _$InsuredPerson63;
  ...
  static Serializer<InsuredPerson63> get serializer => _$insuredPerson63Serializer;
}

abstract class SubInsurances63
    implements Built<SubInsurances63, SubInsurances63Builder> {
  SubInsurances63._();

  factory SubInsurances63([updates(SubInsurances63Builder b)]) = _$SubInsurances63;
  ...
  static Serializer<SubInsurances63> get serializer => _$subInsurances63Serializer;
}

abstract class ShopMap63 implements Built<ShopMap63, ShopMap63Builder> {
  ShopMap63._();

  factory ShopMap63([updates(ShopMap63Builder b)]) = _$ShopMap63;
  ...
  static Serializer<ShopMap63> get serializer => _$shopMap63Serializer;
}

abstract class SupplierMap63 implements Built<SupplierMap63, SupplierMap63Builder> {
  SupplierMap63._();

  factory SupplierMap63([updates(SupplierMap63Builder b)]) = _$SupplierMap63;
  ...
  static Serializer<SupplierMap63> get serializer => _$supplierMap63Serializer;
}

abstract class FilterGroups63
    implements Built<FilterGroups63, FilterGroups63Builder> {
  FilterGroups63._();

  factory FilterGroups63([updates(FilterGroups63Builder b)]) = _$FilterGroups63;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options63> get options;

  static Serializer<FilterGroups63> get serializer => _$filterGroups63Serializer;
}

abstract class Options63 implements Built<Options63, Options63Builder> {
  Options63._();

  factory Options63([updates(Options63Builder b)]) = _$Options63;
  ...
  static Serializer<Options63> get serializer => _$options63Serializer;
}

abstract class PackageLabelInfo63
    implements Built<PackageLabelInfo63, PackageLabelInfo63Builder> {
  PackageLabelInfo63._();

  factory PackageLabelInfo63([updates(PackageLabelInfo63Builder b)]) =
      _$PackageLabelInfo63;
  ...
  static Serializer<PackageLabelInfo63> get serializer =>
      _$packageLabelInfo63Serializer;
}

abstract class ActivityList63
    implements Built<ActivityList63, ActivityList63Builder> {
  ActivityList63._();

  factory ActivityList63([update(ActivityList63Builder b)]) = _$ActivityList63;
  ...
  CardTags63 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList63> get serializer => _$activityList63Serializer;
}

abstract class CardTags63 implements Built<CardTags63, CardTags63Builder> {
  CardTags63._();

  factory CardTags63([update(CardTags63Builder b)]) = _$CardTags63;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags63> get serializer => _$cardTags63Serializer;
}

@SerializersFor([
  SearchResultPollResult63,
])
final Serializers serializers63 = _$serializers63;
