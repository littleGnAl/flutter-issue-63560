...
part 'generated_search_result_poll_result92.g.dart';

abstract class SearchResultPollResult92
    implements Built<SearchResultPollResult92, SearchResultPollResult92Builder> {
  SearchResultPollResult92._();

  factory SearchResultPollResult92([updates(SearchResultPollResult92Builder b)]) =
  ...
  BuiltList<VehicleInfoList92> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap92> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap92> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups92> get filterGroups;
  ...
  static Serializer<SearchResultPollResult92> get serializer =>
      _$searchResultPollResult92Serializer;
}

abstract class VehicleInfoList92
    implements Built<VehicleInfoList92, VehicleInfoList92Builder> {
  VehicleInfoList92._();

  factory VehicleInfoList92([updates(VehicleInfoList92Builder b)]) =
      _$VehicleInfoList92;
  ...
  BuiltList<Packages92> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic92> get options;
  ...
  static Serializer<VehicleInfoList92> get serializer =>
      _$vehicleInfoList92Serializer;
}

abstract class VehicleCharacteristic92
    implements Built<VehicleCharacteristic92, VehicleCharacteristic92Builder> {
  VehicleCharacteristic92._();

  factory VehicleCharacteristic92([updates(VehicleCharacteristic92Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic92> get serializer =>
      _$vehicleCharacteristic92Serializer;
}

abstract class Service92 implements Built<Service92, Service92Builder> {
  Service92._();

  factory Service92([updates(Service92Builder b)]) = _$Service92;
  ...
  static Serializer<Service92> get serializer => _$service92Serializer;
}

abstract class Price92 implements Built<Price92, Price92Builder> {
  Price92._();

  factory Price92([updates(Price92Builder b)]) = _$Price92;
  ...
  static Serializer<Price92> get serializer => _$price92Serializer;
}

abstract class Packages92 implements Built<Packages92, Packages92Builder> {
  Packages92._();

  factory Packages92([updates(Packages92Builder b)]) = _$Packages92;
  ...
  PackageLabelInfo92 get packageLabelInfo;

  static Serializer<Packages92> get serializer => _$packages92Serializer;
}

abstract class Coverage92 implements Built<Coverage92, Coverage92Builder> {
  Coverage92._();

  factory Coverage92([updates(Coverage92Builder b)]) = _$Coverage92;
  ...
  InsuredPerson92 get insuredPerson;
  ...
  BuiltList<SubInsurances92> get subInsurances;

  static Serializer<Coverage92> get serializer => _$coverage92Serializer;
}

abstract class InsuredPerson92
    implements Built<InsuredPerson92, InsuredPerson92Builder> {
  InsuredPerson92._();

  factory InsuredPerson92([updates(InsuredPerson92Builder b)]) = _$InsuredPerson92;
  ...
  static Serializer<InsuredPerson92> get serializer => _$insuredPerson92Serializer;
}

abstract class SubInsurances92
    implements Built<SubInsurances92, SubInsurances92Builder> {
  SubInsurances92._();

  factory SubInsurances92([updates(SubInsurances92Builder b)]) = _$SubInsurances92;
  ...
  static Serializer<SubInsurances92> get serializer => _$subInsurances92Serializer;
}

abstract class ShopMap92 implements Built<ShopMap92, ShopMap92Builder> {
  ShopMap92._();

  factory ShopMap92([updates(ShopMap92Builder b)]) = _$ShopMap92;
  ...
  static Serializer<ShopMap92> get serializer => _$shopMap92Serializer;
}

abstract class SupplierMap92 implements Built<SupplierMap92, SupplierMap92Builder> {
  SupplierMap92._();

  factory SupplierMap92([updates(SupplierMap92Builder b)]) = _$SupplierMap92;
  ...
  static Serializer<SupplierMap92> get serializer => _$supplierMap92Serializer;
}

abstract class FilterGroups92
    implements Built<FilterGroups92, FilterGroups92Builder> {
  FilterGroups92._();

  factory FilterGroups92([updates(FilterGroups92Builder b)]) = _$FilterGroups92;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options92> get options;

  static Serializer<FilterGroups92> get serializer => _$filterGroups92Serializer;
}

abstract class Options92 implements Built<Options92, Options92Builder> {
  Options92._();

  factory Options92([updates(Options92Builder b)]) = _$Options92;
  ...
  static Serializer<Options92> get serializer => _$options92Serializer;
}

abstract class PackageLabelInfo92
    implements Built<PackageLabelInfo92, PackageLabelInfo92Builder> {
  PackageLabelInfo92._();

  factory PackageLabelInfo92([updates(PackageLabelInfo92Builder b)]) =
      _$PackageLabelInfo92;
  ...
  static Serializer<PackageLabelInfo92> get serializer =>
      _$packageLabelInfo92Serializer;
}

abstract class ActivityList92
    implements Built<ActivityList92, ActivityList92Builder> {
  ActivityList92._();

  factory ActivityList92([update(ActivityList92Builder b)]) = _$ActivityList92;
  ...
  CardTags92 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList92> get serializer => _$activityList92Serializer;
}

abstract class CardTags92 implements Built<CardTags92, CardTags92Builder> {
  CardTags92._();

  factory CardTags92([update(CardTags92Builder b)]) = _$CardTags92;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags92> get serializer => _$cardTags92Serializer;
}

@SerializersFor([
  SearchResultPollResult92,
])
final Serializers serializers92 = _$serializers92;
