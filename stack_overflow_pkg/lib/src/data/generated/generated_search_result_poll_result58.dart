...
part 'generated_search_result_poll_result58.g.dart';

abstract class SearchResultPollResult58
    implements Built<SearchResultPollResult58, SearchResultPollResult58Builder> {
  SearchResultPollResult58._();

  factory SearchResultPollResult58([updates(SearchResultPollResult58Builder b)]) =
  ...
  BuiltList<VehicleInfoList58> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap58> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap58> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups58> get filterGroups;
  ...
  static Serializer<SearchResultPollResult58> get serializer =>
      _$searchResultPollResult58Serializer;
}

abstract class VehicleInfoList58
    implements Built<VehicleInfoList58, VehicleInfoList58Builder> {
  VehicleInfoList58._();

  factory VehicleInfoList58([updates(VehicleInfoList58Builder b)]) =
      _$VehicleInfoList58;
  ...
  BuiltList<Packages58> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic58> get options;
  ...
  static Serializer<VehicleInfoList58> get serializer =>
      _$vehicleInfoList58Serializer;
}

abstract class VehicleCharacteristic58
    implements Built<VehicleCharacteristic58, VehicleCharacteristic58Builder> {
  VehicleCharacteristic58._();

  factory VehicleCharacteristic58([updates(VehicleCharacteristic58Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic58> get serializer =>
      _$vehicleCharacteristic58Serializer;
}

abstract class Service58 implements Built<Service58, Service58Builder> {
  Service58._();

  factory Service58([updates(Service58Builder b)]) = _$Service58;
  ...
  static Serializer<Service58> get serializer => _$service58Serializer;
}

abstract class Price58 implements Built<Price58, Price58Builder> {
  Price58._();

  factory Price58([updates(Price58Builder b)]) = _$Price58;
  ...
  static Serializer<Price58> get serializer => _$price58Serializer;
}

abstract class Packages58 implements Built<Packages58, Packages58Builder> {
  Packages58._();

  factory Packages58([updates(Packages58Builder b)]) = _$Packages58;
  ...
  PackageLabelInfo58 get packageLabelInfo;

  static Serializer<Packages58> get serializer => _$packages58Serializer;
}

abstract class Coverage58 implements Built<Coverage58, Coverage58Builder> {
  Coverage58._();

  factory Coverage58([updates(Coverage58Builder b)]) = _$Coverage58;
  ...
  InsuredPerson58 get insuredPerson;
  ...
  BuiltList<SubInsurances58> get subInsurances;

  static Serializer<Coverage58> get serializer => _$coverage58Serializer;
}

abstract class InsuredPerson58
    implements Built<InsuredPerson58, InsuredPerson58Builder> {
  InsuredPerson58._();

  factory InsuredPerson58([updates(InsuredPerson58Builder b)]) = _$InsuredPerson58;
  ...
  static Serializer<InsuredPerson58> get serializer => _$insuredPerson58Serializer;
}

abstract class SubInsurances58
    implements Built<SubInsurances58, SubInsurances58Builder> {
  SubInsurances58._();

  factory SubInsurances58([updates(SubInsurances58Builder b)]) = _$SubInsurances58;
  ...
  static Serializer<SubInsurances58> get serializer => _$subInsurances58Serializer;
}

abstract class ShopMap58 implements Built<ShopMap58, ShopMap58Builder> {
  ShopMap58._();

  factory ShopMap58([updates(ShopMap58Builder b)]) = _$ShopMap58;
  ...
  static Serializer<ShopMap58> get serializer => _$shopMap58Serializer;
}

abstract class SupplierMap58 implements Built<SupplierMap58, SupplierMap58Builder> {
  SupplierMap58._();

  factory SupplierMap58([updates(SupplierMap58Builder b)]) = _$SupplierMap58;
  ...
  static Serializer<SupplierMap58> get serializer => _$supplierMap58Serializer;
}

abstract class FilterGroups58
    implements Built<FilterGroups58, FilterGroups58Builder> {
  FilterGroups58._();

  factory FilterGroups58([updates(FilterGroups58Builder b)]) = _$FilterGroups58;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options58> get options;

  static Serializer<FilterGroups58> get serializer => _$filterGroups58Serializer;
}

abstract class Options58 implements Built<Options58, Options58Builder> {
  Options58._();

  factory Options58([updates(Options58Builder b)]) = _$Options58;
  ...
  static Serializer<Options58> get serializer => _$options58Serializer;
}

abstract class PackageLabelInfo58
    implements Built<PackageLabelInfo58, PackageLabelInfo58Builder> {
  PackageLabelInfo58._();

  factory PackageLabelInfo58([updates(PackageLabelInfo58Builder b)]) =
      _$PackageLabelInfo58;
  ...
  static Serializer<PackageLabelInfo58> get serializer =>
      _$packageLabelInfo58Serializer;
}

abstract class ActivityList58
    implements Built<ActivityList58, ActivityList58Builder> {
  ActivityList58._();

  factory ActivityList58([update(ActivityList58Builder b)]) = _$ActivityList58;
  ...
  CardTags58 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList58> get serializer => _$activityList58Serializer;
}

abstract class CardTags58 implements Built<CardTags58, CardTags58Builder> {
  CardTags58._();

  factory CardTags58([update(CardTags58Builder b)]) = _$CardTags58;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags58> get serializer => _$cardTags58Serializer;
}
