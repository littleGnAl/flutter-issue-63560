...
part 'generated_search_result_poll_result81.g.dart';

abstract class SearchResultPollResult81
    implements Built<SearchResultPollResult81, SearchResultPollResult81Builder> {
  SearchResultPollResult81._();

  factory SearchResultPollResult81([updates(SearchResultPollResult81Builder b)]) =
  ...
  BuiltList<VehicleInfoList81> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap81> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap81> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups81> get filterGroups;
  ...
  static Serializer<SearchResultPollResult81> get serializer =>
      _$searchResultPollResult81Serializer;
}

abstract class VehicleInfoList81
    implements Built<VehicleInfoList81, VehicleInfoList81Builder> {
  VehicleInfoList81._();

  factory VehicleInfoList81([updates(VehicleInfoList81Builder b)]) =
      _$VehicleInfoList81;
  ...
  BuiltList<Packages81> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic81> get options;
  ...
  static Serializer<VehicleInfoList81> get serializer =>
      _$vehicleInfoList81Serializer;
}

abstract class VehicleCharacteristic81
    implements Built<VehicleCharacteristic81, VehicleCharacteristic81Builder> {
  VehicleCharacteristic81._();

  factory VehicleCharacteristic81([updates(VehicleCharacteristic81Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic81> get serializer =>
      _$vehicleCharacteristic81Serializer;
}

abstract class Service81 implements Built<Service81, Service81Builder> {
  Service81._();

  factory Service81([updates(Service81Builder b)]) = _$Service81;
  ...
  static Serializer<Service81> get serializer => _$service81Serializer;
}

abstract class Price81 implements Built<Price81, Price81Builder> {
  Price81._();

  factory Price81([updates(Price81Builder b)]) = _$Price81;
  ...
  static Serializer<Price81> get serializer => _$price81Serializer;
}

abstract class Packages81 implements Built<Packages81, Packages81Builder> {
  Packages81._();

  factory Packages81([updates(Packages81Builder b)]) = _$Packages81;
  ...
  PackageLabelInfo81 get packageLabelInfo;

  static Serializer<Packages81> get serializer => _$packages81Serializer;
}

abstract class Coverage81 implements Built<Coverage81, Coverage81Builder> {
  Coverage81._();

  factory Coverage81([updates(Coverage81Builder b)]) = _$Coverage81;
  ...
  InsuredPerson81 get insuredPerson;
  ...
  BuiltList<SubInsurances81> get subInsurances;

  static Serializer<Coverage81> get serializer => _$coverage81Serializer;
}

abstract class InsuredPerson81
    implements Built<InsuredPerson81, InsuredPerson81Builder> {
  InsuredPerson81._();

  factory InsuredPerson81([updates(InsuredPerson81Builder b)]) = _$InsuredPerson81;
  ...
  static Serializer<InsuredPerson81> get serializer => _$insuredPerson81Serializer;
}

abstract class SubInsurances81
    implements Built<SubInsurances81, SubInsurances81Builder> {
  SubInsurances81._();

  factory SubInsurances81([updates(SubInsurances81Builder b)]) = _$SubInsurances81;
  ...
  static Serializer<SubInsurances81> get serializer => _$subInsurances81Serializer;
}

abstract class ShopMap81 implements Built<ShopMap81, ShopMap81Builder> {
  ShopMap81._();

  factory ShopMap81([updates(ShopMap81Builder b)]) = _$ShopMap81;
  ...
  static Serializer<ShopMap81> get serializer => _$shopMap81Serializer;
}

abstract class SupplierMap81 implements Built<SupplierMap81, SupplierMap81Builder> {
  SupplierMap81._();

  factory SupplierMap81([updates(SupplierMap81Builder b)]) = _$SupplierMap81;
  ...
  static Serializer<SupplierMap81> get serializer => _$supplierMap81Serializer;
}

abstract class FilterGroups81
    implements Built<FilterGroups81, FilterGroups81Builder> {
  FilterGroups81._();

  factory FilterGroups81([updates(FilterGroups81Builder b)]) = _$FilterGroups81;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options81> get options;

  static Serializer<FilterGroups81> get serializer => _$filterGroups81Serializer;
}

abstract class Options81 implements Built<Options81, Options81Builder> {
  Options81._();

  factory Options81([updates(Options81Builder b)]) = _$Options81;
  ...
  static Serializer<Options81> get serializer => _$options81Serializer;
}

abstract class PackageLabelInfo81
    implements Built<PackageLabelInfo81, PackageLabelInfo81Builder> {
  PackageLabelInfo81._();

  factory PackageLabelInfo81([updates(PackageLabelInfo81Builder b)]) =
      _$PackageLabelInfo81;
  ...
  static Serializer<PackageLabelInfo81> get serializer =>
      _$packageLabelInfo81Serializer;
}

abstract class ActivityList81
    implements Built<ActivityList81, ActivityList81Builder> {
  ActivityList81._();

  factory ActivityList81([update(ActivityList81Builder b)]) = _$ActivityList81;
  ...
  CardTags81 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList81> get serializer => _$activityList81Serializer;
}

abstract class CardTags81 implements Built<CardTags81, CardTags81Builder> {
  CardTags81._();

  factory CardTags81([update(CardTags81Builder b)]) = _$CardTags81;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags81> get serializer => _$cardTags81Serializer;
}

@SerializersFor([
  SearchResultPollResult81,
])
final Serializers serializers81 = _$serializers81;
