...
part 'generated_search_result_poll_result91.g.dart';

abstract class SearchResultPollResult91
    implements Built<SearchResultPollResult91, SearchResultPollResult91Builder> {
  SearchResultPollResult91._();

  factory SearchResultPollResult91([updates(SearchResultPollResult91Builder b)]) =
  ...
  BuiltList<VehicleInfoList91> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap91> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap91> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups91> get filterGroups;
  ...
  static Serializer<SearchResultPollResult91> get serializer =>
      _$searchResultPollResult91Serializer;
}

abstract class VehicleInfoList91
    implements Built<VehicleInfoList91, VehicleInfoList91Builder> {
  VehicleInfoList91._();

  factory VehicleInfoList91([updates(VehicleInfoList91Builder b)]) =
      _$VehicleInfoList91;
  ...
  BuiltList<Packages91> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic91> get options;
  ...
  static Serializer<VehicleInfoList91> get serializer =>
      _$vehicleInfoList91Serializer;
}

abstract class VehicleCharacteristic91
    implements Built<VehicleCharacteristic91, VehicleCharacteristic91Builder> {
  VehicleCharacteristic91._();

  factory VehicleCharacteristic91([updates(VehicleCharacteristic91Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic91> get serializer =>
      _$vehicleCharacteristic91Serializer;
}

abstract class Service91 implements Built<Service91, Service91Builder> {
  Service91._();

  factory Service91([updates(Service91Builder b)]) = _$Service91;
  ...
  static Serializer<Service91> get serializer => _$service91Serializer;
}

abstract class Price91 implements Built<Price91, Price91Builder> {
  Price91._();

  factory Price91([updates(Price91Builder b)]) = _$Price91;
  ...
  static Serializer<Price91> get serializer => _$price91Serializer;
}

abstract class Packages91 implements Built<Packages91, Packages91Builder> {
  Packages91._();

  factory Packages91([updates(Packages91Builder b)]) = _$Packages91;
  ...
  PackageLabelInfo91 get packageLabelInfo;

  static Serializer<Packages91> get serializer => _$packages91Serializer;
}

abstract class Coverage91 implements Built<Coverage91, Coverage91Builder> {
  Coverage91._();

  factory Coverage91([updates(Coverage91Builder b)]) = _$Coverage91;
  ...
  InsuredPerson91 get insuredPerson;
  ...
  BuiltList<SubInsurances91> get subInsurances;

  static Serializer<Coverage91> get serializer => _$coverage91Serializer;
}

abstract class InsuredPerson91
    implements Built<InsuredPerson91, InsuredPerson91Builder> {
  InsuredPerson91._();

  factory InsuredPerson91([updates(InsuredPerson91Builder b)]) = _$InsuredPerson91;
  ...
  static Serializer<InsuredPerson91> get serializer => _$insuredPerson91Serializer;
}

abstract class SubInsurances91
    implements Built<SubInsurances91, SubInsurances91Builder> {
  SubInsurances91._();

  factory SubInsurances91([updates(SubInsurances91Builder b)]) = _$SubInsurances91;
  ...
  static Serializer<SubInsurances91> get serializer => _$subInsurances91Serializer;
}

abstract class ShopMap91 implements Built<ShopMap91, ShopMap91Builder> {
  ShopMap91._();

  factory ShopMap91([updates(ShopMap91Builder b)]) = _$ShopMap91;
  ...
  static Serializer<ShopMap91> get serializer => _$shopMap91Serializer;
}

abstract class SupplierMap91 implements Built<SupplierMap91, SupplierMap91Builder> {
  SupplierMap91._();

  factory SupplierMap91([updates(SupplierMap91Builder b)]) = _$SupplierMap91;
  ...
  static Serializer<SupplierMap91> get serializer => _$supplierMap91Serializer;
}

abstract class FilterGroups91
    implements Built<FilterGroups91, FilterGroups91Builder> {
  FilterGroups91._();

  factory FilterGroups91([updates(FilterGroups91Builder b)]) = _$FilterGroups91;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options91> get options;

  static Serializer<FilterGroups91> get serializer => _$filterGroups91Serializer;
}

abstract class Options91 implements Built<Options91, Options91Builder> {
  Options91._();

  factory Options91([updates(Options91Builder b)]) = _$Options91;
  ...
  static Serializer<Options91> get serializer => _$options91Serializer;
}

abstract class PackageLabelInfo91
    implements Built<PackageLabelInfo91, PackageLabelInfo91Builder> {
  PackageLabelInfo91._();

  factory PackageLabelInfo91([updates(PackageLabelInfo91Builder b)]) =
      _$PackageLabelInfo91;
  ...
  static Serializer<PackageLabelInfo91> get serializer =>
      _$packageLabelInfo91Serializer;
}

abstract class ActivityList91
    implements Built<ActivityList91, ActivityList91Builder> {
  ActivityList91._();

  factory ActivityList91([update(ActivityList91Builder b)]) = _$ActivityList91;
  ...
  CardTags91 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList91> get serializer => _$activityList91Serializer;
}

abstract class CardTags91 implements Built<CardTags91, CardTags91Builder> {
  CardTags91._();

  factory CardTags91([update(CardTags91Builder b)]) = _$CardTags91;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags91> get serializer => _$cardTags91Serializer;
}

@SerializersFor([
  SearchResultPollResult91,
])
final Serializers serializers91 = _$serializers91;
