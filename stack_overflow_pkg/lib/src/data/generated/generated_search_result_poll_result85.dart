...
part 'generated_search_result_poll_result85.g.dart';

abstract class SearchResultPollResult85
    implements Built<SearchResultPollResult85, SearchResultPollResult85Builder> {
  SearchResultPollResult85._();

  factory SearchResultPollResult85([updates(SearchResultPollResult85Builder b)]) =
  ...
  BuiltList<VehicleInfoList85> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap85> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap85> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups85> get filterGroups;
  ...
  static Serializer<SearchResultPollResult85> get serializer =>
      _$searchResultPollResult85Serializer;
}

abstract class VehicleInfoList85
    implements Built<VehicleInfoList85, VehicleInfoList85Builder> {
  VehicleInfoList85._();

  factory VehicleInfoList85([updates(VehicleInfoList85Builder b)]) =
      _$VehicleInfoList85;
  ...
  BuiltList<Packages85> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic85> get options;
  ...
  static Serializer<VehicleInfoList85> get serializer =>
      _$vehicleInfoList85Serializer;
}

abstract class VehicleCharacteristic85
    implements Built<VehicleCharacteristic85, VehicleCharacteristic85Builder> {
  VehicleCharacteristic85._();

  factory VehicleCharacteristic85([updates(VehicleCharacteristic85Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic85> get serializer =>
      _$vehicleCharacteristic85Serializer;
}

abstract class Service85 implements Built<Service85, Service85Builder> {
  Service85._();

  factory Service85([updates(Service85Builder b)]) = _$Service85;
  ...
  static Serializer<Service85> get serializer => _$service85Serializer;
}

abstract class Price85 implements Built<Price85, Price85Builder> {
  Price85._();

  factory Price85([updates(Price85Builder b)]) = _$Price85;
  ...
  static Serializer<Price85> get serializer => _$price85Serializer;
}

abstract class Packages85 implements Built<Packages85, Packages85Builder> {
  Packages85._();

  factory Packages85([updates(Packages85Builder b)]) = _$Packages85;
  ...
  PackageLabelInfo85 get packageLabelInfo;

  static Serializer<Packages85> get serializer => _$packages85Serializer;
}

abstract class Coverage85 implements Built<Coverage85, Coverage85Builder> {
  Coverage85._();

  factory Coverage85([updates(Coverage85Builder b)]) = _$Coverage85;
  ...
  InsuredPerson85 get insuredPerson;
  ...
  BuiltList<SubInsurances85> get subInsurances;

  static Serializer<Coverage85> get serializer => _$coverage85Serializer;
}

abstract class InsuredPerson85
    implements Built<InsuredPerson85, InsuredPerson85Builder> {
  InsuredPerson85._();

  factory InsuredPerson85([updates(InsuredPerson85Builder b)]) = _$InsuredPerson85;
  ...
  static Serializer<InsuredPerson85> get serializer => _$insuredPerson85Serializer;
}

abstract class SubInsurances85
    implements Built<SubInsurances85, SubInsurances85Builder> {
  SubInsurances85._();

  factory SubInsurances85([updates(SubInsurances85Builder b)]) = _$SubInsurances85;
  ...
  static Serializer<SubInsurances85> get serializer => _$subInsurances85Serializer;
}

abstract class ShopMap85 implements Built<ShopMap85, ShopMap85Builder> {
  ShopMap85._();

  factory ShopMap85([updates(ShopMap85Builder b)]) = _$ShopMap85;
  ...
  static Serializer<ShopMap85> get serializer => _$shopMap85Serializer;
}

abstract class SupplierMap85 implements Built<SupplierMap85, SupplierMap85Builder> {
  SupplierMap85._();

  factory SupplierMap85([updates(SupplierMap85Builder b)]) = _$SupplierMap85;
  ...
  static Serializer<SupplierMap85> get serializer => _$supplierMap85Serializer;
}

abstract class FilterGroups85
    implements Built<FilterGroups85, FilterGroups85Builder> {
  FilterGroups85._();

  factory FilterGroups85([updates(FilterGroups85Builder b)]) = _$FilterGroups85;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options85> get options;

  static Serializer<FilterGroups85> get serializer => _$filterGroups85Serializer;
}

abstract class Options85 implements Built<Options85, Options85Builder> {
  Options85._();

  factory Options85([updates(Options85Builder b)]) = _$Options85;
  ...
  static Serializer<Options85> get serializer => _$options85Serializer;
}

abstract class PackageLabelInfo85
    implements Built<PackageLabelInfo85, PackageLabelInfo85Builder> {
  PackageLabelInfo85._();

  factory PackageLabelInfo85([updates(PackageLabelInfo85Builder b)]) =
      _$PackageLabelInfo85;
  ...
  static Serializer<PackageLabelInfo85> get serializer =>
      _$packageLabelInfo85Serializer;
}

abstract class ActivityList85
    implements Built<ActivityList85, ActivityList85Builder> {
  ActivityList85._();

  factory ActivityList85([update(ActivityList85Builder b)]) = _$ActivityList85;
  ...
  CardTags85 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList85> get serializer => _$activityList85Serializer;
}

abstract class CardTags85 implements Built<CardTags85, CardTags85Builder> {
  CardTags85._();

  factory CardTags85([update(CardTags85Builder b)]) = _$CardTags85;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags85> get serializer => _$cardTags85Serializer;
}

@SerializersFor([
  SearchResultPollResult85,
])
final Serializers serializers85 = _$serializers85;
