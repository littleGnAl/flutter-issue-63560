...
part 'generated_search_result_poll_result43.g.dart';

abstract class SearchResultPollResult43
    implements Built<SearchResultPollResult43, SearchResultPollResult43Builder> {
  SearchResultPollResult43._();

  factory SearchResultPollResult43([updates(SearchResultPollResult43Builder b)]) =
  ...
  BuiltList<VehicleInfoList43> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap43> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap43> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups43> get filterGroups;
  ...
  static Serializer<SearchResultPollResult43> get serializer =>
      _$searchResultPollResult43Serializer;
}

abstract class VehicleInfoList43
    implements Built<VehicleInfoList43, VehicleInfoList43Builder> {
  VehicleInfoList43._();

  factory VehicleInfoList43([updates(VehicleInfoList43Builder b)]) =
      _$VehicleInfoList43;
  ...
  BuiltList<Packages43> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic43> get options;
  ...
  static Serializer<VehicleInfoList43> get serializer =>
      _$vehicleInfoList43Serializer;
}

abstract class VehicleCharacteristic43
    implements Built<VehicleCharacteristic43, VehicleCharacteristic43Builder> {
  VehicleCharacteristic43._();

  factory VehicleCharacteristic43([updates(VehicleCharacteristic43Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic43> get serializer =>
      _$vehicleCharacteristic43Serializer;
}

abstract class Service43 implements Built<Service43, Service43Builder> {
  Service43._();

  factory Service43([updates(Service43Builder b)]) = _$Service43;
  ...
  static Serializer<Service43> get serializer => _$service43Serializer;
}

abstract class Price43 implements Built<Price43, Price43Builder> {
  Price43._();

  factory Price43([updates(Price43Builder b)]) = _$Price43;
  ...
  static Serializer<Price43> get serializer => _$price43Serializer;
}

abstract class Packages43 implements Built<Packages43, Packages43Builder> {
  Packages43._();

  factory Packages43([updates(Packages43Builder b)]) = _$Packages43;
  ...
  PackageLabelInfo43 get packageLabelInfo;

  static Serializer<Packages43> get serializer => _$packages43Serializer;
}

abstract class Coverage43 implements Built<Coverage43, Coverage43Builder> {
  Coverage43._();

  factory Coverage43([updates(Coverage43Builder b)]) = _$Coverage43;
  ...
  InsuredPerson43 get insuredPerson;
  ...
  BuiltList<SubInsurances43> get subInsurances;

  static Serializer<Coverage43> get serializer => _$coverage43Serializer;
}

abstract class InsuredPerson43
    implements Built<InsuredPerson43, InsuredPerson43Builder> {
  InsuredPerson43._();

  factory InsuredPerson43([updates(InsuredPerson43Builder b)]) = _$InsuredPerson43;
  ...
  static Serializer<InsuredPerson43> get serializer => _$insuredPerson43Serializer;
}

abstract class SubInsurances43
    implements Built<SubInsurances43, SubInsurances43Builder> {
  SubInsurances43._();

  factory SubInsurances43([updates(SubInsurances43Builder b)]) = _$SubInsurances43;
  ...
  static Serializer<SubInsurances43> get serializer => _$subInsurances43Serializer;
}

abstract class ShopMap43 implements Built<ShopMap43, ShopMap43Builder> {
  ShopMap43._();

  factory ShopMap43([updates(ShopMap43Builder b)]) = _$ShopMap43;
  ...
  static Serializer<ShopMap43> get serializer => _$shopMap43Serializer;
}

abstract class SupplierMap43 implements Built<SupplierMap43, SupplierMap43Builder> {
  SupplierMap43._();

  factory SupplierMap43([updates(SupplierMap43Builder b)]) = _$SupplierMap43;
  ...
  static Serializer<SupplierMap43> get serializer => _$supplierMap43Serializer;
}

abstract class FilterGroups43
    implements Built<FilterGroups43, FilterGroups43Builder> {
  FilterGroups43._();

  factory FilterGroups43([updates(FilterGroups43Builder b)]) = _$FilterGroups43;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options43> get options;

  static Serializer<FilterGroups43> get serializer => _$filterGroups43Serializer;
}

abstract class Options43 implements Built<Options43, Options43Builder> {
  Options43._();

  factory Options43([updates(Options43Builder b)]) = _$Options43;
  ...
  static Serializer<Options43> get serializer => _$options43Serializer;
}

abstract class PackageLabelInfo43
    implements Built<PackageLabelInfo43, PackageLabelInfo43Builder> {
  PackageLabelInfo43._();

  factory PackageLabelInfo43([updates(PackageLabelInfo43Builder b)]) =
      _$PackageLabelInfo43;
  ...
  static Serializer<PackageLabelInfo43> get serializer =>
      _$packageLabelInfo43Serializer;
}

abstract class ActivityList43
    implements Built<ActivityList43, ActivityList43Builder> {
  ActivityList43._();

  factory ActivityList43([update(ActivityList43Builder b)]) = _$ActivityList43;
  ...
  CardTags43 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList43> get serializer => _$activityList43Serializer;
}

abstract class CardTags43 implements Built<CardTags43, CardTags43Builder> {
  CardTags43._();

  factory CardTags43([update(CardTags43Builder b)]) = _$CardTags43;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags43> get serializer => _$cardTags43Serializer;
}
