...
part 'generated_search_result_poll_result38.g.dart';

abstract class SearchResultPollResult38
    implements Built<SearchResultPollResult38, SearchResultPollResult38Builder> {
  SearchResultPollResult38._();

  factory SearchResultPollResult38([updates(SearchResultPollResult38Builder b)]) =
  ...
  BuiltList<VehicleInfoList38> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap38> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap38> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups38> get filterGroups;
  ...
  static Serializer<SearchResultPollResult38> get serializer =>
      _$searchResultPollResult38Serializer;
}

abstract class VehicleInfoList38
    implements Built<VehicleInfoList38, VehicleInfoList38Builder> {
  VehicleInfoList38._();

  factory VehicleInfoList38([updates(VehicleInfoList38Builder b)]) =
      _$VehicleInfoList38;
  ...
  BuiltList<Packages38> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic38> get options;
  ...
  static Serializer<VehicleInfoList38> get serializer =>
      _$vehicleInfoList38Serializer;
}

abstract class VehicleCharacteristic38
    implements Built<VehicleCharacteristic38, VehicleCharacteristic38Builder> {
  VehicleCharacteristic38._();

  factory VehicleCharacteristic38([updates(VehicleCharacteristic38Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic38> get serializer =>
      _$vehicleCharacteristic38Serializer;
}

abstract class Service38 implements Built<Service38, Service38Builder> {
  Service38._();

  factory Service38([updates(Service38Builder b)]) = _$Service38;
  ...
  static Serializer<Service38> get serializer => _$service38Serializer;
}

abstract class Price38 implements Built<Price38, Price38Builder> {
  Price38._();

  factory Price38([updates(Price38Builder b)]) = _$Price38;
  ...
  static Serializer<Price38> get serializer => _$price38Serializer;
}

abstract class Packages38 implements Built<Packages38, Packages38Builder> {
  Packages38._();

  factory Packages38([updates(Packages38Builder b)]) = _$Packages38;
  ...
  PackageLabelInfo38 get packageLabelInfo;

  static Serializer<Packages38> get serializer => _$packages38Serializer;
}

abstract class Coverage38 implements Built<Coverage38, Coverage38Builder> {
  Coverage38._();

  factory Coverage38([updates(Coverage38Builder b)]) = _$Coverage38;
  ...
  InsuredPerson38 get insuredPerson;
  ...
  BuiltList<SubInsurances38> get subInsurances;

  static Serializer<Coverage38> get serializer => _$coverage38Serializer;
}

abstract class InsuredPerson38
    implements Built<InsuredPerson38, InsuredPerson38Builder> {
  InsuredPerson38._();

  factory InsuredPerson38([updates(InsuredPerson38Builder b)]) = _$InsuredPerson38;
  ...
  static Serializer<InsuredPerson38> get serializer => _$insuredPerson38Serializer;
}

abstract class SubInsurances38
    implements Built<SubInsurances38, SubInsurances38Builder> {
  SubInsurances38._();

  factory SubInsurances38([updates(SubInsurances38Builder b)]) = _$SubInsurances38;
  ...
  static Serializer<SubInsurances38> get serializer => _$subInsurances38Serializer;
}

abstract class ShopMap38 implements Built<ShopMap38, ShopMap38Builder> {
  ShopMap38._();

  factory ShopMap38([updates(ShopMap38Builder b)]) = _$ShopMap38;
  ...
  static Serializer<ShopMap38> get serializer => _$shopMap38Serializer;
}

abstract class SupplierMap38 implements Built<SupplierMap38, SupplierMap38Builder> {
  SupplierMap38._();

  factory SupplierMap38([updates(SupplierMap38Builder b)]) = _$SupplierMap38;
  ...
  static Serializer<SupplierMap38> get serializer => _$supplierMap38Serializer;
}

abstract class FilterGroups38
    implements Built<FilterGroups38, FilterGroups38Builder> {
  FilterGroups38._();

  factory FilterGroups38([updates(FilterGroups38Builder b)]) = _$FilterGroups38;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options38> get options;

  static Serializer<FilterGroups38> get serializer => _$filterGroups38Serializer;
}

abstract class Options38 implements Built<Options38, Options38Builder> {
  Options38._();

  factory Options38([updates(Options38Builder b)]) = _$Options38;
  ...
  static Serializer<Options38> get serializer => _$options38Serializer;
}

abstract class PackageLabelInfo38
    implements Built<PackageLabelInfo38, PackageLabelInfo38Builder> {
  PackageLabelInfo38._();

  factory PackageLabelInfo38([updates(PackageLabelInfo38Builder b)]) =
      _$PackageLabelInfo38;
  ...
  static Serializer<PackageLabelInfo38> get serializer =>
      _$packageLabelInfo38Serializer;
}

abstract class ActivityList38
    implements Built<ActivityList38, ActivityList38Builder> {
  ActivityList38._();

  factory ActivityList38([update(ActivityList38Builder b)]) = _$ActivityList38;
  ...
  CardTags38 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList38> get serializer => _$activityList38Serializer;
}

abstract class CardTags38 implements Built<CardTags38, CardTags38Builder> {
  CardTags38._();

  factory CardTags38([update(CardTags38Builder b)]) = _$CardTags38;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags38> get serializer => _$cardTags38Serializer;
}
