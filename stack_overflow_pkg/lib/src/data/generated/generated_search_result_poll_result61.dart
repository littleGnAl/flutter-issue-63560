...
abstract class SearchResultPollResult61
    implements Built<SearchResultPollResult61, SearchResultPollResult61Builder> {
  SearchResultPollResult61._();

  factory SearchResultPollResult61([updates(SearchResultPollResult61Builder b)]) =
  ...
  BuiltList<VehicleInfoList61> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap61> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap61> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups61> get filterGroups;
  ...
  static Serializer<SearchResultPollResult61> get serializer =>
      _$searchResultPollResult61Serializer;
}

abstract class VehicleInfoList61
    implements Built<VehicleInfoList61, VehicleInfoList61Builder> {
  VehicleInfoList61._();

  factory VehicleInfoList61([updates(VehicleInfoList61Builder b)]) =
      _$VehicleInfoList61;
  ...
  BuiltList<Packages61> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic61> get options;
  ...
  static Serializer<VehicleInfoList61> get serializer =>
      _$vehicleInfoList61Serializer;
}

abstract class VehicleCharacteristic61
    implements Built<VehicleCharacteristic61, VehicleCharacteristic61Builder> {
  VehicleCharacteristic61._();

  factory VehicleCharacteristic61([updates(VehicleCharacteristic61Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic61> get serializer =>
      _$vehicleCharacteristic61Serializer;
}

abstract class Service61 implements Built<Service61, Service61Builder> {
  Service61._();

  factory Service61([updates(Service61Builder b)]) = _$Service61;
  ...
  static Serializer<Service61> get serializer => _$service61Serializer;
}

abstract class Price61 implements Built<Price61, Price61Builder> {
  Price61._();

  factory Price61([updates(Price61Builder b)]) = _$Price61;
  ...
  static Serializer<Price61> get serializer => _$price61Serializer;
}

abstract class Packages61 implements Built<Packages61, Packages61Builder> {
  Packages61._();

  factory Packages61([updates(Packages61Builder b)]) = _$Packages61;
  ...
  PackageLabelInfo61 get packageLabelInfo;

  static Serializer<Packages61> get serializer => _$packages61Serializer;
}

abstract class Coverage61 implements Built<Coverage61, Coverage61Builder> {
  Coverage61._();

  factory Coverage61([updates(Coverage61Builder b)]) = _$Coverage61;
  ...
  InsuredPerson61 get insuredPerson;
  ...
  BuiltList<SubInsurances61> get subInsurances;

  static Serializer<Coverage61> get serializer => _$coverage61Serializer;
}

abstract class InsuredPerson61
    implements Built<InsuredPerson61, InsuredPerson61Builder> {
  InsuredPerson61._();

  factory InsuredPerson61([updates(InsuredPerson61Builder b)]) = _$InsuredPerson61;
  ...
  static Serializer<InsuredPerson61> get serializer => _$insuredPerson61Serializer;
}

abstract class SubInsurances61
    implements Built<SubInsurances61, SubInsurances61Builder> {
  SubInsurances61._();

  factory SubInsurances61([updates(SubInsurances61Builder b)]) = _$SubInsurances61;
  ...
  static Serializer<SubInsurances61> get serializer => _$subInsurances61Serializer;
}

abstract class ShopMap61 implements Built<ShopMap61, ShopMap61Builder> {
  ShopMap61._();

  factory ShopMap61([updates(ShopMap61Builder b)]) = _$ShopMap61;
  ...
  static Serializer<ShopMap61> get serializer => _$shopMap61Serializer;
}

abstract class SupplierMap61 implements Built<SupplierMap61, SupplierMap61Builder> {
  SupplierMap61._();

  factory SupplierMap61([updates(SupplierMap61Builder b)]) = _$SupplierMap61;
  ...
  static Serializer<SupplierMap61> get serializer => _$supplierMap61Serializer;
}

abstract class FilterGroups61
    implements Built<FilterGroups61, FilterGroups61Builder> {
  FilterGroups61._();

  factory FilterGroups61([updates(FilterGroups61Builder b)]) = _$FilterGroups61;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options61> get options;

  static Serializer<FilterGroups61> get serializer => _$filterGroups61Serializer;
}

abstract class Options61 implements Built<Options61, Options61Builder> {
  Options61._();

  factory Options61([updates(Options61Builder b)]) = _$Options61;
  ...
  static Serializer<Options61> get serializer => _$options61Serializer;
}

abstract class PackageLabelInfo61
    implements Built<PackageLabelInfo61, PackageLabelInfo61Builder> {
  PackageLabelInfo61._();

  factory PackageLabelInfo61([updates(PackageLabelInfo61Builder b)]) =
      _$PackageLabelInfo61;
  ...
  static Serializer<PackageLabelInfo61> get serializer =>
      _$packageLabelInfo61Serializer;
}

abstract class ActivityList61
    implements Built<ActivityList61, ActivityList61Builder> {
  ActivityList61._();

  factory ActivityList61([update(ActivityList61Builder b)]) = _$ActivityList61;
  ...
  CardTags61 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList61> get serializer => _$activityList61Serializer;
}

abstract class CardTags61 implements Built<CardTags61, CardTags61Builder> {
  CardTags61._();

  factory CardTags61([update(CardTags61Builder b)]) = _$CardTags61;
