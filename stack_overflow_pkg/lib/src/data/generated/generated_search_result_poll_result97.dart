...
part 'generated_search_result_poll_result97.g.dart';

abstract class SearchResultPollResult97
    implements Built<SearchResultPollResult97, SearchResultPollResult97Builder> {
  SearchResultPollResult97._();

  factory SearchResultPollResult97([updates(SearchResultPollResult97Builder b)]) =
  ...
  BuiltList<VehicleInfoList97> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap97> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap97> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups97> get filterGroups;
  ...
  static Serializer<SearchResultPollResult97> get serializer =>
      _$searchResultPollResult97Serializer;
}

abstract class VehicleInfoList97
    implements Built<VehicleInfoList97, VehicleInfoList97Builder> {
  VehicleInfoList97._();

  factory VehicleInfoList97([updates(VehicleInfoList97Builder b)]) =
      _$VehicleInfoList97;
  ...
  BuiltList<Packages97> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic97> get options;
  ...
  static Serializer<VehicleInfoList97> get serializer =>
      _$vehicleInfoList97Serializer;
}

abstract class VehicleCharacteristic97
    implements Built<VehicleCharacteristic97, VehicleCharacteristic97Builder> {
  VehicleCharacteristic97._();

  factory VehicleCharacteristic97([updates(VehicleCharacteristic97Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic97> get serializer =>
      _$vehicleCharacteristic97Serializer;
}

abstract class Service97 implements Built<Service97, Service97Builder> {
  Service97._();

  factory Service97([updates(Service97Builder b)]) = _$Service97;
  ...
  static Serializer<Service97> get serializer => _$service97Serializer;
}

abstract class Price97 implements Built<Price97, Price97Builder> {
  Price97._();

  factory Price97([updates(Price97Builder b)]) = _$Price97;
  ...
  static Serializer<Price97> get serializer => _$price97Serializer;
}

abstract class Packages97 implements Built<Packages97, Packages97Builder> {
  Packages97._();

  factory Packages97([updates(Packages97Builder b)]) = _$Packages97;
  ...
  PackageLabelInfo97 get packageLabelInfo;

  static Serializer<Packages97> get serializer => _$packages97Serializer;
}

abstract class Coverage97 implements Built<Coverage97, Coverage97Builder> {
  Coverage97._();

  factory Coverage97([updates(Coverage97Builder b)]) = _$Coverage97;
  ...
  InsuredPerson97 get insuredPerson;
  ...
  BuiltList<SubInsurances97> get subInsurances;

  static Serializer<Coverage97> get serializer => _$coverage97Serializer;
}

abstract class InsuredPerson97
    implements Built<InsuredPerson97, InsuredPerson97Builder> {
  InsuredPerson97._();

  factory InsuredPerson97([updates(InsuredPerson97Builder b)]) = _$InsuredPerson97;
  ...
  static Serializer<InsuredPerson97> get serializer => _$insuredPerson97Serializer;
}

abstract class SubInsurances97
    implements Built<SubInsurances97, SubInsurances97Builder> {
  SubInsurances97._();

  factory SubInsurances97([updates(SubInsurances97Builder b)]) = _$SubInsurances97;
  ...
  static Serializer<SubInsurances97> get serializer => _$subInsurances97Serializer;
}

abstract class ShopMap97 implements Built<ShopMap97, ShopMap97Builder> {
  ShopMap97._();

  factory ShopMap97([updates(ShopMap97Builder b)]) = _$ShopMap97;
  ...
  static Serializer<ShopMap97> get serializer => _$shopMap97Serializer;
}

abstract class SupplierMap97 implements Built<SupplierMap97, SupplierMap97Builder> {
  SupplierMap97._();

  factory SupplierMap97([updates(SupplierMap97Builder b)]) = _$SupplierMap97;
  ...
  static Serializer<SupplierMap97> get serializer => _$supplierMap97Serializer;
}

abstract class FilterGroups97
    implements Built<FilterGroups97, FilterGroups97Builder> {
  FilterGroups97._();

  factory FilterGroups97([updates(FilterGroups97Builder b)]) = _$FilterGroups97;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options97> get options;

  static Serializer<FilterGroups97> get serializer => _$filterGroups97Serializer;
}

abstract class Options97 implements Built<Options97, Options97Builder> {
  Options97._();

  factory Options97([updates(Options97Builder b)]) = _$Options97;
  ...
  static Serializer<Options97> get serializer => _$options97Serializer;
}

abstract class PackageLabelInfo97
    implements Built<PackageLabelInfo97, PackageLabelInfo97Builder> {
  PackageLabelInfo97._();

  factory PackageLabelInfo97([updates(PackageLabelInfo97Builder b)]) =
      _$PackageLabelInfo97;
  ...
  static Serializer<PackageLabelInfo97> get serializer =>
      _$packageLabelInfo97Serializer;
}

abstract class ActivityList97
    implements Built<ActivityList97, ActivityList97Builder> {
  ActivityList97._();

  factory ActivityList97([update(ActivityList97Builder b)]) = _$ActivityList97;
  ...
  CardTags97 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList97> get serializer => _$activityList97Serializer;
}

abstract class CardTags97 implements Built<CardTags97, CardTags97Builder> {
  CardTags97._();

  factory CardTags97([update(CardTags97Builder b)]) = _$CardTags97;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags97> get serializer => _$cardTags97Serializer;
}

@SerializersFor([
  SearchResultPollResult97,
])
final Serializers serializers97 = _$serializers97;
