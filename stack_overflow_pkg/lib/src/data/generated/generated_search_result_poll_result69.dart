...
part 'generated_search_result_poll_result69.g.dart';

abstract class SearchResultPollResult69
    implements Built<SearchResultPollResult69, SearchResultPollResult69Builder> {
  SearchResultPollResult69._();

  factory SearchResultPollResult69([updates(SearchResultPollResult69Builder b)]) =
  ...
  BuiltList<VehicleInfoList69> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap69> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap69> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups69> get filterGroups;
  ...
  static Serializer<SearchResultPollResult69> get serializer =>
      _$searchResultPollResult69Serializer;
}

abstract class VehicleInfoList69
    implements Built<VehicleInfoList69, VehicleInfoList69Builder> {
  VehicleInfoList69._();

  factory VehicleInfoList69([updates(VehicleInfoList69Builder b)]) =
      _$VehicleInfoList69;
  ...
  BuiltList<Packages69> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic69> get options;
  ...
  static Serializer<VehicleInfoList69> get serializer =>
      _$vehicleInfoList69Serializer;
}

abstract class VehicleCharacteristic69
    implements Built<VehicleCharacteristic69, VehicleCharacteristic69Builder> {
  VehicleCharacteristic69._();

  factory VehicleCharacteristic69([updates(VehicleCharacteristic69Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic69> get serializer =>
      _$vehicleCharacteristic69Serializer;
}

abstract class Service69 implements Built<Service69, Service69Builder> {
  Service69._();

  factory Service69([updates(Service69Builder b)]) = _$Service69;
  ...
  static Serializer<Service69> get serializer => _$service69Serializer;
}

abstract class Price69 implements Built<Price69, Price69Builder> {
  Price69._();

  factory Price69([updates(Price69Builder b)]) = _$Price69;
  ...
  static Serializer<Price69> get serializer => _$price69Serializer;
}

abstract class Packages69 implements Built<Packages69, Packages69Builder> {
  Packages69._();

  factory Packages69([updates(Packages69Builder b)]) = _$Packages69;
  ...
  PackageLabelInfo69 get packageLabelInfo;

  static Serializer<Packages69> get serializer => _$packages69Serializer;
}

abstract class Coverage69 implements Built<Coverage69, Coverage69Builder> {
  Coverage69._();

  factory Coverage69([updates(Coverage69Builder b)]) = _$Coverage69;
  ...
  InsuredPerson69 get insuredPerson;
  ...
  BuiltList<SubInsurances69> get subInsurances;

  static Serializer<Coverage69> get serializer => _$coverage69Serializer;
}

abstract class InsuredPerson69
    implements Built<InsuredPerson69, InsuredPerson69Builder> {
  InsuredPerson69._();

  factory InsuredPerson69([updates(InsuredPerson69Builder b)]) = _$InsuredPerson69;
  ...
  static Serializer<InsuredPerson69> get serializer => _$insuredPerson69Serializer;
}

abstract class SubInsurances69
    implements Built<SubInsurances69, SubInsurances69Builder> {
  SubInsurances69._();

  factory SubInsurances69([updates(SubInsurances69Builder b)]) = _$SubInsurances69;
  ...
  static Serializer<SubInsurances69> get serializer => _$subInsurances69Serializer;
}

abstract class ShopMap69 implements Built<ShopMap69, ShopMap69Builder> {
  ShopMap69._();

  factory ShopMap69([updates(ShopMap69Builder b)]) = _$ShopMap69;
  ...
  static Serializer<ShopMap69> get serializer => _$shopMap69Serializer;
}

abstract class SupplierMap69 implements Built<SupplierMap69, SupplierMap69Builder> {
  SupplierMap69._();

  factory SupplierMap69([updates(SupplierMap69Builder b)]) = _$SupplierMap69;
  ...
  static Serializer<SupplierMap69> get serializer => _$supplierMap69Serializer;
}

abstract class FilterGroups69
    implements Built<FilterGroups69, FilterGroups69Builder> {
  FilterGroups69._();

  factory FilterGroups69([updates(FilterGroups69Builder b)]) = _$FilterGroups69;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options69> get options;

  static Serializer<FilterGroups69> get serializer => _$filterGroups69Serializer;
}

abstract class Options69 implements Built<Options69, Options69Builder> {
  Options69._();

  factory Options69([updates(Options69Builder b)]) = _$Options69;
  ...
  static Serializer<Options69> get serializer => _$options69Serializer;
}

abstract class PackageLabelInfo69
    implements Built<PackageLabelInfo69, PackageLabelInfo69Builder> {
  PackageLabelInfo69._();

  factory PackageLabelInfo69([updates(PackageLabelInfo69Builder b)]) =
      _$PackageLabelInfo69;
  ...
  static Serializer<PackageLabelInfo69> get serializer =>
      _$packageLabelInfo69Serializer;
}

abstract class ActivityList69
    implements Built<ActivityList69, ActivityList69Builder> {
  ActivityList69._();

  factory ActivityList69([update(ActivityList69Builder b)]) = _$ActivityList69;
  ...
  CardTags69 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList69> get serializer => _$activityList69Serializer;
}

abstract class CardTags69 implements Built<CardTags69, CardTags69Builder> {
  CardTags69._();

  factory CardTags69([update(CardTags69Builder b)]) = _$CardTags69;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags69> get serializer => _$cardTags69Serializer;
}
