...
part 'generated_search_result_poll_result22.g.dart';

abstract class SearchResultPollResult22
    implements Built<SearchResultPollResult22, SearchResultPollResult22Builder> {
  SearchResultPollResult22._();

  factory SearchResultPollResult22([updates(SearchResultPollResult22Builder b)]) =
  ...
  BuiltList<VehicleInfoList22> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap22> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap22> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups22> get filterGroups;
  ...
  static Serializer<SearchResultPollResult22> get serializer =>
      _$searchResultPollResult22Serializer;
}

abstract class VehicleInfoList22
    implements Built<VehicleInfoList22, VehicleInfoList22Builder> {
  VehicleInfoList22._();

  factory VehicleInfoList22([updates(VehicleInfoList22Builder b)]) =
      _$VehicleInfoList22;
  ...
  BuiltList<Packages22> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic22> get options;
  ...
  static Serializer<VehicleInfoList22> get serializer =>
      _$vehicleInfoList22Serializer;
}

abstract class VehicleCharacteristic22
    implements Built<VehicleCharacteristic22, VehicleCharacteristic22Builder> {
  VehicleCharacteristic22._();

  factory VehicleCharacteristic22([updates(VehicleCharacteristic22Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic22> get serializer =>
      _$vehicleCharacteristic22Serializer;
}

abstract class Service22 implements Built<Service22, Service22Builder> {
  Service22._();

  factory Service22([updates(Service22Builder b)]) = _$Service22;
  ...
  static Serializer<Service22> get serializer => _$service22Serializer;
}

abstract class Price22 implements Built<Price22, Price22Builder> {
  Price22._();

  factory Price22([updates(Price22Builder b)]) = _$Price22;
  ...
  static Serializer<Price22> get serializer => _$price22Serializer;
}

abstract class Packages22 implements Built<Packages22, Packages22Builder> {
  Packages22._();

  factory Packages22([updates(Packages22Builder b)]) = _$Packages22;
  ...
  PackageLabelInfo22 get packageLabelInfo;

  static Serializer<Packages22> get serializer => _$packages22Serializer;
}

abstract class Coverage22 implements Built<Coverage22, Coverage22Builder> {
  Coverage22._();

  factory Coverage22([updates(Coverage22Builder b)]) = _$Coverage22;
  ...
  InsuredPerson22 get insuredPerson;
  ...
  BuiltList<SubInsurances22> get subInsurances;

  static Serializer<Coverage22> get serializer => _$coverage22Serializer;
}

abstract class InsuredPerson22
    implements Built<InsuredPerson22, InsuredPerson22Builder> {
  InsuredPerson22._();

  factory InsuredPerson22([updates(InsuredPerson22Builder b)]) = _$InsuredPerson22;
  ...
  static Serializer<InsuredPerson22> get serializer => _$insuredPerson22Serializer;
}

abstract class SubInsurances22
    implements Built<SubInsurances22, SubInsurances22Builder> {
  SubInsurances22._();

  factory SubInsurances22([updates(SubInsurances22Builder b)]) = _$SubInsurances22;
  ...
  static Serializer<SubInsurances22> get serializer => _$subInsurances22Serializer;
}

abstract class ShopMap22 implements Built<ShopMap22, ShopMap22Builder> {
  ShopMap22._();

  factory ShopMap22([updates(ShopMap22Builder b)]) = _$ShopMap22;
  ...
  static Serializer<ShopMap22> get serializer => _$shopMap22Serializer;
}

abstract class SupplierMap22 implements Built<SupplierMap22, SupplierMap22Builder> {
  SupplierMap22._();

  factory SupplierMap22([updates(SupplierMap22Builder b)]) = _$SupplierMap22;
  ...
  static Serializer<SupplierMap22> get serializer => _$supplierMap22Serializer;
}

abstract class FilterGroups22
    implements Built<FilterGroups22, FilterGroups22Builder> {
  FilterGroups22._();

  factory FilterGroups22([updates(FilterGroups22Builder b)]) = _$FilterGroups22;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options22> get options;

  static Serializer<FilterGroups22> get serializer => _$filterGroups22Serializer;
}

abstract class Options22 implements Built<Options22, Options22Builder> {
  Options22._();

  factory Options22([updates(Options22Builder b)]) = _$Options22;
  ...
  static Serializer<Options22> get serializer => _$options22Serializer;
}

abstract class PackageLabelInfo22
    implements Built<PackageLabelInfo22, PackageLabelInfo22Builder> {
  PackageLabelInfo22._();

  factory PackageLabelInfo22([updates(PackageLabelInfo22Builder b)]) =
      _$PackageLabelInfo22;
  ...
  static Serializer<PackageLabelInfo22> get serializer =>
      _$packageLabelInfo22Serializer;
}

abstract class ActivityList22
    implements Built<ActivityList22, ActivityList22Builder> {
  ActivityList22._();

  factory ActivityList22([update(ActivityList22Builder b)]) = _$ActivityList22;
  ...
  CardTags22 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList22> get serializer => _$activityList22Serializer;
}

abstract class CardTags22 implements Built<CardTags22, CardTags22Builder> {
  CardTags22._();

  factory CardTags22([update(CardTags22Builder b)]) = _$CardTags22;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags22> get serializer => _$cardTags22Serializer;
}
