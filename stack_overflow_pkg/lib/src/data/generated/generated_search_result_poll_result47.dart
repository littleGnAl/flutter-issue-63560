...
part 'generated_search_result_poll_result47.g.dart';

abstract class SearchResultPollResult47
    implements Built<SearchResultPollResult47, SearchResultPollResult47Builder> {
  SearchResultPollResult47._();

  factory SearchResultPollResult47([updates(SearchResultPollResult47Builder b)]) =
  ...
  BuiltList<VehicleInfoList47> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap47> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap47> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups47> get filterGroups;
  ...
  static Serializer<SearchResultPollResult47> get serializer =>
      _$searchResultPollResult47Serializer;
}

abstract class VehicleInfoList47
    implements Built<VehicleInfoList47, VehicleInfoList47Builder> {
  VehicleInfoList47._();

  factory VehicleInfoList47([updates(VehicleInfoList47Builder b)]) =
      _$VehicleInfoList47;
  ...
  BuiltList<Packages47> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic47> get options;
  ...
  static Serializer<VehicleInfoList47> get serializer =>
      _$vehicleInfoList47Serializer;
}

abstract class VehicleCharacteristic47
    implements Built<VehicleCharacteristic47, VehicleCharacteristic47Builder> {
  VehicleCharacteristic47._();

  factory VehicleCharacteristic47([updates(VehicleCharacteristic47Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic47> get serializer =>
      _$vehicleCharacteristic47Serializer;
}

abstract class Service47 implements Built<Service47, Service47Builder> {
  Service47._();

  factory Service47([updates(Service47Builder b)]) = _$Service47;
  ...
  static Serializer<Service47> get serializer => _$service47Serializer;
}

abstract class Price47 implements Built<Price47, Price47Builder> {
  Price47._();

  factory Price47([updates(Price47Builder b)]) = _$Price47;
  ...
  static Serializer<Price47> get serializer => _$price47Serializer;
}

abstract class Packages47 implements Built<Packages47, Packages47Builder> {
  Packages47._();

  factory Packages47([updates(Packages47Builder b)]) = _$Packages47;
  ...
  PackageLabelInfo47 get packageLabelInfo;

  static Serializer<Packages47> get serializer => _$packages47Serializer;
}

abstract class Coverage47 implements Built<Coverage47, Coverage47Builder> {
  Coverage47._();

  factory Coverage47([updates(Coverage47Builder b)]) = _$Coverage47;
  ...
  InsuredPerson47 get insuredPerson;
  ...
  BuiltList<SubInsurances47> get subInsurances;

  static Serializer<Coverage47> get serializer => _$coverage47Serializer;
}

abstract class InsuredPerson47
    implements Built<InsuredPerson47, InsuredPerson47Builder> {
  InsuredPerson47._();

  factory InsuredPerson47([updates(InsuredPerson47Builder b)]) = _$InsuredPerson47;
  ...
  static Serializer<InsuredPerson47> get serializer => _$insuredPerson47Serializer;
}

abstract class SubInsurances47
    implements Built<SubInsurances47, SubInsurances47Builder> {
  SubInsurances47._();

  factory SubInsurances47([updates(SubInsurances47Builder b)]) = _$SubInsurances47;
  ...
  static Serializer<SubInsurances47> get serializer => _$subInsurances47Serializer;
}

abstract class ShopMap47 implements Built<ShopMap47, ShopMap47Builder> {
  ShopMap47._();

  factory ShopMap47([updates(ShopMap47Builder b)]) = _$ShopMap47;
  ...
  static Serializer<ShopMap47> get serializer => _$shopMap47Serializer;
}

abstract class SupplierMap47 implements Built<SupplierMap47, SupplierMap47Builder> {
  SupplierMap47._();

  factory SupplierMap47([updates(SupplierMap47Builder b)]) = _$SupplierMap47;
  ...
  static Serializer<SupplierMap47> get serializer => _$supplierMap47Serializer;
}

abstract class FilterGroups47
    implements Built<FilterGroups47, FilterGroups47Builder> {
  FilterGroups47._();

  factory FilterGroups47([updates(FilterGroups47Builder b)]) = _$FilterGroups47;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options47> get options;

  static Serializer<FilterGroups47> get serializer => _$filterGroups47Serializer;
}

abstract class Options47 implements Built<Options47, Options47Builder> {
  Options47._();

  factory Options47([updates(Options47Builder b)]) = _$Options47;
  ...
  static Serializer<Options47> get serializer => _$options47Serializer;
}

abstract class PackageLabelInfo47
    implements Built<PackageLabelInfo47, PackageLabelInfo47Builder> {
  PackageLabelInfo47._();

  factory PackageLabelInfo47([updates(PackageLabelInfo47Builder b)]) =
      _$PackageLabelInfo47;
  ...
  static Serializer<PackageLabelInfo47> get serializer =>
      _$packageLabelInfo47Serializer;
}

abstract class ActivityList47
    implements Built<ActivityList47, ActivityList47Builder> {
  ActivityList47._();

  factory ActivityList47([update(ActivityList47Builder b)]) = _$ActivityList47;
  ...
  CardTags47 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList47> get serializer => _$activityList47Serializer;
}

abstract class CardTags47 implements Built<CardTags47, CardTags47Builder> {
  CardTags47._();

  factory CardTags47([update(CardTags47Builder b)]) = _$CardTags47;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags47> get serializer => _$cardTags47Serializer;
}

@SerializersFor([
  SearchResultPollResult47,
])
final Serializers serializers47 = _$serializers47;
