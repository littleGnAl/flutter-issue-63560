...
part 'generated_search_result_poll_result89.g.dart';

abstract class SearchResultPollResult89
    implements Built<SearchResultPollResult89, SearchResultPollResult89Builder> {
  SearchResultPollResult89._();

  factory SearchResultPollResult89([updates(SearchResultPollResult89Builder b)]) =
  ...
  BuiltList<VehicleInfoList89> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap89> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap89> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups89> get filterGroups;
  ...
  static Serializer<SearchResultPollResult89> get serializer =>
      _$searchResultPollResult89Serializer;
}

abstract class VehicleInfoList89
    implements Built<VehicleInfoList89, VehicleInfoList89Builder> {
  VehicleInfoList89._();

  factory VehicleInfoList89([updates(VehicleInfoList89Builder b)]) =
      _$VehicleInfoList89;
  ...
  BuiltList<Packages89> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic89> get options;
  ...
  static Serializer<VehicleInfoList89> get serializer =>
      _$vehicleInfoList89Serializer;
}

abstract class VehicleCharacteristic89
    implements Built<VehicleCharacteristic89, VehicleCharacteristic89Builder> {
  VehicleCharacteristic89._();

  factory VehicleCharacteristic89([updates(VehicleCharacteristic89Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic89> get serializer =>
      _$vehicleCharacteristic89Serializer;
}

abstract class Service89 implements Built<Service89, Service89Builder> {
  Service89._();

  factory Service89([updates(Service89Builder b)]) = _$Service89;
  ...
  static Serializer<Service89> get serializer => _$service89Serializer;
}

abstract class Price89 implements Built<Price89, Price89Builder> {
  Price89._();

  factory Price89([updates(Price89Builder b)]) = _$Price89;
  ...
  static Serializer<Price89> get serializer => _$price89Serializer;
}

abstract class Packages89 implements Built<Packages89, Packages89Builder> {
  Packages89._();

  factory Packages89([updates(Packages89Builder b)]) = _$Packages89;
  ...
  PackageLabelInfo89 get packageLabelInfo;

  static Serializer<Packages89> get serializer => _$packages89Serializer;
}

abstract class Coverage89 implements Built<Coverage89, Coverage89Builder> {
  Coverage89._();

  factory Coverage89([updates(Coverage89Builder b)]) = _$Coverage89;
  ...
  InsuredPerson89 get insuredPerson;
  ...
  BuiltList<SubInsurances89> get subInsurances;

  static Serializer<Coverage89> get serializer => _$coverage89Serializer;
}

abstract class InsuredPerson89
    implements Built<InsuredPerson89, InsuredPerson89Builder> {
  InsuredPerson89._();

  factory InsuredPerson89([updates(InsuredPerson89Builder b)]) = _$InsuredPerson89;
  ...
  static Serializer<InsuredPerson89> get serializer => _$insuredPerson89Serializer;
}

abstract class SubInsurances89
    implements Built<SubInsurances89, SubInsurances89Builder> {
  SubInsurances89._();

  factory SubInsurances89([updates(SubInsurances89Builder b)]) = _$SubInsurances89;
  ...
  static Serializer<SubInsurances89> get serializer => _$subInsurances89Serializer;
}

abstract class ShopMap89 implements Built<ShopMap89, ShopMap89Builder> {
  ShopMap89._();

  factory ShopMap89([updates(ShopMap89Builder b)]) = _$ShopMap89;
  ...
  static Serializer<ShopMap89> get serializer => _$shopMap89Serializer;
}

abstract class SupplierMap89 implements Built<SupplierMap89, SupplierMap89Builder> {
  SupplierMap89._();

  factory SupplierMap89([updates(SupplierMap89Builder b)]) = _$SupplierMap89;
  ...
  static Serializer<SupplierMap89> get serializer => _$supplierMap89Serializer;
}

abstract class FilterGroups89
    implements Built<FilterGroups89, FilterGroups89Builder> {
  FilterGroups89._();

  factory FilterGroups89([updates(FilterGroups89Builder b)]) = _$FilterGroups89;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options89> get options;

  static Serializer<FilterGroups89> get serializer => _$filterGroups89Serializer;
}

abstract class Options89 implements Built<Options89, Options89Builder> {
  Options89._();

  factory Options89([updates(Options89Builder b)]) = _$Options89;
  ...
  static Serializer<Options89> get serializer => _$options89Serializer;
}

abstract class PackageLabelInfo89
    implements Built<PackageLabelInfo89, PackageLabelInfo89Builder> {
  PackageLabelInfo89._();

  factory PackageLabelInfo89([updates(PackageLabelInfo89Builder b)]) =
      _$PackageLabelInfo89;
  ...
  static Serializer<PackageLabelInfo89> get serializer =>
      _$packageLabelInfo89Serializer;
}

abstract class ActivityList89
    implements Built<ActivityList89, ActivityList89Builder> {
  ActivityList89._();

  factory ActivityList89([update(ActivityList89Builder b)]) = _$ActivityList89;
  ...
  CardTags89 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList89> get serializer => _$activityList89Serializer;
}

abstract class CardTags89 implements Built<CardTags89, CardTags89Builder> {
  CardTags89._();

  factory CardTags89([update(CardTags89Builder b)]) = _$CardTags89;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags89> get serializer => _$cardTags89Serializer;
}
