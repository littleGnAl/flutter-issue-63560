...
part 'generated_search_result_poll_result27.g.dart';

abstract class SearchResultPollResult27
    implements Built<SearchResultPollResult27, SearchResultPollResult27Builder> {
  SearchResultPollResult27._();

  factory SearchResultPollResult27([updates(SearchResultPollResult27Builder b)]) =
  ...
  BuiltList<VehicleInfoList27> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap27> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap27> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups27> get filterGroups;
  ...
  static Serializer<SearchResultPollResult27> get serializer =>
      _$searchResultPollResult27Serializer;
}

abstract class VehicleInfoList27
    implements Built<VehicleInfoList27, VehicleInfoList27Builder> {
  VehicleInfoList27._();

  factory VehicleInfoList27([updates(VehicleInfoList27Builder b)]) =
      _$VehicleInfoList27;
  ...
  BuiltList<Packages27> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic27> get options;
  ...
  static Serializer<VehicleInfoList27> get serializer =>
      _$vehicleInfoList27Serializer;
}

abstract class VehicleCharacteristic27
    implements Built<VehicleCharacteristic27, VehicleCharacteristic27Builder> {
  VehicleCharacteristic27._();

  factory VehicleCharacteristic27([updates(VehicleCharacteristic27Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic27> get serializer =>
      _$vehicleCharacteristic27Serializer;
}

abstract class Service27 implements Built<Service27, Service27Builder> {
  Service27._();

  factory Service27([updates(Service27Builder b)]) = _$Service27;
  ...
  static Serializer<Service27> get serializer => _$service27Serializer;
}

abstract class Price27 implements Built<Price27, Price27Builder> {
  Price27._();

  factory Price27([updates(Price27Builder b)]) = _$Price27;
  ...
  static Serializer<Price27> get serializer => _$price27Serializer;
}

abstract class Packages27 implements Built<Packages27, Packages27Builder> {
  Packages27._();

  factory Packages27([updates(Packages27Builder b)]) = _$Packages27;
  ...
  PackageLabelInfo27 get packageLabelInfo;

  static Serializer<Packages27> get serializer => _$packages27Serializer;
}

abstract class Coverage27 implements Built<Coverage27, Coverage27Builder> {
  Coverage27._();

  factory Coverage27([updates(Coverage27Builder b)]) = _$Coverage27;
  ...
  InsuredPerson27 get insuredPerson;
  ...
  BuiltList<SubInsurances27> get subInsurances;

  static Serializer<Coverage27> get serializer => _$coverage27Serializer;
}

abstract class InsuredPerson27
    implements Built<InsuredPerson27, InsuredPerson27Builder> {
  InsuredPerson27._();

  factory InsuredPerson27([updates(InsuredPerson27Builder b)]) = _$InsuredPerson27;
  ...
  static Serializer<InsuredPerson27> get serializer => _$insuredPerson27Serializer;
}

abstract class SubInsurances27
    implements Built<SubInsurances27, SubInsurances27Builder> {
  SubInsurances27._();

  factory SubInsurances27([updates(SubInsurances27Builder b)]) = _$SubInsurances27;
  ...
  static Serializer<SubInsurances27> get serializer => _$subInsurances27Serializer;
}

abstract class ShopMap27 implements Built<ShopMap27, ShopMap27Builder> {
  ShopMap27._();

  factory ShopMap27([updates(ShopMap27Builder b)]) = _$ShopMap27;
  ...
  static Serializer<ShopMap27> get serializer => _$shopMap27Serializer;
}

abstract class SupplierMap27 implements Built<SupplierMap27, SupplierMap27Builder> {
  SupplierMap27._();

  factory SupplierMap27([updates(SupplierMap27Builder b)]) = _$SupplierMap27;
  ...
  static Serializer<SupplierMap27> get serializer => _$supplierMap27Serializer;
}

abstract class FilterGroups27
    implements Built<FilterGroups27, FilterGroups27Builder> {
  FilterGroups27._();

  factory FilterGroups27([updates(FilterGroups27Builder b)]) = _$FilterGroups27;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options27> get options;

  static Serializer<FilterGroups27> get serializer => _$filterGroups27Serializer;
}

abstract class Options27 implements Built<Options27, Options27Builder> {
  Options27._();

  factory Options27([updates(Options27Builder b)]) = _$Options27;
  ...
  static Serializer<Options27> get serializer => _$options27Serializer;
}

abstract class PackageLabelInfo27
    implements Built<PackageLabelInfo27, PackageLabelInfo27Builder> {
  PackageLabelInfo27._();

  factory PackageLabelInfo27([updates(PackageLabelInfo27Builder b)]) =
      _$PackageLabelInfo27;
  ...
  static Serializer<PackageLabelInfo27> get serializer =>
      _$packageLabelInfo27Serializer;
}

abstract class ActivityList27
    implements Built<ActivityList27, ActivityList27Builder> {
  ActivityList27._();

  factory ActivityList27([update(ActivityList27Builder b)]) = _$ActivityList27;
  ...
  CardTags27 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList27> get serializer => _$activityList27Serializer;
}

abstract class CardTags27 implements Built<CardTags27, CardTags27Builder> {
  CardTags27._();

  factory CardTags27([update(CardTags27Builder b)]) = _$CardTags27;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags27> get serializer => _$cardTags27Serializer;
}

@SerializersFor([
  SearchResultPollResult27,
])
final Serializers serializers27 = _$serializers27;
