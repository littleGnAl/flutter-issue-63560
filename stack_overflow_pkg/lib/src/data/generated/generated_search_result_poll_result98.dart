...
part 'generated_search_result_poll_result98.g.dart';

abstract class SearchResultPollResult98
    implements Built<SearchResultPollResult98, SearchResultPollResult98Builder> {
  SearchResultPollResult98._();

  factory SearchResultPollResult98([updates(SearchResultPollResult98Builder b)]) =
  ...
  BuiltList<VehicleInfoList98> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap98> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap98> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups98> get filterGroups;
  ...
  static Serializer<SearchResultPollResult98> get serializer =>
      _$searchResultPollResult98Serializer;
}

abstract class VehicleInfoList98
    implements Built<VehicleInfoList98, VehicleInfoList98Builder> {
  VehicleInfoList98._();

  factory VehicleInfoList98([updates(VehicleInfoList98Builder b)]) =
      _$VehicleInfoList98;
  ...
  BuiltList<Packages98> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic98> get options;
  ...
  static Serializer<VehicleInfoList98> get serializer =>
      _$vehicleInfoList98Serializer;
}

abstract class VehicleCharacteristic98
    implements Built<VehicleCharacteristic98, VehicleCharacteristic98Builder> {
  VehicleCharacteristic98._();

  factory VehicleCharacteristic98([updates(VehicleCharacteristic98Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic98> get serializer =>
      _$vehicleCharacteristic98Serializer;
}

abstract class Service98 implements Built<Service98, Service98Builder> {
  Service98._();

  factory Service98([updates(Service98Builder b)]) = _$Service98;
  ...
  static Serializer<Service98> get serializer => _$service98Serializer;
}

abstract class Price98 implements Built<Price98, Price98Builder> {
  Price98._();

  factory Price98([updates(Price98Builder b)]) = _$Price98;
  ...
  static Serializer<Price98> get serializer => _$price98Serializer;
}

abstract class Packages98 implements Built<Packages98, Packages98Builder> {
  Packages98._();

  factory Packages98([updates(Packages98Builder b)]) = _$Packages98;
  ...
  PackageLabelInfo98 get packageLabelInfo;

  static Serializer<Packages98> get serializer => _$packages98Serializer;
}

abstract class Coverage98 implements Built<Coverage98, Coverage98Builder> {
  Coverage98._();

  factory Coverage98([updates(Coverage98Builder b)]) = _$Coverage98;
  ...
  InsuredPerson98 get insuredPerson;
  ...
  BuiltList<SubInsurances98> get subInsurances;

  static Serializer<Coverage98> get serializer => _$coverage98Serializer;
}

abstract class InsuredPerson98
    implements Built<InsuredPerson98, InsuredPerson98Builder> {
  InsuredPerson98._();

  factory InsuredPerson98([updates(InsuredPerson98Builder b)]) = _$InsuredPerson98;
  ...
  static Serializer<InsuredPerson98> get serializer => _$insuredPerson98Serializer;
}

abstract class SubInsurances98
    implements Built<SubInsurances98, SubInsurances98Builder> {
  SubInsurances98._();

  factory SubInsurances98([updates(SubInsurances98Builder b)]) = _$SubInsurances98;
  ...
  static Serializer<SubInsurances98> get serializer => _$subInsurances98Serializer;
}

abstract class ShopMap98 implements Built<ShopMap98, ShopMap98Builder> {
  ShopMap98._();

  factory ShopMap98([updates(ShopMap98Builder b)]) = _$ShopMap98;
  ...
  static Serializer<ShopMap98> get serializer => _$shopMap98Serializer;
}

abstract class SupplierMap98 implements Built<SupplierMap98, SupplierMap98Builder> {
  SupplierMap98._();

  factory SupplierMap98([updates(SupplierMap98Builder b)]) = _$SupplierMap98;
  ...
  static Serializer<SupplierMap98> get serializer => _$supplierMap98Serializer;
}

abstract class FilterGroups98
    implements Built<FilterGroups98, FilterGroups98Builder> {
  FilterGroups98._();

  factory FilterGroups98([updates(FilterGroups98Builder b)]) = _$FilterGroups98;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options98> get options;

  static Serializer<FilterGroups98> get serializer => _$filterGroups98Serializer;
}

abstract class Options98 implements Built<Options98, Options98Builder> {
  Options98._();

  factory Options98([updates(Options98Builder b)]) = _$Options98;
  ...
  static Serializer<Options98> get serializer => _$options98Serializer;
}

abstract class PackageLabelInfo98
    implements Built<PackageLabelInfo98, PackageLabelInfo98Builder> {
  PackageLabelInfo98._();

  factory PackageLabelInfo98([updates(PackageLabelInfo98Builder b)]) =
      _$PackageLabelInfo98;
  ...
  static Serializer<PackageLabelInfo98> get serializer =>
      _$packageLabelInfo98Serializer;
}

abstract class ActivityList98
    implements Built<ActivityList98, ActivityList98Builder> {
  ActivityList98._();

  factory ActivityList98([update(ActivityList98Builder b)]) = _$ActivityList98;
  ...
  CardTags98 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList98> get serializer => _$activityList98Serializer;
}

abstract class CardTags98 implements Built<CardTags98, CardTags98Builder> {
  CardTags98._();

  factory CardTags98([update(CardTags98Builder b)]) = _$CardTags98;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags98> get serializer => _$cardTags98Serializer;
}

@SerializersFor([
  SearchResultPollResult98,
])
final Serializers serializers98 = _$serializers98;
