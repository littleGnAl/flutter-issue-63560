...
part 'generated_search_result_poll_result68.g.dart';

abstract class SearchResultPollResult68
    implements Built<SearchResultPollResult68, SearchResultPollResult68Builder> {
  SearchResultPollResult68._();

  factory SearchResultPollResult68([updates(SearchResultPollResult68Builder b)]) =
  ...
  BuiltList<VehicleInfoList68> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap68> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap68> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups68> get filterGroups;
  ...
  static Serializer<SearchResultPollResult68> get serializer =>
      _$searchResultPollResult68Serializer;
}

abstract class VehicleInfoList68
    implements Built<VehicleInfoList68, VehicleInfoList68Builder> {
  VehicleInfoList68._();

  factory VehicleInfoList68([updates(VehicleInfoList68Builder b)]) =
      _$VehicleInfoList68;
  ...
  BuiltList<Packages68> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic68> get options;
  ...
  static Serializer<VehicleInfoList68> get serializer =>
      _$vehicleInfoList68Serializer;
}

abstract class VehicleCharacteristic68
    implements Built<VehicleCharacteristic68, VehicleCharacteristic68Builder> {
  VehicleCharacteristic68._();

  factory VehicleCharacteristic68([updates(VehicleCharacteristic68Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic68> get serializer =>
      _$vehicleCharacteristic68Serializer;
}

abstract class Service68 implements Built<Service68, Service68Builder> {
  Service68._();

  factory Service68([updates(Service68Builder b)]) = _$Service68;
  ...
  static Serializer<Service68> get serializer => _$service68Serializer;
}

abstract class Price68 implements Built<Price68, Price68Builder> {
  Price68._();

  factory Price68([updates(Price68Builder b)]) = _$Price68;
  ...
  static Serializer<Price68> get serializer => _$price68Serializer;
}

abstract class Packages68 implements Built<Packages68, Packages68Builder> {
  Packages68._();

  factory Packages68([updates(Packages68Builder b)]) = _$Packages68;
  ...
  PackageLabelInfo68 get packageLabelInfo;

  static Serializer<Packages68> get serializer => _$packages68Serializer;
}

abstract class Coverage68 implements Built<Coverage68, Coverage68Builder> {
  Coverage68._();

  factory Coverage68([updates(Coverage68Builder b)]) = _$Coverage68;
  ...
  InsuredPerson68 get insuredPerson;
  ...
  BuiltList<SubInsurances68> get subInsurances;

  static Serializer<Coverage68> get serializer => _$coverage68Serializer;
}

abstract class InsuredPerson68
    implements Built<InsuredPerson68, InsuredPerson68Builder> {
  InsuredPerson68._();

  factory InsuredPerson68([updates(InsuredPerson68Builder b)]) = _$InsuredPerson68;
  ...
  static Serializer<InsuredPerson68> get serializer => _$insuredPerson68Serializer;
}

abstract class SubInsurances68
    implements Built<SubInsurances68, SubInsurances68Builder> {
  SubInsurances68._();

  factory SubInsurances68([updates(SubInsurances68Builder b)]) = _$SubInsurances68;
  ...
  static Serializer<SubInsurances68> get serializer => _$subInsurances68Serializer;
}

abstract class ShopMap68 implements Built<ShopMap68, ShopMap68Builder> {
  ShopMap68._();

  factory ShopMap68([updates(ShopMap68Builder b)]) = _$ShopMap68;
  ...
  static Serializer<ShopMap68> get serializer => _$shopMap68Serializer;
}

abstract class SupplierMap68 implements Built<SupplierMap68, SupplierMap68Builder> {
  SupplierMap68._();

  factory SupplierMap68([updates(SupplierMap68Builder b)]) = _$SupplierMap68;
  ...
  static Serializer<SupplierMap68> get serializer => _$supplierMap68Serializer;
}

abstract class FilterGroups68
    implements Built<FilterGroups68, FilterGroups68Builder> {
  FilterGroups68._();

  factory FilterGroups68([updates(FilterGroups68Builder b)]) = _$FilterGroups68;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options68> get options;

  static Serializer<FilterGroups68> get serializer => _$filterGroups68Serializer;
}

abstract class Options68 implements Built<Options68, Options68Builder> {
  Options68._();

  factory Options68([updates(Options68Builder b)]) = _$Options68;
  ...
  static Serializer<Options68> get serializer => _$options68Serializer;
}

abstract class PackageLabelInfo68
    implements Built<PackageLabelInfo68, PackageLabelInfo68Builder> {
  PackageLabelInfo68._();

  factory PackageLabelInfo68([updates(PackageLabelInfo68Builder b)]) =
      _$PackageLabelInfo68;
  ...
  static Serializer<PackageLabelInfo68> get serializer =>
      _$packageLabelInfo68Serializer;
}

abstract class ActivityList68
    implements Built<ActivityList68, ActivityList68Builder> {
  ActivityList68._();

  factory ActivityList68([update(ActivityList68Builder b)]) = _$ActivityList68;
  ...
  CardTags68 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList68> get serializer => _$activityList68Serializer;
}

abstract class CardTags68 implements Built<CardTags68, CardTags68Builder> {
  CardTags68._();

  factory CardTags68([update(CardTags68Builder b)]) = _$CardTags68;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags68> get serializer => _$cardTags68Serializer;
}

@SerializersFor([
  SearchResultPollResult68,
])
final Serializers serializers68 = _$serializers68;
