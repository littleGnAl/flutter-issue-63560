...
part 'generated_search_result_poll_result41.g.dart';

abstract class SearchResultPollResult41
    implements Built<SearchResultPollResult41, SearchResultPollResult41Builder> {
  SearchResultPollResult41._();

  factory SearchResultPollResult41([updates(SearchResultPollResult41Builder b)]) =
  ...
  BuiltList<VehicleInfoList41> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap41> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap41> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups41> get filterGroups;
  ...
  static Serializer<SearchResultPollResult41> get serializer =>
      _$searchResultPollResult41Serializer;
}

abstract class VehicleInfoList41
    implements Built<VehicleInfoList41, VehicleInfoList41Builder> {
  VehicleInfoList41._();

  factory VehicleInfoList41([updates(VehicleInfoList41Builder b)]) =
      _$VehicleInfoList41;
  ...
  BuiltList<Packages41> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic41> get options;
  ...
  static Serializer<VehicleInfoList41> get serializer =>
      _$vehicleInfoList41Serializer;
}

abstract class VehicleCharacteristic41
    implements Built<VehicleCharacteristic41, VehicleCharacteristic41Builder> {
  VehicleCharacteristic41._();

  factory VehicleCharacteristic41([updates(VehicleCharacteristic41Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic41> get serializer =>
      _$vehicleCharacteristic41Serializer;
}

abstract class Service41 implements Built<Service41, Service41Builder> {
  Service41._();

  factory Service41([updates(Service41Builder b)]) = _$Service41;
  ...
  static Serializer<Service41> get serializer => _$service41Serializer;
}

abstract class Price41 implements Built<Price41, Price41Builder> {
  Price41._();

  factory Price41([updates(Price41Builder b)]) = _$Price41;
  ...
  static Serializer<Price41> get serializer => _$price41Serializer;
}

abstract class Packages41 implements Built<Packages41, Packages41Builder> {
  Packages41._();

  factory Packages41([updates(Packages41Builder b)]) = _$Packages41;
  ...
  PackageLabelInfo41 get packageLabelInfo;

  static Serializer<Packages41> get serializer => _$packages41Serializer;
}

abstract class Coverage41 implements Built<Coverage41, Coverage41Builder> {
  Coverage41._();

  factory Coverage41([updates(Coverage41Builder b)]) = _$Coverage41;
  ...
  InsuredPerson41 get insuredPerson;
  ...
  BuiltList<SubInsurances41> get subInsurances;

  static Serializer<Coverage41> get serializer => _$coverage41Serializer;
}

abstract class InsuredPerson41
    implements Built<InsuredPerson41, InsuredPerson41Builder> {
  InsuredPerson41._();

  factory InsuredPerson41([updates(InsuredPerson41Builder b)]) = _$InsuredPerson41;
  ...
  static Serializer<InsuredPerson41> get serializer => _$insuredPerson41Serializer;
}

abstract class SubInsurances41
    implements Built<SubInsurances41, SubInsurances41Builder> {
  SubInsurances41._();

  factory SubInsurances41([updates(SubInsurances41Builder b)]) = _$SubInsurances41;
  ...
  static Serializer<SubInsurances41> get serializer => _$subInsurances41Serializer;
}

abstract class ShopMap41 implements Built<ShopMap41, ShopMap41Builder> {
  ShopMap41._();

  factory ShopMap41([updates(ShopMap41Builder b)]) = _$ShopMap41;
  ...
  static Serializer<ShopMap41> get serializer => _$shopMap41Serializer;
}

abstract class SupplierMap41 implements Built<SupplierMap41, SupplierMap41Builder> {
  SupplierMap41._();

  factory SupplierMap41([updates(SupplierMap41Builder b)]) = _$SupplierMap41;
  ...
  static Serializer<SupplierMap41> get serializer => _$supplierMap41Serializer;
}

abstract class FilterGroups41
    implements Built<FilterGroups41, FilterGroups41Builder> {
  FilterGroups41._();

  factory FilterGroups41([updates(FilterGroups41Builder b)]) = _$FilterGroups41;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options41> get options;

  static Serializer<FilterGroups41> get serializer => _$filterGroups41Serializer;
}

abstract class Options41 implements Built<Options41, Options41Builder> {
  Options41._();

  factory Options41([updates(Options41Builder b)]) = _$Options41;
  ...
  static Serializer<Options41> get serializer => _$options41Serializer;
}

abstract class PackageLabelInfo41
    implements Built<PackageLabelInfo41, PackageLabelInfo41Builder> {
  PackageLabelInfo41._();

  factory PackageLabelInfo41([updates(PackageLabelInfo41Builder b)]) =
      _$PackageLabelInfo41;
  ...
  static Serializer<PackageLabelInfo41> get serializer =>
      _$packageLabelInfo41Serializer;
}

abstract class ActivityList41
    implements Built<ActivityList41, ActivityList41Builder> {
  ActivityList41._();

  factory ActivityList41([update(ActivityList41Builder b)]) = _$ActivityList41;
  ...
  CardTags41 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList41> get serializer => _$activityList41Serializer;
}

abstract class CardTags41 implements Built<CardTags41, CardTags41Builder> {
  CardTags41._();

  factory CardTags41([update(CardTags41Builder b)]) = _$CardTags41;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags41> get serializer => _$cardTags41Serializer;
}
