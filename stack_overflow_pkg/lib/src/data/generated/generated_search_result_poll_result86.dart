...
part 'generated_search_result_poll_result86.g.dart';

abstract class SearchResultPollResult86
    implements Built<SearchResultPollResult86, SearchResultPollResult86Builder> {
  SearchResultPollResult86._();

  factory SearchResultPollResult86([updates(SearchResultPollResult86Builder b)]) =
  ...
  BuiltList<VehicleInfoList86> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap86> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap86> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups86> get filterGroups;
  ...
  static Serializer<SearchResultPollResult86> get serializer =>
      _$searchResultPollResult86Serializer;
}

abstract class VehicleInfoList86
    implements Built<VehicleInfoList86, VehicleInfoList86Builder> {
  VehicleInfoList86._();

  factory VehicleInfoList86([updates(VehicleInfoList86Builder b)]) =
      _$VehicleInfoList86;
  ...
  BuiltList<Packages86> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic86> get options;
  ...
  static Serializer<VehicleInfoList86> get serializer =>
      _$vehicleInfoList86Serializer;
}

abstract class VehicleCharacteristic86
    implements Built<VehicleCharacteristic86, VehicleCharacteristic86Builder> {
  VehicleCharacteristic86._();

  factory VehicleCharacteristic86([updates(VehicleCharacteristic86Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic86> get serializer =>
      _$vehicleCharacteristic86Serializer;
}

abstract class Service86 implements Built<Service86, Service86Builder> {
  Service86._();

  factory Service86([updates(Service86Builder b)]) = _$Service86;
  ...
  static Serializer<Service86> get serializer => _$service86Serializer;
}

abstract class Price86 implements Built<Price86, Price86Builder> {
  Price86._();

  factory Price86([updates(Price86Builder b)]) = _$Price86;
  ...
  static Serializer<Price86> get serializer => _$price86Serializer;
}

abstract class Packages86 implements Built<Packages86, Packages86Builder> {
  Packages86._();

  factory Packages86([updates(Packages86Builder b)]) = _$Packages86;
  ...
  PackageLabelInfo86 get packageLabelInfo;

  static Serializer<Packages86> get serializer => _$packages86Serializer;
}

abstract class Coverage86 implements Built<Coverage86, Coverage86Builder> {
  Coverage86._();

  factory Coverage86([updates(Coverage86Builder b)]) = _$Coverage86;
  ...
  InsuredPerson86 get insuredPerson;
  ...
  BuiltList<SubInsurances86> get subInsurances;

  static Serializer<Coverage86> get serializer => _$coverage86Serializer;
}

abstract class InsuredPerson86
    implements Built<InsuredPerson86, InsuredPerson86Builder> {
  InsuredPerson86._();

  factory InsuredPerson86([updates(InsuredPerson86Builder b)]) = _$InsuredPerson86;
  ...
  static Serializer<InsuredPerson86> get serializer => _$insuredPerson86Serializer;
}

abstract class SubInsurances86
    implements Built<SubInsurances86, SubInsurances86Builder> {
  SubInsurances86._();

  factory SubInsurances86([updates(SubInsurances86Builder b)]) = _$SubInsurances86;
  ...
  static Serializer<SubInsurances86> get serializer => _$subInsurances86Serializer;
}

abstract class ShopMap86 implements Built<ShopMap86, ShopMap86Builder> {
  ShopMap86._();

  factory ShopMap86([updates(ShopMap86Builder b)]) = _$ShopMap86;
  ...
  static Serializer<ShopMap86> get serializer => _$shopMap86Serializer;
}

abstract class SupplierMap86 implements Built<SupplierMap86, SupplierMap86Builder> {
  SupplierMap86._();

  factory SupplierMap86([updates(SupplierMap86Builder b)]) = _$SupplierMap86;
  ...
  static Serializer<SupplierMap86> get serializer => _$supplierMap86Serializer;
}

abstract class FilterGroups86
    implements Built<FilterGroups86, FilterGroups86Builder> {
  FilterGroups86._();

  factory FilterGroups86([updates(FilterGroups86Builder b)]) = _$FilterGroups86;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options86> get options;

  static Serializer<FilterGroups86> get serializer => _$filterGroups86Serializer;
}

abstract class Options86 implements Built<Options86, Options86Builder> {
  Options86._();

  factory Options86([updates(Options86Builder b)]) = _$Options86;
  ...
  static Serializer<Options86> get serializer => _$options86Serializer;
}

abstract class PackageLabelInfo86
    implements Built<PackageLabelInfo86, PackageLabelInfo86Builder> {
  PackageLabelInfo86._();

  factory PackageLabelInfo86([updates(PackageLabelInfo86Builder b)]) =
      _$PackageLabelInfo86;
  ...
  static Serializer<PackageLabelInfo86> get serializer =>
      _$packageLabelInfo86Serializer;
}

abstract class ActivityList86
    implements Built<ActivityList86, ActivityList86Builder> {
  ActivityList86._();

  factory ActivityList86([update(ActivityList86Builder b)]) = _$ActivityList86;
  ...
  CardTags86 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList86> get serializer => _$activityList86Serializer;
}

abstract class CardTags86 implements Built<CardTags86, CardTags86Builder> {
  CardTags86._();

  factory CardTags86([update(CardTags86Builder b)]) = _$CardTags86;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags86> get serializer => _$cardTags86Serializer;
}

@SerializersFor([
  SearchResultPollResult86,
])
final Serializers serializers86 = _$serializers86;
