...
part 'generated_search_result_poll_result25.g.dart';

abstract class SearchResultPollResult25
    implements Built<SearchResultPollResult25, SearchResultPollResult25Builder> {
  SearchResultPollResult25._();

  factory SearchResultPollResult25([updates(SearchResultPollResult25Builder b)]) =
  ...
  BuiltList<VehicleInfoList25> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap25> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap25> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups25> get filterGroups;
  ...
  static Serializer<SearchResultPollResult25> get serializer =>
      _$searchResultPollResult25Serializer;
}

abstract class VehicleInfoList25
    implements Built<VehicleInfoList25, VehicleInfoList25Builder> {
  VehicleInfoList25._();

  factory VehicleInfoList25([updates(VehicleInfoList25Builder b)]) =
      _$VehicleInfoList25;
  ...
  BuiltList<Packages25> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic25> get options;
  ...
  static Serializer<VehicleInfoList25> get serializer =>
      _$vehicleInfoList25Serializer;
}

abstract class VehicleCharacteristic25
    implements Built<VehicleCharacteristic25, VehicleCharacteristic25Builder> {
  VehicleCharacteristic25._();

  factory VehicleCharacteristic25([updates(VehicleCharacteristic25Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic25> get serializer =>
      _$vehicleCharacteristic25Serializer;
}

abstract class Service25 implements Built<Service25, Service25Builder> {
  Service25._();

  factory Service25([updates(Service25Builder b)]) = _$Service25;
  ...
  static Serializer<Service25> get serializer => _$service25Serializer;
}

abstract class Price25 implements Built<Price25, Price25Builder> {
  Price25._();

  factory Price25([updates(Price25Builder b)]) = _$Price25;
  ...
  static Serializer<Price25> get serializer => _$price25Serializer;
}

abstract class Packages25 implements Built<Packages25, Packages25Builder> {
  Packages25._();

  factory Packages25([updates(Packages25Builder b)]) = _$Packages25;
  ...
  PackageLabelInfo25 get packageLabelInfo;

  static Serializer<Packages25> get serializer => _$packages25Serializer;
}

abstract class Coverage25 implements Built<Coverage25, Coverage25Builder> {
  Coverage25._();

  factory Coverage25([updates(Coverage25Builder b)]) = _$Coverage25;
  ...
  InsuredPerson25 get insuredPerson;
  ...
  BuiltList<SubInsurances25> get subInsurances;

  static Serializer<Coverage25> get serializer => _$coverage25Serializer;
}

abstract class InsuredPerson25
    implements Built<InsuredPerson25, InsuredPerson25Builder> {
  InsuredPerson25._();

  factory InsuredPerson25([updates(InsuredPerson25Builder b)]) = _$InsuredPerson25;
  ...
  static Serializer<InsuredPerson25> get serializer => _$insuredPerson25Serializer;
}

abstract class SubInsurances25
    implements Built<SubInsurances25, SubInsurances25Builder> {
  SubInsurances25._();

  factory SubInsurances25([updates(SubInsurances25Builder b)]) = _$SubInsurances25;
  ...
  static Serializer<SubInsurances25> get serializer => _$subInsurances25Serializer;
}

abstract class ShopMap25 implements Built<ShopMap25, ShopMap25Builder> {
  ShopMap25._();

  factory ShopMap25([updates(ShopMap25Builder b)]) = _$ShopMap25;
  ...
  static Serializer<ShopMap25> get serializer => _$shopMap25Serializer;
}

abstract class SupplierMap25 implements Built<SupplierMap25, SupplierMap25Builder> {
  SupplierMap25._();

  factory SupplierMap25([updates(SupplierMap25Builder b)]) = _$SupplierMap25;
  ...
  static Serializer<SupplierMap25> get serializer => _$supplierMap25Serializer;
}

abstract class FilterGroups25
    implements Built<FilterGroups25, FilterGroups25Builder> {
  FilterGroups25._();

  factory FilterGroups25([updates(FilterGroups25Builder b)]) = _$FilterGroups25;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options25> get options;

  static Serializer<FilterGroups25> get serializer => _$filterGroups25Serializer;
}

abstract class Options25 implements Built<Options25, Options25Builder> {
  Options25._();

  factory Options25([updates(Options25Builder b)]) = _$Options25;
  ...
  static Serializer<Options25> get serializer => _$options25Serializer;
}

abstract class PackageLabelInfo25
    implements Built<PackageLabelInfo25, PackageLabelInfo25Builder> {
  PackageLabelInfo25._();

  factory PackageLabelInfo25([updates(PackageLabelInfo25Builder b)]) =
      _$PackageLabelInfo25;
  ...
  static Serializer<PackageLabelInfo25> get serializer =>
      _$packageLabelInfo25Serializer;
}

abstract class ActivityList25
    implements Built<ActivityList25, ActivityList25Builder> {
  ActivityList25._();

  factory ActivityList25([update(ActivityList25Builder b)]) = _$ActivityList25;
  ...
  CardTags25 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList25> get serializer => _$activityList25Serializer;
}

abstract class CardTags25 implements Built<CardTags25, CardTags25Builder> {
  CardTags25._();

  factory CardTags25([update(CardTags25Builder b)]) = _$CardTags25;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags25> get serializer => _$cardTags25Serializer;
}
