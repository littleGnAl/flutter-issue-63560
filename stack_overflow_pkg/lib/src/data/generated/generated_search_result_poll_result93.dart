...
part 'generated_search_result_poll_result93.g.dart';

abstract class SearchResultPollResult93
    implements Built<SearchResultPollResult93, SearchResultPollResult93Builder> {
  SearchResultPollResult93._();

  factory SearchResultPollResult93([updates(SearchResultPollResult93Builder b)]) =
  ...
  BuiltList<VehicleInfoList93> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap93> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap93> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups93> get filterGroups;
  ...
  static Serializer<SearchResultPollResult93> get serializer =>
      _$searchResultPollResult93Serializer;
}

abstract class VehicleInfoList93
    implements Built<VehicleInfoList93, VehicleInfoList93Builder> {
  VehicleInfoList93._();

  factory VehicleInfoList93([updates(VehicleInfoList93Builder b)]) =
      _$VehicleInfoList93;
  ...
  BuiltList<Packages93> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic93> get options;
  ...
  static Serializer<VehicleInfoList93> get serializer =>
      _$vehicleInfoList93Serializer;
}

abstract class VehicleCharacteristic93
    implements Built<VehicleCharacteristic93, VehicleCharacteristic93Builder> {
  VehicleCharacteristic93._();

  factory VehicleCharacteristic93([updates(VehicleCharacteristic93Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic93> get serializer =>
      _$vehicleCharacteristic93Serializer;
}

abstract class Service93 implements Built<Service93, Service93Builder> {
  Service93._();

  factory Service93([updates(Service93Builder b)]) = _$Service93;
  ...
  static Serializer<Service93> get serializer => _$service93Serializer;
}

abstract class Price93 implements Built<Price93, Price93Builder> {
  Price93._();

  factory Price93([updates(Price93Builder b)]) = _$Price93;
  ...
  static Serializer<Price93> get serializer => _$price93Serializer;
}

abstract class Packages93 implements Built<Packages93, Packages93Builder> {
  Packages93._();

  factory Packages93([updates(Packages93Builder b)]) = _$Packages93;
  ...
  PackageLabelInfo93 get packageLabelInfo;

  static Serializer<Packages93> get serializer => _$packages93Serializer;
}

abstract class Coverage93 implements Built<Coverage93, Coverage93Builder> {
  Coverage93._();

  factory Coverage93([updates(Coverage93Builder b)]) = _$Coverage93;
  ...
  InsuredPerson93 get insuredPerson;
  ...
  BuiltList<SubInsurances93> get subInsurances;

  static Serializer<Coverage93> get serializer => _$coverage93Serializer;
}

abstract class InsuredPerson93
    implements Built<InsuredPerson93, InsuredPerson93Builder> {
  InsuredPerson93._();

  factory InsuredPerson93([updates(InsuredPerson93Builder b)]) = _$InsuredPerson93;
  ...
  static Serializer<InsuredPerson93> get serializer => _$insuredPerson93Serializer;
}

abstract class SubInsurances93
    implements Built<SubInsurances93, SubInsurances93Builder> {
  SubInsurances93._();

  factory SubInsurances93([updates(SubInsurances93Builder b)]) = _$SubInsurances93;
  ...
  static Serializer<SubInsurances93> get serializer => _$subInsurances93Serializer;
}

abstract class ShopMap93 implements Built<ShopMap93, ShopMap93Builder> {
  ShopMap93._();

  factory ShopMap93([updates(ShopMap93Builder b)]) = _$ShopMap93;
  ...
  static Serializer<ShopMap93> get serializer => _$shopMap93Serializer;
}

abstract class SupplierMap93 implements Built<SupplierMap93, SupplierMap93Builder> {
  SupplierMap93._();

  factory SupplierMap93([updates(SupplierMap93Builder b)]) = _$SupplierMap93;
  ...
  static Serializer<SupplierMap93> get serializer => _$supplierMap93Serializer;
}

abstract class FilterGroups93
    implements Built<FilterGroups93, FilterGroups93Builder> {
  FilterGroups93._();

  factory FilterGroups93([updates(FilterGroups93Builder b)]) = _$FilterGroups93;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options93> get options;

  static Serializer<FilterGroups93> get serializer => _$filterGroups93Serializer;
}

abstract class Options93 implements Built<Options93, Options93Builder> {
  Options93._();

  factory Options93([updates(Options93Builder b)]) = _$Options93;
  ...
  static Serializer<Options93> get serializer => _$options93Serializer;
}

abstract class PackageLabelInfo93
    implements Built<PackageLabelInfo93, PackageLabelInfo93Builder> {
  PackageLabelInfo93._();

  factory PackageLabelInfo93([updates(PackageLabelInfo93Builder b)]) =
      _$PackageLabelInfo93;
  ...
  static Serializer<PackageLabelInfo93> get serializer =>
      _$packageLabelInfo93Serializer;
}

abstract class ActivityList93
    implements Built<ActivityList93, ActivityList93Builder> {
  ActivityList93._();

  factory ActivityList93([update(ActivityList93Builder b)]) = _$ActivityList93;
  ...
  CardTags93 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList93> get serializer => _$activityList93Serializer;
}

abstract class CardTags93 implements Built<CardTags93, CardTags93Builder> {
  CardTags93._();

  factory CardTags93([update(CardTags93Builder b)]) = _$CardTags93;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags93> get serializer => _$cardTags93Serializer;
}
