...
part 'generated_search_result_poll_result73.g.dart';

abstract class SearchResultPollResult73
    implements Built<SearchResultPollResult73, SearchResultPollResult73Builder> {
  SearchResultPollResult73._();

  factory SearchResultPollResult73([updates(SearchResultPollResult73Builder b)]) =
  ...
  BuiltList<VehicleInfoList73> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap73> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap73> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups73> get filterGroups;
  ...
  static Serializer<SearchResultPollResult73> get serializer =>
      _$searchResultPollResult73Serializer;
}

abstract class VehicleInfoList73
    implements Built<VehicleInfoList73, VehicleInfoList73Builder> {
  VehicleInfoList73._();

  factory VehicleInfoList73([updates(VehicleInfoList73Builder b)]) =
      _$VehicleInfoList73;
  ...
  BuiltList<Packages73> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic73> get options;
  ...
  static Serializer<VehicleInfoList73> get serializer =>
      _$vehicleInfoList73Serializer;
}

abstract class VehicleCharacteristic73
    implements Built<VehicleCharacteristic73, VehicleCharacteristic73Builder> {
  VehicleCharacteristic73._();

  factory VehicleCharacteristic73([updates(VehicleCharacteristic73Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic73> get serializer =>
      _$vehicleCharacteristic73Serializer;
}

abstract class Service73 implements Built<Service73, Service73Builder> {
  Service73._();

  factory Service73([updates(Service73Builder b)]) = _$Service73;
  ...
  static Serializer<Service73> get serializer => _$service73Serializer;
}

abstract class Price73 implements Built<Price73, Price73Builder> {
  Price73._();

  factory Price73([updates(Price73Builder b)]) = _$Price73;
  ...
  static Serializer<Price73> get serializer => _$price73Serializer;
}

abstract class Packages73 implements Built<Packages73, Packages73Builder> {
  Packages73._();

  factory Packages73([updates(Packages73Builder b)]) = _$Packages73;
  ...
  PackageLabelInfo73 get packageLabelInfo;

  static Serializer<Packages73> get serializer => _$packages73Serializer;
}

abstract class Coverage73 implements Built<Coverage73, Coverage73Builder> {
  Coverage73._();

  factory Coverage73([updates(Coverage73Builder b)]) = _$Coverage73;
  ...
  InsuredPerson73 get insuredPerson;
  ...
  BuiltList<SubInsurances73> get subInsurances;

  static Serializer<Coverage73> get serializer => _$coverage73Serializer;
}

abstract class InsuredPerson73
    implements Built<InsuredPerson73, InsuredPerson73Builder> {
  InsuredPerson73._();

  factory InsuredPerson73([updates(InsuredPerson73Builder b)]) = _$InsuredPerson73;
  ...
  static Serializer<InsuredPerson73> get serializer => _$insuredPerson73Serializer;
}

abstract class SubInsurances73
    implements Built<SubInsurances73, SubInsurances73Builder> {
  SubInsurances73._();

  factory SubInsurances73([updates(SubInsurances73Builder b)]) = _$SubInsurances73;
  ...
  static Serializer<SubInsurances73> get serializer => _$subInsurances73Serializer;
}

abstract class ShopMap73 implements Built<ShopMap73, ShopMap73Builder> {
  ShopMap73._();

  factory ShopMap73([updates(ShopMap73Builder b)]) = _$ShopMap73;
  ...
  static Serializer<ShopMap73> get serializer => _$shopMap73Serializer;
}

abstract class SupplierMap73 implements Built<SupplierMap73, SupplierMap73Builder> {
  SupplierMap73._();

  factory SupplierMap73([updates(SupplierMap73Builder b)]) = _$SupplierMap73;
  ...
  static Serializer<SupplierMap73> get serializer => _$supplierMap73Serializer;
}

abstract class FilterGroups73
    implements Built<FilterGroups73, FilterGroups73Builder> {
  FilterGroups73._();

  factory FilterGroups73([updates(FilterGroups73Builder b)]) = _$FilterGroups73;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options73> get options;

  static Serializer<FilterGroups73> get serializer => _$filterGroups73Serializer;
}

abstract class Options73 implements Built<Options73, Options73Builder> {
  Options73._();

  factory Options73([updates(Options73Builder b)]) = _$Options73;
  ...
  static Serializer<Options73> get serializer => _$options73Serializer;
}

abstract class PackageLabelInfo73
    implements Built<PackageLabelInfo73, PackageLabelInfo73Builder> {
  PackageLabelInfo73._();

  factory PackageLabelInfo73([updates(PackageLabelInfo73Builder b)]) =
      _$PackageLabelInfo73;
  ...
  static Serializer<PackageLabelInfo73> get serializer =>
      _$packageLabelInfo73Serializer;
}

abstract class ActivityList73
    implements Built<ActivityList73, ActivityList73Builder> {
  ActivityList73._();

  factory ActivityList73([update(ActivityList73Builder b)]) = _$ActivityList73;
  ...
  CardTags73 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList73> get serializer => _$activityList73Serializer;
}

abstract class CardTags73 implements Built<CardTags73, CardTags73Builder> {
  CardTags73._();

  factory CardTags73([update(CardTags73Builder b)]) = _$CardTags73;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags73> get serializer => _$cardTags73Serializer;
}
