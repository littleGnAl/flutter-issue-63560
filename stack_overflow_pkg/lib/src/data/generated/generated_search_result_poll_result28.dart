...
part 'generated_search_result_poll_result28.g.dart';

abstract class SearchResultPollResult28
    implements Built<SearchResultPollResult28, SearchResultPollResult28Builder> {
  SearchResultPollResult28._();

  factory SearchResultPollResult28([updates(SearchResultPollResult28Builder b)]) =
  ...
  BuiltList<VehicleInfoList28> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap28> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap28> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups28> get filterGroups;
  ...
  static Serializer<SearchResultPollResult28> get serializer =>
      _$searchResultPollResult28Serializer;
}

abstract class VehicleInfoList28
    implements Built<VehicleInfoList28, VehicleInfoList28Builder> {
  VehicleInfoList28._();

  factory VehicleInfoList28([updates(VehicleInfoList28Builder b)]) =
      _$VehicleInfoList28;
  ...
  BuiltList<Packages28> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic28> get options;
  ...
  static Serializer<VehicleInfoList28> get serializer =>
      _$vehicleInfoList28Serializer;
}

abstract class VehicleCharacteristic28
    implements Built<VehicleCharacteristic28, VehicleCharacteristic28Builder> {
  VehicleCharacteristic28._();

  factory VehicleCharacteristic28([updates(VehicleCharacteristic28Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic28> get serializer =>
      _$vehicleCharacteristic28Serializer;
}

abstract class Service28 implements Built<Service28, Service28Builder> {
  Service28._();

  factory Service28([updates(Service28Builder b)]) = _$Service28;
  ...
  static Serializer<Service28> get serializer => _$service28Serializer;
}

abstract class Price28 implements Built<Price28, Price28Builder> {
  Price28._();

  factory Price28([updates(Price28Builder b)]) = _$Price28;
  ...
  static Serializer<Price28> get serializer => _$price28Serializer;
}

abstract class Packages28 implements Built<Packages28, Packages28Builder> {
  Packages28._();

  factory Packages28([updates(Packages28Builder b)]) = _$Packages28;
  ...
  PackageLabelInfo28 get packageLabelInfo;

  static Serializer<Packages28> get serializer => _$packages28Serializer;
}

abstract class Coverage28 implements Built<Coverage28, Coverage28Builder> {
  Coverage28._();

  factory Coverage28([updates(Coverage28Builder b)]) = _$Coverage28;
  ...
  InsuredPerson28 get insuredPerson;
  ...
  BuiltList<SubInsurances28> get subInsurances;

  static Serializer<Coverage28> get serializer => _$coverage28Serializer;
}

abstract class InsuredPerson28
    implements Built<InsuredPerson28, InsuredPerson28Builder> {
  InsuredPerson28._();

  factory InsuredPerson28([updates(InsuredPerson28Builder b)]) = _$InsuredPerson28;
  ...
  static Serializer<InsuredPerson28> get serializer => _$insuredPerson28Serializer;
}

abstract class SubInsurances28
    implements Built<SubInsurances28, SubInsurances28Builder> {
  SubInsurances28._();

  factory SubInsurances28([updates(SubInsurances28Builder b)]) = _$SubInsurances28;
  ...
  static Serializer<SubInsurances28> get serializer => _$subInsurances28Serializer;
}

abstract class ShopMap28 implements Built<ShopMap28, ShopMap28Builder> {
  ShopMap28._();

  factory ShopMap28([updates(ShopMap28Builder b)]) = _$ShopMap28;
  ...
  static Serializer<ShopMap28> get serializer => _$shopMap28Serializer;
}

abstract class SupplierMap28 implements Built<SupplierMap28, SupplierMap28Builder> {
  SupplierMap28._();

  factory SupplierMap28([updates(SupplierMap28Builder b)]) = _$SupplierMap28;
  ...
  static Serializer<SupplierMap28> get serializer => _$supplierMap28Serializer;
}

abstract class FilterGroups28
    implements Built<FilterGroups28, FilterGroups28Builder> {
  FilterGroups28._();

  factory FilterGroups28([updates(FilterGroups28Builder b)]) = _$FilterGroups28;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options28> get options;

  static Serializer<FilterGroups28> get serializer => _$filterGroups28Serializer;
}

abstract class Options28 implements Built<Options28, Options28Builder> {
  Options28._();

  factory Options28([updates(Options28Builder b)]) = _$Options28;
  ...
  static Serializer<Options28> get serializer => _$options28Serializer;
}

abstract class PackageLabelInfo28
    implements Built<PackageLabelInfo28, PackageLabelInfo28Builder> {
  PackageLabelInfo28._();

  factory PackageLabelInfo28([updates(PackageLabelInfo28Builder b)]) =
      _$PackageLabelInfo28;
  ...
  static Serializer<PackageLabelInfo28> get serializer =>
      _$packageLabelInfo28Serializer;
}

abstract class ActivityList28
    implements Built<ActivityList28, ActivityList28Builder> {
  ActivityList28._();

  factory ActivityList28([update(ActivityList28Builder b)]) = _$ActivityList28;
  ...
  CardTags28 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList28> get serializer => _$activityList28Serializer;
}

abstract class CardTags28 implements Built<CardTags28, CardTags28Builder> {
  CardTags28._();

  factory CardTags28([update(CardTags28Builder b)]) = _$CardTags28;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags28> get serializer => _$cardTags28Serializer;
}

@SerializersFor([
  SearchResultPollResult28,
])
final Serializers serializers28 = _$serializers28;
