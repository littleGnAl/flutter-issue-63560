...
part 'generated_search_result_poll_result1.g.dart';

abstract class SearchResultPollResult1
    implements Built<SearchResultPollResult1, SearchResultPollResult1Builder> {
  SearchResultPollResult1._();

  factory SearchResultPollResult1([updates(SearchResultPollResult1Builder b)]) =
  ...
  BuiltList<VehicleInfoList1> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap1> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap1> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups1> get filterGroups;
  ...
  static Serializer<SearchResultPollResult1> get serializer =>
      _$searchResultPollResult1Serializer;
}

abstract class VehicleInfoList1
    implements Built<VehicleInfoList1, VehicleInfoList1Builder> {
  VehicleInfoList1._();

  factory VehicleInfoList1([updates(VehicleInfoList1Builder b)]) =
      _$VehicleInfoList1;
  ...
  BuiltList<Packages1> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic1> get options;
  ...
  static Serializer<VehicleInfoList1> get serializer =>
      _$vehicleInfoList1Serializer;
}

abstract class VehicleCharacteristic1
    implements Built<VehicleCharacteristic1, VehicleCharacteristic1Builder> {
  VehicleCharacteristic1._();

  factory VehicleCharacteristic1([updates(VehicleCharacteristic1Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic1> get serializer =>
      _$vehicleCharacteristic1Serializer;
}

abstract class Service1 implements Built<Service1, Service1Builder> {
  Service1._();

  factory Service1([updates(Service1Builder b)]) = _$Service1;
  ...
  static Serializer<Service1> get serializer => _$service1Serializer;
}

abstract class Price1 implements Built<Price1, Price1Builder> {
  Price1._();

  factory Price1([updates(Price1Builder b)]) = _$Price1;
...
abstract class Packages1 implements Built<Packages1, Packages1Builder> {
  Packages1._();

  factory Packages1([updates(Packages1Builder b)]) = _$Packages1;
  ...
  PackageLabelInfo1 get packageLabelInfo;

  static Serializer<Packages1> get serializer => _$packages1Serializer;
}

abstract class Coverage1 implements Built<Coverage1, Coverage1Builder> {
  Coverage1._();

  factory Coverage1([updates(Coverage1Builder b)]) = _$Coverage1;
  ...
  InsuredPerson1 get insuredPerson;
  ...
  BuiltList<SubInsurances1> get subInsurances;

  static Serializer<Coverage1> get serializer => _$coverage1Serializer;
}

abstract class InsuredPerson1
    implements Built<InsuredPerson1, InsuredPerson1Builder> {
  InsuredPerson1._();

  factory InsuredPerson1([updates(InsuredPerson1Builder b)]) = _$InsuredPerson1;
  ...
  static Serializer<InsuredPerson1> get serializer => _$insuredPerson1Serializer;
}

abstract class SubInsurances1
    implements Built<SubInsurances1, SubInsurances1Builder> {
  SubInsurances1._();

  factory SubInsurances1([updates(SubInsurances1Builder b)]) = _$SubInsurances1;
  ...
  static Serializer<SubInsurances1> get serializer => _$subInsurances1Serializer;
}

abstract class ShopMap1 implements Built<ShopMap1, ShopMap1Builder> {
  ShopMap1._();

  factory ShopMap1([updates(ShopMap1Builder b)]) = _$ShopMap1;
  ...
  static Serializer<ShopMap1> get serializer => _$shopMap1Serializer;
}

abstract class SupplierMap1 implements Built<SupplierMap1, SupplierMap1Builder> {
  SupplierMap1._();

  factory SupplierMap1([updates(SupplierMap1Builder b)]) = _$SupplierMap1;
  ...
  static Serializer<SupplierMap1> get serializer => _$supplierMap1Serializer;
}

abstract class FilterGroups1
    implements Built<FilterGroups1, FilterGroups1Builder> {
  FilterGroups1._();

  factory FilterGroups1([updates(FilterGroups1Builder b)]) = _$FilterGroups1;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options1> get options;

  static Serializer<FilterGroups1> get serializer => _$filterGroups1Serializer;
}

abstract class Options1 implements Built<Options1, Options1Builder> {
  Options1._();

  factory Options1([updates(Options1Builder b)]) = _$Options1;
  ...
  static Serializer<Options1> get serializer => _$options1Serializer;
}

abstract class PackageLabelInfo1
    implements Built<PackageLabelInfo1, PackageLabelInfo1Builder> {
  PackageLabelInfo1._();

  factory PackageLabelInfo1([updates(PackageLabelInfo1Builder b)]) =
      _$PackageLabelInfo1;
  ...
  static Serializer<PackageLabelInfo1> get serializer =>
      _$packageLabelInfo1Serializer;
}

abstract class ActivityList1
    implements Built<ActivityList1, ActivityList1Builder> {
  ActivityList1._();

  factory ActivityList1([update(ActivityList1Builder b)]) = _$ActivityList1;
  ...
  CardTags1 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList1> get serializer => _$activityList1Serializer;
}

abstract class CardTags1 implements Built<CardTags1, CardTags1Builder> {
  CardTags1._();

  factory CardTags1([update(CardTags1Builder b)]) = _$CardTags1;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags1> get serializer => _$cardTags1Serializer;
}

@SerializersFor([
  SearchResultPollResult1,
])
final Serializers serializers1 = _$serializers1;
