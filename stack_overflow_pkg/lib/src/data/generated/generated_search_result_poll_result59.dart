...
part 'generated_search_result_poll_result59.g.dart';

abstract class SearchResultPollResult59
    implements Built<SearchResultPollResult59, SearchResultPollResult59Builder> {
  SearchResultPollResult59._();

  factory SearchResultPollResult59([updates(SearchResultPollResult59Builder b)]) =
  ...
  BuiltList<VehicleInfoList59> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap59> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap59> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups59> get filterGroups;
  ...
  static Serializer<SearchResultPollResult59> get serializer =>
      _$searchResultPollResult59Serializer;
}

abstract class VehicleInfoList59
    implements Built<VehicleInfoList59, VehicleInfoList59Builder> {
  VehicleInfoList59._();

  factory VehicleInfoList59([updates(VehicleInfoList59Builder b)]) =
      _$VehicleInfoList59;
  ...
  BuiltList<Packages59> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic59> get options;
  ...
  static Serializer<VehicleInfoList59> get serializer =>
      _$vehicleInfoList59Serializer;
}

abstract class VehicleCharacteristic59
    implements Built<VehicleCharacteristic59, VehicleCharacteristic59Builder> {
  VehicleCharacteristic59._();

  factory VehicleCharacteristic59([updates(VehicleCharacteristic59Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic59> get serializer =>
      _$vehicleCharacteristic59Serializer;
}

abstract class Service59 implements Built<Service59, Service59Builder> {
  Service59._();

  factory Service59([updates(Service59Builder b)]) = _$Service59;
  ...
  static Serializer<Service59> get serializer => _$service59Serializer;
}

abstract class Price59 implements Built<Price59, Price59Builder> {
  Price59._();

  factory Price59([updates(Price59Builder b)]) = _$Price59;
  ...
  static Serializer<Price59> get serializer => _$price59Serializer;
}

abstract class Packages59 implements Built<Packages59, Packages59Builder> {
  Packages59._();

  factory Packages59([updates(Packages59Builder b)]) = _$Packages59;
  ...
  PackageLabelInfo59 get packageLabelInfo;

  static Serializer<Packages59> get serializer => _$packages59Serializer;
}

abstract class Coverage59 implements Built<Coverage59, Coverage59Builder> {
  Coverage59._();

  factory Coverage59([updates(Coverage59Builder b)]) = _$Coverage59;
  ...
  InsuredPerson59 get insuredPerson;
  ...
  BuiltList<SubInsurances59> get subInsurances;

  static Serializer<Coverage59> get serializer => _$coverage59Serializer;
}

abstract class InsuredPerson59
    implements Built<InsuredPerson59, InsuredPerson59Builder> {
  InsuredPerson59._();

  factory InsuredPerson59([updates(InsuredPerson59Builder b)]) = _$InsuredPerson59;
  ...
  static Serializer<InsuredPerson59> get serializer => _$insuredPerson59Serializer;
}

abstract class SubInsurances59
    implements Built<SubInsurances59, SubInsurances59Builder> {
  SubInsurances59._();

  factory SubInsurances59([updates(SubInsurances59Builder b)]) = _$SubInsurances59;
  ...
  static Serializer<SubInsurances59> get serializer => _$subInsurances59Serializer;
}

abstract class ShopMap59 implements Built<ShopMap59, ShopMap59Builder> {
  ShopMap59._();

  factory ShopMap59([updates(ShopMap59Builder b)]) = _$ShopMap59;
  ...
  static Serializer<ShopMap59> get serializer => _$shopMap59Serializer;
}

abstract class SupplierMap59 implements Built<SupplierMap59, SupplierMap59Builder> {
  SupplierMap59._();

  factory SupplierMap59([updates(SupplierMap59Builder b)]) = _$SupplierMap59;
  ...
  static Serializer<SupplierMap59> get serializer => _$supplierMap59Serializer;
}

abstract class FilterGroups59
    implements Built<FilterGroups59, FilterGroups59Builder> {
  FilterGroups59._();

  factory FilterGroups59([updates(FilterGroups59Builder b)]) = _$FilterGroups59;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options59> get options;

  static Serializer<FilterGroups59> get serializer => _$filterGroups59Serializer;
}

abstract class Options59 implements Built<Options59, Options59Builder> {
  Options59._();

  factory Options59([updates(Options59Builder b)]) = _$Options59;
  ...
  static Serializer<Options59> get serializer => _$options59Serializer;
}

abstract class PackageLabelInfo59
    implements Built<PackageLabelInfo59, PackageLabelInfo59Builder> {
  PackageLabelInfo59._();

  factory PackageLabelInfo59([updates(PackageLabelInfo59Builder b)]) =
      _$PackageLabelInfo59;
  ...
  static Serializer<PackageLabelInfo59> get serializer =>
      _$packageLabelInfo59Serializer;
}

abstract class ActivityList59
    implements Built<ActivityList59, ActivityList59Builder> {
  ActivityList59._();

  factory ActivityList59([update(ActivityList59Builder b)]) = _$ActivityList59;
  ...
  CardTags59 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList59> get serializer => _$activityList59Serializer;
}

abstract class CardTags59 implements Built<CardTags59, CardTags59Builder> {
  CardTags59._();

  factory CardTags59([update(CardTags59Builder b)]) = _$CardTags59;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags59> get serializer => _$cardTags59Serializer;
}

@SerializersFor([
  SearchResultPollResult59,
])
final Serializers serializers59 = _$serializers59;
