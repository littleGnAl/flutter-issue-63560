...
part 'generated_search_result_poll_result9.g.dart';

abstract class SearchResultPollResult9
    implements Built<SearchResultPollResult9, SearchResultPollResult9Builder> {
  SearchResultPollResult9._();

  factory SearchResultPollResult9([updates(SearchResultPollResult9Builder b)]) =
  ...
  BuiltList<VehicleInfoList9> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap9> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap9> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups9> get filterGroups;
  ...
  static Serializer<SearchResultPollResult9> get serializer =>
      _$searchResultPollResult9Serializer;
}

abstract class VehicleInfoList9
    implements Built<VehicleInfoList9, VehicleInfoList9Builder> {
  VehicleInfoList9._();

  factory VehicleInfoList9([updates(VehicleInfoList9Builder b)]) =
      _$VehicleInfoList9;
  ...
  BuiltList<Packages9> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic9> get options;
  ...
  static Serializer<VehicleInfoList9> get serializer =>
      _$vehicleInfoList9Serializer;
}

abstract class VehicleCharacteristic9
    implements Built<VehicleCharacteristic9, VehicleCharacteristic9Builder> {
  VehicleCharacteristic9._();

  factory VehicleCharacteristic9([updates(VehicleCharacteristic9Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic9> get serializer =>
      _$vehicleCharacteristic9Serializer;
}

abstract class Service9 implements Built<Service9, Service9Builder> {
  Service9._();

  factory Service9([updates(Service9Builder b)]) = _$Service9;
  ...
  static Serializer<Service9> get serializer => _$service9Serializer;
}

abstract class Price9 implements Built<Price9, Price9Builder> {
  Price9._();

  factory Price9([updates(Price9Builder b)]) = _$Price9;
  ...
  static Serializer<Price9> get serializer => _$price9Serializer;
}

abstract class Packages9 implements Built<Packages9, Packages9Builder> {
  Packages9._();

  factory Packages9([updates(Packages9Builder b)]) = _$Packages9;
  ...
  PackageLabelInfo9 get packageLabelInfo;

  static Serializer<Packages9> get serializer => _$packages9Serializer;
}

abstract class Coverage9 implements Built<Coverage9, Coverage9Builder> {
  Coverage9._();

  factory Coverage9([updates(Coverage9Builder b)]) = _$Coverage9;
  ...
  InsuredPerson9 get insuredPerson;
  ...
  BuiltList<SubInsurances9> get subInsurances;

  static Serializer<Coverage9> get serializer => _$coverage9Serializer;
}

abstract class InsuredPerson9
    implements Built<InsuredPerson9, InsuredPerson9Builder> {
  InsuredPerson9._();

  factory InsuredPerson9([updates(InsuredPerson9Builder b)]) = _$InsuredPerson9;
  ...
  static Serializer<InsuredPerson9> get serializer => _$insuredPerson9Serializer;
}

abstract class SubInsurances9
    implements Built<SubInsurances9, SubInsurances9Builder> {
  SubInsurances9._();

  factory SubInsurances9([updates(SubInsurances9Builder b)]) = _$SubInsurances9;
  ...
  static Serializer<SubInsurances9> get serializer => _$subInsurances9Serializer;
}

abstract class ShopMap9 implements Built<ShopMap9, ShopMap9Builder> {
  ShopMap9._();

  factory ShopMap9([updates(ShopMap9Builder b)]) = _$ShopMap9;
  ...
  static Serializer<ShopMap9> get serializer => _$shopMap9Serializer;
}

abstract class SupplierMap9 implements Built<SupplierMap9, SupplierMap9Builder> {
  SupplierMap9._();

  factory SupplierMap9([updates(SupplierMap9Builder b)]) = _$SupplierMap9;
  ...
  static Serializer<SupplierMap9> get serializer => _$supplierMap9Serializer;
}

abstract class FilterGroups9
    implements Built<FilterGroups9, FilterGroups9Builder> {
  FilterGroups9._();

  factory FilterGroups9([updates(FilterGroups9Builder b)]) = _$FilterGroups9;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options9> get options;

  static Serializer<FilterGroups9> get serializer => _$filterGroups9Serializer;
}

abstract class Options9 implements Built<Options9, Options9Builder> {
  Options9._();

  factory Options9([updates(Options9Builder b)]) = _$Options9;
  ...
  static Serializer<Options9> get serializer => _$options9Serializer;
}

abstract class PackageLabelInfo9
    implements Built<PackageLabelInfo9, PackageLabelInfo9Builder> {
  PackageLabelInfo9._();

  factory PackageLabelInfo9([updates(PackageLabelInfo9Builder b)]) =
      _$PackageLabelInfo9;
  ...
  static Serializer<PackageLabelInfo9> get serializer =>
      _$packageLabelInfo9Serializer;
}

abstract class ActivityList9
    implements Built<ActivityList9, ActivityList9Builder> {
  ActivityList9._();

  factory ActivityList9([update(ActivityList9Builder b)]) = _$ActivityList9;
  ...
  CardTags9 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList9> get serializer => _$activityList9Serializer;
}

abstract class CardTags9 implements Built<CardTags9, CardTags9Builder> {
  CardTags9._();

  factory CardTags9([update(CardTags9Builder b)]) = _$CardTags9;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags9> get serializer => _$cardTags9Serializer;
}

@SerializersFor([
  SearchResultPollResult9,
])
final Serializers serializers9 = _$serializers9;
