...
part 'generated_search_result_poll_result84.g.dart';

abstract class SearchResultPollResult84
    implements Built<SearchResultPollResult84, SearchResultPollResult84Builder> {
  SearchResultPollResult84._();

  factory SearchResultPollResult84([updates(SearchResultPollResult84Builder b)]) =
  ...
  BuiltList<VehicleInfoList84> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap84> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap84> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups84> get filterGroups;
  ...
  static Serializer<SearchResultPollResult84> get serializer =>
      _$searchResultPollResult84Serializer;
}

abstract class VehicleInfoList84
    implements Built<VehicleInfoList84, VehicleInfoList84Builder> {
  VehicleInfoList84._();

  factory VehicleInfoList84([updates(VehicleInfoList84Builder b)]) =
      _$VehicleInfoList84;
  ...
  BuiltList<Packages84> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic84> get options;
  ...
  static Serializer<VehicleInfoList84> get serializer =>
      _$vehicleInfoList84Serializer;
}

abstract class VehicleCharacteristic84
    implements Built<VehicleCharacteristic84, VehicleCharacteristic84Builder> {
  VehicleCharacteristic84._();

  factory VehicleCharacteristic84([updates(VehicleCharacteristic84Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic84> get serializer =>
      _$vehicleCharacteristic84Serializer;
}

abstract class Service84 implements Built<Service84, Service84Builder> {
  Service84._();

  factory Service84([updates(Service84Builder b)]) = _$Service84;
  ...
  static Serializer<Service84> get serializer => _$service84Serializer;
}

abstract class Price84 implements Built<Price84, Price84Builder> {
  Price84._();

  factory Price84([updates(Price84Builder b)]) = _$Price84;
  ...
  static Serializer<Price84> get serializer => _$price84Serializer;
}

abstract class Packages84 implements Built<Packages84, Packages84Builder> {
  Packages84._();

  factory Packages84([updates(Packages84Builder b)]) = _$Packages84;
  ...
  PackageLabelInfo84 get packageLabelInfo;

  static Serializer<Packages84> get serializer => _$packages84Serializer;
}

abstract class Coverage84 implements Built<Coverage84, Coverage84Builder> {
  Coverage84._();

  factory Coverage84([updates(Coverage84Builder b)]) = _$Coverage84;
  ...
  InsuredPerson84 get insuredPerson;
  ...
  BuiltList<SubInsurances84> get subInsurances;

  static Serializer<Coverage84> get serializer => _$coverage84Serializer;
}

abstract class InsuredPerson84
    implements Built<InsuredPerson84, InsuredPerson84Builder> {
  InsuredPerson84._();

  factory InsuredPerson84([updates(InsuredPerson84Builder b)]) = _$InsuredPerson84;
  ...
  static Serializer<InsuredPerson84> get serializer => _$insuredPerson84Serializer;
}

abstract class SubInsurances84
    implements Built<SubInsurances84, SubInsurances84Builder> {
  SubInsurances84._();

  factory SubInsurances84([updates(SubInsurances84Builder b)]) = _$SubInsurances84;
  ...
  static Serializer<SubInsurances84> get serializer => _$subInsurances84Serializer;
}

abstract class ShopMap84 implements Built<ShopMap84, ShopMap84Builder> {
  ShopMap84._();

  factory ShopMap84([updates(ShopMap84Builder b)]) = _$ShopMap84;
  ...
  static Serializer<ShopMap84> get serializer => _$shopMap84Serializer;
}

abstract class SupplierMap84 implements Built<SupplierMap84, SupplierMap84Builder> {
  SupplierMap84._();

  factory SupplierMap84([updates(SupplierMap84Builder b)]) = _$SupplierMap84;
  ...
  static Serializer<SupplierMap84> get serializer => _$supplierMap84Serializer;
}

abstract class FilterGroups84
    implements Built<FilterGroups84, FilterGroups84Builder> {
  FilterGroups84._();

  factory FilterGroups84([updates(FilterGroups84Builder b)]) = _$FilterGroups84;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options84> get options;

  static Serializer<FilterGroups84> get serializer => _$filterGroups84Serializer;
}

abstract class Options84 implements Built<Options84, Options84Builder> {
  Options84._();

  factory Options84([updates(Options84Builder b)]) = _$Options84;
  ...
  static Serializer<Options84> get serializer => _$options84Serializer;
}

abstract class PackageLabelInfo84
    implements Built<PackageLabelInfo84, PackageLabelInfo84Builder> {
  PackageLabelInfo84._();

  factory PackageLabelInfo84([updates(PackageLabelInfo84Builder b)]) =
      _$PackageLabelInfo84;
  ...
  static Serializer<PackageLabelInfo84> get serializer =>
      _$packageLabelInfo84Serializer;
}

abstract class ActivityList84
    implements Built<ActivityList84, ActivityList84Builder> {
  ActivityList84._();

  factory ActivityList84([update(ActivityList84Builder b)]) = _$ActivityList84;
  ...
  CardTags84 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList84> get serializer => _$activityList84Serializer;
}

abstract class CardTags84 implements Built<CardTags84, CardTags84Builder> {
  CardTags84._();

  factory CardTags84([update(CardTags84Builder b)]) = _$CardTags84;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags84> get serializer => _$cardTags84Serializer;
}
