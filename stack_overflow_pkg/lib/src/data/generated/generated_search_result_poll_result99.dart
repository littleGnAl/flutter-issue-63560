...
part 'generated_search_result_poll_result99.g.dart';

abstract class SearchResultPollResult99
    implements Built<SearchResultPollResult99, SearchResultPollResult99Builder> {
  SearchResultPollResult99._();

  factory SearchResultPollResult99([updates(SearchResultPollResult99Builder b)]) =
  ...
  BuiltList<VehicleInfoList99> get vehicleInfoList;

  @nullable
  @BuiltValueField(wireName: 'shop_map')
  BuiltMap<String, ShopMap99> get shopMaps;

  @nullable
  @BuiltValueField(wireName: 'supplier_map')
  BuiltMap<String, SupplierMap99> get supplierMaps;

  @nullable
  @BuiltValueField(wireName: 'filter_groups')
  BuiltList<FilterGroups99> get filterGroups;
  ...
  static Serializer<SearchResultPollResult99> get serializer =>
      _$searchResultPollResult99Serializer;
}

abstract class VehicleInfoList99
    implements Built<VehicleInfoList99, VehicleInfoList99Builder> {
  VehicleInfoList99._();

  factory VehicleInfoList99([updates(VehicleInfoList99Builder b)]) =
      _$VehicleInfoList99;
  ...
  BuiltList<Packages99> get packages;

  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<VehicleCharacteristic99> get options;
  ...
  static Serializer<VehicleInfoList99> get serializer =>
      _$vehicleInfoList99Serializer;
}

abstract class VehicleCharacteristic99
    implements Built<VehicleCharacteristic99, VehicleCharacteristic99Builder> {
  VehicleCharacteristic99._();

  factory VehicleCharacteristic99([updates(VehicleCharacteristic99Builder b)]) =
  ...
  static Serializer<VehicleCharacteristic99> get serializer =>
      _$vehicleCharacteristic99Serializer;
}

abstract class Service99 implements Built<Service99, Service99Builder> {
  Service99._();

  factory Service99([updates(Service99Builder b)]) = _$Service99;
  ...
  static Serializer<Service99> get serializer => _$service99Serializer;
}

abstract class Price99 implements Built<Price99, Price99Builder> {
  Price99._();

  factory Price99([updates(Price99Builder b)]) = _$Price99;
  ...
  static Serializer<Price99> get serializer => _$price99Serializer;
}

abstract class Packages99 implements Built<Packages99, Packages99Builder> {
  Packages99._();

  factory Packages99([updates(Packages99Builder b)]) = _$Packages99;
  ...
  PackageLabelInfo99 get packageLabelInfo;

  static Serializer<Packages99> get serializer => _$packages99Serializer;
}

abstract class Coverage99 implements Built<Coverage99, Coverage99Builder> {
  Coverage99._();

  factory Coverage99([updates(Coverage99Builder b)]) = _$Coverage99;
  ...
  InsuredPerson99 get insuredPerson;
  ...
  BuiltList<SubInsurances99> get subInsurances;

  static Serializer<Coverage99> get serializer => _$coverage99Serializer;
}

abstract class InsuredPerson99
    implements Built<InsuredPerson99, InsuredPerson99Builder> {
  InsuredPerson99._();

  factory InsuredPerson99([updates(InsuredPerson99Builder b)]) = _$InsuredPerson99;
  ...
  static Serializer<InsuredPerson99> get serializer => _$insuredPerson99Serializer;
}

abstract class SubInsurances99
    implements Built<SubInsurances99, SubInsurances99Builder> {
  SubInsurances99._();

  factory SubInsurances99([updates(SubInsurances99Builder b)]) = _$SubInsurances99;
  ...
  static Serializer<SubInsurances99> get serializer => _$subInsurances99Serializer;
}

abstract class ShopMap99 implements Built<ShopMap99, ShopMap99Builder> {
  ShopMap99._();

  factory ShopMap99([updates(ShopMap99Builder b)]) = _$ShopMap99;
  ...
  static Serializer<ShopMap99> get serializer => _$shopMap99Serializer;
}

abstract class SupplierMap99 implements Built<SupplierMap99, SupplierMap99Builder> {
  SupplierMap99._();

  factory SupplierMap99([updates(SupplierMap99Builder b)]) = _$SupplierMap99;
  ...
  static Serializer<SupplierMap99> get serializer => _$supplierMap99Serializer;
}

abstract class FilterGroups99
    implements Built<FilterGroups99, FilterGroups99Builder> {
  FilterGroups99._();

  factory FilterGroups99([updates(FilterGroups99Builder b)]) = _$FilterGroups99;
  ...
  @nullable
  @BuiltValueField(wireName: 'options')
  BuiltList<Options99> get options;

  static Serializer<FilterGroups99> get serializer => _$filterGroups99Serializer;
}

abstract class Options99 implements Built<Options99, Options99Builder> {
  Options99._();

  factory Options99([updates(Options99Builder b)]) = _$Options99;
  ...
  static Serializer<Options99> get serializer => _$options99Serializer;
}

abstract class PackageLabelInfo99
    implements Built<PackageLabelInfo99, PackageLabelInfo99Builder> {
  PackageLabelInfo99._();

  factory PackageLabelInfo99([updates(PackageLabelInfo99Builder b)]) =
      _$PackageLabelInfo99;
  ...
  static Serializer<PackageLabelInfo99> get serializer =>
      _$packageLabelInfo99Serializer;
}

abstract class ActivityList99
    implements Built<ActivityList99, ActivityList99Builder> {
  ActivityList99._();

  factory ActivityList99([update(ActivityList99Builder b)]) = _$ActivityList99;
  ...
  CardTags99 get cardTags;

  @nullable
  @BuiltValueField(wireName: 'native_path')
  String get nativePath;

  static Serializer<ActivityList99> get serializer => _$activityList99Serializer;
}

abstract class CardTags99 implements Built<CardTags99, CardTags99Builder> {
  CardTags99._();

  factory CardTags99([update(CardTags99Builder b)]) = _$CardTags99;

  @nullable
  @BuiltValueField(wireName: 'bestseller')
  String get bestseller;

  static Serializer<CardTags99> get serializer => _$cardTags99Serializer;
}

@SerializersFor([
  SearchResultPollResult99,
])
final Serializers serializers99 = _$serializers99;
